# 🏗️ development Architecture Documentation
...
### Purpose
The development module serves as [describe purpose and role in TerraFusion ecosystem].
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: development
        image: terrafusion/development:latest
        ports:
        - containerPort: 3000
```
