...
echo 🌟 TerraFusionSync: Port 5002 - STARTING...
timeout /t 1 /nobreak >nul
echo 🌟 TerraAgent: Port 5003 - STARTING...
timeout /t 1 /nobreak >nul
echo 🌟 TerraFlow: Port 5001 - STARTING...
timeout /t 1 /nobreak >nul
echo 🌟 TerraMiner: Port 5006 - STARTING...
timeout /t 1 /nobreak >nul
echo 🌟 TerraLevy: Port 5007 - STARTING...
timeout /t 1 /nobreak >nul
echo 🌟 CostForge: Port 5008 - STARTING...
timeout /t 1 /nobreak >nul
