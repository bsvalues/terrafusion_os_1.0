...
echo IDE_PORT=5173 >> "%PACKAGE_DIR%\Config\terrafusion.config"
echo BACKEND_PORT=5000 >> "%PACKAGE_DIR%\Config\terrafusion.config"
...
echo start "TerraFusion Backend" cmd /k "cd Backend && dotnet run --project TerraFusion.API --urls http://localhost:5000" >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
...
echo start http://localhost:5173 >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
echo echo. >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
echo echo TerraFusion Ultimate IDE is starting up! >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
echo echo Frontend: http://localhost:5173 >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
echo echo Backend: http://localhost:5000 >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
echo echo. >> "%PACKAGE_DIR%\START_TERRAFUSION_ULTIMATE.bat"
...
echo 3. Access IDE at http://localhost:5173 >> "%PACKAGE_DIR%\PACKAGE_INFO.txt"
echo. >> "%PACKAGE_DIR%\PACKAGE_INFO.txt"
...
echo 3. Access IDE at http://localhost:5173
echo.
