  ...
  public async monitorOperation<T>(
    ...
    return tracer.startActiveSpan(operationName, {
      ...
      try {
        ...
        // Record metrics
        this.responseTimeHistogram.observe({ operation: operationName, status: 'success' }, duration);
        ...
        this.responseTimeHistogram.observe({ operation: operationName, status: 'error' }, duration);
