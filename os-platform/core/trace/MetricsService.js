...
const TraceAccessControl_js_1 = require("./TraceAccessControl.js");
// ============================================================================
// Metrics Service
// ============================================================================
class MetricsService {
     ...
     */
    filterByWindow(events, start, end) {
    ...
    getSummary(window, countyId) {
        ...
        const uniqueParcels = new Set(invocations.filter(e => e.context.parcelId).map(e => e.context.parcelId)).size;
        // Get denial metrics
        const denials = (0, TraceAccessControl_js_1.getAccessDeniedMetrics)();
        return {
            window,
     ...
     */
    computeDashboardMetrics(countyId, window = '24h') {
        return this.getSummary(window, countyId);
    }
    /**
     * Get recent high-risk activity.
     */
    getHighRiskFeed(limit = 50, countyId) {
        // Get recent events
...
function createMetricsService(traceService) {
