...
exports.LocalAgentReleasePlan = void 0;
exports.renderLocalAgentReleasePlan = renderLocalAgentReleasePlan;
...
class LocalAgentReleasePlan {
    ...
    inspect() {
        const steps = RELEASE_STEPS.map(step => ({
            ...step,
            present: (0, node_fs_1.existsSync)((0, eventLog_js_1.terrafusionPath)(this.repoRoot, step.artifact)),
        }));
...
exports.LocalAgentReleasePlan = LocalAgentReleasePlan;
function renderLocalAgentReleasePlan(report) {
    const lines = [];
