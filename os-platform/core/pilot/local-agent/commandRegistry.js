...
exports.LocalAgentCommandRegistryBuilder = void 0;
exports.listLocalAgentCommands = listLocalAgentCommands;
exports.renderLocalAgentCommandRegistry = renderLocalAgentCommandRegistry;
const node_fs_1 = require("node:fs");
const eventLog_js_1 = require("./eventLog.js");
const LOCAL_AGENT_GLOBAL_OPTIONS = [
    {
        name: '--repo-root',
...
class LocalAgentCommandRegistryBuilder {
    ...
    build() {
        ...
        (0, node_fs_1.writeFileSync)((0, eventLog_js_1.terrafusionPath)(this.repoRoot, 'command-registry.json'), JSON.stringify(registry, null, 2), 'utf8');
        (0, node_fs_1.writeFileSync)((0, eventLog_js_1.terrafusionPath)(this.repoRoot, 'command-registry.md'), renderLocalAgentCommandRegistry(registry), 'utf8');
        (0, eventLog_js_1.appendLocalAgentEvent)(this.repoRoot, 'command_registry_written', {
...
exports.LocalAgentCommandRegistryBuilder = LocalAgentCommandRegistryBuilder;
function listLocalAgentCommands() {
    return LOCAL_AGENT_COMMANDS.map(command => ({ ...command }));
}
function renderLocalAgentCommandRegistry(registry) {
