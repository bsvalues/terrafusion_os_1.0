...
Generated: 2026-05-19T23:47:03.123Z
...
3. Fix terrafusionmarket.com public access posture: usable signup/access request or remove misleading signup route.
4. Resolve June 10 red-team critical attacks until the verdict is no longer RED.
5. Prove Rust engine deployment in the live runtime path or remove Rust from launch claims.
6. Re-run this production readiness audit and keep the verdict below full readiness until all blockers clear.
