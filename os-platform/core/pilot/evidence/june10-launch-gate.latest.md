...
Generated: 2026-05-20T00:35:17.108Z
...
- **api_health**: API health is not live now. Stale readiness evidence is not accepted. (fetch failed)
- **endpoint_smoke**: Endpoint contract smoke did not pass from live probes. (4 failed probe(s), 4 contract mismatch(es))
