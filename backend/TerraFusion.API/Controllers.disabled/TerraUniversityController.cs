...
public class TerraUniversityController : ControllerBase
{
    ...
    public async Task<IActionResult> SubmitAssessment(string assessmentId, [FromBody] SubmitAssessmentRequest request)
    {
        try
        {
    ...
    public async Task<IActionResult> IssueCertification([FromBody] IssueCertificationRequest request)
    {
        try
        {
    ...
    public async Task<IActionResult> GetLearningRecommendations(string employeeId)
    {
        try
        {
