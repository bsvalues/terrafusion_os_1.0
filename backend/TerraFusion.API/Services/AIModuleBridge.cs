...
namespace TerraFusion.API.Services
{
    ...
    public class AIModuleBridge : IAIModuleBridge
    {
        ...
        /// </summary>
        public Task<AIAgentAssignment> GetDedicatedAgentAsync(string moduleId, string task)
        {
            try
            {
                ...
                return Task.FromResult(new AIAgentAssignment
                {
        ...
        /// </summary>
        public Task<List<AICapability>> GetAvailableCapabilitiesAsync(string moduleId)
        {
        ...
        private Task<List<string>> AssignAgentsToModule(string moduleId, ModuleAICapabilities capabilities)
        {
