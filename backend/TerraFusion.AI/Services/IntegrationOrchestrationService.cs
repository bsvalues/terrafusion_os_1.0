        ...
        private void InitializeSystemConnectors()
        {
            ...
            var systems = new[]
            {
                ...
                new SystemConnectorState
                {
                    ...
                    Status = "connected",
                    Version = "8.2.1",
                    Endpoint = "https://tyler-vision.benton.wa.gov/api",
                ...
                new SystemConnectorState
                {
                    ...
                    Status = "connected",
                    Version = "2023.4",
                    Endpoint = "https://aumentum.benton.wa.gov/api",
                ...
                new SystemConnectorState
                {
                    ...
                    Status = "connected",
                    Version = "10.9.1",
                    Endpoint = "https://gis.benton.wa.gov/arcgis/rest/services",
                ...
                new SystemConnectorState
                {
                    ...
                    Status = "connected",
                    Version = "11.0",
                    Endpoint = "https://docs.benton.wa.gov/api",
