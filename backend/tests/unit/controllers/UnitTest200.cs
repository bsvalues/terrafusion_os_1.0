...
/// <summary>
/// UnitTest200 - AI Generated Unit Test
/// Component: Component200
/// Generated: 2025-10-18 23:26:09 UTC
/// </summary>
public class UnitTest200 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component200>> _loggerMock;
    private readonly Component200 _component;

    public UnitTest200(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component200>>();
        _component = new Component200(_loggerMock.Object);
    }
