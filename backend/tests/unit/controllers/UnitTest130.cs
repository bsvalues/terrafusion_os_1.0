...
/// <summary>
/// UnitTest130 - AI Generated Unit Test
/// Component: Component130
/// Generated: 2025-10-18 23:26:09 UTC
/// </summary>
public class UnitTest130 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component130>> _loggerMock;
    private readonly Component130 _component;

    public UnitTest130(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component130>>();
        _component = new Component130(_loggerMock.Object);
    }
