...
/// <summary>
/// UnitTest380 - AI Generated Unit Test
/// Component: Component380
/// Generated: 2025-10-18 23:26:10 UTC
/// </summary>
public class UnitTest380 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component380>> _loggerMock;
    private readonly Component380 _component;

    public UnitTest380(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component380>>();
        _component = new Component380(_loggerMock.Object);
    }
