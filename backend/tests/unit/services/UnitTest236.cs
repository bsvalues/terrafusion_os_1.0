...
/// <summary>
/// UnitTest236 - AI Generated Unit Test
/// Component: Component236
/// Generated: 2025-10-18 23:26:09 UTC
/// </summary>
public class UnitTest236 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component236>> _loggerMock;
    private readonly Component236 _component;

    public UnitTest236(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component236>>();
        _component = new Component236(_loggerMock.Object);
    }
