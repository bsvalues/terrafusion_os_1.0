...
/// <summary>
/// UnitTest300 - AI Generated Unit Test
/// Component: Component300
/// Generated: 2025-10-18 23:26:10 UTC
/// </summary>
public class UnitTest300 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component300>> _loggerMock;
    private readonly Component300 _component;

    public UnitTest300(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component300>>();
        _component = new Component300(_loggerMock.Object);
    }
