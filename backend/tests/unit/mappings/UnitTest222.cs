...
/// <summary>
/// UnitTest222 - AI Generated Unit Test
/// Component: Component222
/// Generated: 2025-10-18 23:26:09 UTC
/// </summary>
public class UnitTest222 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component222>> _loggerMock;
    private readonly Component222 _component;

    public UnitTest222(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component222>>();
        _component = new Component222(_loggerMock.Object);
    }
