...
/// <summary>
/// UnitTest180 - AI Generated Unit Test
/// Component: Component180
/// Generated: 2025-10-18 23:26:09 UTC
/// </summary>
public class UnitTest180 : TerraFusionTestBase
{
    private readonly Mock<ILogger<Component180>> _loggerMock;
    private readonly Component180 _component;

    public UnitTest180(TestSetup factory) : base(factory)
    {
        _loggerMock = new Mock<ILogger<Component180>>();
        _component = new Component180(_loggerMock.Object);
    }
