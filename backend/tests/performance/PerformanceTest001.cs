...
/// <summary>
/// PerformanceTest001 - AI Generated Performance Test
...
public class PerformanceTest001
{
    ...
    {
        var scenario = Scenario.Create("Component1 load test", async context =>
        {
            ...
            var response = await httpClient.PostAsJsonAsync(
                "http://localhost:5000/api/Component1/process", 
                requestData);
