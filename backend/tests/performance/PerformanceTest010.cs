...
/// <summary>
/// PerformanceTest010 - AI Generated Performance Test
...
public class PerformanceTest010
{
    ...
    {
        var scenario = Scenario.Create("Component10 load test", async context =>
        {
            ...
            var response = await httpClient.PostAsJsonAsync(
                "http://localhost:5000/api/Component10/process", 
                requestData);
