...
/// <summary>
/// IntegrationTest130 - AI Generated Integration Test
/// Component: Component130
/// Generated: 2025-10-18 23:26:11 UTC
/// </summary>
public class IntegrationTest130 : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> _factory;
    private readonly HttpClient _client;

    public IntegrationTest130(WebApplicationFactory<Program> factory)
    {
        _factory = factory;
    ...
    public async Task EndpointIntegration_ValidRequest_ReturnsExpectedResponse()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/api/Component130", requestData);
    ...
    public async Task DatabaseIntegration_CRUD_Operations_WorkCorrectly()
    {
        ...
        // Act - Create
        var createResponse = await _client.PostAsJsonAsync("/api/Component130", entity);
        ...
        // Act - Read
        var readResponse = await _client.GetAsync("/api/Component130/{entityId}");
        readResponse.IsSuccessStatusCode.Should().BeTrue();
        
        // Act - Update  
        entity.UpdatedField = "Modified Value";
        var updateResponse = await _client.PutAsJsonAsync("/api/Component130/{entityId}", entity);
        updateResponse.IsSuccessStatusCode.Should().BeTrue();
        
        // Act - Delete
        var deleteResponse = await _client.DeleteAsync("/api/Component130/{entityId}");
        deleteResponse.IsSuccessStatusCode.Should().BeTrue();
        
        // Assert - Verify deletion
        var verifyResponse = await _client.GetAsync("/api/Component130/{entityId}");
