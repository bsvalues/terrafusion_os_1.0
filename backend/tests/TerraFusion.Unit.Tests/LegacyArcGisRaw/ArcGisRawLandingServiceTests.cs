...
public sealed class ArcGisRawLandingServiceTests : IDisposable
{
    ...
    public async Task HappyPath_LandsAllFeatures_WithFullProvenance()
    {
        ...
        var result = await BuildService(client).LandParcelGeomsAsync("53005", countyId, "d1-test");
    ...
    public async Task LandedRows_PreserveAllFeatureFields_Verbatim()
    {
        ...
        await BuildService(client).LandParcelGeomsAsync("53005", countyId, "d1-test");
    ...
    public async Task SameObjectId_DifferentCounties_IsAllowed()
    {
        ...
        var result = await BuildService(client).LandParcelGeomsAsync("53005", benton, "d1-test");
    ...
    public async Task RerunSameCounty_CreatesNewBatch_DoesNotClearOldRows()
    {
        ...
        var run1 = await BuildService(client).LandParcelGeomsAsync("53005", countyId, "d1-run1");
        var run2 = await BuildService(client).LandParcelGeomsAsync("53005", countyId, "d1-run2");
