    ...
    : IClassFixture<Cx16AuthorizationGateFactory>, IAsyncLifetime
{
  ...
  private HttpClient CreateAuthenticatedClient(Guid countyId, string countyCode, string role = "Assessor", string[]? perms = null)
  {
...
public sealed class Cx16AuthorizationGateFactory : WebApplicationFactory<ApiProgram>
{
  ...
  protected override void ConfigureWebHost(IWebHostBuilder builder)
  {
    ...
    builder.ConfigureTestServices(services =>
    {
      ...
      // CX-16: Use REAL DynamicModulePolicyProvider + PluginPermissionHandler
      // instead of stub-to-authenticated policies
      ...
      // Empty plugin repo — CX-16 tests JWT perm claims, not plugin access
...
public sealed class Cx16TestAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
  ...
  protected override Task<AuthenticateResult> HandleAuthenticateAsync()
  {
    ...
    // CX-16: Support perm claims via header for real policy enforcement
