...
namespace TerraFusion.Security.Models
{
    ...
    /// <summary>
    /// Consolidated LDAP authentication result (canonical definition).
    /// Merges fields from all previous duplicates.
    /// </summary>
    public class LdapAuthResult
    {
        ...
        {
            return new LdapAuthResult { Success = true, User = user, IsAuthenticated = true };
        }
