        ...
        .AddJwtBearer(options =>
        {
            ...
            options.Events = new JwtBearerEvents
            {
                ...
                OnTokenValidated = context =>
                {
                    ...
                    {
                        var validationContext = new TokenValidationContext
                        {
                            SecurityToken = context.SecurityToken,
                            Principal = context.Principal,
                            HttpContext = context.HttpContext
                        };
                        return tokenValidationService.ValidateGovernmentTokenAsync(validationContext);
                    }
                    return Task.CompletedTask;
                },
                ...
                OnChallenge = context =>
                {
                    ...
                    context.Response.Headers.Append("X-Government-Auth-Required", "true");
                    context.Response.Headers.Append("X-Compliance-Level", "FISMA-HIGH");
                    return Task.CompletedTask;
                }
            };
        });
