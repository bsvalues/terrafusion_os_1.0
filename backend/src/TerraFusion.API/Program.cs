...
// R2-W2: Register IAtlasService for real Benton County GIS/spatial data
builder.Services.AddScoped<TerraFusion.Core.Services.IAtlasService, TerraFusion.Core.Services.AtlasService>();
