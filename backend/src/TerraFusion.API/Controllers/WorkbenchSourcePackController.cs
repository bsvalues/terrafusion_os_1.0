...
/// <summary>
/// WORKBENCH-V0.3 SLICE-K: OS Shell Source Pack Fit Panel endpoints.
///
/// <para>
/// Surfaces two operations:
/// <list type="bullet">
///   <item><see cref="Run"/> — spawns pack-validator-runner.mjs and returns raw pipe-delimited stdout.</item>
...
{
    private readonly IPackValidatorRunnerService _service;

    public WorkbenchSourcePackController(IPackValidatorRunnerService service)
    {
        _service = service;
    }

    /// <summary>
    /// Spawns <c>pack-validator-runner.mjs</c> and returns the raw pipe-delimited output.
    ...
    public async Task<IActionResult> Run(CancellationToken ct)
    {
        ...
        catch (Exception ex)
        {
            ...
            {
                error    = $"Failed to start pack validator process: {ex.Message}",
                exitCode = 2,
            });
        }
    ...
    /// <summary>
    /// Returns whether a pack validator run is currently in progress.
