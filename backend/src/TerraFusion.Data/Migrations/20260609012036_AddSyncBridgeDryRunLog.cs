...
{
    /// <inheritdoc />
    public partial class AddSyncBridgeDryRunLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PreviewRunId = table.Column<Guid>(type: "uuid", nullable: false),
                    CountyId = table.Column<Guid>(type: "uuid", nullable: true),
                    CountyCode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Lane = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    OperationalYear = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dry_run_log", x => x.PreviewRunId);
                    table.CheckConstraint("ck_dry_run_log_is_preview", "\"IsPreview\" = true");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_dry_run_log_CountyId_RequestedAt",
                schema: "sync_bridge",
                table: "dry_run_log",
                columns: new[] { "CountyId", "RequestedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_dry_run_log_Lane",
                schema: "sync_bridge",
                table: "dry_run_log",
                column: "Lane");

            migrationBuilder.CreateIndex(
                name: "IX_dry_run_log_RequestedAt",
                schema: "sync_bridge",
                table: "dry_run_log",
                column: "RequestedAt");
