...
namespace TerraFusion.Data.Migrations
{
    ...
    [Migration("20260612212854_ForgeValuationReferenceData")]
    partial class ForgeValuationReferenceData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.CamaImprovementDetail", b =>
                {
                    ...
                    b.ToTable("cama_improvement_details");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.Pacs.PacsLevyCertificationAggregateLimit", b =>
                {
                    ...
                    b.ToTable("pacs_levy_cert_agg_limits");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.Pacs.PacsLevyCertificationConstitutionalLimit", b =>
                {
                    ...
                    b.ToTable("pacs_levy_cert_const_limits");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.Pacs.PacsLevyCertificationHighestLawful", b =>
                {
                    ...
                    b.ToTable("pacs_levy_cert_highest_lawful");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.Pacs.PacsLevyTaxAreaAssoc", b =>
                {
                    ...
                    b.ToTable("pacs_levy_tax_area_assocs");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.ParcelAdjustmentRecord", b =>
                {
                    ...
                    b.ToTable("ParcelAdjustmentRecords");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.PropertyWorkbenchFlag", b =>
                {
                    ...
                    b.ToTable("PropertyWorkbenchFlags");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.SaleComparableRecord", b =>
                {
                    ...
                    b.ToTable("SaleComparableRecords");
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.SyncBridge.DryRunLog", b =>
                {
                    ...
                    b.ToTable("dry_run_log", "sync_bridge", t =>
                        {
                            t.HasCheckConstraint("ck_dry_run_log_is_preview", "\"IsPreview\" = true");
                        });
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.TerraForge.CompSet", b =>
                {
                    b.Property<Guid>("CompSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("CertifiedAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("FederationStatus")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<string>("PromotedFromMode")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<string>("ProvenanceMutation")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("ProvenancePersistence")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("ProvenanceRuntime")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.Property<Guid?>("SourceCompSetId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SubjectParcelId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("CountyId", "CompSetId")
                        .HasDatabaseName("IX_CompSets_CountyId_CompSetId");

                    b.HasIndex("CountyId", "SourceCompSetId")
                        .HasDatabaseName("IX_CompSets_CountyId_SourceCompSetId");

                    b.HasIndex("CountyId", "Mode", "Status")
                        .HasDatabaseName("IX_CompSets_CountyId_Mode_Status");

                    b.ToTable("CompSets", (string)null);
                });

            modelBuilder.Entity("TerraFusion.Core.Entities.TerraForge.CompSetCandidate", b =>
                {
                    b.Property<Guid>("CompSetCandidateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DiagnosisVersion")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<string>("DiagnosticFlagsJson")
                        .HasColumnType("text");
                    ...
                    b.HasKey("CompSetCandidateId");

                    b.HasIndex("CompSetId");
                    ...
                    b.ToTable("CompSetCandidates", (string)null);
                });

            modelBuilder.Entity("TerraFusion.Core.Entities.TerraForge.CompSetCandidateReview", b =>
                {
                    b.Property<Guid>("CompSetCandidateReviewId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AcknowledgedFlagsJson")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("QualificationOverride")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasKey("CompSetCandidateReviewId");

                    b.HasIndex("CountyId", "CompSetCandidateId")
                        .IsUnique()
                    ...
                    b.ToTable("CompSetCandidateReviews", (string)null);
                });
            ...
            modelBuilder.Entity("TerraFusion.Core.Entities.TerraForge.CompSetCandidate", b =>
                {
                    b.HasOne("TerraFusion.Core.Entities.TerraForge.CompSet", "CompSet")
                        .WithMany("Candidates")
                        .HasForeignKey("CompSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompSet");
                });
