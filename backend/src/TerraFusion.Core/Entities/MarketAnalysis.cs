...
/// <summary>
/// R2 Wave 29 — Market area analysis result with county isolation.
...
public class MarketAnalysis
{
    ...
    /// <summary>Coefficient of dispersion (COD) — ratio-study quality metric.</summary>
    public double CoefficientOfDispersion { get; set; }

    /// <summary>Price-related differential (PRD) — vertical equity metric.</summary>
