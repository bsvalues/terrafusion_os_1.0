...
describe('PropertyValuationForm', () => {
  it('renders initial state with required fields', async () => {
  ...
  it('handles state transitions and async submit', async () => {
  ...
  it('guards permissions (read-only when cannot edit)', async () => {
  ...
  it('resilient to null/undefined props', () => {
    renderForm({ defaultBedrooms: undefined, defaultBathrooms: null as any });
