...
- **Controller**: `backend/Terrafusion.API/Controllers/HarrisPACSIntegrationController.cs`
- **Service**: `backend/Terrafusion.Core/Services/HarrisPACSIntegrationService.cs`
