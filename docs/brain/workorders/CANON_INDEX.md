...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; E1/E2 parity sequence complete; E3 bounded extraction scope audit active |
