...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; mixed-domain snapshot rejected and Dossier evidence-registry read decomposition active |
