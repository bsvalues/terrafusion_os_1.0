...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; E3 rejected direct extraction and F1 built-fresh Atlas projection foundation is active |
