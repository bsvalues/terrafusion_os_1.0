...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; Atlas F1 merged standalone and unwired, and Dais contract/isolation preparation is active |
