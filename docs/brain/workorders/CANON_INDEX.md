...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; Atlas read contract frozen; adapter/parity preparation active |
