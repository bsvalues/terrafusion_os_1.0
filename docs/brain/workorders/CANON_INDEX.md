...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; Dais decomposition is complete, its implementation is authority-gated, and Dossier preparation is active |
