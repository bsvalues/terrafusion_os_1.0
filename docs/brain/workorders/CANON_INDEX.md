...
| Five-suite repository program | [`five-suite-federated-repository-buildout.md`](programs/five-suite-federated-repository-buildout.md) | Active federated topology; Atlas extraction blocked; Atlas read-contract implementation/freeze active |
