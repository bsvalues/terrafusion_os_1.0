...
| TerraFusion Owner-Usable Product V1 | [`terrafusion-owner-usable-product-v1.md`](programs/terrafusion-owner-usable-product-v1.md) | ACTIVE under Issue #1589 / `OWNER-TUOP-V1-MISSION-AUTHORITY-20260911`; product-recovery loop with live Product Reality Matrix; terminal `TERRAFUSION_OWNER_USABLE_PRODUCT_V1: PASS` on an exact launched candidate; feeds WAL production gates |
