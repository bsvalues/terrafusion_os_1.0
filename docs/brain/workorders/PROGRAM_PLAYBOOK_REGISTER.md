...
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md)                   | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between cohorts; WO-SR-007A complete and authority consumed             | Portfolio reconciliation                                                  | Highest-value dependency-cleared bounded node             | Operator recomputes the portfolio and admits bounded work inside existing authority                     | Stop only when the selected successor requires new protected runtime, extraction, deployment, production, county/PACS/SQL, credential, ownership-transfer, cutover, or conflicting authority                                                                                           |
