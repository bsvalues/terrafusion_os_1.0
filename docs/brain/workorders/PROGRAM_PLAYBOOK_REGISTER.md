...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Governed Multi-Agent Operator Activation](programs/governed-multi-agent-operator-activation.md) | `GOAL-MAO-001` | `LOOP-MAO-001` | Active; operator merge ratified but inactive | `WO-MAO-001` | `WO-MAO-002` | Continue inside recorded program, file, action, and risk authority | MAO-001 is Mode A; MAO-002 activates only after two exact PRs/final SHAs/scopes/reviewer/expiry are registered and the governed-spine interlock passes |
