...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Governed Multi-Agent Operator Activation](programs/governed-multi-agent-operator-activation.md) | `GOAL-MAO-001` | `LOOP-MAO-001` | Active; MAO-002 pilot complete with independent post-merge assurance | `WO-MAO-003` | `WO-MAO-004` | Continue through the ratified MAO chain; reservations must now be mechanically enforced | Stop on protected boundary, failed required gate, unresolved collision, scope expansion, or new owner authority |
