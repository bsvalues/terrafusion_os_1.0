...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; GPT source-identity decomposition | `WO-SR-005E-A2` ready | GPT source-identity projection verdict | Continue R2 design/evidence automatically; do not infer adapter, extraction, provider, runtime, or F1 authority | Stop on implementation outside a newly bounded envelope, extraction, custody/persistence, runtime/provider adoption, packages/publication, unrelated workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
