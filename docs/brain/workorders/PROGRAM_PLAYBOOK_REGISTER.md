...
*(Updated 2026-07-16 - WO-PORTFOLIO-004 standing operator authority ratification)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Standing delivery authority active; ALL_LANES_PARKED remains the live graph result | `WO-PORTFOLIO-004` complete on protected merge | None until a canonical node is admitted or a recorded wall is cleared | Auto-select, deliver, merge, and continue dependency-cleared authorized nodes | Standing authority covers routine delivery only; protected boundaries remain walls |
