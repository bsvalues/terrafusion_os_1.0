...
*(Updated 2026-07-08 — WO-BACKEND-OE-013; WO-CODEX-OP-008 register integration; WO-OP-AUTO-012 operator autonomy; WO-REL-004 release tag/version evidence model)*
...
| [Release Engineering](programs/release-engineering.md) | `GOAL-TF-RELEASE-ENGINEERING-001` | `LOOP-TF-RELEASE-ENGINEERING-001` | Active | `WO-REL-004` | `WO-REL-005` | Auto only for docs/governance evidence contracts after owner-selected Release Engineering lane | Stop on CI/workflow/deployment/runtime/schema/secrets/county/PACS/live-resource scope |
