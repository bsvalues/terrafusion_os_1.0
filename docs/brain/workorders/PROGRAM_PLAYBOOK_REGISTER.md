...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between GPT cohorts | `WO-SR-005E-A2` complete | `WO-SR-005E-E0` proposed; exact R3 authority required | Resume automatically only after the bounded E0 envelope is recorded; do not infer adapter, extraction, provider, runtime, or F1 authority | Stop on ungranted implementation, extraction, custody/persistence, runtime/provider adoption, packages/publication, unrelated workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
