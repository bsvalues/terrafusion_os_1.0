...
*(Updated 2026-07-28 - Forge non-production persistent-selection rehearsal complete)*

| Program | Goal | Loop | Status | Current WO | Next WO | Continuation | Stop Rules |
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between cohorts; WO-SR-006C complete and authority consumed | Portfolio reconciliation | No successor automatically admitted | Recompute the bounded dependency-cleared graph | Stop on canonical configuration, production/deployment, source retirement, cutover, protected resources, credentials, or new scope |
