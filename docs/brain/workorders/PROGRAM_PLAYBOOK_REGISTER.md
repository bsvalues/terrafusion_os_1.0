...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active with exact implementation-authority boundary; all R2 contract design complete | `WO-SR-005E-I` proposed/authority-gated | Dais, Dossier, and GPT contract implementation WOs | Resume only under exact R3 non-core source authority | Stop on runtime/provider adoption, packages, workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
