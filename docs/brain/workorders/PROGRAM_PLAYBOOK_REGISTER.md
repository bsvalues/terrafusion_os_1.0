...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between bounded cohorts; Dais E1/E2 complete | `WO-SR-005C-E2` complete | Portfolio reconciliation; F1 not authorized | Reconcile the next dependency-cleared bounded cohort; do not infer F1 authority | Stop on extraction, runtime/provider adoption, packages/publication, unrelated workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
