...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active in owner-authorized Dossier E1/E2 cohort | `WO-SR-005D-E1` complete | `WO-SR-005D-E2` active | Continue automatically through E2 under the bounded envelope; do not infer extraction, custody, runtime, or F1 authority | Stop on extraction, custody/persistence, runtime/provider adoption, packages/publication, unrelated workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
