...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; Forge shadow-consumption envelope granted | `WO-SR-006A` active | Forge producer, then sovereign shadow consumer | Continue automatically inside `OWNER-SR-006A-R3-FORGE-SHADOW-CONSUMPTION-20260728` | Stop on new credentials, hash mismatch, runtime mutation, publication, deployment, protected resources, or scope expansion |
