...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; Dais decomposition complete, implementation authority-gated | `WO-SR-005D-P` Dossier custody/evidence-integrity preparation | Exact Dossier contract decomposition if coherent | Continue read-only R2 evidence | Stop on implementation, source copying, packages, workflows, county/PACS/SQL, secrets, deployment, or cutover |
