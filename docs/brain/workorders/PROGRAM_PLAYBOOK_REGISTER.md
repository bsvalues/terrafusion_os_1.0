...
*(Updated 2026-07-17 - WO-PORTFOLIO-007 unscoped Workbench tab handoff)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - unscoped Workbench tab handoff selected | `WO-PORTFOLIO-007` complete on protected merge | Portfolio reconciliation | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
