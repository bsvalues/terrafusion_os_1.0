...
_(Updated 2026-08-20 - WO-SR-009D complete; authority consumed; portfolio reconciliation current)_

| Program                                                                                                            | Goal                                     | Loop                                     | Status                                                                       | Current WO                                                                | Next state                                                  | Continuation                                                                                         | Stop Rules                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md)                   | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between cohorts; WO-SR-009D complete and authority consumed             | None; portfolio reconciliation current                                      | Select only an authorized dependency-cleared successor       | Recompute portfolio; do not infer GPT runtime adoption or another Dossier successor                    | Stop on missing authority, protected resources, deployment, live data, schema/persistence, cutover, or new product direction                                                                                                                                                                                                             |
