...
*(Updated 2026-07-17 - WO-ATLAS-008 GIS package Mapbox token metadata disposition audit)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - Atlas metadata contract aligned; portfolio reconciliation next | `WO-ATLAS-009` complete on protected merge | `WO-PORTFOLIO-010` Post-Atlas Portfolio Reconciliation | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
