...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; GPT preparation complete, current adapter not parity-safe | `WO-SR-005E-C` GPT grounded-context contract decomposition | Bounded implementation only if decomposition and authority pass | Continue exact R2 docs/evidence design | Stop on implementation, provider calls, source copying, packages, workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
