...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Contract-freeze cohort complete; broader extraction remains gated | `WO-SR-005E-I` complete on merge | Portfolio reconciliation | Sequential R3 envelope consumed on terminal merge | Stop on runtime/provider adoption, packages, workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
