...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between cohorts; Dais A/E3 audits complete | `WO-SR-005C-A` and `WO-SR-005C-E3` complete | `WO-SR-005C-E1` proposed / exact R3 envelope required | Continue E1 to E2 only under the proposed bounded envelope; F1 remains later | Stop on extraction, runtime/provider adoption, packages, workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
