...
*(Updated 2026-07-18 - WO-LOCAL-095 recovered the historical Docker store and isolated the remaining container-reconstitution boundary)*
...
| [Local OMEN Runtime Repair](programs/ACTIVE_PROGRAM_PLAYBOOK.md#program-5---local-omen-runtime-repair) | `GOAL-LOCAL-OMEN-RUNTIME-REPAIR` | `LOOP-LOCAL-OMEN-RUNTIME-REPAIR` | Engine recovered - proof containers require bounded reconstitution | `WO-LOCAL-095` complete | Proposed `WO-LOCAL-096` proof-container recovery | No auto container mutation | Recreate only named proof containers under an exact data-preserving runtime envelope |
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Reconciled - follow-on protected boundary | `WO-LOCAL-095` complete | Proposed `WO-LOCAL-096` proof-container recovery | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Container recreation/build requires an exact runtime envelope; other successors retain their recorded boundaries |
...
| Local OMEN proof containers are absent after historical Docker-store recovery | Proposed WO-LOCAL-096 | Exact data-preserving container recreation and app-image provenance before SW-09 mutation |
