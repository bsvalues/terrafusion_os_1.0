...
*(Updated 2026-07-13 — PROGRAM-MAO-001 governance reconciliation and pilot routing)*

| Program | Goal | Loop | Status | Current WO | Next WO | Continuation | Stop Rules |
|---------|------|------|--------|------------|---------|--------------|------------|
| [Governed Multi-Agent Operator Activation](programs/governed-multi-agent-operator-activation.md) | `GOAL-MAO-001` | `LOOP-MAO-001` | Active | `WO-MAO-001` | `WO-MAO-002` | Continue inside recorded program, file, action, and risk authority | Stop only at a true authority wall; MAO-002 merge authority is limited to its two exact dispatch PRs after reservations exist |
