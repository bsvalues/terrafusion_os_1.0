...
| [Release Engineering](programs/release-engineering.md) | `GOAL-TF-RELEASE-ENGINEERING-001` | `LOOP-TF-RELEASE-ENGINEERING-001` | Active | `WO-REL-003` | `WO-REL-004` | Auto only for docs/governance evidence contracts after owner-selected Release Engineering lane | Stop on CI/workflow/deployment/runtime/schema/secrets/county/PACS/live-resource scope |
