...
*(Updated 2026-07-17 - WO-PORTFOLIO-005 evidence publisher capacity repair)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - standing delivery authority plus bounded publisher repair | `WO-PORTFOLIO-005` complete on protected merge | Portfolio reconciliation | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive evidence handling, or protected boundaries |
