...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; Dais preparation complete and appeal decomposition admitted | `WO-SR-005C-C` Dais appeal-workflow contract decomposition | Bounded contract implementation/freeze only if decomposition is implementation-ready | Continue exact R2 docs/evidence design | Stop on contract/runtime implementation, source copying, packages, workflows, county/PACS/SQL, secrets, deployment, or cutover |
