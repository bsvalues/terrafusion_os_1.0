...
_(Updated 2026-08-06 - WO-SR-009C approved and blocked at exact Point-mapping scope wall)_

| Program                                                                                                            | Goal                                     | Loop                                     | Status                                                                       | Current WO                                                                | Next state                                                  | Continuation                                                                                         | Stop Rules                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md)                   | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; WO-SR-009C approved but product execution suspended at exact scope wall | `WO-SR-009C` blocked: `FROZEN_ADAPTER_POINT_MAPPING_AUTH_REQUIRED`          | Exact adapter/test amendment decision                        | Continue automatically after amendment; no per-stage relay                                           | Stop on frozen-adapter or out-of-allowlist change, Atlas mutation, legacy anonymous GIS adoption, protected resources, deployment, or failed required proof                                                                                                                                                                               |
