...
_(Updated 2026-09-11 - Washington Assessor Launch V1 and TerraFusion Owner-Usable Product V1 active; Five-Suite terminal state preserved)_

| Program                                                                                                            | Goal                                     | Loop                                     | Status                                                                       | Current WO                                                                | Next state                                                  | Continuation                                                                                         | Stop Rules                                                                                                                                                                                                                                                                                                                                |
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Washington Assessor Launch V1](programs/washington-assessor-launch-v1.md)                                         | `GOAL-WASHINGTON-ASSESSOR-LAUNCH-V1`     | `LOOP-WASHINGTON-ASSESSOR-LAUNCH-V1`     | ACTIVE under `OWNER-WAL-V1-MISSION-AUTHORITY-20260827`                        | `WO-WAL-000` completes on protected merge; 001/002/003 plus bounded 004 clear next | Stabilize 001-004 contracts, then 005/006                    | Continue automatically through 007 acceptance, 008 production/external assessor acceptance, and 009 terminal closeout | Stop only on Issue #1485 hard walls, external-source write-back, protected data/credentials, unresolved county-isolation or exact-release proof, failed required controls, conflicting higher canon, or a consequential new objective outside the owner directive |
| [TerraFusion Owner-Usable Product V1](programs/terrafusion-owner-usable-product-v1.md) | `GOAL-TERRAFUSION-OWNER-USABLE-PRODUCT-V1` | `LOOP-TERRAFUSION-OWNER-USABLE-PRODUCT-V1` | ACTIVE under `OWNER-TUOP-V1-MISSION-AUTHORITY-20260911` (Issue #1589) | `WO-TUOP-000` completes on protected merge; `WO-TUOP-001` first live Product Reality Matrix clears next | Observe launched candidate from the screen; classify defects; derive exact bounded repair children | Continue automatically through repair-child waves to `TERRAFUSION_OWNER_USABLE_PRODUCT_V1: PASS` on an exact launched candidate; accepted candidate then feeds WAL production gates | Stop only on Issue #1589 hard walls, Benton production access, external write-back, protected data/credentials, failed required controls, conflicting higher canon, or a consequential new objective outside the owner directive |
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md)                   | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | COMPLETE through `WO-SR-MISSION-COMPLETION`                                   | Terminal evidence reconciled                                               | No mission successor; Forge WO-SR-007 remains outside mission | No automatic continuation inside the completed mission                                               | Stop on any missing/mismatched protected identity, failed required first-party control, mission hard wall, conflicting higher canon, or a genuinely new objective |
...
| Cross-Project Historical Audit (WilliamOS/TerraGroq)                                                               | none in TerraFusion                      | none in TerraFusion                      | `OUT_OF_SCOPE_CROSS_PROJECT`                                                 | `WO-LOCAL-093` through `WO-LOCAL-097` superseded                          | None in TerraFusion; `WO-LOCAL-098` withdrawn               | No TerraFusion continuation                                                                          | Transfer or continuation requires the separate project's repository, canon, WO, and authority; no implicit authority transfer                                                                                                                                                                                                             |
...
| [Portfolio Operator](programs/portfolio-operator.md)                                                               | `GOAL-PORTFOLIO-OPERATOR-001`            | `LOOP-PORTFOLIO-OPERATOR-001`            | Portfolio reconciliation after Five-Suite terminal closeout                  | No current selected Work Order; `WO-PORTFOLIO-013` remains complete       | No selected successor; portfolio reconciliation             | Do not select unrelated work implicitly; Forge WO-SR-007 remains outside the completed mission       | Protected boundaries remain exact; any new selected work must have applicable objective and authority                                                                                                                                                                                                                                    |
...
| WilliamOS/TerraGroq OMEN evidence was incorrectly admitted to TerraFusion                 | WO-LOCAL-093 through WO-LOCAL-097                  | Superseded as `OUT_OF_SCOPE_CROSS_PROJECT`; no TerraFusion capability delivered and WO-LOCAL-098 withdrawn                                                                                        |
