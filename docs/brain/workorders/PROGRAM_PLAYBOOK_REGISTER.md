...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; mixed-domain Dossier snapshot rejected | `WO-SR-005D-C2` Dossier evidence-registry read contract decomposition | Bounded implementation only if decomposition and authority pass | Continue exact R2 docs/evidence design | Stop on implementation, custody mutation, source copying, packages, workflows, county/PACS/SQL, secrets, deployment, or cutover |
