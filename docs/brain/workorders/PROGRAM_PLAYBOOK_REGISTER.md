...
*(Updated 2026-07-17 - WO-ATLAS-001 MapLibre migration reality audit)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - Atlas stale-branch audit complete on merge | `WO-ATLAS-001` complete on protected merge | `WO-ATLAS-002` PropertyAtlas Popup Text-Safety Repair | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
