...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between cohorts; F1 layer complete; cutover dependency audit complete | `WO-SR-006-P` complete | `WO-SR-006A` blocked on exact CI/private-artifact authority | Continue automatically inside recorded authority | Stop on cross-repository CI/credential access, runtime adoption, source retirement, deployment, protected resources, or scope expansion |
