...
*(Updated 2026-07-17 - WO-PORTFOLIO-008 open PR backlog reconciliation)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - open PR backlog reconciled | `WO-PORTFOLIO-008` complete on protected merge | `WO-ATLAS-001` MapLibre Migration Reality Audit | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
