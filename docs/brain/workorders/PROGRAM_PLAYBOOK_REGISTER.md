...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active; Dossier registry-read decomposition complete | `WO-SR-005E-P` GPT governed-AI contract and grounding preparation | Exact GPT decomposition or NO_GO | Continue exact R2 read-only evidence | Stop on implementation, provider calls, source copying, packages, workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
