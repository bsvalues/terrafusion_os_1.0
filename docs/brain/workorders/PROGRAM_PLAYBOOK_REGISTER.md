...
|---------|------|------|--------|------------|---------|--------------|------------|
| [Five-Suite Federated Repository Buildout](programs/five-suite-federated-repository-buildout.md) | `GOAL-FIVE-SUITE-FEDERATED-REPOSITORIES` | `LOOP-FIVE-SUITE-FEDERATED-REPOSITORIES` | Active between bounded cohorts; Dossier E1/E2 complete | `WO-SR-005D-E2` complete | Portfolio reconciliation | Select the next dependency-cleared bounded node; do not infer extraction, custody, runtime, or F1 authority | Stop on extraction, custody/persistence, runtime/provider adoption, packages/publication, unrelated workflows, county/PACS/SQL, credentials, secrets, deployment, or cutover |
