...
*(Updated 2026-07-17 - WO-ATLAS-006 Mapbox token alias contract audit)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - Mapbox token alias contract audit complete on merge | `WO-ATLAS-006` complete on protected merge | `WO-ATLAS-007` GeoForge Mapbox Token Alias Cleanup | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
