...
*(Updated 2026-07-17 - WO-PORTFOLIO-006 shell routing contract reconciliation)*
...
| [Portfolio Operator](programs/portfolio-operator.md) | `GOAL-PORTFOLIO-OPERATOR-001` | `LOOP-PORTFOLIO-OPERATOR-001` | Active - shell routing contract reconciliation selected | `WO-PORTFOLIO-006` complete on protected merge | Portfolio reconciliation | Auto-select, admit, deliver, merge, and continue dependency-cleared authorized nodes | Stop only on scope expansion, failed required proof, destructive action, or protected boundaries |
