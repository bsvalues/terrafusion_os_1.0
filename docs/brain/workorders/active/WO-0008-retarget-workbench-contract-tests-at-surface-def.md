# WO-0008 — Retarget workbench contract tests at Surface defined9 rendered6 drop Codex fiction
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0008`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0008` = PROCEED)
...
{
  "id": "WO-0008",
  "task": "Retarget workbench contract tests at Surface defined9 rendered6 drop Codex fiction",
  "risk": "R1",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "docs/brain/memory/**",
