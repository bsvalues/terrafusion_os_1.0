# WO-0006 — Resolve D-012 Dais Dossier forge countyStudyApi cross-suite import via OS-owned bridge

- **Risk:** R4 · **Suite:** UNRESOLVED · **Agent:** Architect
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0006`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0006` = PROCEED)
...
{
  "id": "WO-0006",
  "task": "Resolve D-012 Dais Dossier forge countyStudyApi cross-suite import via OS-owned bridge",
  "risk": "R4",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "docs/brain/memory/**",
