# WO-0004 — Implement D-010 tolerate fix: registry tooling accepts quarantined applications dir
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0004`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0004` = PROCEED)
...
{
  "id": "WO-0004",
  "task": "Implement D-010 tolerate fix: registry tooling accepts quarantined applications dir",
  "risk": "R2",
  "suite": "TerraAtlas",
  "allowed_files": [
    "backend/src/TerraFusion.*/**/*Atlas*",
