# WO-0005 — Verify Shell-Contract release gate (dock, top bar, workbench routing)
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0005`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0005` = PROCEED)
...
{
  "id": "WO-0005",
  "task": "Verify Shell-Contract release gate (dock, top bar, workbench routing)",
  "risk": "R4",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "docs/brain/memory/**",
