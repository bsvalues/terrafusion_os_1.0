# WO-0011 — Commit-race hardening: staged-file guard across status next review-diff proof commit-plan
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0011`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0011` = PROCEED)
...
{
  "id": "WO-0011",
  "task": "Commit-race hardening: staged-file guard across status next review-diff proof commit-plan",
  "risk": "R0",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "docs/brain/memory/**",
