# WO-0003 — Resolve D-010 applications restore-vs-tolerate decision
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0003`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0003` = PROCEED)
...
{
  "id": "WO-0003",
  "task": "Resolve D-010 applications restore-vs-tolerate decision",
  "risk": "R0",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "docs/brain/memory/**",
