# WO-0002 — Embed Brain v0.3 loop doctrine in root agent entrypoint
...
## Required proof
- `pnpm brain check`
- `pnpm brain review-diff --workorder WO-0002`
...
## Acceptance criteria
- [ ] only allowed files touched (`brain review-diff --workorder WO-0002` = PROCEED)
...
{
  "id": "WO-0002",
  "task": "Embed Brain v0.3 loop doctrine in root agent entrypoint",
  "risk": "R0",
  "suite": "UNRESOLVED",
  "allowed_files": [
    "AGENT_ENTRYPOINT.md",
