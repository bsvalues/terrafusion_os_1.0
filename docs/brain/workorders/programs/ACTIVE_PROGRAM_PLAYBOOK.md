...
`WO-MAO-002` falsified automatic continuation, zero-founder routing, isolated-worktree discipline,
bounded scope, operator-merge behavior, and automatic next-action selection. It did **not** prove
