...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-I Atlas read contract implementation/freeze | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-I Atlas read contract implementation/freeze | NO - active ratified program | `program`, `once`, `evidence` |
