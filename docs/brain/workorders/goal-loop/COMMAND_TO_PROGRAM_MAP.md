...
| `terrafusion-owner-usable-product-v1` | TerraFusion Owner-Usable Product V1 | 000 ACTIVE on protected main (88a4629ea); 001 matrix v1 recorded in progress, derived child 002 (auth honesty + sign-in) blocked on 001 merge | NO - owner mission authority recorded (Issue #1589); exact reservations still required | `once`, `program`, `merge-watch`, `evidence`, `recovery`, `discovery` |
