...
| `program-next` | Portfolio Operator | WO-ATLAS-005 GeoForge Popup DOM Safety Repair | YES - `protected-system-required` until direct exact-scope R3 activation is recorded | `program`, `once`, `evidence` |
