...
| `program-next`                  | Five-Suite Federated Repository Buildout | WO-SR-005A Forge bounded extraction and provenance                   | NO - active dependency-cleared program                                  | `program`, `evidence`, `discovery`         |
| `suite-repositories`            | Five-Suite Federated Repository Buildout | WO-SR-005A Forge bounded extraction and provenance                   | NO - active ratified program                                            | `program`, `evidence`, `discovery`         |
