...
| `program-next` | Portfolio Operator | WO-ATLAS-002 PropertyAtlas Popup Text-Safety Repair | YES - exact frontend scope requires recorded R3 activation authority | `program`, `evidence`, `discovery` |
