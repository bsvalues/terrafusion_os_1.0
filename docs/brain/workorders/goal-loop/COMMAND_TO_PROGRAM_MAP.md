...
| `program-next` | Portfolio Operator | `WO-SR-005E-A3` GPT adapter/parity reconciliation | NO - dependency-cleared R2 read-only reconciliation | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | `WO-SR-005E-E0` complete; `WO-SR-005E-A3` ready | YES for E1/E2 implementation, extraction, runtime/provider adoption, F1, or any new R3/protected scope | `program`, `once`, `evidence` |
