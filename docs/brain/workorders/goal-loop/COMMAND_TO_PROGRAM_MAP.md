...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-E3 Atlas bounded extraction scope audit | NO - active dependency-cleared program | `program`, `once`, `evidence`, `discovery` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-E3 Atlas bounded extraction scope audit | NO - active ratified program | `program`, `once`, `evidence`, `discovery` |
