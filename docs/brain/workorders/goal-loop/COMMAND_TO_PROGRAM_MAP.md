...
| `program-next` | Portfolio Operator | WO-ATLAS-009 GIS Package Mapbox Token Metadata Alignment | NO - bounded R3 exact-file authority is active | `program`, `once`, `evidence` |
