...
| `program-next` | Portfolio Operator | WO-ATLAS-008 GIS Package Mapbox Token Metadata Disposition Audit | NO - docs-only R1 follow-up admitted by the GeoForge cleanup evidence | `program`, `once`, `evidence` |
