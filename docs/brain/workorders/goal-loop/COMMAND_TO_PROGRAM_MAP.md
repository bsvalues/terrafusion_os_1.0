...
the paired operational variables were released, and that grant creates no continuing Mode B
authority. This route grants no runtime, product, production, credential, county, or county-data
authority.
