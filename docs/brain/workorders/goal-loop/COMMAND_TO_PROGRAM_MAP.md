...
| `program-next` | Portfolio Operator | WO-PORTFOLIO-005 evidence publisher capacity repair | NO - bounded R3 repair admitted and complete on protected merge | `program`, `evidence`, `discovery` |
