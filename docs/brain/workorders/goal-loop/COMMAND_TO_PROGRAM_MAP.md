...
| `program-next` | Portfolio Operator | WO-SR-005E-E3 GPT bounded extraction scope audit | NO for R2 audit; YES for extraction, runtime/provider adoption, F1, successor R3, or protected scope | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005E-E3 after Dossier E3 found no direct-copy slice | NO for R2 audit; YES for extraction, runtime/provider adoption, F1, successor R3, or protected scope | `program`, `once`, `evidence` |
