...
| `program-next` | Portfolio Operator | `WO-SR-005E-A4` GPT standalone repository path canon registration | NO - dependency-cleared R2 governance reconciliation | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | `WO-SR-005E-A3` complete; `WO-SR-005E-A4` ready | YES for E1/E2 implementation, extraction, runtime/provider adoption, F1, or any new R3/protected scope | `program`, `once`, `evidence` |
