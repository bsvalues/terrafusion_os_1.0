...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-P Atlas contract and parity gate preparation | NO - active dependency-cleared program | `program`, `evidence`, `discovery` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-P Atlas contract and parity gate preparation | NO - active ratified program | `program`, `evidence`, `discovery` |
