...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-E2 Atlas standalone synthetic parity | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-E2 Atlas standalone synthetic parity | NO - active ratified program | `program`, `once`, `evidence` |
