...
| `program-next` | Portfolio Operator | WO-ATLAS-002 PropertyAtlas Popup Text-Safety Repair | NO - bounded R3 current-main security repair admitted by WO-ATLAS-001 | `program`, `evidence`, `discovery` |
