...
| `program-next` | Portfolio Operator | `WO-SR-005E-E1` proposed / exact R3 E1/E2 envelope required | YES - A3 complete; implementation authority is not active | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | `WO-SR-005E-A3` complete; E1/E2 implementation-ready but blocked | YES for E1/E2 implementation, extraction, runtime/provider adoption, F1, or any new R3/protected scope | `program`, `once`, `evidence` |
