...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-C Atlas read contract decomposition | NO - active dependency-cleared program | `program`, `evidence`, `discovery` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-C Atlas read contract decomposition | NO - active ratified program | `program`, `evidence`, `discovery` |
