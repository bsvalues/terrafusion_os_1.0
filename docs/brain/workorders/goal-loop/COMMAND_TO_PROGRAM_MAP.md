...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005D-P Dossier custody/evidence-integrity preparation | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005D-P Dossier custody/evidence-integrity preparation | NO - active ratified program | `program`, `once`, `evidence` |
