...
| `program-next` | Portfolio Operator | WO-SR-005C-E2 active after E1 completion | NO - owner-authorized E1/E2 envelope active | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005C-E1 complete; E2 standalone parity active | NO for E2; F1 remains separately gated | `program`, `once`, `evidence` |
