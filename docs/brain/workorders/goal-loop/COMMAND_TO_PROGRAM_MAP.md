...
| `program-next` | Portfolio Operator | No executable WO selected after WO-AZURE-003 | YES - blocked until a concrete portfolio reconciliation WO is registered | `program`, `evidence`, `discovery` |
