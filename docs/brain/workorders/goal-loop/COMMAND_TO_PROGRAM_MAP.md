...
| `program-next` | Portfolio Operator | WO-PORTFOLIO-009 Protected-Path Authority Planner Integration | NO - bounded R3 mechanical prerequisite; WO-ATLAS-009 remains blocked | `program`, `once`, `evidence` |
