...
| `program-next` | Portfolio Operator | WO-ATLAS-005 GeoForge Popup DOM Safety Repair | NO - bounded protected R3 safety repair under standing operator direction | `program`, `once`, `evidence` |
