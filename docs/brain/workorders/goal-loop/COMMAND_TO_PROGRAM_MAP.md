...
| `terrafusion-owner-usable-product-v1` | TerraFusion Owner-Usable Product V1 | 000 + 001 (matrix v1) on protected main (43ef0238e); Step Zero shell-lineage SETTLED (native-shell WPF canonical, electron superseded); children: 002 auth honesty + sign-in, 003 lineage drift fix (ready), 004 canonical release assembly (blocked on 003) | NO - owner mission authority recorded (Issue #1589); exact reservations still required | `once`, `program`, `merge-watch`, `evidence`, `recovery`, `discovery` |
