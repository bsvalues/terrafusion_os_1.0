...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005C-C Dais appeal-workflow contract decomposition | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005C-C Dais appeal-workflow contract decomposition | NO - active ratified program | `program`, `once`, `evidence` |
