...
| `program-next` | Portfolio Operator | TRUE_PORTFOLIO_BOUNDARY after WO-PORTFOLIO-011 | YES - every incomplete candidate crosses protected authority | `once`, `evidence`, `discovery` |
