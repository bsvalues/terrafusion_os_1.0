...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005D-I active; WO-SR-005E-I follows under the sequential R3 envelope | NO - recorded bounded authority applies | `program`, `once`, `evidence` |
