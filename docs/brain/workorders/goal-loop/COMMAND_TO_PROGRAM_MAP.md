...
| `governed-multi-agent-operator` | Governed Multi-Agent Operator Activation | WO-MAO-005 (ACTIVE); next WO-MAO-006 | NO - ratified R3 continuation envelope covers eligible MAO-005 through MAO-007 work | `once`, `program`, `evidence`, `discovery` |
...
**Current / next:** `WO-MAO-005` is active; `WO-MAO-006` is next.
...
| WO-MAO-005 | Evidence-Informed Agent Playbooks | **ACTIVE** |
| WO-MAO-006 | Portfolio Rollout | **NEXT** |
