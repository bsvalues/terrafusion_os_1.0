...
| `program-next` | Portfolio Operator | ALL_LANES_PARKED after WO-PORTFOLIO-002 reconciliation | YES - no registered node is executable inside current authority | `program`, `evidence`, `discovery` |
