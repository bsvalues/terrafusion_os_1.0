...
| `program-next` | Portfolio Operator | Portfolio reconciliation after GPT E1/E2 closeout | NO for reconciliation; YES for successor/protected scope | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | GPT E1/E2 complete; envelope consumed; reconcile next cohort | NO for reconciliation; YES for extraction, runtime/provider adoption, F1, successor R3, or protected scope | `program`, `once`, `evidence` |
