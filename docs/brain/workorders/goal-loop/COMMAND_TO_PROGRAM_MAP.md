...
| `program-next` | Portfolio Operator | WO-ATLAS-001 MapLibre Migration Reality Audit | NO - bounded R0 audit admitted after WO-PORTFOLIO-008 protected merge | `program`, `evidence`, `discovery` |
