...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-F1 Atlas standalone spatial projection foundation | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-F1 Atlas standalone spatial projection foundation | NO - active ratified program | `program`, `once`, `evidence` |
