...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005B-E1 Atlas sovereign adapter implementation | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005B-E1 Atlas sovereign adapter implementation | NO - active ratified program | `program`, `once`, `evidence` |
