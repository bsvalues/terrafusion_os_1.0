...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005D-C Dossier evidence-snapshot contract decomposition | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005D-C Dossier evidence-snapshot contract decomposition | NO - active ratified program | `program`, `once`, `evidence` |
