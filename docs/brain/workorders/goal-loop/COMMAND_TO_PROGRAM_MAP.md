...
| `program-next` | Five-Suite Federated Repository Buildout | WO-SR-005C-P Dais domain-contract and county-isolation preparation | NO - active dependency-cleared program | `program`, `once`, `evidence` |
| `suite-repositories` | Five-Suite Federated Repository Buildout | WO-SR-005C-P Dais domain-contract and county-isolation preparation | NO - active ratified program | `program`, `once`, `evidence` |
