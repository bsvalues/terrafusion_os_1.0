...
| `POST /api/dossier/documents/search` | `[Authorize]` + `read:dossier` | Not applicable while disabled | Global middleware + `X-R1-Scope` | None active | Documents module | `Post-R1` | Explicit `501` |
| `GET /api/dossier/documents/{id}` | `[Authorize]` + `read:dossier` | Not applicable while disabled | Global middleware + `X-R1-Scope` | None active | Documents module | `Post-R1` | Explicit `501` |
| `POST /api/dossier/evidence/search` | `[Authorize]` + `read:dossier` | Not applicable while disabled | Global middleware + `X-R1-Scope` | None active | Evidence module | `Post-R1` | Explicit `501` |
| `GET /api/dossier/evidence/{evidenceId}/chain` | `[Authorize]` + `read:dossier` | Not applicable while disabled | Global middleware + `X-R1-Scope` | None active | Evidence module | `Post-R1` | Explicit `501` |
