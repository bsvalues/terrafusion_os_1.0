...
## Readback F1 — canonical identity re-key repair (2026-06-08)
Production readback found land/improvement/geometry canonical rows keyed to a **prior** parcel-identity
generation (orphaned after the live 83,326-parcel spine replaced it). Repaired by set-based canonical
re-key onto the live spine (`evidence/2026-06-08-f1-set-based-rekey-repair.md`): tf_land 87,767 = truth
/ 100% live / 0 orphan (588 abort-lost rows restored from truth); tf_improvement 99,694 / 100% live / 0
orphan; tf_parcel_geom 79,105 live / 0 dangling / 970 NULL-APN residual preserved. **Source seals
remained valid — only canonical parcel FKs were re-keyed.** F2 (tf_parcel ~3.1M debris) still deferred.
