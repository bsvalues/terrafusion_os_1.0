...
describe('Synthetic Data Generation - Government Testing', () => {
  ...
  class BentonCountyDataGenerator {
    private readonly BENTON_ZIP_CODES = ['99301', '99302', '99320', '99337', '99338', '99352', '99354']
    private readonly STREET_NAMES = ['Main St', 'First Ave', 'Columbia Dr', 'Jadwin Ave', 'George Washington Way', 'Stevens Dr']
    private readonly OWNER_SURNAMES = ['Johnson', 'Smith', 'Williams', 'Brown', 'Jones', 'Garcia', 'Miller', 'Davis']
  ...
  class AIAgentDataGenerator {
    ...
    generateSwarm(size: number = 1008) {
      const agentTypes = ['revenue_hunter', 'property_assessor', 'compliance_monitor', 'data_processor', 'analyst', 'coordinator']
