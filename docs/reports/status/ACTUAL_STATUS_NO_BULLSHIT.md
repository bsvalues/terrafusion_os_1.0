...
2. That code WON'T BUILD because of duplicate `node_modules` TypeScript
   conflicts
...
**Bottom line:** You have a C# app that works, a backend that works, databases
that work. The only broken part is the UI file it's trying to load.
