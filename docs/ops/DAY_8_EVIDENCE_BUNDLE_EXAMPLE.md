# Day 8 Evidence Bundle — Wave 0 (EXAMPLE)
...
> **Day:** 8 of 14  
> **Date:** 2026-02-11  
> **Bundle ID:** `EXAMPLE_sha256:bundle_day8_1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b`
...
| DR Freshness | 32d | +1 | ≤90d | ✔ |

**All KPIs within threshold.** Continuing Week 2 stable operations.
...
|--------------|----------------|--------|
| `EXAMPLE_sha256:exc_8b9c...` | 12d | Renewed Day 7; monitoring |
...
|----------|------|----------|
| KPI Export | `EXAMPLE_sha256:kpi_day8_...` | ☑ |
| Audit Log | `EXAMPLE_sha256:audit_day8_...` | ☑ |
| Exception Report | `EXAMPLE_sha256:exc_day8_...` | ☑ |
...
|------|----|-----------|-----------|
| Incident Commander | `EXAMPLE_sha256:operator_1a2b...` | ☑ | 2026-02-11 09:15 UTC |
