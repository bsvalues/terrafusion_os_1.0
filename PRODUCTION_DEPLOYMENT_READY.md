...
| Service | URL | Purpose |
|---------|-----|---------|
| **API Health** | `http://localhost:5000/health` | System health monitoring |
| **API Main** | `http://localhost:5000/api` | Core API endpoints |
| **Prometheus** | `http://localhost:9090` | Metrics collection |
| **Grafana** | `http://localhost:3000` | Performance dashboards |
| **Database** | `localhost:5432` | PostgreSQL (internal) |
| **Redis** | `localhost:6379` | Cache layer (internal) |
