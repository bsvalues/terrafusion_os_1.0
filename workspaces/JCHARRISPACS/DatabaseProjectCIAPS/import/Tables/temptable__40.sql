CREATE TABLE [import].[temptable__40] (
    [ParcelNumber]     NVARCHAR (MAX) NULL,
    [Complete/Status]  NVARCHAR (MAX) NULL,
    [ParcelAddress]    NVARCHAR (MAX) NULL,
    ...
    [TypeoOfStructure] NVARCHAR (MAX) NULL
);
