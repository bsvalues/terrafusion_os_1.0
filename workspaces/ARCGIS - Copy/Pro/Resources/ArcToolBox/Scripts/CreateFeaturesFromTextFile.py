...
def execute():
    ...
    try:
        ...
        gp.CreateFeatureclass(os.path.split(outputFC)[0], os.path.split(outputFC)[1], inDataType, "#", "ENABLED", "ENABLED",
                              outputSR)
        ...
        for line in inputTxtFile.readlines():
            ...
            # For a multipoint the text file is organized a bit differently.
            # Groups of points must be inserted at the same time.
