...
def calculateDistanceBand(inputFC, kNeighs, concept = "EUCLIDEAN"):
    ...
    minDistOut = LOCALE.format_string("%0.6f", minDist)
    avgDistOut = LOCALE.format_string("%0.6f", avgDist)
    maxDistOut = LOCALE.format_string("%0.6f", maxDist)
    ...
    tableOut = UTILS.outputTextTable(total,header=header,pad=1, footnote=[distanceMeasuredStr], colPad=4,
