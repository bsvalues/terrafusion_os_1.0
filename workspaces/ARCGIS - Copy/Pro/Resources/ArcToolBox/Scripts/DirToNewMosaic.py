...
*********************************************************************************************************************"""
# Importing ScriptUtils which imports required libraries and creates the geoprocssing object
...
try:
    ...
    for in_raster_dataset in in_raster_datasets:
        if icnt == 1:
            ...
            try:
                ...
                sr = '#'
            try:
                ConversionUtils.gp.CreateRasterDataset(out_location, out_name, "#", pixeltype, sr, bandcnt, keyword,
                                                       "#", "#", "#", origin)
        ...
        if bSDE == 1:
            try:
                ConversionUtils.gp.Mosaic_management(in_raster_dataset, out_raster, mosaic_mode, colormap_mode,
                                                     background, nodata, oneto8, tolerance)
    ...
    if bSDE == 0:
        ...
        ConversionUtils.gp.Mosaic_management(in_rasters, out_raster, mosaic_mode, colormap_mode, background, nodata,
                                             oneto8, tolerance)
