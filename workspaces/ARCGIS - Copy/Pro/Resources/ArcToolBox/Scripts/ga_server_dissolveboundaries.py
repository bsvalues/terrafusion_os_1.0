"""
 ga_server_dissolveboundaries.py

 Front end of 'Dissolve Boundaries' GeoAnalytics Server tool.
...
if __name__ == '__main__':
    ...
    params = dict(inputLayer=get_value(0, as_value=True),
                  ...
                  multipart=get_value(2, as_value=True),
                  dissolveFields=get_value(4),
                  summaryFields=get_value(5, as_value=True, 
                  val_table='summary_fields'))
