        ...
        if out_raster.find('.sde') > -1 or out_raster.find('.gdb') > -1:
            for in_raster_dataset in in_raster_datasets:
                try:
                    ...
                    gp.Mosaic_management(in_raster_dataset, out_raster, mosaic_mode, colormap_mode, background, nodata,
                                         oneto8, tolerance)
            ...
            try:
                gp.Mosaic_management(in_rasters, out_raster, mosaic_mode, colormap_mode, background, nodata, oneto8,
                                     tolerance)
