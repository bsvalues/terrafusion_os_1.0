...
# source: indoorsprotocol/locatorevents.proto
...
LocatorEvent = _reflection.GeneratedProtocolMessageType('LocatorEvent', (_message.Message,), {
  ...
  '__module__' : 'indoorsprotocol.locatorevents_pb2'
