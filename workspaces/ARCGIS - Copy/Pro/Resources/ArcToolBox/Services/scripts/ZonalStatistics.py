...
if __name__ == '__main__':
    ...
    inputValueRaster = arcpy.GetParameterAsText(2) 
    outputName = arcpy.GetParameterAsText(3) 
    statisticType = arcpy.GetParameterAsText(4) 
    percentileValue = arcpy.GetParameterAsText(5)
    percentileInterpolationType = arcpy.GetParameterAsText(6) 
    circularCalculation = arcpy.GetParameterAsText(7) 
    circularWrapValue = arcpy.GetParameterAsText(8) 
    ignoreNodata = arcpy.GetParameterAsText(9)
    processAsMultidemensional = arcpy.GetParameterAsText(10)
    # Environment setting
    ...
    try:
        ...
        if inputValueRaster != None and inputValueRaster != "" and inputValueRaster != "#":
        ...
        # ZonalStatistics(in_zone_data, zone_field, in_value_raster, out_raster, {statistics_type}, {ignore_nodata}, {process_as_multidimensional}, {percentile_value}, 
