...
class Dataset(Base):
    ...
    @property
    def isTraditionalVersioned(self) -> bool:
        """Indicates whether the dataset is traditional versioned."""
    @property
    def isBranchVersioned(self) -> bool:
        """Indicates whether the dataset is branch versioned."""
    @property
    def minimumRequiredClientVersion(self) -> str:
        """The minimum software version to open the dataset"""
    @property
