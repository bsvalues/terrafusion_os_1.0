...
class SearchNeighborhoodStandard3D(_NamedAttrObject):
    ...
    __esri_toolinfo__ = [
        ...
        "Long:::",
        "Long:::",
        "String::ONE_SECTOR|FOUR_SECTORS|SIX_SECTORS|EIGHT_SECTORS|TWELVE_SECTORS|TWENTY_SECTORS:"
        ]
    ...
    def __init__(self,
        ...
        self.radius = radius
        self.nbrMax = _ValidateParameter(nbrMax, 2)
        self.nbrMin = _ValidateParameter(nbrMin, 1)
        self.sectorType = _ValidateParameter(sectorType, "TWELVE_SECTORS")

SearchNeighborhoodStandard3D._add_attr("nbrType", "NBRTYPE", "Standard3D", True)
SearchNeighborhoodStandard3D._add_attr("radius", "RADIUS")
SearchNeighborhoodStandard3D._add_attr("nbrMax", "NBR_MAX")
SearchNeighborhoodStandard3D._add_attr("nbrMin", "NBR_MIN")
SearchNeighborhoodStandard3D._add_attr("sectorType", "SECTOR_TYPE")
