...
def CalculateDensity(
    ...
    field=None,
    cellSize=None,
    cellSizeUnits: Literal["MILES", "FEET", "KILOMETERS", "METERS"] | None = None,
    radius=None,
    radiusUnits: Literal["MILES", "FEET", "KILOMETERS", "METERS"] | None = None,
    boundingPolygonLayer=None,
    areaUnits: Literal["SQUAREMILES", "SQUAREKILOMETERS"] | None = None,
    classificationType: Literal["EQUALINTERVAL", "GEOMETRICINTERVAL", "NATURALBREAKS", "EQUALAREA", "STANDARDDEVIATION"]
    | None = None,
    numClasses=None,
...
def InterpolatePoints(
    ...
    outputName=None,
    field=None,
    interpolateOption: Literal["1", "5", "9"] | None = None,
    outputPredictionError: Literal["OUTPUT_ERROR", "NO_ERROR"] | None = None,
    classificationType: Literal["EQUALAREA", "EQUALINTERVAL", "GEOMETRICINTERVAL", "MANUAL"] | None = None,
    numClasses=None,
    classBreaks=None,
    boundingPolygonLayer=None,
    predictAtPointLayer=None,
) -> Result3[str | FeatureSet, str | FeatureSet, str | FeatureSet]:
...
def DissolveBoundaries(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DissolveBoundaries_sfa(*gp_fixargs((inputLayer, outputName, dissolveFields, summaryFields), True))
        )
        return retval
    except Exception as e:
        raise e
...
def MergeLayers(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.MergeLayers_sfa(*gp_fixargs((inputLayer, mergeLayer, outputName, mergingAttributes), True))
        )
        return retval
    except Exception as e:
        raise e
...
def OverlayLayers(
    ...
    overlayLayer=None,
    outputName=None,
    overlayType: Literal["INTERSECT", "UNION", "ERASE"] | None = None,
    outputType: Literal["INPUT", "LINE", "POINT"] | None = None,
    snapToInput: Literal["SNAP", "NO_SNAP"] | None = None,
    tolerance=None,
) -> Result1[str | FeatureSet]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.OverlayLayers_sfa(
                *gp_fixargs(
                    (inputLayer, overlayLayer, outputName, overlayType, outputType, snapToInput, tolerance), True
                )
            )
        )
        return retval
...
def AggregatePoints(
    ...
    polygonLayer=None,
    outputName=None,
    keepBoundariesWithNoPoints: Literal["KEEP_EMPTY", "REMOVE_EMPTY"] | None = None,
    summaryFields=None,
    groupByField=None,
    minorityMajority: Literal["ADD_MIN_MAJ", "NO_MIN_MAJ"] | None = None,
    percentPoints: Literal["ADD_PERCENT", "NO_PERCENT"] | None = None,
...
def SummarizeNearby(
    ...
    | None = None,
    distances=None,
    units: Literal["METERS", "KILOMETERS", "FEET", "YARDS", "MILES", "SECONDS", "MINUTES", "HOURS"] | None = None,
    timeOfDay=None,
    timeZoneForTimeOfDay: Literal["UTC", "GEOLOCAL"] | None = None,
    returnBoundaries: Literal["RETURN_BOUNDARIES", "RETURN_INPUT"] | None = None,
    sumShape: Literal["ADD_SHAPE_SUM", "NO_SHAPE_SUM"] | None = None,
    shapeUnits: Literal[
        "METERS",
        "KILOMETERS",
        "FEET",
    ...
    groupByField=None,
    minorityMajority: Literal["ADD_MIN_MAJ", "NO_MIN_MAJ"] | None = None,
    percentShape: Literal["ADD_PERCENT", "NO_PERCENT"] | None = None,
) -> Result2[str | FeatureSet, str | RecordSet]:
...
def CreateBuffers(
    ...
    distances=None,
    field=None,
    units: Literal["METERS", "KILOMETERS", "FEET", "MILES", "NAUTICALMILES", "YARDS"] | None = None,
    dissolveType: Literal["NONE", "DISSOLVE"] | None = None,
    ringType: Literal["DISKS", "RINGS"] | None = None,
    sideType: Literal["FULL", "RIGHT", "LEFT", "OUTSIDE"] | None = None,
    endType: Literal["ROUND", "FLAT"] | None = None,
) -> Result1[str | FeatureSet]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CreateBuffers_sfa(
                *gp_fixargs(
                    (inputLayer, outputName, distances, field, units, dissolveType, ringType, sideType, endType), True
                )
            )
        )
        return retval
