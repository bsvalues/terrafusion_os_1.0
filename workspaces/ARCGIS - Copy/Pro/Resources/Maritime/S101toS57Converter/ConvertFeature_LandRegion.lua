...
local function ConvertFeature_LandRegion(feature)
    local s57Feature = S57Lib.CreateFeature("LNDRGN")

    s57Feature.CATLND = feature.categoryOfLandRegion.GetCommaSeparatedValues()
...
return ConvertFeature_LandRegion