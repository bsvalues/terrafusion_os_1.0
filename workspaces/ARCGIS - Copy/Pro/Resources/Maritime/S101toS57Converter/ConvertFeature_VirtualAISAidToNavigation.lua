...
local function ConvertFeature_VirtualAISAidToNavigation(feature)
    local s57Feature = S57Lib.CreateFeature("NEWOBJ")
    ...
    feature.mMSICode.DidNotConvert = true
    ...
    feature.virtualAISAidToNavigationType.DidNotConvert = true
...
return ConvertFeature_VirtualAISAidToNavigation