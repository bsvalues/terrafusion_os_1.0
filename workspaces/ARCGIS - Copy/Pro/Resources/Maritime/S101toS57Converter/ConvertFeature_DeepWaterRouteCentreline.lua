...
local function ConvertFeature_DeepWaterRouteCentreline(feature)
    local s57Feature = S57Lib.CreateFeature("DWRTCL")
    ...
    s57Feature.CATTSS = feature.iMOAdopted.GetFirstValue()
...
return ConvertFeature_DeepWaterRouteCentreline