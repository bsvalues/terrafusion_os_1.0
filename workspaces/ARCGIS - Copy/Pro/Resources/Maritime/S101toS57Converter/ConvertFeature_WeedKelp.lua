...
local function ConvertFeature_WeedKelp(feature)
    local s57Feature = S57Lib.CreateFeature("WEDKLP")

    s57Feature.CATWED = feature.categoryOfWeedKelp.GetFirstValue()
...
return ConvertFeature_WeedKelp