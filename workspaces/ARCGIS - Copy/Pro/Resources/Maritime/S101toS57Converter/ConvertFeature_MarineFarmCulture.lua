...
local function ConvertFeature_MarineFarmCulture(feature)
    local s57Feature = S57Lib.CreateFeature("MARCUL")

    s57Feature.CATMFA = feature.categoryOfMarineFarmCulture.GetFirstValue()
...
return ConvertFeature_MarineFarmCulture