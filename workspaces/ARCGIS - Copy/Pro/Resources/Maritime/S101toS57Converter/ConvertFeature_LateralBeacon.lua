...
local function ConvertFeature_LateralBeacon(feature)
    local s57Feature = S57Lib.CreateFeature("BCNLAT")

    s57Feature.BCNSHP = feature.beaconShape.GetFirstValue()
    s57Feature.CATLAM = feature.categoryOfLateralMark.GetFirstValue()
...
return ConvertFeature_LateralBeacon