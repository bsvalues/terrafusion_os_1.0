...
local function ConvertFeature_TrafficSeparationSchemeRoundabout(feature)
    local s57Feature = S57Lib.CreateFeature("TSSRON")
...
return ConvertFeature_TrafficSeparationSchemeRoundabout