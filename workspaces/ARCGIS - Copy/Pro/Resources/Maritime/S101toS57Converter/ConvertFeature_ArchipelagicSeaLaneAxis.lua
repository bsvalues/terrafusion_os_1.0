...
local function ConvertFeature_ArchipelagicSeaLaneAxis(feature)
    local s57Feature = S57Lib.CreateFeature("ASLXIS")
...
return ConvertFeature_ArchipelagicSeaLaneAxis