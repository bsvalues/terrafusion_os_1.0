...
local function ConvertFeature_RecommendedRouteCentreline(feature)
    local s57Feature = S57Lib.CreateFeature("RCRTCL")
...
return ConvertFeature_RecommendedRouteCentreline