...
local function ConvertFeature_SiloTank(feature)
    local s57Feature = S57Lib.CreateFeature("SILTNK")

    s57Feature.BUISHP = feature.buildingShape.GetFirstValue()
    s57Feature.CATSIL = feature.categoryOfSiloTank.GetFirstValue()
...
return ConvertFeature_SiloTank