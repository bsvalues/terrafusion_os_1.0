...
local function ConvertFeature_HarbourFacility(feature)
    local s57Feature = S57Lib.CreateFeature("HRBFAC")

    s57Feature.CATHAF = feature.categoryOfHarbourFacility.GetCommaSeparatedValues()
    ...
    s57Feature.PRODCT = feature.product.GetFirstValue()
...
return ConvertFeature_HarbourFacility