...
local function ConvertFeature_Pile(feature)
    local s57Feature = S57Lib.CreateFeature("PILPNT")

    s57Feature.CATPLE = feature.categoryOfPile.GetFirstValue()
