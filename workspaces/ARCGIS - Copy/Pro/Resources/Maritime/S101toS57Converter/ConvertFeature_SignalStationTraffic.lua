...
local function ConvertFeature_SignalStationTraffic(feature)
    local s57Feature = S57Lib.CreateFeature("SISTAT")

    s57Feature.CATSIT = feature.categoryOfSignalStationTraffic.GetCommaSeparatedValues()
...
return ConvertFeature_SignalStationTraffic