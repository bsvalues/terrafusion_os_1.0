...
local function ConvertFeature_Hulk(feature)
    local s57Feature = S57Lib.CreateFeature("HULKES")

    s57Feature.CATHLK = feature.categoryOfHulk.GetCommaSeparatedValues()
