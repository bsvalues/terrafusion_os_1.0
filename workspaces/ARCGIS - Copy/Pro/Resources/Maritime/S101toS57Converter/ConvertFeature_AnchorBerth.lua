...
local function ConvertFeature_AnchorBerth(feature)
    local s57Feature = S57Lib.CreateFeature("ACHBRT")

    s57Feature.CATACH = feature.categoryOfAnchorage.GetCommaSeparatedValues()
    s57Feature.CATCGO = feature.categoryOfCargo.GetCommaSeparatedValues()
...
return ConvertFeature_AnchorBerth