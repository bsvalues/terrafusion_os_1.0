...
local function ConvertFeature_CurrentNonGravitational(feature)
    local s57Feature = S57Lib.CreateFeature("CURENT")
...
return ConvertFeature_CurrentNonGravitational