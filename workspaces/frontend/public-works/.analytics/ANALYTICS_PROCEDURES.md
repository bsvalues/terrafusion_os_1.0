# Analytics & Machine Learning Operations for public-works
...
- **project-timeline**: Enabled with daily updates
- **cost-estimate**: Enabled with daily updates
- **resource-allocation**: Enabled with daily updates
...
- budget-anomalies: Real-time detection
- schedule-anomalies: Real-time detection
