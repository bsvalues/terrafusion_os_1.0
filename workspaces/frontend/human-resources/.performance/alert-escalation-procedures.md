# Alert & Escalation Procedures for human-resources
...
### 🔴 Critical (P1)
- **Trigger**: 89.91000000000001% uptime or <75.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.905% uptime or >180.0ms response
...
### 🔵 Medium (P3)
- **Trigger**: 98.90100000000001% uptime or >225.0ms response
