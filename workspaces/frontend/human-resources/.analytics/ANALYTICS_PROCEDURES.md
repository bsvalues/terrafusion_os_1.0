# Analytics & Machine Learning Operations for human-resources
...
- **employee-churn**: Enabled with daily updates
- **performance-trends**: Enabled with daily updates
- **career-path**: Enabled with daily updates
...
- salary-anomalies: Real-time detection
- access-violations: Real-time detection
- policy-deviations: Real-time detection
...
- Recommendation Model: Production
