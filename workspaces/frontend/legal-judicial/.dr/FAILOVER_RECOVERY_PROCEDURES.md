# Failover & Recovery Procedures for legal-judicial
...
1. **Local Storage**
   - Path: `/var/backups/legal-judicial`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-legal-judicial`
   - Region: us-east-1
   - Retention: 365 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-legal-judicial`
   - Region: eastus
   - Retention: 365 days
   - Purpose: Geographic redundancy
