# Analytics & Machine Learning Operations for economic-development
...
- **business-growth**: Enabled with daily updates
- **investment-trends**: Enabled with daily updates
- **economic-indicators**: Enabled with daily updates
...
- trend-anomalies: Real-time detection
- data-inconsistencies: Real-time detection
