# Failover & Recovery Procedures for economic-development
...
1. **Local Storage**
   - Path: `/var/backups/economic-development`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-economic-development`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-economic-development`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
