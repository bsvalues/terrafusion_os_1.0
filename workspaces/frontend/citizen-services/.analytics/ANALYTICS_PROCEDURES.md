# Analytics & Machine Learning Operations for citizen-services

**Analytics Tier**: HIGH
**Analytics Level**: advanced
**Data Retention**: 1095 days
...
- **service-demand**: Enabled with daily updates
- **satisfaction-score**: Enabled with daily updates
- **resolution-time**: Enabled with daily updates
...
- service-degradation: Real-time detection
- usage-patterns: Real-time detection
...
- **Warm Data** (archived): 1065 days
- **Cold Data** (long-term): 1095 days
