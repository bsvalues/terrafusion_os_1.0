...
class ArcGISChangeDetector:
    def __init__(self):
        self.name = 'Change Detector'
        self.description = 'Change Detection python raster function to inference a pytorch chnage detector'
