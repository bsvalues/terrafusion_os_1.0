...
local function ConvertFeature_TrafficSeparationSchemeLanePart(feature)
    local s57Feature = S57Lib.CreateFeature("TSSLPT")
...
return ConvertFeature_TrafficSeparationSchemeLanePart