...
local function ConvertFeature_OffshoreProductionArea(feature)
    local s57Feature = S57Lib.CreateFeature("OSPARE")

    s57Feature.CATPRA = feature.categoryOfOffshoreProductionArea.GetFirstValue()
...
return ConvertFeature_OffshoreProductionArea