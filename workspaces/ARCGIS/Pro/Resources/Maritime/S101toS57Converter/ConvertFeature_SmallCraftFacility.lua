...
local function ConvertFeature_SmallCraftFacility(feature)
    local s57Feature = S57Lib.CreateFeature("SMCFAC")

    s57Feature.CATSCF = feature.categoryOfSmallCraftFacility.GetCommaSeparatedValues()
...
return ConvertFeature_SmallCraftFacility