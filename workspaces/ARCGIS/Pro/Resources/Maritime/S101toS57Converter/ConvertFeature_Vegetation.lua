...
local function ConvertFeature_Vegetation(feature)
    local s57Feature = S57Lib.CreateFeature("VEGATN")

    s57Feature.CATVEG = feature.categoryOfVegetation.GetFirstValue()
...
return ConvertFeature_Vegetation