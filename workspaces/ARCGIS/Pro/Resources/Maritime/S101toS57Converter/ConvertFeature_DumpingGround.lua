...
local function ConvertFeature_DumpingGround(feature)
    local s57Feature = S57Lib.CreateFeature("DMPGRD")

    s57Feature.CATDPG = feature.categoryOfDumpingGround.GetCommaSeparatedValues()

    feature.dateDisused.DidNotConvert = true
...
return ConvertFeature_DumpingGround