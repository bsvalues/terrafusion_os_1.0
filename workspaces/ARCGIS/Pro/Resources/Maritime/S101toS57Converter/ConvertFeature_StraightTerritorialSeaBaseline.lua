...
local function ConvertFeature_StraightTerritorialSeaBaseline(feature)
    local s57Feature = S57Lib.CreateFeature("STSLNE")
...
return ConvertFeature_StraightTerritorialSeaBaseline