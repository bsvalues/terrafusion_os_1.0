...
local function ConvertFeature_SignalStationWarning(feature)
    local s57Feature = S57Lib.CreateFeature("SISTAW")

    s57Feature.CATSIW = feature.categoryOfSignalStationWarning.GetCommaSeparatedValues()
...
return ConvertFeature_SignalStationWarning