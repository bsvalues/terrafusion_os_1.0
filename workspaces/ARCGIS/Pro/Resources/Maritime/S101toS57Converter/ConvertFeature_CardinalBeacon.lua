...
local ConvertAttribute_topmark = S101To57AttributeConversionFunctions.topmark

local function ConvertFeature_CardinalBeacon(feature)
    local s57Feature = S57Lib.CreateFeature("BCNCAR")

    s57Feature.BCNSHP = feature.beaconShape.GetFirstValue()
    s57Feature.CATCAM = feature.categoryOfCardinalMark.GetFirstValue()
    ...
    local equipment = ConvertAttribute_topmark(feature.topmark)

    return {s57Feature = s57Feature, equipments = {equipment}}
end

return ConvertFeature_CardinalBeacon