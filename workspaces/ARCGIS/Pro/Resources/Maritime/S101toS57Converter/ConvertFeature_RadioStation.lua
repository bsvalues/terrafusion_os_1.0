...
local ConvertAttribute_frequencyPair = S101To57AttributeConversionFunctions.frequencyPair
...
local function ConvertFeature_RadioStation(feature)
    local s57Feature = S57Lib.CreateFeature("RDOSTA")

    s57Feature.CALSGN = feature.callSign.GetFirstValue()
    s57Feature.CATROS = feature.categoryOfRadioStation.GetCommaSeparatedValues()
    s57Feature.COMCHA = feature.communicationChannel.GetCommaSeparatedValues()
    s57Feature.ESTRNG = feature.estimatedRangeOfTransmission.GetFirstValue()
    ...
    s57Feature.SIGFRQ = ConvertAttribute_frequencyPair(feature.frequencyPair)
...
return ConvertFeature_RadioStation