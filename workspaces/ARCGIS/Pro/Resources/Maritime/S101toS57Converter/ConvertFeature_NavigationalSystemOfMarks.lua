...
local function ConvertFeature_NavigationalSystemOfMarks(feature)
    local s57Feature = S57Lib.CreateFeature("M_NSYS")
...
return ConvertFeature_NavigationalSystemOfMarks