...
def CreateSpaceTimeCubeDefinedLocations(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CreateSpaceTimeCubeDefinedLocations_stpm(
                *gp_fixargs(
                    (
                        in_features,
                        output_cube,
...
def CreateSpaceTimeCubeMDRasterLayer(
    in_md_raster=None,
    output_cube=None,
    fill_empty_bins: Literal["ZEROS", "SPATIAL_NEIGHBORS", "SPACE_TIME_NEIGHBORS", "TEMPORAL_TREND"] | None = None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CreateSpaceTimeCubeMDRasterLayer_stpm(*gp_fixargs((in_md_raster, output_cube, fill_empty_bins), True))
        )
        return retval
    except Exception as e:
        raise e
...
def VisualizeSpaceTimeCube2D(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.VisualizeSpaceTimeCube2D_stpm(
                *gp_fixargs((in_cube, cube_variable, display_theme, output_features, enable_time_series_popups), True)
            )
        )
        return retval
    except Exception as e:
...
def VisualizeSpaceTimeCube3D(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.VisualizeSpaceTimeCube3D_stpm(
                *gp_fixargs((in_cube, cube_variable, display_theme, output_features), True)
            )
        )
        return retval
    except Exception as e:
...
def ChangePointDetection(
    ...
    output_features=None,
    change_type: Literal["MEAN", "STANDARD_DEVIATION", "SLOPE", "COUNT"] | None = None,
    method: Literal["AUTO_DETECT", "DEFINED_NUMBER"] | None = None,
...
def EmergingHotSpotAnalysis(
    ...
    neighborhood_time_step=None,
    polygon_mask=None,
    conceptualization_of_spatial_relationships: Literal[
        "FIXED_DISTANCE", "K_NEAREST_NEIGHBORS", "CONTIGUITY_EDGES_ONLY", "CONTIGUITY_EDGES_CORNERS"
    ]
    | None = None,
    number_of_neighbors=None,
    define_global_window: Literal["ENTIRE_CUBE", "NEIGHBORHOOD_TIME_STEP", "INDIVIDUAL_TIME_STEP"] | None = None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.EmergingHotSpotAnalysis_stpm(
                *gp_fixargs(
                    (
                        in_cube,
                        analysis_variable,
...
def TimeSeriesClustering(
    ...
    analysis_variable=None,
    output_features=None,
    characteristic_of_interest: Literal["VALUE", "PROFILE", "PROFILE_FOURIER"] | None = None,
    cluster_count=None,
    output_table_for_charts=None,
    shape_characteristic_to_ignore: list[Literal["TIME_LAG", "RANGE"]]
    | Literal["TIME_LAG", "RANGE"]
    | str
    | None = None,
    enable_time_series_popups: Literal["CREATE_POPUP", "NO_POPUP"] | None = None,
) -> Result2[str, str]:
...
@gptooldoc("TimeSeriesCrossCorrelation_stpm", None)
def TimeSeriesCrossCorrelation(
    in_cube=None,
    analysis_variable_1=None,
    analysis_variable_2=None,
    output_features=None,
    enable_pop_ups: Literal["CREATE_POPUP", "NO_POPUP"] | None = None,
    max_lag=None,
    lag_direction: Literal["BOTH", "FORWARD", "BACKWARD"] | None = None,
    neighborhood_type: Literal[
        "NO_NBRS", "FIXED_DISTANCE", "K_NEAREST_NEIGHBORS", "CONTIGUITY_EDGES_ONLY", "CONTIGUITY_EDGES_CORNERS"
    ]
    | None = None,
    num_nbrs=None,
    distance_band=None,
    spatial_weights: Literal["EQUAL", "BISQUARE", "GAUSSIAN"] | None = None,
    filter_option: Literal["FILTER", "NO_FILTER"] | None = None,
    out_corr_table=None,
    out_pair_table=None,
) -> Result:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.TimeSeriesCrossCorrelation_stpm(
                *gp_fixargs(
                    (
                        in_cube,
                        analysis_variable_1,
...
def CurveFitForecast(
    ...
    output_features=None,
    output_cube=None,
    number_of_time_steps_to_forecast=None,
    curve_type: Literal["LINEAR", "PARABOLIC", "EXPONENTIAL", "GOMPERTZ", "AUTO_DETECT"] | None = None,
    number_for_validation=None,
...
def EvaluateForecastsByLocation(
    ...
    output_features=None,
    output_cube=None,
    evaluate_using_validation_results: Literal["USE_VALIDATION", "NO_VALIDATION"] | None = None,
) -> Result2[str, str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.EvaluateForecastsByLocation_stpm(
                *gp_fixargs((in_cubes, output_features, output_cube, evaluate_using_validation_results), True)
            )
        )
        return retval
    except Exception as e:
...
def ExponentialSmoothingForecast(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.ExponentialSmoothingForecast_stpm(
                *gp_fixargs(
                    (
                        in_cube,
                        analysis_variable,
...
def ForestBasedForecast(
    ...
    maximum_depth=None,
    sample_size=None,
    forecast_approach: Literal["VALUE", "VALUE_DETREND", "RESIDUAL", "RESIDUAL_DETREND"] | None = None,
    outlier_option: Literal["NONE", "IDENTIFY"] | None = None,
    level_of_confidence: Literal["90%", "95%", "99%"] | None = None,
    maximum_number_of_outliers=None,
    ...
    model_scale: Literal["INDIVIDUAL_LOCATION", "ENTIRE_CUBE", "TIME_SERIES_CLUSTER"] | None = None,
...
def DescribeSpaceTimeCube(
    in_cube=None,
    out_characteristics_table=None,
    out_spatial_extent=None,
) -> Result2[str, str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DescribeSpaceTimeCube_stpm(*gp_fixargs((in_cube, out_characteristics_table, out_spatial_extent), True))
        )
        return retval
    except Exception as e:
        raise e
...
def FillMissingValues(
    ...
    out_features=None,
    fields_to_fill=None,
    fill_method: Literal["MINIMUM", "AVERAGE", "MEDIAN", "MAXIMUM", "TEMPORAL_TREND"] | None = None,
    conceptualization_of_spatial_relationships: Literal[
        "FIXED_DISTANCE",
        "K_NEAREST_NEIGHBORS",
    ...
    | None = None,
    distance_band=None,
    temporal_neighborhood=None,
    time_field=None,
    number_of_spatial_neighbors=None,
    location_id=None,
    related_table=None,
    related_location_id=None,
...
def SubsetSpaceTimeCube(
    in_cube=None,
    out_cube=None,
    spatial_subset_method: Literal["FEATURES", "EXTENT", "SPACE_TIME_CUBE", "NONE"] | None = None,
    temporal_subset_method: Literal["USER_DEFINED", "NUMBER_OF_TIME_STEPS", "SPACE_TIME_CUBE", "NONE"] | None = None,
    in_subset_features=None,
    spatial_relationship: Literal["INTERSECT", "CONTAINS", "WITHIN", "HAVE_THEIR_CENTER_IN"] | None = None,
    spatial_extent=None,
    in_spatial_cube=None,
    time_span_subset=None,
    remove_time_steps=None,
    in_temporal_cube=None,
) -> Result1[str]:
