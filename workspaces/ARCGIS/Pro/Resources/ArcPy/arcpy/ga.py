...
def DiffusionInterpolationWithBarriers(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DiffusionInterpolationWithBarriers_ga(
                *gp_fixargs(
                    (
                        in_features,
                        z_field,
...
def EBKRegressionPrediction(
    ...
    out_ga_layer=None,
    out_raster=None,
    out_diagnostic_feature_class=None,
    measurement_error_field=None,
    min_cumulative_variance=None,
    in_subset_features=None,
    transformation_type: Literal["NONE", "EMPIRICAL", "LOGEMPIRICAL"] | None = None,
    semivariogram_model_type: Literal["EXPONENTIAL", "NUGGET", "WHITTLE", "K_BESSEL"] | None = None,
    max_local_points=None,
    overlap_factor=None,
    number_simulations=None,
    search_neighborhood=None,
...
def EmpiricalBayesianKriging(
    ...
    max_local_points=None,
    overlap_factor=None,
    number_semivariograms=None,
    search_neighborhood=None,
    output_type: Literal["PREDICTION", "QUANTILE", "PROBABILITY", "PREDICTION_STANDARD_ERROR"] | None = None,
    quantile_value=None,
    threshold_type: Literal["EXCEED", "NOT_EXCEED"] | None = None,
    probability_threshold=None,
    semivariogram_model_type: Literal[
        "POWER",
        "LINEAR",
        "THIN_PLATE_SPLINE",
        "EXPONENTIAL",
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.EmpiricalBayesianKriging_ga(
                *gp_fixargs(
                    (
                        in_features,
                        z_field,
...
def EmpiricalBayesianKriging3D(
    ...
    | None = None,
    measurement_error_field=None,
    semivariogram_model_type: Literal["POWER", "LINEAR", "THIN_PLATE_SPLINE", "EXPONENTIAL", "WHITTLE", "K_BESSEL"]
    | None = None,
    transformation_type: Literal["NONE", "EMPIRICAL", "LOGEMPIRICAL"] | None = None,
    subset_size=None,
    overlap_factor=None,
    number_simulations=None,
    trend_removal: Literal["NONE", "FIRST"] | None = None,
    elev_inflation_factor=None,
    search_neighborhood=None,
    output_elevation=None,
    output_type: Literal["PREDICTION", "PREDICTION_STANDARD_ERROR", "PROBABILITY", "QUANTILE"] | None = None,
    quantile_value=None,
    threshold_type: Literal["EXCEED", "NOT_EXCEED"] | None = None,
    probability_threshold=None,
) -> Result1[str | Layer]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.EmpiricalBayesianKriging3D_ga(
                *gp_fixargs(
                    (
                        in_features,
                        elevation_field,
...
def GAMovingWindowKriging(
    in_ga_model_source=None,
    in_datasets=None,
    in_locations=None,
    neighbors_max=None,
    out_featureclass=None,
    cell_size=None,
    out_surface_grid=None,
) -> Result2[str, str]:
...
def GlobalPolynomialInterpolation(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GlobalPolynomialInterpolation_ga(
                *gp_fixargs((in_features, z_field, out_ga_layer, out_raster, cell_size, power, weight_field), True)
            )
        )
        return retval
    except Exception as e:
...
def IDW3D(
    ...
    power=None,
    elev_inflation_factor=None,
    out_cv_features=None,
    x_spacing=None,
    y_spacing=None,
    elevation_spacing=None,
    in_study_area=None,
    min_elev_raster=None,
    max_elev_raster=None,
    search_neighborhood=None,
) -> Result:
...
def KernelInterpolationWithBarriers(
    ...
    cell_size=None,
    in_barrier_features=None,
    kernel_function: Literal["EXPONENTIAL", "GAUSSIAN", "QUARTIC", "EPANECHNIKOV", "POLYNOMIAL5", "CONSTANT"]
    | None = None,
    bandwidth=None,
    power=None,
    ridge=None,
    output_type: Literal["PREDICTION", "PREDICTION_STANDARD_ERROR"] | None = None,
) -> Result2[str | Layer, str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.KernelInterpolationWithBarriers_ga(
                *gp_fixargs(
                    (
                        in_features,
                        z_field,
...
def LocalPolynomialInterpolation(
    ...
    | None = None,
    bandwidth=None,
    use_condition_number: Literal["USE_CONDITION_NUMBER", "NO_USE_CONDITION_NUMBER"] | None = None,
    condition_number=None,
    weight_field=None,
    output_type: Literal["PREDICTION", "PREDICTION_STANDARD_ERROR", "CONDITION_NUMBER"] | None = None,
) -> Result2[str | Layer, str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.LocalPolynomialInterpolation_ga(
                *gp_fixargs(
                    (
                        in_features,
                        z_field,
...
def RadialBasisFunctions(
    ...
    cell_size=None,
    search_neighborhood=None,
    radial_basis_functions: Literal[
        "COMPLETELY_REGULARIZED_SPLINE",
        "SPLINE_WITH_TENSION",
        "MULTIQUADRIC_FUNCTION",
        "INVERSE_MULTIQUADRIC_FUNCTION",
        "THIN_PLATE_SPLINE",
    ]
    | None = None,
...
def CreateSpatiallyBalancedPoints(
    in_probability_raster=None,
    number_output_points=None,
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CreateSpatiallyBalancedPoints_ga(
                *gp_fixargs((in_probability_raster, number_output_points, out_feature_class), True)
            )
        )
        return retval
    except Exception as e:
...
def DensifySamplingNetwork(
    in_geostat_layer=None,
    number_output_points=None,
    out_feature_class=None,
    selection_criteria: Literal["STDERR", "STDERR_THRESHOLD", "QUARTILE_THRESHOLD", "QUARTILE_THRESHOLD_UPPER"]
    | None = None,
    threshold=None,
    in_weight_raster=None,
    in_candidate_point_features=None,
    inhibition_distance=None,
) -> Result1[str]:
...
def ExtractValuesToTable(
    ...
    in_rasters=None,
    out_table=None,
    out_raster_names_table=None,
    add_warning_field: Literal["ADD_WARNING_FIELD", "DO_NOT_ADD_WARNING_FIELD"] | None = None,
) -> Result2[str, str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.ExtractValuesToTable_ga(
                *gp_fixargs((in_features, in_rasters, out_table, out_raster_names_table, add_warning_field), True)
            )
        )
        return retval
    except Exception as e:
...
def GaussianGeostatisticalSimulations(
    ...
    output_simulation_prefix=None,
    in_conditioning_features=None,
    conditioning_field=None,
    cell_size=None,
    in_bounding_dataset=None,
    save_simulated_rasters: Literal["SAVE_SIMULATIONS", "DO_NOT_SAVE_SIMULATIONS"] | None = None,
    quantile=None,
    threshold=None,
    in_stats_polygons=None,
    raster_stat_type: list[
        Literal["MIN", "MAX", "MEAN", "STDDEV", "QUARTILE1", "MEDIAN", "QUARTILE3", "QUANTILE", "P_THRSHLD"]
    ]
    | Literal["MIN", "MAX", "MEAN", "STDDEV", "QUARTILE1", "MEDIAN", "QUARTILE3", "QUANTILE", "P_THRSHLD"]
    | str
    | None = None,
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GaussianGeostatisticalSimulations_ga(
                *gp_fixargs(
                    (
                        in_geostat_layer,
...
def CompareGeostatisticalLayers(
    in_geostat_layers=None,
    out_cv_table=None,
    out_geostat_layer=None,
    comparison_method: Literal["SINGLE", "SORTING", "AVERAGE_RANK"] | None = None,
    criterion: Literal["ACCURACY", "BIAS", "WORST_CASE", "STANDARD_ERROR", "PRECISION"] | None = None,
    criteria_hierarchy=None,
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CompareGeostatisticalLayers_ga(
                *gp_fixargs(
                    (
                        in_geostat_layers,
                        out_cv_table,
...
def CrossValidation(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CrossValidation_ga(*gp_fixargs((in_geostat_layer, out_point_feature_class), True))
        )
...
@gptooldoc("DirectionalTrend_ga", None)
def DirectionalTrend(
    ...
    """DirectionalTrend_ga(in_features, analysis_field, {direction}, {determine_direction}, {order})
...
def ExploratoryInterpolation(
    ...
    | Literal[
        "SIMPLE_KRIGING", "ORDINARY_KRIGING", "UNIVERSAL_KRIGING", "EBK", "KERNEL_INTERPOLATION", "IDW", "RBF", "GPI"
    ]
    | str
    | None = None,
    comparison_method: Literal["SINGLE", "SORTING", "AVERAGE_RANK"] | None = None,
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.ExploratoryInterpolation_ga(
                *gp_fixargs(
                    (
                        in_features,
                        value_field,
...
def GANeighborhoodSelection(
    ...
    major_semiaxis=None,
    angle=None,
    shape_type: Literal["ONE_SECTOR", "FOUR_SECTORS", "FOUR_SECTORS_SHIFTED", "EIGHT_SECTORS"] | None = None,
) -> Result1[str | Layer]:
...
def GASemivariogramSensitivity(
    ...
    in_datasets=None,
    in_locations=None,
    nugget_span_percents=None,
    nugget_calc_times=None,
    partialsill_span_percents=None,
    partialsill_calc_times=None,
    range_span_percents=None,
    range_calc_times=None,
    minrange_span_percents=None,
    minrange_calc_times=None,
    out_table=None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GASemivariogramSensitivity_ga(
                *gp_fixargs(
                    (
                        in_ga_model_source,
                        in_datasets,
...
def GenerateSubsetPolygons(
    ...
    out_feature_class=None,
    min_points_per_subset=None,
    max_points_per_subset=None,
    coincident_points: Literal["COINCIDENT_SINGLE", "COINCIDENT_ALL"] | None = None,
) -> Result1[str]:
...
def SubsetFeatures(
    in_features=None,
    out_training_feature_class=None,
    out_test_feature_class=None,
    size_of_training_dataset=None,
    subset_size_units: Literal["PERCENTAGE_OF_INPUT", "ABSOLUTE_VALUE"] | None = None,
) -> Result2[str, str]:
...
def ArealInterpolationLayerToPolygons(
    in_areal_interpolation_layer=None,
    in_polygon_features=None,
    out_feature_class=None,
    append_all_fields: Literal["ALL", "FID_ONLY"] | None = None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.ArealInterpolationLayerToPolygons_ga(
                *gp_fixargs(
                    (in_areal_interpolation_layer, in_polygon_features, out_feature_class, append_all_fields), True
                )
            )
        )
        return retval
...
def GACalculateZValue(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GACalculateZValue_ga(*gp_fixargs((in_geostat_layer, point_coord), True))
        )
        return retval
    except Exception as e:
        raise e
...
def GACreateGeostatisticalLayer(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GACreateGeostatisticalLayer_ga(*gp_fixargs((in_ga_model_source, in_datasets, out_layer), True))
        )
        return retval
    except Exception as e:
        raise e
...
def GAGetModelParameter(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GAGetModelParameter_ga(*gp_fixargs((in_ga_model_source, model_param_xpath), True))
        )
        return retval
    except Exception as e:
        raise e
...
def GALayer3DToMultidimensionalRaster(
    in_3d_geostat_layer=None,
    out_multidimensional_raster=None,
    cell_size=None,
    explicit_only: Literal["EXPLICIT_VALUES", "NO_EXPLICIT_VALUES"] | None = None,
    min_elev=None,
    max_elev=None,
    elev_interval=None,
    elev_values=None,
    ...
    | None = None,
    quantile_probability_value=None,
    additional_outputs=None,
    build_transpose: Literal["BUILD_TRANSPOSE", "DO_NOT_BUILD_TRANSPOSE"] | None = None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GALayer3DToMultidimensionalRaster_ga(
                *gp_fixargs(
                    (
                        in_3d_geostat_layer,
...
def GALayer3DToNetCDF(
    in_3d_geostat_layers=None,
    out_netcdf_file=None,
    export_locations: Literal["3D_GRIDDED_POINTS", "CUSTOM_3D_POINTS"] | None = None,
    x_spacing=None,
    y_spacing=None,
    elevation_spacing=None,
    in_points_3d=None,
...
def GALayerToContour(
    in_geostat_layer=None,
    contour_type: Literal["SAME_AS_LAYER", "CONTOUR", "FILLED_CONTOUR"] | None = None,
    out_feature_class=None,
    contour_quality: Literal["DRAFT", "PRESENTATION"] | None = None,
    classification_type: Literal["GEOMETRIC_INTERVAL", "EQUAL_INTERVAL", "QUANTILE", "MANUAL"] | None = None,
    classes_count=None,
    classes_breaks=None,
    out_elevation=None,
) -> Result1[str]:
...
def GALayerToGrid(
    ...
    out_surface_grid=None,
    cell_size=None,
    points_per_block_horz=None,
    points_per_block_vert=None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GALayerToGrid_ga(
                *gp_fixargs(
                    (in_geostat_layer, out_surface_grid, cell_size, points_per_block_horz, points_per_block_vert), True
                )
            )
        )
        return retval
...
def GASetModelParameter(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GASetModelParameter_ga(
                *gp_fixargs((in_ga_model_source, model_param_xpath, in_param_value, out_ga_model), True)
            )
        )
        return retval
    except Exception as e:
