# Failover & Recovery Procedures for TerraFusionIDE
...
1. **Local Storage**
   - Path: `/var/backups/TerraFusionIDE`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-TerraFusionIDE`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-TerraFusionIDE`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
