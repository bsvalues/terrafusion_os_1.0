# Failover & Recovery Procedures for unified-system
...
1. **Local Storage**
   - Path: `/var/backups/unified-system`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-unified-system`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-unified-system`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
