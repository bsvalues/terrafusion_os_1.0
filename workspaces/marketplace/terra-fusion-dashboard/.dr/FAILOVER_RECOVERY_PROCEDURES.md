# Failover & Recovery Procedures for terra-fusion-dashboard
...
1. **Local Storage**
   - Path: `/var/backups/terra-fusion-dashboard`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-terra-fusion-dashboard`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-terra-fusion-dashboard`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
