# Failover & Recovery Procedures for marketplace-frontend
...
1. **Local Storage**
   - Path: `/var/backups/marketplace-frontend`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-marketplace-frontend`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-marketplace-frontend`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
