# Failover & Recovery Procedures for submissions
...
1. **Local Storage**
   - Path: `/var/backups/submissions`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-submissions`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-submissions`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
