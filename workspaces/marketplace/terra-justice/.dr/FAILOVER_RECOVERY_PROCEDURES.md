# Failover & Recovery Procedures for terra-justice
...
1. **Local Storage**
   - Path: `/var/backups/terra-justice`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-terra-justice`
   - Region: us-east-1
   - Retention: 365 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-terra-justice`
   - Region: eastus
   - Retention: 365 days
   - Purpose: Geographic redundancy
