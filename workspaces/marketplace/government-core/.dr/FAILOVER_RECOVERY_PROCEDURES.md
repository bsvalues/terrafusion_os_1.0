# Failover & Recovery Procedures for government-core
...
1. **Local Storage**
   - Path: `/var/backups/government-core`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-government-core`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-government-core`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
