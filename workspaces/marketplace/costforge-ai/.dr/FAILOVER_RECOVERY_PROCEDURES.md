# Failover & Recovery Procedures for costforge-ai
...
1. **Local Storage**
   - Path: `/var/backups/costforge-ai`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-costforge-ai`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-costforge-ai`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
