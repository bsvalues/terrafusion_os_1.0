# Analytics & Machine Learning Operations for api

**Analytics Tier**: CRITICAL
**Analytics Level**: enterprise
**Data Retention**: 365 days
**ML Frameworks**: statsmodels, tensorflow, isolation-forest
...
- **api-failure**: Enabled with daily updates
- **latency-spike**: Enabled with daily updates
- **throughput-demand**: Enabled with daily updates
...
- traffic-anomalies: Real-time detection
- error-rate-spikes: Real-time detection
- ddos-patterns: Real-time detection
