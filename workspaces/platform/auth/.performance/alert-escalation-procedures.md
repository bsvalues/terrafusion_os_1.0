# Alert & Escalation Procedures for auth
...
### 🔴 Critical (P1)
- **Trigger**: 89.991% uptime or <25.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.9905% uptime or >60.0ms response
...
### 🔵 Medium (P3)
- **Trigger**: 98.9901% uptime or >75.0ms response
...
- Response Time P99: 100ms target
