# Failover & Recovery Procedures for consciousness
...
1. **Local Storage**
   - Path: `/var/backups/consciousness`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-consciousness`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-consciousness`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
