# Failover & Recovery Procedures for specialized
...
1. **Local Storage**
   - Path: `/var/backups/specialized`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-specialized`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-specialized`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
