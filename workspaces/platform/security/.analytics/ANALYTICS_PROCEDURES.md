# Analytics & Machine Learning Operations for security
...
- **threat-intelligence**: Enabled with daily updates
- **vulnerability-likelihood**: Enabled with daily updates
- **breach-risk**: Enabled with daily updates
...
- security-anomalies: Real-time detection
- protocol-violations: Real-time detection
- threat-patterns: Real-time detection
