# Failover & Recovery Procedures for performance
...
1. **Local Storage**
   - Path: `/var/backups/performance`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-performance`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-performance`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
