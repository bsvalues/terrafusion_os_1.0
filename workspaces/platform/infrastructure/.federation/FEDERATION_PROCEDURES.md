# Federation & Enterprise Integration for infrastructure

**Federation Role**: data_aggregator
**Gateway Type**: data_gateway
**Federation Tier**: 2
**Sync Frequency**: 5000ms
...
- Syncs with high_tier tier workspaces
- Uses data_gateway gateway
