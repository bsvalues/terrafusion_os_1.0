            ...
            BEGIN
                ...
                IF @property_name NOT IN ('ENCRYPTION_ALGORITHM', 'RETENTION_WINDOW', 
                    'MAX_PROJECT_VERSIONS', 'VERSION_CLEANUP_ENABLED', 'OPERATION_CLEANUP_ENABLED', 
                    'SERVER_LOGGING_LEVEL','SERVER_OPERATION_ENCRYPTION_LEVEL')
                BEGIN
                ...
                BEGIN
                    ...
                    BEGIN TRY
                        ...
                        BEGIN
                            RAISERROR(27101,16,1,'property_value')
                        END
                        ...
                        IF @curr_level NOT in (1,2)         --a number other than 1 and 2 is invalid
                        BEGIN
