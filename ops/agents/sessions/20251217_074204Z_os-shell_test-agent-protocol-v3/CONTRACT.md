...
> Session: `20251217_074204Z_os-shell_test-agent-protocol-v3`
> Project: TerraFusion OS Shell
> Feature: Test Agent Protocol V3
> Mode: feature | Risk: med | SpecLock: strict
> Created: 2025-12-17T07:42:04Z
...
5. **Commit discipline**: Commit after each significant increment, run gate.
   - Commit message format: `feat(os-shell): <slice> [SESSION:20251217_074204Z_os-shell_test-agent-protocol-v3]`
   - Run: `tf gate`
...
### Git
- **Base branch**: main
- **Work branch**: feat/os-shell/test-agent-protocol-v3
...
2. Paste diff into `PATCHLOG.md` with:
   ...
   - Fenced `diff` block
3. Run: `tf gate`
4. Commit: `git commit -m "feat(os-shell): <slice> [SESSION:20251217_074204Z_os-shell_test-agent-protocol-v3]"`
5. Repeat
