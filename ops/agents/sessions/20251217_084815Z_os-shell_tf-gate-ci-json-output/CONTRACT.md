...
> Feature: tf gate --ci JSON output
> Mode: feature | Risk: low | SpecLock: strict
> Created: 2025-12-17T08:48:15Z
...
5. **Commit discipline**: Commit after each significant increment, run gate.
   - Commit message format: `feat(os-shell): <slice> [SESSION:20251217_084815Z_os-shell_tf-gate-ci-json-output]`
   - Run: `tf gate`
...
### Git
- **Base branch**: main
- **Work branch**: feat/os-shell/tf-gate-ci-json-output
...
2. Paste diff into `PATCHLOG.md` with:
   ...
   - Fenced `diff` block
3. Run: `tf gate`
4. Commit: `git commit -m "feat(os-shell): <slice> [SESSION:20251217_084815Z_os-shell_tf-gate-ci-json-output]"`
5. Repeat
