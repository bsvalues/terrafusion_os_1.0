...
> Feature: phase-3.2-moduleloader-startmenu-integration
> Mode: feature | Risk: med | SpecLock: strict
> Created: 2025-12-29T23:45:01Z
...
5. **Commit discipline**: Commit after each significant increment, run gate.
   - Commit message format: `feat(os-shell): <slice> [SESSION:20251229_234501Z_os-shell_phase-32-moduleloader-startmenu-integration]`
...
### Git
- **Base branch**: main
- **Work branch**: feat/os-shell/phase-32-moduleloader-startmenu-integration
...
4. Commit: `git commit -m "feat(os-shell): <slice> [SESSION:20251229_234501Z_os-shell_phase-32-moduleloader-startmenu-integration]"`
5. Repeat
