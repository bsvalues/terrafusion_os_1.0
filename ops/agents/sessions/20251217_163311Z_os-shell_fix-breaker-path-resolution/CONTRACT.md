...
> Feature: Fix breaker PATH resolution
> Mode: bugfix | Risk: low | SpecLock: strict
> Created: 2025-12-17T16:33:11Z
...
5. **Commit discipline**: Commit after each significant increment, run gate.
   - Commit message format: `feat(os-shell): <slice> [SESSION:20251217_163311Z_os-shell_fix-breaker-path-resolution]`
...
### Git
- **Base branch**: main
- **Work branch**: feat/os-shell/fix-breaker-path-resolution
...
4. Commit: `git commit -m "feat(os-shell): <slice> [SESSION:20251217_163311Z_os-shell_fix-breaker-path-resolution]"`
5. Repeat
