...
Don't push forward if things are breaking. Better to rollback cleanly and fix the issue than to compound problems.
...
*"A clean rollback and proper fix is worth ten hacks and workarounds."*
