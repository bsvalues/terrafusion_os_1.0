...
class PerformanceMonitor {
    ...
    middleware() {
        return (req, res, next) => {
            ...
            res.end = (...args) => {
                ...
                endpointMetrics.avg_response_time = Math.round(endpointMetrics.total_time / endpointMetrics.requests);
    ...
    startMonitoring() {
        setInterval(() => {
            ...
            console.log(`[PERFORMANCE] Requests: ${this.metrics.requests}, Avg Response: ${this.metrics.performance.avg_response_time}ms, Memory: ${this.metrics.performance.peak_memory}MB`);
        }, 30000);
    ...
    getHealthStatus() {
        const errorRate = this.metrics.requests > 0 ? 
            (this.metrics.responses.errors / this.metrics.requests) * 100 : 0;
