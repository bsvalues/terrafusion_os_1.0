/**
 * Outputs for TerraFusionPro Production Environment
 */
...
output "application_insights_instrumentation_key" {
  ...
  value       = azurerm_application_insights.terrafusionpro.instrumentation_key
  sensitive   = true
}

output "key_vault_uri" {
  description = "Key Vault URI"
  value       = azurerm_key_vault.terrafusionpro.vault_uri
}