...
size="sm" className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-md hover:shadow-lg transition-all duration-300">
...
value="data" className="flex-1">Data Components</TabsTrigger>
...
className="text-sm text-emerald-600 font-medium flex items-center mt-1">
...
className="text-sm font-medium mt-3 text-green-800">Filing</div>
...
className="text-sm font-medium mt-3 text-green-800">Review</div>
                      <div className="text-xs text-gray-500">Completed</div>
                    </div>
...
className="text-xs text-blue-600">In Progress</div>
                    </div>
...
className="text-xs text-gray-400">Pending</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
...
className="text-right p-4 font-medium text-blue-800">Value</th><>

                          <th className="text-right p-4 font-medium text-blue-800">Prev. Tax</th>
                          <th
</>

className="text-right p-4 font-medium text-blue-800">New Tax</th>
...
className="p-4 text-right text-slate-700">$450,000</td><>

                          <td className="p-4 text-right text-slate-700">$675.00</td>
                          <td
</>

className="p-4 text-right text-slate-700">$671.40</td>
...
className="p-4 text-right text-slate-700">$375,000</td><>

                          <td className="p-4 text-right text-slate-700">$562.50</td>
                          <td
</>

className="p-4 text-right text-slate-700">$559.50</td>
                          <td className="p-4 text-right text-emerald-600 font-medium">-0.53%</td>
                        </tr>
                        <tr className="border-b border-slate-100/50 transition-colors hover:bg-blue-50/20"><>
...
className="p-4 text-right text-slate-700">$520,000</td><>

                          <td className="p-4 text-right text-slate-700">$780.00</td>
                          <td
</>

className="p-4 text-right text-slate-700">$775.84</td>
                          <td className="p-4 text-right text-emerald-600 font-medium">-0.53%</td>
                        </tr>
                      </tbody>
                    </table>
...
className="text-xs text-slate-400">Target: less than 1.0%</span>
                    </div>
                  </div>
                </Card>
...
className="text-xs text-slate-400">Approved</span>
                    </div>
                  </div>
                </Card>
...
className="text-xs text-slate-400">Not subject to limit</span>
                    </div>
                  </div>
                </Card>
              </div>
...
className="text-xs text-slate-500 mt-1">Rate per $1,000 assessed value</p>
                          </div>
                        </div>
                      </div>
                    </div>
