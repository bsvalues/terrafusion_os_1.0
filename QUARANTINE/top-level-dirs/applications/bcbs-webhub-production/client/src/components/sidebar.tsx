...
href="/">
        ...
        <Link href="/ai-recommendations">
          <a className={`flex items-center px-4 py-2 mt-1 rounded-lg ${isActive("/ai-recommendations") ? "bg-blue-700 text-white" : "text-neutral-300 hover:bg-neutral-800"}`}>
            <span className="material-icons mr-3">psychology</span>
            AI Recommendations
          </a>
        </Link>
        
        <Link href="/action-demo">
          <a className={`flex items-center px-4 py-2 mt-1 rounded-lg ${isActive("/action-demo") ? "bg-blue-700 text-white" : "text-neutral-300 hover:bg-neutral-800"}`}>
