...
<>
          ...
          <TabsTrigger
</> value="complete" className="flex items-center">
<>
            <Wand2 className="h-4 w-4 mr-1" />
            Complete
          </TabsTrigger>
          <TabsTrigger
</> value="explain" className="flex items-center">
<>
            <Lightbulb className="h-4 w-4 mr-1" />
            Explain
          </TabsTrigger>
          <TabsTrigger
</> value="fix" className="flex items-center">
<>
            <BugReport className="h-4 w-4 mr-1" />
            Fix
          </TabsTrigger>
          <TabsTrigger
</> value="improve" className="flex items-center">
<>
            <Sparkles className="h-4 w-4 mr-1" />
            Improve
          </TabsTrigger>
          <TabsTrigger
</> value="assessment" className="flex items-center">
<>
...
<>
                  ...
                  <Button
</> size="sm" onClick={insertSelectedCode} className="h-8">
                    Insert
                  </Button>
                </div>
                  ...
                  <Card key={index} className="overflow-hidden">
                    <CardHeader className="py-3">
                      <CardTitle className="text-sm flex items-center">
                        ...
                        {item.type === 'fix' && <BugReport className="h-4 w-4 mr-1" />}
...
<>
                ...
                <p
</> className="text-xs text-gray-400">Your AI interactions will appear here</p>
              </div>
            )}
          </TabsContent>
        </div>
