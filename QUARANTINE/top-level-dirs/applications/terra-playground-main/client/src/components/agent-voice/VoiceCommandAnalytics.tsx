...
<>
      ...
      <p
</> className="mt-1">Start using voice commands to see analytics here.</p>
    </div>
  );
...
<>
          ...
          <p
</> className="mt-1">Great job! No common errors were detected.</p>
        </div>
      );
...
<>
            ...
            <TableHead
</> className="text-right">Success Rate</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
...
<>
              ...
              <TableCell
</> className="max-w-[300px] truncate" title={command.commandText}>
                {command.commandText}
              </TableCell>
<>
...
<>
                    ...
                    <CardDescription
</>>The most frequently used voice commands</CardDescription>
                  </CardHeader>
                  <CardContent>
...
<>
                    ...
                    <CardDescription
</>>Breakdown of command usage by type</CardDescription>
                  </CardHeader>
...
<>
                    ...
                    <CardDescription
</>>Command usage over time</CardDescription>
                  </CardHeader>
...
<>
                    ...
                    <CardDescription
</>>Most frequent error messages</CardDescription>
                  </CardHeader>
