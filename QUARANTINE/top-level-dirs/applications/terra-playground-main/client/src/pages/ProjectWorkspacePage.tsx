...
<>
          ...
          <Button
</> onClick={() => navigate('/development')}>Back to Projects</Button>
        </div>
      </DevelopmentWorkspaceLayout>
    );
  }
...
<>
          ...
          <p
</> className="text-gray-500">{project.description}</p>
        </div>
...
<>
                ...
                <TabsTrigger
</> value="preview" className="flex items-center">
<>
                  <Code className="h-4 w-4 mr-1" />
                  Preview
                </TabsTrigger>
                <TabsTrigger
</> value="terminal" className="flex items-center">
<>
                  <Terminal className="h-4 w-4 mr-1" />
                  Terminal
                </TabsTrigger>
                <TabsTrigger
</> value="settings" className="flex items-center">
...
<>
              <p>$ npm run dev</p>
              <p
</> className="text-green-400">Starting development server...</p>
