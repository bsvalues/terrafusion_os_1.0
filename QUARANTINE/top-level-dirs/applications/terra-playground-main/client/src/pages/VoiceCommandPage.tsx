...
<>
              ...
              <CardDescription
</>>Speak to your assessment assistant</CardDescription>
            </CardHeader>
            <CardContent>
              <AgentVoiceInterface
...
<>
                    <li>"Show me property data for BC001"</li>
                            <li
</>>"Generate a valuation report for 1320 N Louis Avenue"</li>
<>
                    <li>"How are residential properties assessed?"</li>
                            <li
</>>"Help me understand land value calculations"</li>
                  </ul>
                </AlertDescription>
              </Alert>
            </CardContent>
...
<>
              ...
              <CardDescription
</>>Recent voice command interactions and results</CardDescription>
            </CardHeader>
            <CardContent>
