...
import { Check, Warning, Bot, Database, BarChart, Network, CpuIcon  } from '@mui/icons-material';
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2
</> className="text-xl font-semibold">Property Assessment Agent</h2>
                </div><>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2
</> className="text-xl font-semibold">Data Ingestion Agent</h2>
                </div><>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2
</> className="text-xl font-semibold">Reporting Agent</h2>
                </div><>
                ...
                <div><>
                  ...
                  <ul
                    ...
                    <li className="flex items-center"><>
                      ...
                      <Warning className="h-4 w-4 mr-2 text-primary" />
