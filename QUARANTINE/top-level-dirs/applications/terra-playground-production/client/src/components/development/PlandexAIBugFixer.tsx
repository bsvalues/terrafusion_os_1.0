...
import { Loader2, BugReport, CheckCircle2, Code, ArrowRight  } from '@mui/icons-material';
    ...
    <div className={className}>
      <Card>
        <CardHeader>
          ...
          <CardDescription
</>>Automatically fix bugs in your code using AI</CardDescription>
        </CardHeader>
        ...
        <CardFooter className="flex justify-between"><>
          ...
          >
            {isFixing ? (
              ...
              <>
                <BugReport className="mr-2 h-4 w-4" />
                Fix Bugs
              </>
            )}
          </Button>
