          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="flex items-center mt-1 space-x-2">
                ...
                <span
</> className="text-xs text-gray-500">Type: {model.type.replace('_', ' ')}</span>
              </div>
            </div>
            ...
            <div>
              {isEditing ? (
                <div className="flex space-x-2">
                  ...
                  <Button
</> size="sm" onClick={handleSaveChanges}>
        ...
        <div className="px-6">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-5 mb-4"><>
              ...
              <TabsTrigger
</> value="variables" className="flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div><>
                    ...
                    <div
                      ...
                      <div className="flex justify-between"><>
                        ...
                        <span
</> className="font-mono text-sm">{model.modelId}</span>
                      </div>
                      <div className="flex justify-between"><>

                        <span className="text-gray-500">Created:</span>
                        <span
</>>{new Date(model.createdAt).toLocaleDateString()}</span>
                      </div>
                      <div className="flex justify-between"><>

                        <span className="text-gray-500">Last Modified:</span>
                        <span
</>>{new Date(model.lastModifiedAt).toLocaleDateString()}</span>
                      </div>
                      <div className="flex justify-between"><>
                  ...
                  <div><>
                    ...
                    <div
</> className="bg-gray-50 p-4 rounded-md grid grid-cols-2 gap-2">
                      <div className="flex flex-col items-center p-3 border rounded-md bg-white">
                        ...
                        <span
</> className="text-xs text-gray-500">Variables</span>
                      </div>
                      <div className="flex flex-col items-center p-3 border rounded-md bg-white">
                        ...
                        <span
</> className="text-xs text-gray-500">Components</span>
                      </div>
                      <div className="flex flex-col items-center p-3 border rounded-md bg-white">
                        ...
                        <span
</> className="text-xs text-gray-500">Calculations</span>
                      </div>
                      <div className="flex flex-col items-center p-3 border rounded-md bg-white">
                        ...
                        <span
</> className="text-xs text-gray-500">Validations</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {variables.map((variable: any) => (
                        <tr key={variable.id}><>
                          ...
                          <td
</> className="px-6 py-4 whitespace-nowrap">{variable.type}</td><>
            ...
            <TabsContent value="components">
              <div className="mb-4 flex justify-between items-center"><>
                ...
                <Button
</> size="sm" onClick={() => setIsComponentDialogOpen(true)}>
                  <Plus className="h-4 w-4 mr-1" />
                  Add Component
                </Button>
              </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {components.map((component: any) => (
                        <tr key={component.id}><>
                          ...
                          <td
</> className="px-6 py-4 whitespace-nowrap">{component.type}</td><>
            ...
            <TabsContent value="calculations">
              <div className="mb-4 flex justify-between items-center"><>
                ...
                <Button
</> size="sm" onClick={() => setIsCalculationDialogOpen(true)}>
                  <Plus className="h-4 w-4 mr-1" />
                  Add Calculation
                </Button>
              </div>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {calculations.map((calculation: any) => (
                        <tr key={calculation.id}><>
                          ...
                          <td
</> className="px-6 py-4">{calculation.description}</td><>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {validationRules.map((rule: any) => (
                        <tr key={rule.id}><>
                          ...
                          <td
</> className="px-6 py-4">{rule.description}</td><>
