    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div><>
          ...
          <p
</> className="text-gray-500">Deploy, monitor, and manage applications and integrations</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="applications" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-3 mb-6"><>
          ...
          <TabsTrigger
</> value="integrations">Integrations</TabsTrigger>
            ...
            <Card className="lg:col-span-1">
              <CardHeader>
                <CardTitle className="flex justify-between items-center"><>
                  ...
                  <Button
</> variant="outline" size="icon" onClick={() => refetchApplications()}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      <div><>
                        ...
                        <div
</> className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md h-[200px] overflow-auto">
            ...
            <Card className="lg:col-span-1">
              <CardHeader>
                <CardTitle className="flex justify-between items-center"><>
                  ...
                  <Button
</> variant="outline" size="icon" onClick={() => refetchIntegrations()}>
                    <Refresh className="h-4 w-4" />
                  </Button>
                </CardTitle>
            ...
            {isCreatingIntegration ? (
              <Card className="lg:col-span-2">
                <CardHeader><>
                  ...
                  <CardDescription
</>>Configure a new system integration</CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...integrationForm}>
                    ...
                    >
                          ...
                          <FormItem><>
                            ...
                            <Select
                              ...
                              <SelectContent><>
                                ...
                                <SelectItem
</> value="apikey">API Key</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                      ...
                      <div className="flex justify-end space-x-2 pt-4"><>
                        ...
                        <Button
</> type="submit" disabled={createIntegrationMutation.isPending}>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div><>
                      ...
                      <h3 className="text-sm font-medium mb-2">Configuration</h3>
                      <div
</> className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md h-[300px] overflow-auto">
                        <pre className="text-xs">
                          <code>
                            {JSON.stringify(
                              {
        ...
        <TabsContent value="deployment">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Configure and deploy a new application component</CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...deployForm}>
                <form onSubmit={deployForm.handleSubmit(onDeploySubmit)} className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem><>
                            ...
                            <FormDescription
</>>A unique name for this application</FormDescription>
                            <FormMessage />
                          </FormItem>
                        )}
                      />
                          ...
                          <FormItem><>
                            ...
                            <Select
                              ...
                              <SelectContent><>
                                ...
                                <SelectItem
</> value="api">API Service</SelectItem><>

                                <SelectItem value="ui">User Interface</SelectItem>
                                <SelectItem
</> value="agent">Intelligent Agent</SelectItem>
                  ...
                  <div className="flex justify-end space-x-2 pt-2"><>
                    ...
                    <Button
</> type="submit" disabled={deployApplicationMutation.isPending}>
