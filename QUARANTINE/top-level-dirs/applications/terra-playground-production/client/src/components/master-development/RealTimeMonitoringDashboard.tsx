    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div><>
          ...
          <p
</> className="text-gray-500">Master Development Agent system performance dashboard</p>
        </div>
        <div className="flex items-center space-x-2"><>
          ...
          <Button
</> variant="outline" size="sm" onClick={handleRefresh} disabled={isPolling}>
      ...
      <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-3 mb-6"><>
          ...
          <TabsTrigger
</> value="metrics">Detailed Metrics</TabsTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>Detailed authentication metrics</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Total</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold text-green-600">347</p>
                          <p
</> className="text-xs text-gray-500">Successful</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold text-red-600">5</p>
                          <p
</> className="text-xs text-gray-500">Failed</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Generated</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">87</p>
                          <p
</> className="text-xs text-gray-500">Active</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">45</p>
                          <p
</> className="text-xs text-gray-500">Refreshed</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>Database and data processing statistics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div><>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Total Queries</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">120</p>
                          <p
</> className="text-xs text-gray-500">Avg. Time (ms)</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">93.5%</p>
                          <p
</> className="text-xs text-gray-500">Cache Hit Rate</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        ...
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Txns Active</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">50</p>
                          <p
</> className="text-xs text-gray-500">Pool Size</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="md:col-span-2">
              <CardHeader><>
                ...
                <CardDescription
</>>Message queue and service integration</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Queue Size</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">75</p>
                          <p
</> className="text-xs text-gray-500">Msg/sec</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">250</p>
                          <p
</> className="text-xs text-gray-500">Avg. Latency (ms)</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">2 min</p>
                          <p
</> className="text-xs text-gray-500">Oldest Message</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div
                      ...
                      <div className="grid grid-cols-2 gap-4 text-center">
                        <div><>
                          ...
                          <p
</> className="text-xs text-gray-500">Active Connections</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">0</p>
                          <p
</> className="text-xs text-gray-500">Pending Requests</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">1.2%</p>
                          <p
</> className="text-xs text-gray-500">Error Rate</p>
                        </div>
                        <div><>

                          <p className="text-2xl font-bold">99.85%</p>
                          <p
</> className="text-xs text-gray-500">Uptime</p>
                        </div>
                      </div>
                    </div>
                  </div>
