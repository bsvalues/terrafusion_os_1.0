...
import { Warning, Shield, Info, BarChart2, ExternalLink  } from '@mui/icons-material';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export function RiskFactorCard({
  ...
  const getRiskIcon = () => {
    ...
    if (level.toLowerCase().includes('high')) return <Warning className="h-4 w-4" />;
        ...
        <div className="space-y-3">
          <div className="space-y-1">
            <div className="flex justify-between text-sm"><>
              ...
              <span
</> className="font-medium">{score}/100</span>
            </div><>
