...
const testPropertyComponents = () => {
  ...
  allPassed =
    simulateTest('PropertyCard renders with property data', () => {
      const mockProperty = {
        propertyId: 'BC001',
        address: '123 Main St',
  ...
  allPassed =
    simulateTest('PropertyDetail renders with full property details', () => {
      const mockProperty = {
        propertyId: 'BC001',
        address: '123 Main St',
        parcelNumber: '12345',
...
const testAIComponents = () => {
  ...
  allPassed =
    simulateTest('PropertyStoryViewer renders with story data', () => {
      const mockStory = {
        id: 1,
        propertyId: 'BC001',
  ...
  allPassed =
    simulateTest('AgentSystemPanel renders with system status', () => {
      const mockStatus = {
        status: 'initialized',
        agents: [
