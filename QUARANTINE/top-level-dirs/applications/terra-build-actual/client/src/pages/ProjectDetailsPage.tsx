...
value="items" className="rounded-none data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:shadow-none">
            Project Items
          </TabsTrigger>
...
className="text-xs text-muted-foreground capitalize">{member.role}</div>
                                </div>
                              </div>
                            </div>
                          ))}
...
</>>Track the completion status of this project</CardDescription>
                  </div>
<>
...
</>>Track all changes and actions in this project</CardDescription>
                </CardHeader>
                <CardContent>
