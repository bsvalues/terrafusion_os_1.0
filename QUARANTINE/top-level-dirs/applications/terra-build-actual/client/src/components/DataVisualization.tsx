...
value="regionalComparison" className="data-[state=active]:bg-[#243E4D] data-[state=active]:text-white">Regional Comparison</TabsTrigger>
<>
...
value="costBreakdown" className="data-[state=active]:bg-[#243E4D] data-[state=active]:text-white">Cost Breakdown</TabsTrigger>
        </TabsList>
...
value="COM1">Commercial (COM1)</SelectItem>
<>

                      <SelectItem value="IND1">Industrial (IND1)</SelectItem>
                      <SelectItem
</>
value="AGR1">Agricultural (AGR1)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
...
value="Eastern">Eastern</SelectItem>
<>
...
className="text-right py-2 text-[#243E4D]">Amount</th>
...
className="text-right py-2">${costBreakdownQuery.data.values[index].toLocaleString()}</td>
