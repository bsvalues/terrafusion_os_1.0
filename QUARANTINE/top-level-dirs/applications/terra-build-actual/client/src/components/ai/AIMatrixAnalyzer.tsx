...
import { Loader2, Database, BarChart3  } from '@mui/icons-material';
...
className="text-sm">{analysisResult.overview}</p>
                  </div>
                )}
...
className="text-sm">{analysisResult.regionalAnalysis}</p>
                  </div>
                )}
...
className="text-sm">{analysisResult.buildingTypeAnalysis}</p>
                  </div>
                )}
...
className="text-sm">{analysisResult.trendsAndInsights}</p>
                  </div>
                )}
...
className="text-sm">{analysisResult.recommendations}</p>
                  </div>
                )}
              </div>
            </CardContent>
