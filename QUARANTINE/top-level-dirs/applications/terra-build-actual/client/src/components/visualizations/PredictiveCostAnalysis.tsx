...
value="factors">Contributing Factors</TabsTrigger>
...
className="font-medium">{form.getValues().buildingType}</div>
<>

                                <div className="text-muted-foreground">Region:</div>
                                <div
</>
className="font-medium">{form.getValues().region}</div>
<>

                                <div className="text-muted-foreground">Square Feet:</div>
                                <div
</>
className="font-medium">{form.getValues().squareFeet.toLocaleString()}</div>
<>

                                <div className="text-muted-foreground">Year Built:</div>
                                <div
</>
className="font-medium">{form.getValues().year || 'Not specified'}</div>
<>

                                <div className="text-muted-foreground">Quality:</div>
                                <div
</>
className="font-medium">{form.getValues().quality || 'Not specified'}</div>
<>

                                <div className="text-muted-foreground">Complexity:</div>
                                <div
</>
className="font-medium">{form.getValues().complexity || 'Not specified'}</div>
<>

                                <div className="text-muted-foreground">Condition:</div>
                                <div
</>
className="font-medium">{form.getValues().condition || 'Not specified'}</div>
                              </div>
                            </div>
                          </div>
                        </TabsContent>
...
className="text-sm font-medium">{(prediction.confidenceScore * 100).toFixed(0)}%</span>
                                    </div>
<>
...
</>>{formatCurrency(prediction.confidenceInterval.lower)}</span>
                                    </div>
...
</>>{formatCurrency(prediction.confidenceInterval.upper)}</span>
                                    </div>
                                    <div className="flex justify-between">
<>
...
</>>{formatCurrency(prediction.confidenceInterval.upper - prediction.confidenceInterval.lower)}</span>
                                    </div>
                                  </div>
...
</>>Use the comparison feature to see how different factors affect costs</li>
<>

                            <li>Save predictions to compare different building scenarios</li>
                            <li
</>
</>>The more details you provide, the more accurate the prediction</li>
                          </ul>
                        </div>
                      </div>
                    </div>
