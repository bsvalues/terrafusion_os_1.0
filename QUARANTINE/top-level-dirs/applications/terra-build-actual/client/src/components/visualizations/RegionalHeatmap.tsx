...
className="text-sm font-bold">${county.value.toFixed(2)}</div>
                  </div>
...
className="mt-1">Average Cost: <span className="font-medium">${county.value.toFixed(2)}/sqft</span></div>
...
</>>${(heatmapData.minValue + (heatmapData.maxValue - heatmapData.minValue) / 2).toFixed(2)}</div>
