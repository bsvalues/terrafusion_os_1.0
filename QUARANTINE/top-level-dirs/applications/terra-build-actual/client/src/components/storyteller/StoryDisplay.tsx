...
import { Clock, Database, Info, Lightbulb, Layers, BarChart3  } from '@mui/icons-material';
...
variant="outline" className={confidenceLevel.color}>
...
className="text-gray-500">Chart visualization would appear here</p>
                      </div>
                    </div>
