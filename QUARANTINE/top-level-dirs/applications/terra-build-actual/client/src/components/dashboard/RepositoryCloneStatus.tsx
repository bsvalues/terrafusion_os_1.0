...
className="h-10 bg-neutral-200 rounded"></div>
<>
...
className="h-6 bg-neutral-200 rounded"></div>
<>
...
variant="success">Complete</Badge>
      </div>
...
className="flex items-center p-3 bg-neutral-100 rounded-md">
<>

              <i className="ri-github-fill text-neutral-600 mr-2 text-xl"></i>
              <span
</>
className="text-sm font-mono text-neutral-600">{repository?.sourceRepo || "bsvalues/BSBuildingCost"}</span>
              <a 
...
className="text-sm font-mono text-neutral-600">{repository?.targetRepo || "yourteam/BSBuildingCost"}</span>
