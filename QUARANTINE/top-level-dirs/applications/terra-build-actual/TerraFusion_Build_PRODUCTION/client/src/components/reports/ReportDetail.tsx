...
className="mt-2 text-2xl">{report.title}</CardTitle>
...
className="font-medium">{report.content.property.address}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.property.parcel_id}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.property.county}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.property.building_type}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.property.year_built}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.property.square_feet.toLocaleString()} sq ft</dd>
                    </div>
                  )}
                </dl>
              </CardContent>
...
className="font-medium">{formatDate(report.content.assessment.date)}</dd>
                    </div>
                  )}
...
className="font-medium">{formatCurrency(report.content.assessment.land_value)}</dd>
                    </div>
                  )}
...
className="font-medium">{formatCurrency(report.content.assessment.improvement_value)}</dd>
                    </div>
                  )}
...
className="font-semibold text-lg">{formatCurrency(report.content.assessment.total_value)}</dd>
                    </div>
                  )}
...
className="font-medium">{formatCurrency(report.content.assessment.previous_value)}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.assessor.name}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.assessor.department}</dd>
                    </div>
                  )}
...
className="font-medium">{report.content.assessor.contact}</dd>
                    </div>
                  )}
                </dl>
              </CardContent>
...
</>>Distribution of property costs by category</CardDescription>
              </CardHeader>
              <CardContent>
...
</>>Property value trend over time</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
...
</>>Value comparison with similar properties</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
