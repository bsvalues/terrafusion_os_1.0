...
</>>Unable to load benchmarking data.</CardDescription>
        </CardHeader>
        <CardContent>
...
value="totalCost">Total Cost</TabsTrigger>
...
className="text-right">{formatCurrency(data.statistics.regional.min)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.regional.max)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.regional.average)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.regional.median)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{data.statistics.regionalSampleSize} buildings</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
className="text-right">{formatCurrency(data.statistics.statewide.min)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.statewide.max)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.statewide.average)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.statistics.statewide.median)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{data.statistics.statewideSampleSize} buildings</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
className="text-right">{data.buildingTypeDescription || data.buildingType}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{data.regionDescription || data.region}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{data.squareFootage.toLocaleString()} sq.ft</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.costPerSqft)}</td>
                    </tr>
                    <tr>
<>
...
className="text-right">{formatCurrency(data.totalCost)}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
