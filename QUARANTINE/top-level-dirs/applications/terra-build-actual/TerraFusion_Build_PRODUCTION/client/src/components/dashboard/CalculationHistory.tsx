...
value="factors">Factors</TabsTrigger>
...
className="text-sm">{selectedCalculation.region}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.buildingType}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.squareFootage.toLocaleString()} sq.ft</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.yearBuilt || "N/A"}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{formatCurrency(parseFloat(selectedCalculation.baseCost))}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm font-semibold">{formatCurrency(parseFloat(selectedCalculation.totalCost))}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{formatCurrency(parseFloat(selectedCalculation.costPerSqft))}/sq.ft</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{format(new Date(selectedCalculation.createdAt), "PPP")}</p>
                  </div>
                </div>
              </TabsContent>
...
className="text-sm">{selectedCalculation.complexityFactor}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.conditionFactor || "N/A"}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.regionFactor}</p>
                  </div>
                  <div className="space-y-1">
<>
...
className="text-sm">{selectedCalculation.condition || "N/A"}</p>
                  </div>
...
className="text-sm">{formatCurrency(parseFloat(selectedCalculation.depreciationAmount))}</p>
                    </div>
                  )}
...
className="text-sm">{formatCurrency(parseFloat(selectedCalculation.assessedValue))}</p>
                    </div>
                  )}
                </div>
              </TabsContent>
...
className="text-sm font-medium">{formatCurrency(parseFloat(value as string))}</p>
                      </div>
                    ))}
                  </div>
                ) : (
...
variant="destructive" onClick={handleDelete} disabled={remove.isPending}>
              {remove.isPending ? (
