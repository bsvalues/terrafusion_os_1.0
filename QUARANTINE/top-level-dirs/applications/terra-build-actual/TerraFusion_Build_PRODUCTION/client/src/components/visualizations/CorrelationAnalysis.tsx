...
import { AlertCircle, Info  } from '@mui/icons-material';
import { 
  ScatterChart, 
  Scatter, 
  XAxis, 
...
className="mt-1">Points represent individual buildings, and the line shows the trend.</p>
