...
import ... from "@/WorkflowProvider";
import ... from "@/WorkflowVisualizer";
      ...
      case 'in-progress':
        return (
          <Badge className="bg-blue-500 text-white">
            <Refresh className="h-3 w-3 mr-1 animate-spin" /> In Progress
          </Badge>
        );
      case 'paused':
        return (
...
className="text-base mb-2">Create New Workflow</CardTitle>
          <CardDescription className="text-xs">
