...
className="max-w-md truncate">{item.message}</TableCell>
...
className="text-sm">{selectedConnection.message}</p>
              </div>
...
className="bg-muted p-4 rounded-md text-xs overflow-auto max-h-48">
