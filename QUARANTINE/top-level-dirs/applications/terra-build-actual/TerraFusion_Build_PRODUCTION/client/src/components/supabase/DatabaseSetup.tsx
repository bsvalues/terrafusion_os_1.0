...
</>>{isLoading ? 'Loading...' : connectionStatus}</div><>

            <div className="font-medium">Configured:</div>
            <div
</>

</>>{isConfigured ? 'Yes' : 'No'}</div><>

            <div className="font-medium">Environment:</div>
            <div
</>

</>>{import.meta.env.DEV ? 'Development' : 'Production'}</div>
          </div>
