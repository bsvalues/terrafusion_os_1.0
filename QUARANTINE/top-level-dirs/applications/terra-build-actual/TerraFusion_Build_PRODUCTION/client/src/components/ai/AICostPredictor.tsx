...
</>>${predictionResult.baseCost?.toFixed(2)}</div>
<>
...
</>>{predictionResult.regionFactor}</div>
<>
...
</>>{predictionResult.complexityFactor}</div>
<>
...
className="text-sm">{predictionResult.explanation}</p>
                      </div>
                    )}
                  </div>
                </CardContent>
