...
import { AlertCircle, TrendingUp, LineChart as LineChartIcon, Activity  } from '@mui/icons-material';
...
className="text-sm font-bold">{(dataQuality.completenessScore * 100).toFixed(1)}%</div>
                      </div>
<>
...
variant="outline">{missing.field}</Badge>
                            </div>
                          ))}
