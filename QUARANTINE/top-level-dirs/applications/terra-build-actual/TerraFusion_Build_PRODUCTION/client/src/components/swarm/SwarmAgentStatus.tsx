...
import { BarChart, FileText, Activity, Clock  } from '@mui/icons-material';
...
className="text-right">Processing Tasks</TableHead>
...
className="text-right">{agent.processingTasks}</TableCell>
