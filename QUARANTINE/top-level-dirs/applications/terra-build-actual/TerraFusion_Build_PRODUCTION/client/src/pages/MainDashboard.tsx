...
import { ExternalLink  } from '@mui/icons-material';
import ... from "@/components/QuickExportButton";
...
</>>This tab will appear in a separate window.</p>
      </div>`
    });
  };
...
className="text-neutral-600 mb-6">Compare multiple cost calculation scenarios side-by-side for better decision making.</p>
...
className="text-neutral-600 mb-6">Customize how different cost factors influence building assessments for Benton County.</p>
...
className="text-neutral-600 mb-6">Manage cost matrix entries for Benton County, Washington building assessment.</p>
                <CostMatrixManager />
              </div>
            )}
...
className="text-neutral-600 mb-6">Compare cost matrices across different years to analyze trends and variations.</p>
                <CostMatrixCompare />
              </div>
            )}
...
className="text-neutral-600 mb-6">Monitoring tools and utilities for the BCBS Building Cost application.</p>
              </div>
            )}
          </div>
        </div>
...
className="text-sm text-gray-600 mb-4">Regional cost variations across Benton County.</p>
...
className="text-sm text-gray-600 mb-4">Impact of material costs on overall assessments.</p>
                <div className="bg-gray-100 h-40 rounded-md flex items-center justify-center mb-4">
...
className="text-sm text-gray-600 mb-4">Building costs across different regions.</p>
                <div className="bg-gray-100 h-40 rounded-md flex items-center justify-center mb-4">
...
className="text-sm text-gray-600 mb-4">How seasons affect building costs in Benton County.</p>
                <div className="bg-gray-100 h-40 rounded-md flex items-center justify-center mb-4">
