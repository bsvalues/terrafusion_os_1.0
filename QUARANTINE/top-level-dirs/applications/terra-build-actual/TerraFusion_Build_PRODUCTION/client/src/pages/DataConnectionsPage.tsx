...
import { Shield, Server, Database, FolderSync, FileType  } from '@mui/icons-material';
...
value="config" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
<>
...
href="/data-connections/ftp" className="inline-block w-full">
