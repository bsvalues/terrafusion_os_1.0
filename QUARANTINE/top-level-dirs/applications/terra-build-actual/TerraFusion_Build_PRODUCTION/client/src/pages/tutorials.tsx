...
import { Calculator, ChartBar, FileSpreadsheet, Map, Building2, Database  } from '@mui/icons-material';
...
className="text-muted-foreground mb-4">{description}</p>
...
className="text-[#47AD55] font-medium cursor-pointer hover:underline text-sm">
              Start Tutorial
            </span>
          </div>
        </CardContent>
