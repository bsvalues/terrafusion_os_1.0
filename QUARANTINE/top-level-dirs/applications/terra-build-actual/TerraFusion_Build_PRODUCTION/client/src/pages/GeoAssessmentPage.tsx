...
className="mt-1">{selectedProperty.propId}</p>
                  </div>
...
className="mt-1">{selectedProperty.owner || "Unknown"}</p>
                  </div>
...
className="mt-1">{selectedProperty.propertyType || "Unknown"}</p>
                  </div>
...
className="mt-1">{selectedProperty.yearBuilt}</p>
                    </div>
                  )}
...
className="mt-1">{selectedProperty.squareFeet.toLocaleString()}</p>
                    </div>
                  )}
                </div>
