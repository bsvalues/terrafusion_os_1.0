                ...
                <div className="text-center py-8 border-2 border-dashed rounded-lg">
                  ...
                  <div className="flex justify-center gap-4">
                    ...
                    <div className="inline-flex items-center">
                      ...
                      <ContextualTooltip content="Download a standardized template that's pre-formatted for easy data entry and processing."
                        className="ml-2"
                        asSpan={true}
                      />
                    </div>
              ...
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                  <div className="inline-flex items-center">
                    ...
                    <ContextualTooltip content="Download as a formatted Excel file with data validation and formatting applied."
                      className="ml-2"
                      asSpan={true}
                    />
                  </div>
                  <div className="inline-flex items-center">
                    ...
                    <ContextualTooltip content="Download as a simple CSV file for maximum compatibility with other systems."
                      className="ml-2"
                      asSpan={true}
                    />
                  </div>
                  <div className="inline-flex items-center">
                    ...
                    <ContextualTooltip content="Generate a comprehensive PDF report with data visualizations and summaries."
                      className="ml-2"
                      asSpan={true}
                    />
                  </div>
                  <div className="inline-flex items-center">
                    ...
                    <ContextualTooltip content="Export as JSON for integration with web services and APIs."
                      className="ml-2"
                      asSpan={true}
                    />
                  </div>
