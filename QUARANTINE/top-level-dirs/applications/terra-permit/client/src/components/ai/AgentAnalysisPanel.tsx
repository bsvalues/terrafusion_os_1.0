...
>{rec}</span>
          ...
          <div className="pt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button onClick={() => handleAnalyzeImpact(false)}
                variant="outline"
                className="flex-1"
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button variant={activeChart === 'bar' ? 'default' : 'outline'} 
                  size="sm" 
                ...
                <Button variant={activeChart === 'line' ? 'default' : 'outline'} 
                  size="sm" 
    ...
    <div className="space-y-4">
      {!answer ? (
          <div>
            ...
            <Textarea id="tour-question-input" 
              value={question} 
