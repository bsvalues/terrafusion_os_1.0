...
SELECT DISTINCT 
                         ...
                         ta.tax_area_number AS tax_code_area, pv.appraised_val, pv.ag_use_val, hood.hood_name AS neighborhood_name, pv.hood_cd AS neighborhood_code, pv.legal_acreage AS legal_acres, pp.land_sqft, pp.yr_blt AS year_blt, 
                         pp.property_use_cd AS primary_use, pv.cycle
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[40] 4[22] 2[12] 3) )"
      End
