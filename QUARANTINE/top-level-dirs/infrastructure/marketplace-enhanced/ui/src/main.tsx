        ...
        <main className="tf-main">
          <div className="tf-content">
            <Routes>
              ...
              <Route path="/plugins" element={<GovernmentPluginManager />} />
              <Route path="/analytics" element={<AdvancedAnalytics />} />
              <Route path="/legacy" element={
                <div className="tf-legacy-layout">
                  <PluginSidebar />
                  <div className="tf-legacy-content">
                    <DashboardPage />
                  </div>
                </div>
              } />
              <Route path="/agent-telemetry" element={<AgentTelemetryAssistant />} />
            </Routes>
          </div>
        </main>
        <AIAssistant />
