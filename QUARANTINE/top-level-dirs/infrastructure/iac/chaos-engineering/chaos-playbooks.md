...
## Overview
This document outlines chaos engineering practices and procedures for Terrafusion infrastructure resilience testing.
...
**Trigger**: Single service failure affecting < 25% of users
...
**Trigger**: Multiple service failures affecting > 50% of users
**RTO**: 15 minutes
**RPO**: 5 minutes
...
**Trigger**: Total platform unavailability
**RTO**: 4 hours
**RPO**: 15 minutes
