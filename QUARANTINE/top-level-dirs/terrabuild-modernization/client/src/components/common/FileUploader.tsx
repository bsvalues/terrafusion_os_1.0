...
import { AlertCircleIcon, CheckCircleIcon, FileIcon, UploadCloudIcon, XIcon } from 'lucide-react';
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await create.mutateAsync({
        fileName: file.name,
        filename: file.name, // Required by extended schema
        filePath: `/uploads/${file.name}`, // Construct file path
        fileType: file.type,
        fileSize: file.size, // Keep as number for schema consistency
        status: 'uploaded',
