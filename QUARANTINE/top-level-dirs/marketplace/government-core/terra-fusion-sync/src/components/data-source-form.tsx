...
export function DataSourceForm() {
        ...
        return (
          <>
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="tf-government-badge">
                  <FormLabel className="tf-transcendence-glow">Database Type</FormLabel>
                  <Select
                    onValueChange={field.onChange} 
                    defaultValue={field.value}
                  >
                    <FormControl>
                      <SelectTrigger data-testid="dialect-select" className="tf-clarity-gradient">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="tf-government-badge">
                  <FormLabel className="tf-transcendence-glow">Server Name/IP</FormLabel>
                  <FormControl>
                    <div className="flex items-center space-x-2">
                      <Server className="w-4 h-4 text-muted-foreground" />
                      <Input placeholder="localhost or server name" {...field} data-testid="host-input" className="tf-clarity-gradient" />
                    </div>
                  </FormControl>
                  <FormDescription className="tf-government-badge">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="tf-government-badge">
                  <FormLabel className="tf-transcendence-glow">Port</FormLabel>
                  <FormControl>
                    <Input 
                      type="number" 
                      placeholder="1433"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="tf-government-badge">
                  <FormLabel className="tf-transcendence-glow">Database Name</FormLabel>
                  <FormControl>
                    <div className="flex items-center space-x-2">
                      <Database className="w-4 h-4 text-muted-foreground" />
                      <Input placeholder="master" {...field} data-testid="database-input" className="tf-clarity-gradient" />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between space-y-0 rounded-lg border p-4 tf-government-badge">
                  <div className="space-y-0.5">
                    <FormLabel className="tf-transcendence-glow">Windows Authentication</FormLabel>
                    <FormDescription className="tf-clarity-gradient">
            ...
            {!form.watch("config.config.trustedConnection") && (
              <>
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="tf-government-badge">
                      <FormLabel className="tf-transcendence-glow">Username</FormLabel>
                      <FormControl>
                        <div className="flex items-center space-x-2">
                          <User className="w-4 h-4 text-muted-foreground" />
                          <Input placeholder="sa" {...field} data-testid="username-input" className="tf-clarity-gradient" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="tf-government-badge">
                      <FormLabel className="tf-transcendence-glow">Password</FormLabel>
                      <FormControl>
                        <div className="flex items-center space-x-2">
                          <Lock className="w-4 h-4 text-muted-foreground" />
                          <Input type="password" {...field} data-testid="password-input" className="tf-clarity-gradient" />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between space-y-0 rounded-lg border p-4 tf-government-badge">
                  <div className="space-y-0.5">
                    <FormLabel className="tf-transcendence-glow">Encrypt Connection</FormLabel>
                    <FormDescription className="tf-clarity-gradient">
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit as any)} className="space-y-6" data-testid="data-source-form">
        <FormField
          control={form.control}
          name="name"
          render={({ field }) => (
            <FormItem className="tf-government-badge">
              <FormLabel className="tf-transcendence-glow">Name</FormLabel>
              <FormControl>
                <Input placeholder="My Data Source" {...field} data-testid="name-input" className="tf-clarity-gradient" />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="tf-government-badge">
              <FormLabel className="tf-transcendence-glow">Type</FormLabel>
              <Select
              ...
              >
                <FormControl>
                  <SelectTrigger data-testid="type-select" className="tf-clarity-gradient">
