...
const getLinkTypeBadge = (linkType: string | null) => {
  if (!linkType) return <Badge variant="outline">Unspecified</Badge>;
  ...
  return (
    <Badge variant={badgeVariants[linkType] || "outline"}>
      {linkType.replace('_', ' ').toUpperCase()}
    </Badge>
  );
};

export default function DocumentParcelManagement() {
  ...
  const handleCreateLink = () => {
    if (selectedTab === "documents" && selectedDocumentId && selectedParcelId) {
    ...
    } else if (selectedTab === "parcels" && selectedParcelId && selectedDocumentId) {
      createLinkMutation.mutate({
        documentId: selectedDocumentId,
        parcelId: selectedParcelId,
        linkType: linkType,
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage relationships between documents and parcels
          </p>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <Select value={searchType} onValueChange={(value: "document" | "parcel") => setSearchType(value)}>
                    ...
                    <Dialog open={isLinkDialogOpen} onOpenChange={setIsLinkDialogOpen}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Create a relationship between this document and a parcel
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Select value={selectedParcelId?.toString() || ""} onValueChange={(value) => setSelectedParcelId(Number(value))}>
                              <SelectTrigger>
                              ...
                              <SelectContent>
                                {parcels?.map((parcel) => (
                                  <SelectItem key={parcel.id} value={parcel.id.toString()}>
                                    {parcel.parcelNumber} - {parcel.address || "No address"}
                                  </SelectItem>
                                ))}
                              </SelectContent>
                            </Select>
              ...
              <CardContent>
                {selectedDocument ? (
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="space-y-2">
                          ...
                          {selectedDocument.workflowId && (
                            <p className="text-sm text-muted-foreground">
                              Workflow ID: {selectedDocument.workflowId}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="border rounded-md p-2 bg-muted/50 h-20 overflow-y-auto">
                          <p className="text-sm">
                    ...
                    ) : selectedDocument.parcels?.length > 0 ? (
                  ...
                  <div className="flex items-center justify-center h-48 text-muted-foreground">
                    Select a document to view its details and linked parcels
                  </div>
                )}
              </CardContent>
            </Card>
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <div className="ml-2">
                              ...
                              <p className="text-xs text-muted-foreground">{parcel.address || "No address"}</p>
                            </div>
                          </div>
                        </Button>
                      ))}
            ...
            <Card className="col-span-2">
                    ...
                    <Dialog open={isLinkDialogOpen} onOpenChange={setIsLinkDialogOpen}>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Create a relationship between this parcel and a document
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Select value={selectedDocumentId?.toString() || ""} onValueChange={(value) => setSelectedDocumentId(Number(value))}>
                              <SelectTrigger>
              ...
              <CardContent>
                {selectedParcel ? (
                        ...
                        <div className="space-y-2">
                          <dl className="space-y-1">
                            <div className="flex">
                              ...
                              <dd className="ml-2">{selectedParcel.parcelNumber}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Address:</dt>
                              <dd className="ml-2">{selectedParcel.address || "N/A"}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Owner:</dt>
                              <dd className="ml-2">{selectedParcel.owner || "N/A"}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Acreage:</dt>
                              <dd className="ml-2">{selectedParcel.acreage || selectedParcel.acres || "N/A"}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Property Type:</dt>
                              <dd className="ml-2">{selectedParcel.propertyType || "N/A"}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Zoning:</dt>
                              <dd className="ml-2">{selectedParcel.zoning || "N/A"}</dd>
                            </div>
                            <div className="flex">
                              <dt className="font-semibold">Assessed Value:</dt>
                              <dd className="ml-2">{selectedParcel.assessedValue || "N/A"}</dd>
                            </div>
                          </dl>
                        </div>
                      </div>
                  ...
                  <div className="flex items-center justify-center h-48 text-muted-foreground">
                    Select a parcel to view its details and linked documents
                  </div>
                )}
              </CardContent>
            </Card>
