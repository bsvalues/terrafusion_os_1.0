    ...
    def __init__(self):
        self.services = {
            "Legacy Flask Services": {
                "TerraFusion Build": {"port": 5000, "tech": "Node.js", "health": "/api/health"},
                "TerraFlow": {"port": 5001, "tech": "Flask", "health": "/health"},
                "TerraFusionSync": {"port": 5002, "tech": "Flask", "health": "/health"},
                "TerraAgent": {"port": 5003, "tech": "Flask", "health": "/health"},
                "TerraFusionAssessor": {"port": 5004, "tech": "Next.js", "health": "/api/health"},
                "TerraFusionDashboard": {"port": 5005, "tech": "React", "health": "/api/health"},
                "TerraMiner": {"port": 5006, "tech": "Flask", "health": "/health"},
                "TerraFusionLevy": {"port": 5007, "tech": "Flask", "health": "/health"}
            },
            "Modern Rust Services": {
                "TerraFusionSync (Rust)": {"port": 6002, "tech": "Rust/Axum", "health": "/health"},
                "TerraAgent (Rust)": {"port": 6003, "tech": "Rust/Axum", "health": "/health"},
                "TerraMiner (Rust)": {"port": 6006, "tech": "Rust/Axum", "health": "/health"}
            },
            "Frontend Services": {
                "TerraFusion UI": {"port": 3000, "tech": "Next.js 15", "health": "/api/health"}
            },
            "Infrastructure": {
                "Redis Cache": {"port": 6379, "tech": "Redis", "health": None},
                "PostgreSQL": {"port": 5432, "tech": "PostgreSQL", "health": None}
            }
        }
