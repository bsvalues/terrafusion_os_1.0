...
const SpacingScale = ({
  ...
  marginBottom: '48px'
    ...
    {Object.entries(scale).map(([key, value]) => <SpacingBox key={key} name={key} value={value} />)}
  </div>;
export const BaseSpacing: Story = {
  render: () => <div>
      ...
      lineHeight: '1.6'
        ...
        TerraFusion uses an 8px base unit grid system. All spacing values are multiples of 8px
        to ensure visual consistency and rhythm throughout the interface.
      </p>
      <div style={{
      display: 'grid',
...
export const SemanticSpacing: Story = {
  render: () => <div>
      ...
      lineHeight: '1.6'
        ...
        Use semantic spacing tokens for consistency. These provide meaningful names for common spacing patterns.
      </p>
  ...
  render: () => <div>
      ...
      marginBottom: '48px'
        ...
        gap: tokens.stack.md
          ...
          {['Item 1', 'Item 2', 'Item 3'].map(item => <div key={item} style={{
      ...
      <div>
        ...
        maxWidth: '600px'
          ...
          {['Box 1', 'Box 2', 'Box 3', 'Box 4', 'Box 5', 'Box 6'].map(box => <div key={box} style={{
          backgroundColor: tokens.colors.brand.primary[500],
          padding: tokens.spacing[4],
          borderRadius: tokens.radius.md
