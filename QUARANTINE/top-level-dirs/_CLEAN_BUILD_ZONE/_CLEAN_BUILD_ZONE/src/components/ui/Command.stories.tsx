...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Fast, composable command menu for creating searchable command palettes and navigation interfaces.',
      },
    },
  },
  tags: ['autodocs'],
    ...
    return (
      <>
        <Button onClick={() => setOpen(true)}>
          Open Command Palette <kbd className="ml-2 pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">⌘K</kbd>
        </Button>
      ...
      <div className="space-y-4">
        ...
        {selected && (
          <div className="p-4 border rounded-lg bg-muted">
            <p className="text-sm">Selected command: <strong>{selected}</strong></p>
          </div>
        )}
      </div>
    );
      ...
      <div className="rounded-lg border p-6 space-y-4">
        ...
        <Command className="rounded-lg border shadow-md w-[450px]">
          ...
          <CommandList>
            ...
            <CommandGroup heading="Items">
              <CommandItem>
                <span>This is an extremely long command item label that tests text wrapping and overflow handling in the command component</span>
              </CommandItem>
              <CommandItem>
                <span>Another very long item with lots of text to demonstrate truncation behavior</span>
              </CommandItem>
            </CommandGroup>
          </CommandList>
        </Command>
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <CommandDialog open={searchOpen} onOpenChange={setSearchOpen}>
            ...
            <CommandList>
              <CommandEmpty>No results found.</CommandEmpty>
              <CommandGroup heading="Files">
                <CommandItem><FileIcon className="mr-2 h-4 w-4" />README.md</CommandItem>
                <CommandItem><FileIcon className="mr-2 h-4 w-4" />package.json</CommandItem>
              </CommandGroup>
              <CommandSeparator />
              <CommandGroup heading="Actions">
                <CommandItem><RocketIcon className="mr-2 h-4 w-4" />Deploy</CommandItem>
                <CommandItem><CalendarIcon className="mr-2 h-4 w-4" />Schedule</CommandItem>
              </CommandGroup>
            </CommandList>
          </CommandDialog>
        </div>
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <Button onClick={() => setCommandOpen(true)} variant="outline">
            Quick Actions
            <kbd className="ml-2 pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium">⌘⇧P</kbd>
          </Button>
