...
import { Trash2, AlertTriangle, Save, FileX, LogOut } from 'lucide-react';
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="confirm-text">
                Type <code className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-sm">DELETE</code> to confirm
              </Label>
              <Input
                id="confirm-text"
                value={confirmText}
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will process all pending records and may take several minutes.
      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="space-y-3 pt-3">
            ...
            <p className="text-sm">
              Your work will be automatically saved, but any unsaved changes
              in the last 5 minutes may be lost.
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-amber-800">
                      3 team members have access. They will lose access when you
                      delete this file.
                    </p>
                  </div>
                </div>
    ...
    <div className="max-w-4xl space-y-8 p-8">
      <div>
        ...
        <p className="text-slate-600">
          Use alert dialogs to interrupt the user with important information that
          requires a decision or acknowledgment.
        </p>
      </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Use for critical decisions</strong> that cannot be easily undone
                (deletions, destructive actions, irreversible changes)
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-green-600">✓</span>
              <span>
                <strong>Provide clear action buttons</strong> with descriptive labels
                ("Delete Account" not just "OK")
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-green-600">✓</span>
              <span>
                <strong>Explain consequences</strong> clearly in the description
            ...
            <li className="flex gap-3">
              <span className="text-green-600">✓</span>
              <span>
                <strong>Use destructive styling</strong> (red) for dangerous actions
                to visually reinforce the warning
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-green-600">✓</span>
              <span>
                <strong>Require confirmation</strong> for high-risk actions (type
                "DELETE", checkboxes, multi-step)
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-green-600">✓</span>
              <span>
                <strong>Support keyboard navigation</strong> (Escape to cancel, Tab
                between buttons)
              </span>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex gap-3">
              ...
              <span>
                <strong>Don't overuse</strong> alert dialogs for minor decisions or
                informational messages (use Toast or Dialog instead)
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-red-600">✗</span>
              <span>
                <strong>Don't use generic labels</strong> like "OK" or "Submit" -
            ...
            <li className="flex gap-3">
              <span className="text-red-600">✗</span>
              <span>
                <strong>Don't nest alert dialogs</strong> - if you need multi-step
                confirmation, use a wizard or stepper instead
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-red-600">✗</span>
              <span>
                <strong>Don't include forms</strong> with many fields - keep it
                simple or use a regular Dialog
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-red-600">✗</span>
              <span>
                <strong>Don't trap users</strong> without a clear way to cancel or
                close the dialog
              </span>
            </li>
          </ul>
            ...
            <tbody className="divide-y divide-slate-200">
              <tr>
                ...
                <td className="px-4 py-3 text-sm">
                  Close the alert dialog (same as Cancel)
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-sm">
                  Move focus between Cancel and Action buttons
                </td>
              </tr>
              <tr>
                <td className="px-4 py-3">
    ...
    <AlertDialogFooter>
      ...
      <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-6">
        ...
        <p className="text-sm text-blue-800">
          The AlertDialog automatically manages focus: when opened, focus moves to
          the first focusable element (usually Cancel button). When closed, focus
          returns to the trigger element. This ensures keyboard users can navigate
          efficiently and screen readers announce the dialog properly.
        </p>
      </div>
      ...
      <div className="rounded-lg border-2 border-purple-200 bg-purple-50 p-6">
        ...
        <p className="text-sm text-purple-800">
          AlertDialog uses <code>role="alertdialog"</code> to announce critical
          content to screen readers. The title is referenced via{' '}
          <code>aria-labelledby</code> and description via{' '}
          <code>aria-describedby</code>. The dialog is modal, preventing interaction
          with background content until dismissed.
        </p>
      </div>
    </div>
  ),
