        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <CardContent>
                <p className="text-3xl font-bold">$49<span className="text-sm">/mo</span></p>
              </CardContent>
              <CardFooter>
            ...
            >
              ...
              <CardContent>
                <p className="text-3xl font-bold">$99<span className="text-sm">/mo</span></p>
              </CardContent>
              <CardFooter>
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
          ...
          <ul className="space-y-1 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span><strong>1.3.1 Info and Relationships:</strong> Semantic HTML with proper heading hierarchy</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>1.4.3 Contrast (Minimum):</strong> 4.5:1 text contrast ratio</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>2.1.1 Keyboard:</strong> Interactive cards accessible via Tab and Enter</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>2.4.3 Focus Order:</strong> Logical tab order through card elements</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>2.4.7 Focus Visible:</strong> Clear focus ring on interactive cards</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>2.5.5 Target Size:</strong> Buttons within cards meet 44×44px minimum</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-green-600">✓</span>
              <span><strong>4.1.2 Name, Role, Value:</strong> Proper ARIA labels and roles</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="space-y-8 max-w-4xl">
      ...
      <div>
        ...
        <Card>
          <CardHeader>
            <CardTitle>
              This is an extremely long card title that might wrap to multiple lines and we need to ensure it still looks good and maintains proper spacing
            </CardTitle>
            <CardDescription>
              And here's an equally long description that goes on and on explaining various aspects of the card content in excessive detail to test text wrapping behavior and ensure the card layout remains stable
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p>
      ...
      <div>
        ...
        <Card>
          ...
          <CardFooter className="flex-wrap gap-2">
            ...
            <Button size="sm" variant="outline">Action 4</Button>
      ...
      <div className="p-4 bg-amber-50 dark:bg-amber-950 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          <li>• <strong>Empty content:</strong> Cards still maintain proper structure</li>
          <li>• <strong>Long text:</strong> Text wraps naturally, maintains readability</li>
          <li>• <strong>Minimal content:</strong> Card maintains minimum height</li>
          <li>• <strong>Full-bleed images:</strong> Use p-0 and overflow-hidden</li>
          <li>• <strong>Many actions:</strong> Use flex-wrap in footer</li>
          <li>• <strong>Nested cards:</strong> Use subtle borders to distinguish levels</li>
        </ul>
      </div>
    </div>
  )
  ...
  render: () => (
    <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="p-6 flex-1">
              ...
              <p className="text-muted-foreground mb-4">
                Image on top for mobile, on left for desktop. Flex direction changes at md breakpoint.
              </p>
      ...
      <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          <li>• <strong>Grid layouts:</strong> Use grid-cols-1 md:grid-cols-2 lg:grid-cols-3</li>
          <li>• <strong>Image placement:</strong> Use flex-col md:flex-row to change layout</li>
          <li>• <strong>Content density:</strong> Show/hide details at different breakpoints</li>
          <li>• <strong>Touch targets:</strong> Ensure buttons are 44×44px minimum on mobile</li>
          <li>• <strong>Text size:</strong> Use responsive text classes (text-sm md:text-base)</li>
        </ul>
      </div>
    </div>
  )
  ...
  render: () => (
    <div className="space-y-8 max-w-6xl">
      <div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            { name: 'Pro', price: 29, features: ['5 Users', '100GB Storage', 'Priority Support', 'Advanced Features'] },
            { name: 'Enterprise', price: 99, features: ['Unlimited Users', '1TB Storage', '24/7 Phone Support', 'Custom Integration'] },
          ].map((plan) => (
      ...
      <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          <li>• <strong>Product cards:</strong> Price prominent, features list, clear CTA</li>
          <li>• <strong>Article cards:</strong> Image first, metadata, brief description</li>
          <li>• <strong>Dashboard widgets:</strong> Key metric large, trend indicator</li>
          <li>• <strong>List items:</strong> Horizontal layout, avatar/icon, quick action</li>
          <li>• <strong>Consistency:</strong> Use same card pattern across similar content</li>
        </ul>
      </div>
    </div>
  )
