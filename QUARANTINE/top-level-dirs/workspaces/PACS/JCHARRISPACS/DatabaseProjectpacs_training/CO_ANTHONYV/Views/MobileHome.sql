CREATE VIEW [CO\ANTHONYV].MobileHome
AS
SELECT DISTINCT 
                         TOP (100) PERCENT pv.prop_id AS MH_Prop_ID, p.geo_id AS MH_Geo_ID, p.prop_type_cd, pa.child_prop_id AS Linked_Real_Prop_ID, pa1.geo_id AS Linked_Real_Geo_ID, ac.file_as_name, pv.legal_desc AS MH_Legal
...
WHERE        (pv.prop_val_yr = 2021) AND (pv.prop_inactive_dt IS NULL) AND (p.geo_id LIKE '4%') AND (pa.child_prop_id IN
                             (SELECT        prop_id
                               FROM            dbo.property
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'CO\ANTHONYV', @level1type = N'VIEW', @level1name = N'MobileHome';
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "pa1"
            ...
            End
            DisplayFlags = 280
            TopColu', @level0type = N'SCHEMA', @level0name = N'CO\ANTHONYV', @level1type = N'VIEW', @level1name = N'MobileHome';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'mn = 0
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'CO\ANTHONYV', @level1type = N'VIEW', @level1name = N'MobileHome';
