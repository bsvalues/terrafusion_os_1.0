            ...
            CREATE PROCEDURE [internal].[cleanup_server_execution_keys]
                @cleanup_flag       int,         -- flag of which kind of execution keys to remove
            ...
            AS
                ...
                BEGIN TRY
                    ...
                    BEGIN
                        -- delete per operation certificates and symmetric keys
                    ...
                    BEGIN
                        -- delete per project certificates and symmetric keys
                        INSERT INTO [internal].[operations] (
                            [operation_type],  
                            [created_time], 
                            [object_type],
