...
local function ConvertFeature_ProductionStorageArea(feature)
    local s57Feature = S57Lib.CreateFeature("PRDARE")

    s57Feature.CATPRA = feature.categoryOfProductionArea.GetFirstValue()
...
return ConvertFeature_ProductionStorageArea