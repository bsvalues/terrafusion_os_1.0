...
local function ConvertFeature_Checkpoint(feature)
    local s57Feature = S57Lib.CreateFeature("CHKPNT")

    s57Feature.CATCHP = feature.categoryOfCheckpoint.GetFirstValue()
...
return ConvertFeature_Checkpoint