...
local function ConvertFeature_RescueStation(feature)
    local s57Feature = S57Lib.CreateFeature("RSCSTA")

    s57Feature.CATRSC = feature.categoryOfRescueStation.GetCommaSeparatedValues()
...
return ConvertFeature_RescueStation