...
local function ConvertFeature_SpecialPurposeGeneralBeacon(feature)
    local s57Feature = S57Lib.CreateFeature("BCNSPP")
...
return ConvertFeature_SpecialPurposeGeneralBeacon