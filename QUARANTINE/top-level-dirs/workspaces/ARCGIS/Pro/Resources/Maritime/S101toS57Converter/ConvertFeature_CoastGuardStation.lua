...
local function ConvertFeature_CoastGuardStation(feature)
    local s57Feature = S57Lib.CreateFeature("CGUSTA")
    ...
    feature.isMRCC.DidNotConvert = true
...
return ConvertFeature_CoastGuardStation