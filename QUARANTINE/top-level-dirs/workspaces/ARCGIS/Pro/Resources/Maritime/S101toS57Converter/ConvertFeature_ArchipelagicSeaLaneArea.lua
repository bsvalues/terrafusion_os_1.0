...
local function ConvertFeature_ArchipelagicSeaLaneArea(feature)
    local s57Feature = S57Lib.CreateFeature("ARCSLN")
...
return ConvertFeature_ArchipelagicSeaLaneArea