...
local function ConvertFeature_RadioCallingInPoint(feature)
    local s57Feature = S57Lib.CreateFeature("RDOCAL")
    ...
    s57Feature.ORIENT = feature.orientationValue.GetCommaSeparatedValues()
...
return ConvertFeature_RadioCallingInPoint