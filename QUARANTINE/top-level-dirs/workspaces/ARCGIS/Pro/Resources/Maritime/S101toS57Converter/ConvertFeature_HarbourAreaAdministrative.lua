...
local function ConvertFeature_HarbourAreaAdministrative(feature)
    local s57Feature = S57Lib.CreateFeature("HRBARE")
...
return ConvertFeature_HarbourAreaAdministrative