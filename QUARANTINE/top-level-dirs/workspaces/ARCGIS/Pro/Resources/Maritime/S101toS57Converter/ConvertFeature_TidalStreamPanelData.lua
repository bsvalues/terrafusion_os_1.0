...
local ConvertAttribute_tidalStreamPanelValues = S101To57AttributeConversionFunctions.tidalStreamPanelValues

local function ConvertFeature_TidalStreamPanelData(feature)
    local s57Feature = S57Lib.CreateFeature("TS_PAD")
    ...
    feature.stationName.DidNotConvert = true

    feature.stationNumber.DidNotConvert = true

    s57Feature.TS_TSP = ConvertAttribute_tidalStreamPanelValues(feature.stationName, feature.stationNumber, feature.tidalStreamPanelValues)
...
return ConvertFeature_TidalStreamPanelData