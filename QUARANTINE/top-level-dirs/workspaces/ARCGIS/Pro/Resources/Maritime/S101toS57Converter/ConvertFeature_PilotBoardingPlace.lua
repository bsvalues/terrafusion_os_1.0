...
local function ConvertFeature_PilotBoardingPlace(feature)
    local s57Feature = S57Lib.CreateFeature("PILBOP")

    s57Feature.CATPIL = feature.categoryOfPilotBoardingPlace.GetFirstValue()

    feature.categoryOfPreference.DidNotConvert = true

    feature.destination.DidNotConvert = true
    ...
    feature.pilotMovement.DidNotConvert = true
...
return ConvertFeature_PilotBoardingPlace