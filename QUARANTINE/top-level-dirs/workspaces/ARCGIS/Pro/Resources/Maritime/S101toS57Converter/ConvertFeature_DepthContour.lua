...
local function ConvertFeature_DepthContour(feature)
    local s57Feature = S57Lib.CreateFeature("DEPCNT")

    s57Feature.VALDCO = feature.valueOfDepthContour.GetFirstValue()
...
return ConvertFeature_DepthContour