...
local function ConvertFeature_SpecialPurposeGeneralBuoy(feature)
    local s57Feature = S57Lib.CreateFeature("BOYSPP")
...
return ConvertFeature_SpecialPurposeGeneralBuoy