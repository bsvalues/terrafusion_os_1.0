...
local function ConvertFeature_TrafficSeparationSchemeCrossing(feature)
    local s57Feature = S57Lib.CreateFeature("TSSCRS")
...
return ConvertFeature_TrafficSeparationSchemeCrossing