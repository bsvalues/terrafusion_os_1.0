...
local function ConvertFeature_Conveyor(feature)
    local s57Feature = S57Lib.CreateFeature("CONVYR")

    s57Feature.CATCON = feature.categoryOfConveyor.GetFirstValue()
...
return ConvertFeature_Conveyor