...
local ConvertAttribute_speed = S101To57AttributeConversionFunctions.speed

local function ConvertFeature_TidalStreamFloodEbb(feature)
    local s57Feature = S57Lib.CreateFeature("TS_FEB")

    s57Feature.CAT_TS = feature.categoryOfTidalStream.GetFirstValue()
    ...
    s57Feature.CURVEL = ConvertAttribute_speed(feature.speed)
...
return ConvertFeature_TidalStreamFloodEbb