...
local function ConvertFeature_CableArea(feature)
    local s57Feature = S57Lib.CreateFeature("CBLARE")

    s57Feature.CATCBL = feature.categoryOfCable.GetCommaSeparatedValues()
...
return ConvertFeature_CableArea