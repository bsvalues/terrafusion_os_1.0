...
local function ConvertFeature_SeaAreaNamedWaterArea(feature)
    local s57Feature = S57Lib.CreateFeature("SEAARE")

    s57Feature.CATSEA = feature.categoryOfSeaArea.GetFirstValue()
...
return ConvertFeature_SeaAreaNamedWaterArea