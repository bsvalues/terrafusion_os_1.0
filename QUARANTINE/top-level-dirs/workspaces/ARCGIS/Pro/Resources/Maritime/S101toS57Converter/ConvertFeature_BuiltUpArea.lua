...
local function ConvertFeature_BuiltUpArea(feature)
    local s57Feature = S57Lib.CreateFeature("BUAARE")

    s57Feature.CATBUA = feature.categoryOfBuiltUpArea.GetFirstValue()
...
return ConvertFeature_BuiltUpArea