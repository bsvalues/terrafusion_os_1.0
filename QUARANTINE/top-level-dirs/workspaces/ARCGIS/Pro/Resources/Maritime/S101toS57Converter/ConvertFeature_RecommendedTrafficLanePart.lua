...
local function ConvertFeature_RecommendedTrafficLanePart(feature)
    local s57Feature = S57Lib.CreateFeature("RCTLPT")
...
return ConvertFeature_RecommendedTrafficLanePart