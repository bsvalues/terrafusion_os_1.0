...
local function ConvertFeature_MilitaryPracticeArea(feature)
    local s57Feature = S57Lib.CreateFeature("MIPARE")

    s57Feature.CATMPA = feature.categoryOfMilitaryPracticeArea.GetCommaSeparatedValues()
    ...
    s57Feature.NATION = feature.nationality.GetFirstValue()
...
return ConvertFeature_MilitaryPracticeArea