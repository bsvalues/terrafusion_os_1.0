...
local function ConvertFeature_FerryRoute(feature)
    local s57Feature = S57Lib.CreateFeature("FERYRT")

    s57Feature.CATFRY = feature.categoryOfFerry.GetCommaSeparatedValues()
...
return ConvertFeature_FerryRoute