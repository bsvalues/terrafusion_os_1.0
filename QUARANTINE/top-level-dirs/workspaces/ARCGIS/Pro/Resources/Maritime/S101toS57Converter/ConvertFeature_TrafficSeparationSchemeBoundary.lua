...
local function ConvertFeature_TrafficSeparationSchemeBoundary(feature)
    local s57Feature = S57Lib.CreateFeature("TSSBND")
...
return ConvertFeature_TrafficSeparationSchemeBoundary