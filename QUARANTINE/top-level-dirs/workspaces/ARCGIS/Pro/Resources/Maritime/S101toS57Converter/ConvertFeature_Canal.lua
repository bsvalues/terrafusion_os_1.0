...
local function ConvertFeature_Canal(feature)
    local s57Feature = S57Lib.CreateFeature("CANALS")

    s57Feature.CATCAN = feature.categoryOfCanal.GetFirstValue()
