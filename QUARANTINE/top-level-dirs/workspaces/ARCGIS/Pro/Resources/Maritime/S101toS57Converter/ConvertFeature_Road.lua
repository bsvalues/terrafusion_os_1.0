...
local function ConvertFeature_Road(feature)
    local s57Feature = S57Lib.CreateFeature("ROADWY")

    s57Feature.CATROD = feature.categoryOfRoad.GetFirstValue()
