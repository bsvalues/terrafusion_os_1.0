...
local function ConvertFeature_OffshorePlatform(feature)
    local s57Feature = S57Lib.CreateFeature("OFSPLF")

    s57Feature.CATOFP = feature.categoryOfOffshorePlatform.GetFirstValue()
    ...
    feature.flareStack.DidNotConvert = true
...
return ConvertFeature_OffshorePlatform