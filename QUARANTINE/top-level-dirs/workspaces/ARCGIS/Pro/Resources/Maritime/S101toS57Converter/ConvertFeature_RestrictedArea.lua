...
local function ConvertFeature_RestrictedArea(feature)
    local s57Feature = S57Lib.CreateFeature("RESARE")

    s57Feature.CATREA = feature.categoryOfRestrictedArea.GetCommaSeparatedValues()
...
return ConvertFeature_RestrictedArea