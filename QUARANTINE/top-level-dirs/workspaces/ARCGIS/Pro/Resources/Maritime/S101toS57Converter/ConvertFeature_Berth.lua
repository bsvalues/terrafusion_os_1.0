...
local function ConvertFeature_Berth(feature)
    local s57Feature = S57Lib.CreateFeature("BERTHS")
    ...
    feature.minimumBerthDepth.DidNotConvert = true
