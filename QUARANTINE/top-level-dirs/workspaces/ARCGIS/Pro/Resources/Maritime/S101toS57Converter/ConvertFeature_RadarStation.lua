...
local function ConvertFeature_RadarStation(feature)
    local s57Feature = S57Lib.CreateFeature("RADSTA")

    s57Feature.CALSGN = feature.callSign.GetFirstValue()
    s57Feature.CATRAS = feature.categoryOfRadarStation.GetCommaSeparatedValues()
...
return ConvertFeature_RadarStation