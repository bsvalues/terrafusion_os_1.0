...
local ConvertAttribute_verticalClearanceSafe = S101To57AttributeConversionFunctions.verticalClearanceSafe
local ConvertAttribute_verticalDatum = S101To57AttributeConversionFunctions.verticalDatum

local function ConvertFeature_CableOverhead(feature)
    local s57Feature = S57Lib.CreateFeature("CBLOHD")

    s57Feature.CATCBL = feature.categoryOfCable.GetFirstValue()
    ...
    s57Feature.ICEFAC = feature.iceFactor.GetFirstValue()
    ...
    local vcs = ConvertAttribute_verticalClearanceSafe(feature.verticalClearanceSafe)
    s57Feature.VERCSA = vcs.VERCSA
    s57Feature.VERACC = vcs.VERACC
...
return ConvertFeature_CableOverhead