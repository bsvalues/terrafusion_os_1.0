...
local function ConvertFeature_SweptArea(feature)
    local s57Feature = S57Lib.CreateFeature("SWPARE")

    s57Feature.DRVAL1 = feature.depthRangeMinimumValue.GetFirstValue()

    feature.sweptDate.DidNotConvert = true
...
return ConvertFeature_SweptArea