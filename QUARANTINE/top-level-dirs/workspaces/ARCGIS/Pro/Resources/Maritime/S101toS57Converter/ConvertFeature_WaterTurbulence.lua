...
local function ConvertFeature_WaterTurbulence(feature)
    local s57Feature = S57Lib.CreateFeature("WATTUR")

    s57Feature.CATWAT = feature.categoryOfWaterTurbulence.GetFirstValue()
...
return ConvertFeature_WaterTurbulence