...
local function ConvertFeature_FishingFacility(feature)
    local s57Feature = S57Lib.CreateFeature("FSHFAC")

    s57Feature.CATFIF = feature.categoryOfFishingFacility.GetFirstValue()
...
return ConvertFeature_FishingFacility