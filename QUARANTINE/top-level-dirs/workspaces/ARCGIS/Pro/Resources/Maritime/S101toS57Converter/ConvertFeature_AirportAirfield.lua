...
local function ConvertFeature_AirportAirfield(feature)
    local s57Feature = S57Lib.CreateFeature("AIRARE")

    s57Feature.CATAIR = feature.categoryOfAirportAirfield.GetCommaSeparatedValues()
...
return ConvertFeature_AirportAirfield