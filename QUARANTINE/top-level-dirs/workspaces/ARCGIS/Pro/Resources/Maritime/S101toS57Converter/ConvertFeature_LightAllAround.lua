...
local function ConvertFeature_LightAllAround(feature)
    ...
    s57Feature.LITVIS = feature.lightVisibility.GetFirstValue()

    feature.majorLight.DidNotConvert = true
...
return ConvertFeature_LightAllAround