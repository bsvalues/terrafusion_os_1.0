...
class _CompoundParameter:
    ...
    def _toRepresentation(cls, values):
        userProvidedPounds = [value == "#" for value in values]
        result = [
            repr(value) if not cls._useDefault(value) else "'#'" for value in values
        ]
    ...
    @classmethod
    def _addProperty(cls, name, defaultValue=None):
            ...
            setattr(
                ...
                property(
                    ...
                    fset=lambda instance, value: cls.__propertySetter(
                        instance, name, value, defaultValue
                    ),
                ),
            )
    ...
    def __propertySetter(self, name, value, defaultValue):
