...
def GeneralizedLinearRegression(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.GeneralizedLinearRegression_gapro(
                *gp_fixargs(
                    (
                        input_features,
                        dependent_variable,
...
def CalculateMotionStatistics(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CalculateMotionStatistics_gapro(
                *gp_fixargs(
                    (
                        input_layer,
                        out_feature_class,
...
def CalculateField(
    input_layer=None,
    output=None,
    field_to_calculate: Literal["NEW_FIELD", "EXISTING_FIELD"] | None = None,
    field_name=None,
    existing_field=None,
...
def ClipLayer(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.ClipLayer_gapro(*gp_fixargs((input_layer, clip_layer, out_feature_class), True))
        )
        return retval
    except Exception as e:
        raise e
...
def DissolveBoundaries(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DissolveBoundaries_gapro(
                *gp_fixargs((input_layer, out_feature_class, multipart, dissolve_fields, fields, summary_fields), True)
            )
        )
        return retval
    except Exception as e:
...
def OverlayLayers(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.OverlayLayers_gapro(*gp_fixargs((input_layer, overlay_layer, out_feature_class, overlay_type), True))
        )
        return retval
    except Exception as e:
        raise e
...
def DescribeDataset(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DescribeDataset_gapro(
                *gp_fixargs((input_layer, output, sample_features, sample_layer, extent_layer), True)
            )
        )
        return retval
    except Exception as e:
...
def SummarizeCenterAndDispersion(
    input_layer=None,
    out_central_feature=None,
    out_mean_center=None,
    out_median_center=None,
    out_ellipse=None,
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.SummarizeCenterAndDispersion_gapro(
                *gp_fixargs(
                    (
                        input_layer,
                        out_central_feature,
...
def GroupByProximity(
    ...
    spatial_near_distance=None,
    temporal_relationship: Literal["NEAR", "INTERSECTS", "NONE"] | None = None,
    temporal_near_distance=None,
    attribute_relationship=None,
) -> Result1[str]:
...
# Utilities\Multifile Feature Connections toolset
...
def CopyDatasetFromBDC(
    ...
    try:
        retval = convertArcObjectToPythonObject(gp.CopyDatasetFromBDC_gapro(*gp_fixargs((input_layer, output), True)))
        return retval
    except Exception as e:
        raise e
...
def CreateBDC(
    bdc_location=None,
    bdc_name=None,
    connection_type: Literal["FOLDER"] | None = None,
    data_source_folder=None,
    visible_geometry: Literal["GEOMETRY_VISIBLE", "GEOMETRY_NOT_VISIBLE"] | None = None,
    visible_time: Literal["TIME_VISIBLE", "TIME_NOT_VISIBLE"] | None = None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.CreateBDC_gapro(
                *gp_fixargs(
                    (bdc_location, bdc_name, connection_type, data_source_folder, visible_geometry, visible_time), True
                )
            )
        )
        return retval
...
def DuplicateDatasetFromBDC(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.DuplicateDatasetFromBDC_gapro(*gp_fixargs((bdc_dataset, duplicate_name), True))
        )
        return retval
    except Exception as e:
        raise e
...
def PreviewDatasetFromBDC(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.PreviewDatasetFromBDC_gapro(*gp_fixargs((bdc_dataset, out_preview_file), True))
        )
        return retval
    except Exception as e:
        raise e
...
def RefreshBDC(
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.RefreshBDC_gapro(*gp_fixargs((bdc_file, visible_geometry, visible_time), True))
        )
        return retval
    except Exception as e:
        raise e
...
def RemoveDatasetFromBDC(
    ...
    try:
        retval = convertArcObjectToPythonObject(gp.RemoveDatasetFromBDC_gapro(*gp_fixargs((bdc_datasets,), True)))
        return retval
    except Exception as e:
        raise e
...
def UpdateBDCDatasetProperties(
    ...
    geometry_type: Literal["POINT", "LINE", "POLYGON", "NONE"] | None = None,
    spatial_reference=None,
    geometry_format_type: Literal["XYZ", "WKT", "WKB", "GEOJSON", "ESRIJSON", "ESRISHAPE"] | None = None,
    geometry_field=None,
    x_field=None,
    y_field=None,
    z_field=None,
    time_type: Literal["INSTANT", "INTERVAL", "NONE"] | None = None,
    time_zone=None,
    ...
    has_header_row: Literal["HAS_HEADER", "NO_HEADER"] | None = None,
    encoding=None,
) -> Result1[str]:
    ...
    try:
        retval = convertArcObjectToPythonObject(
            gp.UpdateBDCDatasetProperties_gapro(
                *gp_fixargs(
                    (
                        bdc_dataset,
                        expression,
