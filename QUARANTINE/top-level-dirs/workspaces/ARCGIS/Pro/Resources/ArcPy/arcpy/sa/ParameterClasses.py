...
class FuzzyGaussian(_FuzzyMembership):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.midpoint, self.spread])
...
class FuzzyLinear(_FuzzyMembership):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.minimum, self.maximum])

    def __repr__(self):
        return self._toRepresentation([self.minimum, self.maximum])
...
class FuzzyMSLarge(_FuzzyMembership):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.meanMultiplier, self.STDMultiplier])
...
class HfBinary(_HorizontalFactor):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.zeroFactor, self.cutAngle])
...
class HfForward(_HorizontalFactor):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.zeroFactor, self.sideValue])
...
class HfTable(_HorizontalFactor):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.inTable])
...
class KrigingModelOrdinary(_KrigingModel):
    ...
    __esri_toolinfo__ = ['String::SPHERICAL|CIRCULAR|EXPONENTIAL|GAUSSIAN|LINEAR:', 'Double:::', 'Double:::', 'Double:::', 'Double:::']
...
class KrigingModelUniversal(_KrigingModel):
    ...
    __esri_toolinfo__ = ['String::LINEARDRIFT|QUADRATICDRIFT:', 'Double:::', 'Double:::', 'Double:::', 'Double:::']
...
class NbrCircle(_Neighborhood):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.radius, self.units])
...
class NbrIrregular(_Neighborhood):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.inKernelFile])
...
class NbrRectangle(_Neighborhood):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.width, self.height, self.units])
...
class RadiusVariable(_Radius):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.numberOfPoints, self.maxDistance])
...
class RadiusFixed(_Radius):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.distance, self.minNumberOfPoints])
...
class _Remap(CompoundParameter._CompoundParameter):
    ...
    def __str__(self):
        return "; ".join(
            [" ".join([str(item) for item in record]) for record in self.remapTable]
        )
...
class TimeWithinDay(_Time):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.day, self.startTime, self.endTime])
...
class TimeSpecialDays(_Time):
    ...
    def __str__(self):
        return self._toString([self._keyword])
...
class TimeMultipleDays(_Time):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.year, self.startDay, self.endDay])
...
class TimeWholeYear(_Time):
    ...
    def __str__(self):
        return self._toString([self._keyword, self.year])
...
class TfGaussian(_TransformationFunction):
    ...
    __esri_toolinfo__ = ['Double:::', 'Double:::', 'Double:::', 'Variant:::', 'Double:::', 'Variant:::']
...
class TfLogisticGrowth(_TransformationFunction):
    ...
    __esri_toolinfo__ = ['Double:::', 'Double:::', 'Double:::', 'Double:::', 'Variant:::', 'Double:::', 'Variant:::']
...
class VfHikingTime(_VerticalFactor):
    ...
    def __init__(self, lowCutAngle=None, highCutAngle=None):
        _VerticalFactor.__init__(self, "HIKING_TIME")
        self.lowCutAngle = lowCutAngle
        self.highCutAngle = highCutAngle

    def __str__(self):
        return self._toString([self._keyword, self.lowCutAngle, self.highCutAngle])
...
class VfBidirHikingTime(_VerticalFactor):
    ...
    Spatial Analyst (ArcPy) class that defines a Bidirectional Hiking Time vertical factor object.
    ...
    def __init__(self, lowCutAngle=None, highCutAngle=None):
        _VerticalFactor.__init__(self, "BIDIR_HIKING_TIME")
        self.lowCutAngle = lowCutAngle
        self.highCutAngle = highCutAngle
...
class WOTable(CompoundParameter._CompoundParameter):
    ...
    __esri_toolinfo__ = ['List:::', 'List:::']

    def __init__(self, weightedOverlayTable, evaluationScale):
        CompoundParameter._CompoundParameter.__init__(self)

        self.weightedOverlayTable = [list(record) for record in weightedOverlayTable]
    ...
    def __repr__(self):
        return self._toRepresentation([self.weightedOverlayTable, self.evaluationScale])
...
class WSTable(CompoundParameter._CompoundParameter):
    ...
    def __init__(self, weightedSumTable):
        CompoundParameter._CompoundParameter.__init__(self)
    ...
    def __str__(self):
        return "; ".join(
            [
                " ".join([f"'{str(record[0])}'"] + [str(item) for item in record[1:]])
                for record in self.weightedSumTable
            ]
        )
