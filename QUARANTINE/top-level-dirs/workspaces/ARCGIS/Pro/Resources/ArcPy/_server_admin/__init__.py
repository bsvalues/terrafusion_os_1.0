...
"""Arcrest is a Python binding to the ArcGIS REST Server API, similar to the
   ...
   A simple example of connecting to a server:
      ...
      >>> catalog = _server_admin.Catalog("http://sampleserver1.arcgisonline.com/arcgis/rest/services")
      >>> catalog.services
   ...
   Getting a service from a URL:
      ...
      >>> service = _server_admin.GPService("http://sampleserver1.arcgisonline.com/ArcGIS/rest/services/Specialty/ESRI_Currents_World/GPServer")
      >>> service.url
   ...
   Executing a job:
      ...
      >>> results = service.MessageInABottle(_server_admin.Point(-11, 38, _server_admin.projections.geographic.GCS_WGS_1984), 2)
      >>> import time
...
from _server_admin.geometry import *
from _server_admin.gptypes import *
from _server_admin.server import *
from _server_admin.projections import projected, geographic
