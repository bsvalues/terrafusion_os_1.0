...
"""-----------------------------------------------------------------------------
Name:           AnalyzeChangesUsingCCDC.py
Purpose:        Run AnalyzeChangesUsingCCDC
Author:         Esri Inc.
Created:        24/03/2020
...
TASK_NAME = 'AnalyzeChangesUsingCCDC'
...
if __name__ == '__main__':
    ...
    bandsForDetectingChange = arcpy.GetParameter(2)  #
    bandsForTemporalMasking = arcpy.GetParameter(3)
    chiSquaredThreshold = arcpy.GetParameterAsText(4)  #
    minAnomalyObservations = arcpy.GetParameterAsText(5)
    updateFrequency = arcpy.GetParameterAsText(6)
    ...
    try:
        ...
        arcpy.gp.AnalyzeChangesUsingCCDC_ia(inMdimRas,
                                            outMdimRas,
