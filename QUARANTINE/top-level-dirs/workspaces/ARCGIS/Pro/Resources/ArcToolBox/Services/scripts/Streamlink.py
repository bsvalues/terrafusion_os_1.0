"""-----------------------------------------------------------------------------
Name:              Streamlink.py
Purpose:           This is the service tool that performs hydrology Streamlink analysis
Author:            Esri Inc.
Created:           8/1/2017
...
if __name__ == '__main__':
    ...
    inputstream = arcpy.GetParameterAsText(0)  
    inputflowdirection = arcpy.GetParameterAsText(1)
    ...
    try:
        ...
        inputstream = rasterutils.getInDataPath(inputstream)
        if isinstance(inputstream, dict):
            inputstream = json.dumps(inputstream)
        ...
        # 4. Execute tool
        arcpy.gp.StreamLink_sa(inputstream, inputflowdirection, outputname)
