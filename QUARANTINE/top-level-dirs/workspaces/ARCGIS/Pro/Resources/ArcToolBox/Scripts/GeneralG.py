...
class GeneralG(object):
    ...
    def __init__(self, ssdo, varName, wType, weightsFile = None, 
                 ...
                 exponent = 1.0, numNeighs = 0, displayIt = False):
    ...
    def construct(self):
        ...
        swm = None      # Added to address Coverity CID 278248
        gaTable = None  # Added to address Coverity CID 278250
        ...
        for i in iterVals:
            # Added to address Coverity CID 278248
    ...
    def report(self, fileName = None):
        ...
        ggString = LOCALE.format_string("%0.6f", self.gg)
        egString = LOCALE.format_string("%0.6f", self.eg)
        vgString = LOCALE.format_string("%0.6f", self.vg) 
        zgString = LOCALE.format_string("%0.6f", self.zg) 
        ...
        if self.wType in [0, 1, 7]:
            ...
            footnote = [dmsg.format(distanceOut)]

        outputTable = UTILS.outputTextTable(results, header = header,
                                            pad = 1, colPad=4, footnote=footnote,
