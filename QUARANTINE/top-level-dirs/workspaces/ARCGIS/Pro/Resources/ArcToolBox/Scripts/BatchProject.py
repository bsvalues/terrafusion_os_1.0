...
def execute():
    ...
    msgCoordinateSystem = ConversionUtils.gp.GetIDMessage(
        86110)  # Message "Must Enter a Spatial Reference or Template Feature Class."
    msgWarning = ConversionUtils.gp.GetIDMessage(86111)  # Message "Failed to project %s"
    ...
    if (output_coordinate_system == "" or output_coordinate_system == "#") and (
            template_dataset == "" or template_dataset == "#"):
