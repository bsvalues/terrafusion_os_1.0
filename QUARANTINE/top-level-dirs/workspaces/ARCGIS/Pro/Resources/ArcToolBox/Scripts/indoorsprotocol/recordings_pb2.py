...
# source: indoorsprotocol/recordings.proto
...
_RECORDING.fields_by_name['meta'].message_type = indoorsprotocol_dot_structures__pb2._NAMEDVALUE
_RECORDING.fields_by_name['accelerations'].message_type = indoorsprotocol_dot_sensors__pb2._SENSOR
_RECORDING.fields_by_name['gyros'].message_type = indoorsprotocol_dot_sensors__pb2._SENSOR
_RECORDING.fields_by_name['magnetics'].message_type = indoorsprotocol_dot_sensors__pb2._SENSOR
_RECORDING.fields_by_name['rotations'].message_type = indoorsprotocol_dot_sensors__pb2._SENSOR
_RECORDING.fields_by_name['pressures'].message_type = indoorsprotocol_dot_sensors__pb2._PRESSURE
_RECORDING.fields_by_name['radios'].message_type = indoorsprotocol_dot_sensors__pb2._RADIO
_RECORDING.fields_by_name['steps'].message_type = indoorsprotocol_dot_sensors__pb2._STEP
_RECORDING.fields_by_name['contexts'].message_type = indoorsprotocol_dot_sensors__pb2._CONTEXT
_RECORDING.fields_by_name['positions'].message_type = indoorsprotocol_dot_positions__pb2._POSITION
_RECORDING.fields_by_name['global_positions'].message_type = indoorsprotocol_dot_positions__pb2._GLOBALPOSITION
_RECORDING.fields_by_name['orientations'].message_type = indoorsprotocol_dot_sensors__pb2._ORIENTATION
_RECORDING.fields_by_name['events'].message_type = indoorsprotocol_dot_locatorevents__pb2._LOCATOREVENT
...
Recording = _reflection.GeneratedProtocolMessageType('Recording', (_message.Message,), {
  ...
  '__module__' : 'indoorsprotocol.recordings_pb2'
