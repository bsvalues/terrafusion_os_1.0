# Analytics & Machine Learning Operations for auth

**Analytics Tier**: CRITICAL
**Analytics Level**: enterprise
**Data Retention**: 1825 days
**ML Frameworks**: scikit-learn, tensorflow, isolation-forest
...
- **intrusion-detection**: Enabled with daily updates
- **anomalous-access**: Enabled with daily updates
- **fraud-risk**: Enabled with daily updates
...
- login-anomalies: Real-time detection
- privilege-escalation: Real-time detection
- data-exfiltration: Real-time detection
...
- **Warm Data** (archived): 1795 days
- **Cold Data** (long-term): 1825 days
