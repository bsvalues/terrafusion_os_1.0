# Analytics & Machine Learning Operations for monitoring

**Analytics Tier**: HIGH
**Analytics Level**: advanced
**Data Retention**: 365 days
**ML Frameworks**: statsmodels, scikit-learn, isolation-forest
...
- **system-failure**: Enabled with daily updates
- **performance-degradation**: Enabled with daily updates
- **resource-exhaustion**: Enabled with daily updates
...
- metric-anomalies: Real-time detection
- pattern-anomalies: Real-time detection
- threshold-violations: Real-time detection

### Detection Sensitivity

**Current Sensitivity**: Medium
...
```
Performance Models:    hourly
Anomaly Models:        Hourly
Time Series Models:    hourly
```
...
- Anomaly Model: Production
- Time-series Model: Production
...
- **Warm Data** (archived): 335 days
- **Cold Data** (long-term): 365 days
