# Federation & Enterprise Integration for security

**Federation Role**: security_broker
**Gateway Type**: security_gateway
**Federation Tier**: 1
...
**Role**: security_broker
- Participates in federation network
- Syncs with critical tier workspaces
- Uses security_gateway gateway
