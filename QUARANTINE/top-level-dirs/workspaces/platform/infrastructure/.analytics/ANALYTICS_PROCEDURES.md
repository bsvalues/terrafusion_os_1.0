# Analytics & Machine Learning Operations for infrastructure
...
- **resource-capacity**: Enabled with daily updates
- **cost-optimization**: Enabled with daily updates
- **scaling-needs**: Enabled with daily updates
...
- performance-anomalies: Real-time detection
- cost-anomalies: Real-time detection
- usage-anomalies: Real-time detection
