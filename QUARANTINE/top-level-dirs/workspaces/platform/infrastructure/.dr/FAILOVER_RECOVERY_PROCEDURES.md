# Failover & Recovery Procedures for infrastructure
...
1. **Local Storage**
   - Path: `/var/backups/infrastructure`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-infrastructure`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-infrastructure`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
