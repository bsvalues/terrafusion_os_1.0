# Analytics & Machine Learning Operations for legal-judicial

**Analytics Tier**: CRITICAL
**Analytics Level**: enterprise
**Data Retention**: 2555 days
**ML Frameworks**: tensorflow, scikit-learn, spacy
...
- **case-outcome**: Enabled with daily updates
- **processing-time**: Enabled with daily updates
- **risk-assessment**: Enabled with daily updates
...
- document-irregularities: Real-time detection
- access-patterns: Real-time detection
- data-corruption: Real-time detection
...
```
Performance Models:    daily
Anomaly Models:        Hourly
Time Series Models:    daily
```
...
- **Warm Data** (archived): 2525 days
- **Cold Data** (long-term): 2555 days
