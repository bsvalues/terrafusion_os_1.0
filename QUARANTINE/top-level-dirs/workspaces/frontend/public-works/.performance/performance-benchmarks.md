# Performance Benchmarks for public-works
...
- **Work Order Management**: <150ms response time
- **Asset Tracking**: <150ms response time
- **Maintenance Scheduling**: <150ms response time
