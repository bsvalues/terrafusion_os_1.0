# Failover & Recovery Procedures for public-works
...
1. **Local Storage**
   - Path: `/var/backups/public-works`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-public-works`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-public-works`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
