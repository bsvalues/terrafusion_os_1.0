# Alert & Escalation Procedures for economic-development

**Risk Level**: MEDIUM  
**Priority**: MEDIUM  
**Escalation Timeline**: [15, 45, 120] minutes
...
### 🔴 Critical (P1)
- **Trigger**: 89.55% uptime or <100.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.52499999999999% uptime or >240.0ms response
- **Response Time**: 5 minutes
- **Escalation**: Within 45 minutes
- **Contacts**: On-call engineer, Team lead
- **Action**: Investigate and implement fix

### 🔵 Medium (P3)
- **Trigger**: 98.505% uptime or >300.0ms response
- **Response Time**: 15 minutes
- **Escalation**: Within 120 minutes
...
- Response Time P99: 400ms target
