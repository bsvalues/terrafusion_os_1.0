# Performance Benchmarks for code-enforcement
...
- **Violation Reporting**: <120ms response time
- **Inspection Scheduling**: <120ms response time
- **Enforcement Actions**: <120ms response time
