# Analytics & Machine Learning Operations for code-enforcement
...
- **violation-likelihood**: Enabled with daily updates
- **resolution-time**: Enabled with daily updates
- **repeat-offender**: Enabled with daily updates
...
- complaint-anomalies: Real-time detection
- case-anomalies: Real-time detection
- fraud-patterns: Real-time detection
