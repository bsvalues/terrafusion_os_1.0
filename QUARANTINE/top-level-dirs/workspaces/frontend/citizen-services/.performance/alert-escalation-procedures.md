# Alert & Escalation Procedures for citizen-services
...
### 🔴 Critical (P1)
- **Trigger**: 89.91000000000001% uptime or <50.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.905% uptime or >120.0ms response
...
### 🔵 Medium (P3)
- **Trigger**: 98.90100000000001% uptime or >150.0ms response
