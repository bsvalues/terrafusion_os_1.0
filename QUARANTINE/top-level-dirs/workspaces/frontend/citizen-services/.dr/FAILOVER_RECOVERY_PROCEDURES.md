# Failover & Recovery Procedures for citizen-services
...
1. **Local Storage**
   - Path: `/var/backups/citizen-services`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-citizen-services`
   - Region: us-east-1
   - Retention: 180 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-citizen-services`
   - Region: eastus
   - Retention: 180 days
   - Purpose: Geographic redundancy
