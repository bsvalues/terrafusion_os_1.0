CREATE VIEW [CO\ArcGis].ParcelUpdateV2
AS
SELECT DISTINCT 
                         ...
                         ta.tax_area_number AS tax_code_area, pv.imprv_hstd_val + pv.imprv_non_hstd_val AS ImpVal, CASE WHEN pv.land_hstd_val IS NULL OR
                         pv.land_hstd_val = 0 THEN pv.land_non_hstd_val ELSE CASE WHEN pv.land_non_hstd_val IS NULL OR
                         pv.land_non_hstd_val = 0 THEN pv.land_hstd_val ELSE pv.land_hstd_val + pv.land_non_hstd_val END END AS LandVal, pv.appraised_val, pv.ag_use_val, hood.hood_name AS neighborhood_name, 
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N' End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'CO\ArcGis', @level1type = N'VIEW', @level1name = N'ParcelUpdateV2';


GO

EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'CO\ArcGis', @level1type = N'VIEW', @level1name = N'ParcelUpdateV2';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[40] 4[20] 2[36] 3) )"
      End
