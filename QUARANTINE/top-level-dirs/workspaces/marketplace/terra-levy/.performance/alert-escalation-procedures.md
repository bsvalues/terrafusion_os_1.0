# Alert & Escalation Procedures for terra-levy

**Risk Level**: CRITICAL  
**Priority**: CRITICAL  
**Escalation Timeline**: [1, 5, 15] minutes
...
### 🔴 Critical (P1)
- **Trigger**: 89.955% uptime or <75.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.9525% uptime or >180.0ms response
...
### 🔵 Medium (P3)
- **Trigger**: 98.9505% uptime or >225.0ms response
