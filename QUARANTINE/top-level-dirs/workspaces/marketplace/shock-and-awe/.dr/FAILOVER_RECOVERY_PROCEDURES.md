# Failover & Recovery Procedures for shock-and-awe
...
1. **Local Storage**
   - Path: `/var/backups/shock-and-awe`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-shock-and-awe`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-shock-and-awe`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
