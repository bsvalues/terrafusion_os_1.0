# Failover & Recovery Procedures for terra-collections
...
1. **Local Storage**
   - Path: `/var/backups/terra-collections`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-terra-collections`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-terra-collections`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
