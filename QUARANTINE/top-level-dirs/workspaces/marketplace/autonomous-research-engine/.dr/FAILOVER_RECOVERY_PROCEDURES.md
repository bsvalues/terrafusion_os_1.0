# Failover & Recovery Procedures for autonomous-research-engine
...
1. **Local Storage**
   - Path: `/var/backups/autonomous-research-engine`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-autonomous-research-engine`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-autonomous-research-engine`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
