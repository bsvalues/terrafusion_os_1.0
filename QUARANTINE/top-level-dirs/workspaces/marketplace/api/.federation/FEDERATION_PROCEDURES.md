# Federation & Enterprise Integration for api

**Federation Role**: core_gateway
**Gateway Type**: api_gateway
**Federation Tier**: 1
**Sync Frequency**: 1000ms
