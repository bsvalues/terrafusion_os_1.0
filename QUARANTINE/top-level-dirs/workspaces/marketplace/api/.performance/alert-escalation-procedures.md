# Alert & Escalation Procedures for api
...
### 🔴 Critical (P1)
- **Trigger**: 89.955% uptime or <25.0ms response
...
### 🟡 High (P2)
- **Trigger**: 94.9525% uptime or >60.0ms response
...
### 🔵 Medium (P3)
- **Trigger**: 98.9505% uptime or >75.0ms response
