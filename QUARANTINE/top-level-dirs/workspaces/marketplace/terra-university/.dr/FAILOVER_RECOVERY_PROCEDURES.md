# Failover & Recovery Procedures for terra-university
...
1. **Local Storage**
   - Path: `/var/backups/terra-university`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-terra-university`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-terra-university`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
