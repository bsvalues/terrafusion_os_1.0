# Federation & Enterprise Integration for TerraFusion-PublicRecords

**Federation Role**: standard_node
...
- Syncs with high tier workspaces
...
```
Service: TerraFusion-PublicRecords
Port: 3000
Tags: ['standard_node', 'tier-2']
