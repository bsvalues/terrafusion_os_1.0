# Failover & Recovery Procedures for TerraFusion-PublicRecords
...
1. **Local Storage**
   - Path: `/var/backups/TerraFusion-PublicRecords`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-TerraFusion-PublicRecords`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-TerraFusion-PublicRecords`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
