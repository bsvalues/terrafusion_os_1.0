# Performance Benchmarks for terra-justice
...
- **Case Management**: <100ms response time
- **Court Proceedings**: <100ms response time
- **Sentencing Records**: <100ms response time
