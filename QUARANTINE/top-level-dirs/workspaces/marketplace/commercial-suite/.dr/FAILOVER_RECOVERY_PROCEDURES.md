# Failover & Recovery Procedures for commercial-suite
...
1. **Local Storage**
   - Path: `/var/backups/commercial-suite`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-commercial-suite`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-commercial-suite`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
