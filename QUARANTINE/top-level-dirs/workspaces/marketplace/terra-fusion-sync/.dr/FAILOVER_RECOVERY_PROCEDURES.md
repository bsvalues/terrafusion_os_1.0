# Failover & Recovery Procedures for terra-fusion-sync
...
1. **Local Storage**
   - Path: `/var/backups/terra-fusion-sync`
   - Retention: 30 days
   - Purpose: Quick recovery

2. **AWS Cloud**
   - Bucket: `terrafusion-backups-terra-fusion-sync`
   - Region: us-east-1
   - Retention: 90 days
   - Purpose: Geographic redundancy

3. **Azure Cloud**
   - Container: `terrafusion-backups-terra-fusion-sync`
   - Region: eastus
   - Retention: 90 days
   - Purpose: Geographic redundancy
