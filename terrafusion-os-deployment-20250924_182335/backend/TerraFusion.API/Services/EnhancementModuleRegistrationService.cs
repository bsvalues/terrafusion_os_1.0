...
public class EnhancementModuleRegistrationService : IEnhancementModuleRegistrationService
{
    ...
    private readonly List<EnhancementModuleDefinition> _enhancementModules = new()
    {
        ...
        new EnhancementModuleDefinition
        {
            ...
            Port = 3002,
            HealthCheckUrl = "http://localhost:3001/api/enhancement/consciousness/health",
            MetricsUrl = "http://localhost:3001/api/enhancement/consciousness/metrics",
            ConfigurationSchema = new Dictionary<string, object>
            {
        ...
        new EnhancementModuleDefinition
        {
            ...
            Port = 3003,
            HealthCheckUrl = "http://localhost:3001/api/enhancement/security/health",
            MetricsUrl = "http://localhost:3001/api/enhancement/security/metrics",
            ConfigurationSchema = new Dictionary<string, object>
            {
        ...
        new EnhancementModuleDefinition
        {
            ...
            Port = 3004,
            HealthCheckUrl = "http://localhost:3001/api/enhancement/performance/health",
            MetricsUrl = "http://localhost:3001/api/enhancement/performance/metrics",
            ConfigurationSchema = new Dictionary<string, object>
            {
        ...
        new EnhancementModuleDefinition
        {
            ...
            Port = 3005,
            HealthCheckUrl = "http://localhost:3001/api/enhancement/integration/health",
            MetricsUrl = "http://localhost:3001/api/enhancement/integration/metrics",
            ConfigurationSchema = new Dictionary<string, object>
            {
