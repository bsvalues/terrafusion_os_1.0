...
This document contains step-by-step procedures for responding to common
incidents in the Terrafusion platform. Each runbook follows a consistent format
for quick action during emergencies.
...
2. **Declare Incident**
   - Post in #terrafusion-incidents: "@here P1 Incident: Complete service outage
     detected"
...
3. **Recovery Steps**
   ...
   # Reload model
   curl -X POST http://localhost:\${{TF_ADMIN_PORT:-8080}}/admin/reload-model
   ```
...
**Date**: [Date] **Duration**: [Start Time] - [End Time] **Severity**: P[1-4]
...
Remember: Stay calm, follow the runbook, communicate clearly, and document
everything!
