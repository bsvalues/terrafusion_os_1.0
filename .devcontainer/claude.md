...
## Overview
The `.devcontainer` directory contains the development container configuration for TerraFusion OS, providing a comprehensive, reproducible development environment. This setup enables government-grade AI development with complete tooling integration, security controls, and automated environment provisioning.
...
- **Integration**: VS Code, GitHub Codespaces, and local development container support
...
curl http://localhost:5000/health         # Backend API health
curl http://localhost:3000               # Frontend application
curl http://localhost:8080/demo          # Demo environment
