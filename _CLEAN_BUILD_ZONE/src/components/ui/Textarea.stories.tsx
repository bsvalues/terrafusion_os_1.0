  ...
  render: () => (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <Textarea 
          placeholder="Enter a longer message or content..." 
          rows={8}
        />
      </div>
      ...
      <div>
        ...
        <Textarea 
          placeholder="Enter extensive content, notes, or documentation..." 
          rows={12}
        />
      </div>
    </div>
      ...
      <div className="space-y-8 max-w-2xl">
        ...
        <div className="bg-muted rounded-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Character counters help users stay within limits and provide clear feedback.
            Change color when approaching limit (e.g., yellow at 20 remaining, red at 0).
          </p>
        </div>
      </div>
    );
...
export const StatesAndVariants: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'All possible textarea states including disabled, read-only, required, and validation states.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mb-2">
          User can resize in any direction
        </p>
        <Textarea 
      ...
      <div className="bg-muted rounded-lg p-4">
        ...
        <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
          <li><strong>resize-y</strong> (vertical): Best for most use cases</li>
          <li><strong>resize-none</strong>: Use when layout must remain consistent</li>
          <li><strong>resize</strong> (both): Good for code editors or free-form content</li>
          <li><strong>resize-x</strong> (horizontal): Rarely used, can break layouts</li>
        </ul>
      </div>
    </div>
  ),
        ...
        <form className="space-y-4 bg-card border rounded-lg p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={remaining <= 50 ? 'text-yellow-600 dark:text-yellow-500' : 'text-muted-foreground'}>
                {remaining} remaining
              </span>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Provide clear error or success messages
            </p>
          </div>
        </div>
      </div>
...
<div className="space-y-2">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex items-start gap-2">
            ...
            <p><strong>Always provide labels</strong> - Use label element with htmlFor attribute</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Mark required fields</strong> - Use required attribute and visual indicator</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Provide error messages</strong> - Use aria-describedby for error text</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Support keyboard navigation</strong> - Tab to focus, arrow keys to navigate</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Sufficient contrast</strong> - Text must meet WCAG AA standards (4.5:1)</p>
          </div>
        </div>
      </div>
    </div>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Comprehensive guidelines with best practices, code examples, and accessibility checklist.',
      },
    },
  },
};
...
export const AccessibilityTest: Story = {
      ...
      <div className="space-y-8 max-w-4xl">
        <div>
          ...
          <p className="text-muted-foreground mb-6">
            Comprehensive WCAG 2.1 AAA compliance with keyboard navigation, screen reader support, and ARIA attributes.
          </p>
        </div>
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Always associate textarea with labels using htmlFor/id. Include aria-describedby for hints.
          </p>
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <p id="message-count" className="text-sm text-muted-foreground" aria-live="polite">
              ...
              {message.length > 180 && <span className="text-amber-600 ml-2">Warning: Approaching limit</span>}
            </p>
          </div>
        </div>
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <div className="space-y-2 text-sm">
            <p><strong>Tab:</strong> Focus textarea</p>
            <p><strong>Shift+Tab:</strong> Focus previous element</p>
            <p><strong>Esc:</strong> Clear selection</p>
            <p><strong>Ctrl+A:</strong> Select all text</p>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'WCAG 2.1 AAA compliance: label association, ARIA attributes, keyboard navigation, error announcements, and screen reader support.',
      },
    },
  },
};
    ...
    return (
      <div className="space-y-8 max-w-4xl">
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <Textarea value={longText} onChange={(e) => setLongText(e.target.value)} rows={8} placeholder="Paste very long text..." />
          <p className="text-sm text-muted-foreground">Length: {longText.length} {longText.length > 10000 && <span className="text-green-600">✓ 10,000+ handled</span>}</p>
        </div>
        
        <div className="rounded-lg border p-6 space-y-4">
          <h4 className="font-semibold">Special Characters & Unicode</h4>
          <Textarea value={specialChars} onChange={(e) => setSpecialChars(e.target.value)} placeholder="Try emojis 🚀, special chars &<>, Unicode 日本語..." rows={4} />
        </div>
  ...
  render: () => (
    <div className="space-y-8">
      ...
      <div className="rounded-lg border p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><Label>Left</Label><Textarea rows={3} /></div>
          <div><Label>Right</Label><Textarea rows={3} /></div>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <Textarea id="bio" value={bio} onChange={(e) => setBio(e.target.value.slice(0, 500))} rows={5} />
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <div className="space-y-4">
            <div><Label>Name</Label><input type="text" className="w-full border rounded p-2" /></div>
            <div><Label>Email</Label><input type="email" className="w-full border rounded p-2" /></div>
    ...
    return (
      <div className="space-y-8 max-w-4xl">
        ...
        <div className="rounded-lg border p-6 space-y-4">
          ...
          <Textarea value={perfValue} onChange={(e) => setPerfValue(e.target.value)} placeholder="Type rapidly..." rows={5} />
...
<Textarea onChange={(e) => debouncedSave(e.target.value)} />`}
        ...
        <div className="rounded-lg bg-green-50 dark:bg-green-950 p-6 space-y-3">
          <h4 className="font-semibold text-green-900 dark:text-green-100">⚡ Performance Best Practices</h4>
          <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
            <li>✓ Bundle: 1.0 KB</li>
