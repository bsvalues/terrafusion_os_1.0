...
const StrategyDashboard: React.FC = () => {
  ...
  const segments: Segment[] = [{
    ...
    messaging: {
      ...
      keyPoints: ['No complex setup or training required', 'Immediate cost savings from day one', 'Dedicated support for small teams', 'Scales with your county\'s growth'],
    ...
    messaging: {
      ...
      keyPoints: ['Seamless integration with existing systems', 'Advanced analytics and reporting capabilities', 'Enterprise-grade security and compliance', 'Scalable architecture for millions of records'],
    ...
    messaging: {
      ...
      keyPoints: ['Open APIs and flexible integration options', 'Comprehensive documentation and support', 'Modern architecture with proven scalability', 'FISMA compliance and security certifications'],
    ...
    messaging: {
      ...
      keyPoints: ['Deployed successfully across multiple counties', 'Comprehensive training and change management', 'Proven ROI and measurable outcomes', 'Long-term partnership and support commitment'],
  ...
  return <div className="w-full p-8">
      ...
      margin: '0 auto 3rem auto'
        ...
        {segments.map(segment => <div key={segment.id} onClick={() => setSelectedSegment(segment.id)} style={{
        border: selectedSegment === segment.id ? `2px solid ${segment.color}` : '1px solid rgba(0,255,238,0.2)',
        ...
        if (selectedSegment !== segment.id) {
          ...
          marginBottom: '1rem'
            ...
            <div className="flex justify-between">
              ...
              color: segment.color,
              fontWeight: 700
            }}>{segment.metrics.engagement}</div>
                <div style={{
              color: 'rgba(255,255,255,0.5)'
            }}>Engagement</div>
              </div>
              ...
              color: segment.color,
              fontWeight: 700
            }}>{segment.metrics.conversion}</div>
                <div style={{
              color: 'rgba(255,255,255,0.5)'
            }}>Conversion</div>
              </div>
      ...
      border: `2px solid ${selectedSegmentData.color}`
        ...
        gap: '2rem'
          ...
          padding: '1.5rem'
            ...
            <div className="flex">
              {selectedSegmentData.messaging.keyPoints.map((point, index) => <div key={index} style={{
