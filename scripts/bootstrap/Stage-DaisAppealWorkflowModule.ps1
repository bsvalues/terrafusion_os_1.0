...
function Assert-ManifestIdentity {
  ...
  $stringProperties = @(
    ...
    'schemaFilename','schemaPath','schemaSha256','sourceDtoSha256','sourceManifestPath','sourceManifestSha256','transport'
  )
...
@{
  ...
  ExpectedRepository = $ExpectedRepository; ExpectedCommit = $ExpectedDaisCommit;
...
[ordered]@{
  ...
  repository=$ExpectedRepository; commit=$ExpectedDaisCommit;
...
[pscustomobject]@{
  ...
  fetchTransport=$fetchRepository; suiteCommit=$ExpectedDaisCommit; contract=$Contract;
