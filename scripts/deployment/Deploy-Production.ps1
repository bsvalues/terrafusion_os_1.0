...
function Show-Summary {
    ...
    Write-Log "• API Health: http://localhost:5000/health"
    Write-Log "• API Swagger: http://localhost:5000/swagger (if enabled)"
    Write-Log "• Prometheus: http://localhost:9090 (if enabled)"
    Write-Log "• Grafana: http://localhost:3000 (if enabled)"
    Write-Log ""
