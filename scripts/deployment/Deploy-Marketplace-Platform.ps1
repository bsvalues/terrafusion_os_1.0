...
function Test-MarketplaceDeployment {
    ...
    $services = @(
        @{Name="Core API"; Url="http://localhost:5000/health"; Port=5000},
        @{Name="Marketplace Platform"; Url="http://localhost:3000/health"; Port=3000},
        @{Name="Revenue Analytics"; Url="http://localhost:3001"; Port=3001}
    )
...
function Show-DeploymentSummary {
    ...
    Write-Log "   • Marketplace Portal: http://localhost:3000" "White"
    Write-Log "   • Core API: http://localhost:5000" "White"
    Write-Log "   • Revenue Analytics: http://localhost:3001" "White"
    Write-Log "   • Plugin API: http://localhost:5000/api/marketplace" "White"
    Write-Log "" "White"
    ...
    Write-Log "   • Grafana: http://localhost:3001" "White"
    Write-Log "" "White"
    Write-Log "🎯 Next Steps:" "Yellow"
    Write-Log "   1. Access marketplace at http://localhost:3000" "White"
