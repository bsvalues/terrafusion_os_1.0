...
/**
 * 🎯 BSIncomeValuation_PRODUCTION Migration Script
...
const CONFIG = {
  ...
  sourcePath: 'c:\\Users\\bsval\\OneDrive\\Desktop\\from D\\BSIncomeValuation_PRODUCTION',
  targetPath: path.join(__dirname, '..', 'src-enhanced', 'bsincomevaluation-production'),
  mcpPath: path.join(__dirname, '..', 'src-enhanced', 'mcp-servers', 'bsincomevaluation-production-mcp')
};

console.log('🎯 BSIncomeValuation_PRODUCTION Migration Starting...');
