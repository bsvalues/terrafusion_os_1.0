#!/bin/bash
# TerraFusion OS - Kong Configuration Generator
...
# Government-grade environment variable handling
TF_API_PORT="${TF_API_PORT:-5046}"
TF_FRONTEND_PORT="${TF_FRONTEND_PORT:-3102}"

echo "🚀 TerraFusion OS - Generating Kong Configuration"
...
cat > infrastructure/kubernetes/kong/kong-config-generated.yaml << EOF
...
echo "✅ Kong configuration generated with environment variables"
echo "📁 File: infrastructure/kubernetes/kong/kong-config-generated.yaml"
