...
(function() {
    ...
    const extensionErrorPatterns = [
        /content\.js/i, /awesome json viewer/i, /json viewer/i, /hook\.js/i,
        /extension/i, /chrome-extension/i, /moz-extension/i, /injected/i,
        /content_script/i, /unexpected end of json input/i, /syntaxerror.*json/i,
        /failed to fetch.*extension/i, /network error.*extension/i,
        /message port closed/i, /response was received/i, /main\.js.*143684/i,
        /overridemethod/i, /rt \(main\.js/i, /anonymous.*content\.js/i,
        /something went wrong at awesome/i, /copilot in edge/i
    ];
    ...
    window.addEventListener('error', function(event) {
        ...
        if (extensionErrorPatterns.some(pattern => 
            pattern.test(errorMessage) || pattern.test(source)
        )) {
    ...
    window.addEventListener('unhandledrejection', function(event) {
        ...
        const reasonString = typeof reason === 'object' ? 
        ...
        mutations.forEach(function(mutation) {
            mutation.addedNodes.forEach(function(node) {
                if (node.nodeType === 1) { // Element node
                    ...
                    if (nodeHtml.includes('chrome-extension') || 
