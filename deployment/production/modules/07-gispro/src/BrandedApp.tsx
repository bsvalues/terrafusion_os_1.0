/**
 * GIS Pro - Terrafusion Championship Edition
...
const BrandedApp: React.FC = () =>{
  ...
  return (<TerraFusionWrapper appName="GIS Pro" appIcon="🗺️" appVersion="1.0.0" standalone={isStandalone}><OriginalApp /></TerraFusionWrapper>
  );
};
