...
class HealthServer {
    ...
    handleHealthCheck(req, res) {
        ...
        const statusCode = quickHealth.status === 'healthy' ? 200 : 
                          quickHealth.status === 'warning' ? 200 : 503;
...
<body>
    <div class="container">
        ...
        <div class="status">
            ...
            <div class="apps-grid">
                ${(health.applications?.applications || []).map(app => `
    ...
    start() {
        this.server.listen(CONFIG.port, () => {
            ...
            console.log(`  http://localhost:${CONFIG.port}/health/detailed - Detailed health information`);
            ...
            console.log(`  http://localhost:${CONFIG.port}/health/alerts - Current and historical alerts`);
