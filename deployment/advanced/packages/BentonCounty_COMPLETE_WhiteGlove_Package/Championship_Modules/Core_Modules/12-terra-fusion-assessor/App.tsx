...
function App() {
  ...
  const handleAssessmentRequest = async (property: Property, assessmentType: string, methodology: string) => {
    try {
...
className="search-bar">
                ...
                />
                <button onClick={handlePropertySearch} className="search-btn" disabled={loading}>
