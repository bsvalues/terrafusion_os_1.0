# Os-Platform Service Documentation

## Overview

The os-platform service is a core component of the TerraFusion government services platform, built following THE TERRAFUSION WAY methodology.
