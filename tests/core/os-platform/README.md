...
Government-grade os-platform service built with THE TERRAFUSION WAY.

## Overview

This workspace provides os-platform functionality for the TerraFusion government services platform.
...
See `docs/os-platform.md` for detailed documentation.
