# Engines Service Documentation

## Overview

The engines service is a core component of the TerraFusion government services platform, built following THE TERRAFUSION WAY methodology.
