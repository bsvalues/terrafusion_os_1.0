...
Government-grade infrastructure service built with THE TERRAFUSION WAY.

## Overview

This workspace provides infrastructure functionality for the TerraFusion government services platform.
...
See `docs/infrastructure.md` for detailed documentation.
