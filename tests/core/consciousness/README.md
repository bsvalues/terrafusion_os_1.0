...
Government-grade consciousness service built with THE TERRAFUSION WAY.

## Overview

This workspace provides consciousness functionality for the TerraFusion government services platform.
...
See `docs/consciousness.md` for detailed documentation.
