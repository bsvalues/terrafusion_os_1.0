...
Government-grade backend service built with THE TERRAFUSION WAY.

## Overview

This workspace provides backend functionality for the TerraFusion government services platform.
...
See `docs/backend.md` for detailed documentation.
