...
test.describe('Property Assessment Workflow', () => {
  ...
  test('Complete property assessment workflow', async () => {
    ...
    await page.fill('[data-testid="assessment-notes"]', 'Property assessed using AI valuation with manual adjustment for market conditions');
    ...
    await expect(page.locator('[data-testid="assessment-success"]')).toContainText('Assessment completed successfully');
    ...
    await expect(page.locator('[data-testid="assessment-item"]')).toContainText('123 Championship Way');
  });
  ...
  test('Assessment review and approval workflow', async () => {
    ...
    // Approve assessment
    await page.fill('[data-testid="reviewer-notes"]', 'Assessment approved - values consistent with market analysis');
    ...
    await expect(page.locator('[data-testid="approval-success"]')).toContainText('Assessment approved');
  });
  ...
  test('Assessment appeal workflow', async () => {
    ...
    await page.fill('[data-testid="appeal-reason"]', 'Property overvalued compared to recent sales in area');
    
    // Upload supporting documents
    await page.locator('[data-testid="upload-documents"]').setInputFiles('tests/fixtures/appeal-documents.pdf');
