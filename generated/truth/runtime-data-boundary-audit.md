...
Generated: 2026-05-02T04:57:07.048Z
...
- Product canonical endpoints: 27
- Product unproven endpoints: 10
- Frontend legacy terminology violations: 8
...
`backend/src/TerraFusion.API/Controllers/FieldController.cs` | `api/field`<br>`assignments`<br>`assignments/{id}/status`<br>`assignments/{id}/assessment-review-flag` | terrafusion_canonical | - | - | - | `assessment`<br>`canonical`<br>`parcel`<br>`TerraFusionDbContext` | - | -
...
`backend/src/TerraFusion.API/Program.cs` | - | terrafusion_canonical | - | - | `CAMA`<br>`Harris`<br>`legacy SOURCE`<br>`PACS` | `assessment`<br>`CamaCharacteristics`<br>`canonical`<br>`ComparableSales`<br>`parcel`<br>`Repository`<br>`runtime`<br>`TerraFusionDbContext` | - | Legacy/provenance terminology detected without direct source dependency evidence.
...
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/rag/benton-assessment-basics/export` | - | -
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/rag/health` | - | -
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/rag/index/${datasetKey}` | - | -
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/system/diagnostics/download` | - | -
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/system/safe-mode` | - | -
`frontend/apps/os-shell/src/api/systemDiagnosticsApi.ts` | atlas | `${API_BASE_URL}/api/gpt/system/safe-mode` | - | -
...
`frontend/apps/os-shell/src/components/field/PostInspectionReview.tsx` | unknown | `${API_BASE}/api/field/assignments/${assignment.id}/assessment-review-flag` | - | -
`frontend/apps/os-shell/src/components/field/PostInspectionReview.tsx` | unknown | `${API_BASE}/api/properties/parcel/${encodeURIComponent(assignment.parcelNumber)}/sketch` | - | -
