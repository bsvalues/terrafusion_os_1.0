# TerraFusion Government Project Backlog

This document organizes the work for the TerraFusion Government Building Cost System into user stories and technical tasks, arranged in a Kanban-style backlog.
...
- **Title**: As an assessor, I want to import cost matrix data from Excel files, so that I can use the latest cost factors in my assessments.
  - **Acceptance Criteria**:
    - Upload interface accepts Excel files in the government jurisdiction format
