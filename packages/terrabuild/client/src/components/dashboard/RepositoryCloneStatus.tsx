    ...
    <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex items-center p-3 bg-neutral-100 rounded-md">
              ...
              <span className="text-sm font-mono text-neutral-600">{(repository as any)?.sourceRepo || "bsvalues/BSBuildingCost"}</span>
              <a
          ...
          <div>
            ...
            <div className="flex items-center p-3 bg-neutral-100 rounded-md">
              <i className="ri-github-fill text-neutral-600 mr-2 text-xl"></i>
              <span className="text-sm font-mono text-neutral-600">{(repository as any)?.targetRepo || "yourteam/BSBuildingCost"}</span>
        ...
        <div>
          ...
          <div className="space-y-2">
            {(repository as any)?.steps?.map((step: any, index: number) => (
