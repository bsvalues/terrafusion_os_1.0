...
export async function generateCostReport(
  ...
  // Add document title
  pdf.setFontSize(20);
  pdf.setTextColor(36, 62, 77); // #243E4D - TerraFusion Government OS dark teal
  ...
  if (mergedOptions.showLogo) {
    ...
    pdf.setFontSize(12);
    pdf.setTextColor(60, 171, 54); // #3CAB36 - TerraFusion Government OS green
    pdf.text('TERRAFUSION GOVERNMENT OS', margin, margin + 5);
    pdf.setFontSize(8);
    pdf.text('PROPERTY ASSESSMENT', margin, margin + 10);
  }

  // Add a separator line
  pdf.setDrawColor(41, 183, 211); // #29B7D3 - TerraFusion Government OS light blue
  ...
  // Draw the total cost
  pdf.setFontSize(12);
  pdf.setTextColor(36, 62, 77); // TerraFusion Government OS dark teal
