      ...
      items: [
        {
          ...
          answer: "Cost matrix data can be imported using the Data Import tool. The system accepts Excel files formatted according to the government jurisdiction cost matrix template. The data import tool includes validation to ensure data integrity."
        },
        {
      ...
      items: [
        {
          ...
          answer: "Technical support is available through your local government Assessment Department. Contact information can be configured for your specific jurisdiction through the system administration panel."
        },
        {
        ...
        },
        {
          ...
          answer: "Yes, your government jurisdiction can offer regular training sessions for new users. Additionally, the Tutorials section provides step-by-step guides for using all features of the system."
        }
      ]
    }
  ];
