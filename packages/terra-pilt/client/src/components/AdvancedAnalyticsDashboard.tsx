...
import { TrendingUp, TrendingDown, DollarSign, Building2, Users, AlertTriangle, Zap, Target  } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">AI-powered insights for PILT management</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
          ...
          <CardContent>
            ...
            <Progress value={analyticsData.efficiency.score} className="mt-2 h-2" />
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
          ...
          <CardContent>
            ...
            <p className="text-xs text-purple-600 mt-1">Active recipients</p>
          </CardContent>
        </Card>
