...
import { Settings, Server, Database, Cpu, Network, Bell, CloudOff, Clock, RotateCw } from 'lucide-react';
        ...
        <div className="flex">
          <div className="w-64 border-r pr-6">
            <TabsList className="flex flex-col w-full h-auto space-y-1">
              ...
              <TabsTrigger value="database" className="justify-start">
              ...
              <TabsTrigger value="fallback" className="justify-start">
                <CloudOff className="mr-2 h-4 w-4" />
                Fallback Modes
              </TabsTrigger>
              <TabsTrigger value="scheduling" className="justify-start">
            ...
            <TabsContent value="general" className="space-y-4 mt-0">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg">2023-05-15 14:30:00</p>
                    </div>
                    <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Manage API settings and configurations</CardDescription>
                </CardHeader>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Maximum time for API requests to complete</p>
                      </div>
                      <div className="flex items-center space-x-2">
            ...
            <TabsContent value="services" className="space-y-4 mt-0">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Configure circuit breaker thresholds for services</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-sm font-medium">Error Threshold (%)</label>
                      <input type="range" min="5" max="50" step="5" defaultValue="20" 
                        className="w-full" />
                    ...
                    <div className="space-y-2">
                      ...
                      <input type="range" min="10" max="300" step="10" defaultValue="60" 
                        className="w-full" />
                      <div className="flex justify-between text-xs text-gray-500">
                        <span>10s</span>
                        <span>60s</span>
            ...
            <TabsContent value="database" className="mt-0">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Manage database connection settings</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input type="number" className="w-full rounded-md border" defaultValue="20" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium">Connection Timeout (ms)</label>
                        <input type="number" className="w-full rounded-md border" defaultValue="5000" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium">Query Timeout (ms)</label>
                        <input type="number" className="w-full rounded-md border" defaultValue="10000" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-medium">Max Idle Connections</label>
                        <input type="number" className="w-full rounded-md border" defaultValue="10" />
                      </div>
                    </div>
