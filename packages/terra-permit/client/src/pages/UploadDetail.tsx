...
import { AlertCircle, ArrowLeft, CheckCircle, Clock, FileText, User, XCircle } from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex flex-col gap-2 md:flex-row md:justify-between md:items-center">
            <div>
              ...
              <CardDescription>ID: {event.id} • {new Date(event.date).toLocaleString()}</CardDescription>
            </div>
        ...
        <TabsContent value="timeline" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Chronological events related to this incident</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="actions" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Actions taken or planned to prevent future occurrences</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="logs" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed system logs from the event period</CardDescription>
            </CardHeader>
            <CardContent>
