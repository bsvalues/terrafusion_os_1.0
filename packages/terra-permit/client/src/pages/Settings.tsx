...
import { Settings as SettingsIcon, Save, Bot, ShieldCheck, Key, AlertCircle, CheckCircle } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="app-name" defaultValue="TerraFusionPermit" />
            </div>
      ...
      <TabsContent value="classification">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage how permits are classified</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <TabsContent value="ai">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure AI features and API connections</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="user-email" type="email" defaultValue="admin@example.com" />
              </div>
