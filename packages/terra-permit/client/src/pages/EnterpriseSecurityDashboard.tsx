    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Badge variant={threats?.activethreats > 0 ? "destructive" : "default"} className="text-lg px-4 py-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Progress value={systemOverview.sites.averageComplianceScore} className="h-2" />
                <div className="text-xs text-muted-foreground">
                    ...
                    <CardContent>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span>{site.population.toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Compliance:</span>
                          <Badge variant="outline">{site.complianceLevel}</Badge>
                        </div>
                        <div className="flex justify-between">
                          <span>Permits:</span>
                          <span>{site.metrics.permits}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Processing Rate:</span>
                          <span className="text-green-600">{site.metrics.processing_rate.toFixed(1)}%</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Uptime:</span>
                          <span className="text-green-600">{site.metrics.uptime.toFixed(1)}%</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold">{threats.totalThreats}</p>
                          </div>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-red-600">{threats.activethreats}</p>
                          </div>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-green-600">{threats.mitigatedThreats}</p>
                          </div>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-red-600">{threats.severityBreakdown.critical}</p>
                          </div>
                    ...
                    <Card className="border">
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-muted-foreground">Failed Rotations</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span>{systemOverview.performance.batch.pending}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Processing:</span>
                        <span>{systemOverview.performance.batch.processing}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Total Queued:</span>
                        <span>{systemOverview.performance.batch.total}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>Hit Rate:</span>
                        <span className="text-green-600">{(systemOverview.performance.cache.hitRate * 100).toFixed(1)}%</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Entries:</span>
                        <span>{systemOverview.performance.cache.entries}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Memory Usage:</span>
                        <span>{Math.round(systemOverview.performance.cache.memoryUsage / 1024)} KB</span>
                      </div>
                    </div>
                  </div>
                </div>
