...
import { HelpCircle, BookOpen, Lightbulb, LifeBuoy, FileText, Video, MessageCircle, Upload, Download, BarChart2, FileCheck } from 'lucide-react';
                  ...
                  <CardHeader className="pb-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <CardDescription>{helpContent[activeHelpTopic].description}</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                </Card>
