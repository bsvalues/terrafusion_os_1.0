    ...
    <div className={className} ref={aiDashboardRef} id="tour-ai-dashboard">
      ...
      <Tabs defaultValue="summary" className="space-y-4">
        <TabsList className="grid grid-cols-12 lg:w-fit" id="tour-ai-tabs">
          ...
          <TabsTrigger value="consistency" className="flex items-center">
            <ShieldCheck className="h-4 w-4 mr-2" /> Consistency
          </TabsTrigger>
          <TabsTrigger value="search" className="flex items-center">
            <Search className="h-4 w-4 mr-2" /> Search
          </TabsTrigger>
          <TabsTrigger value="question" className="flex items-center" ref={askAIRef} id="tour-ask-ai">
            <MessageSquareText className="h-4 w-4 mr-2" /> Ask AI
          </TabsTrigger>
          <TabsTrigger value="neighborhood" className="flex items-center">
          ...
          <TabsTrigger value="agentanalysis" className="flex items-center" ref={mcpToolRef} id="tour-mcp-tool">
          ...
          {selectedPermitId && (
            <>
              ...
              <TabsTrigger value="deepanalysis" className="flex items-center">
