      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="px-6 pt-2">
          <TabsList className="grid grid-cols-4 w-full">
            ...
            <TabsTrigger value="documents" className="text-xs" disabled={extractedDocuments.length === 0}>
              Processed Documents
            ...
            <TabsTrigger value="analytics" className="text-xs">Extraction Analytics</TabsTrigger>
          </TabsList>
        </div>
                  ...
                  <>
                    <div className="p-3 border-b bg-muted/30 flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <div className="ml-2">{getStatusBadge(selectedDocument.status)}</div>
                      </div>
                      <div className="flex items-center space-x-2">
              ...
              {extractorMetrics && (
                <div className="grid grid-cols-3 gap-4">
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold">{extractorMetrics.accuracy.toFixed(1)}%</div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="text-3xl font-bold">{extractorMetrics.automationRate.toFixed(1)}%</div>
                    <div className="text-xs text-muted-foreground mt-1">
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex justify-between items-center text-xs mb-1">
                    ...
                    <span>{extractorMetrics?.confidenceThreshold}%</span>
                  </div>
                  ...
                  <div className="flex justify-between text-[10px] text-muted-foreground">
                    ...
                    <span>Higher (Better Accuracy)</span>
                  </div>
                </div>
