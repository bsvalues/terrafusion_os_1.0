    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-sm font-medium">{metrics.enteredCount} ({metrics.enteredPercentage.toFixed(1)}%)</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-sm font-medium">{metrics.skippedCount} ({metrics.skippedPercentage.toFixed(1)}%)</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {Object.entries(categories).map(([category, count]) => (
                <div key={category} className="bg-secondary/30 rounded-md p-2 text-xs">
                  ...
                  <div className="text-muted-foreground">{count} permits</div>
                </div>
              ))}
            </div>
          </div>
        ...
        {potentialIssues.length > 0 && (
          <div>
            <h3 className="text-sm font-medium mb-2 flex items-center">
              <AlertTriangle className="h-4 w-4 mr-1 text-warning" /> Potential Issues
            </h3>
            <ul className="space-y-2">
