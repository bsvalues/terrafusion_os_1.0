                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <span className="text-sm ml-2">{selectedInstance.id}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium">Definition ID:</span>
                          <span className="text-sm ml-2">{selectedInstance.definitionId}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium">Status:</span>
                          <span className="text-sm ml-2">{getStatusBadge(selectedInstance.status)}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium">Progress:</span>
                          <span className="text-sm ml-2">{selectedInstance.progress}%</span>
                        </div>
                        <div>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <span className="text-sm ml-2">{formatTimestamp(selectedInstance.startTime)}</span>
                        </div>
                        <div>
                          <span className="text-sm font-medium">End Time:</span>
                          <span className="text-sm ml-2">{formatTimestamp(selectedInstance.endTime)}</span>
                        </div>
                        <div>
                      ...
                      <TableBody>
                        {selectedInstance.executionHistory.map((historyItem) => (
                          <TableRow key={historyItem.stepId}>
                            ...
                            <TableCell>{getStepStatusIcon(historyItem.status)}</TableCell>
                            <TableCell>{formatTimestamp(historyItem.startTime)}</TableCell>
                            <TableCell>{formatTimestamp(historyItem.endTime)}</TableCell>
                            <TableCell>
              ...
              <TableBody>
                {filteredInstances.map((instance) => (
                  <TableRow key={instance.id}>
                    ...
                    <TableCell>{formatTimestamp(instance.startTime)}</TableCell>
                    <TableCell>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button onClick={() => handleCreateInstance(selectedDefinition.id)}>
                      <PlayCircle className="h-4 w-4 mr-2" />
                      Start New Instance
                    </Button>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <span className="text-sm ml-2">{formatTimestamp(selectedDefinition.createdAt)}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium">Last Updated:</span>
                      <span className="text-sm ml-2">{formatTimestamp(selectedDefinition.updatedAt)}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium">Total Steps:</span>
                      <span className="text-sm ml-2">{selectedDefinition.steps.length}</span>
                    </div>
                  </div>
                              ...
                              <div className="space-y-1 text-sm">
                                {step.type === "agent" && step.config.agentId && (
                                  <div>
                                    ...
                                    <span className="ml-2">{step.config.agentId}</span>
                                  </div>
                                )}
                                ...
                                {step.type === "function" && step.config.functionName && (
                                  <div>
                                    ...
                                    <span className="ml-2">{step.config.functionName}</span>
                                  </div>
                                )}
                                ...
                                {step.type === "conditional" && step.config.condition && (
                                  <div>
                                    ...
                                    <span className="ml-2">{step.config.condition}</span>
                                  </div>
                                )}
                                ...
                                {step.type === "loop" && step.config.iterations !== undefined && (
                                  <div>
                                    ...
                                    <span className="ml-2">{step.config.iterations}</span>
                                  </div>
                                )}
                                
                                <div className="pt-1">
                                  <span className="font-medium">Next:</span>
                                  <span className="ml-2">{step.next || "End"}</span>
                                </div>
                                
                                <div>
                                  <span className="font-medium">Error:</span>
                                  <span className="ml-2">{step.error || "None"}</span>
                                </div>
                              </div>
                            </div>
                          </div>
