  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setIsCreatingCircuit(true)}>
                      ...
                      <div className="pt-3 mt-3 border-t">
                        <div className="grid grid-cols-2 gap-x-4 gap-y-2 mb-4">
                          <div>
                            ...
                            <span className="text-sm ml-2 font-medium">{circuit.metrics.totalRequests}</span>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Successful:</span>
                            <span className="text-sm ml-2 font-medium">{circuit.metrics.successfulRequests}</span>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Failed:</span>
                            <span className="text-sm ml-2 font-medium">{circuit.metrics.failedRequests}</span>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Timeouts:</span>
                            <span className="text-sm ml-2 font-medium">{circuit.metrics.timeouts}</span>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Avg Response Time:</span>
                            <span className="text-sm ml-2 font-medium">{circuit.metrics.averageResponseTime}ms</span>
                          </div>
                          <div>
                            <span className="text-sm text-gray-500">Last State Change:</span>
                            <span className="text-sm ml-2 font-medium">{formatTimestamp(circuit.lastStateChange)}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <Button 
