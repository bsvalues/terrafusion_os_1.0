...
import { AlertTriangle, BarChart3, PieChart as PieChartIcon, LineChart as LineChartIcon, RefreshCcw } from 'lucide-react';
 ...
 */
export function MCPEventVisualizer({ eventBus = new EventBus({ persistEvents: true }), className }: MCPEventVisualizerProps) {
