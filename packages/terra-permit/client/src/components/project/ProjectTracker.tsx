...
import { CheckCircle2, AlertCircle, Clock, XCircle, CircleSlash, Calendar, PieChart, BarChart, ExternalLink } from 'lucide-react';
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <div className="text-xs">
                                ...
                                <p>Progress: {snapshot.overallProgress}%</p>
                                <p>Completed: {snapshot.moduleCounts.completed}</p>
                                <p>In Progress: {snapshot.moduleCounts.inProgress}</p>
                              </div>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
