          ...
          <ContextualTooltip 
            content={
              <div className="space-y-1.5">
                ...
                <div className="text-xs text-blue-700 mt-1">✓ Pre-formatted columns</div>
        ...
        <Alert className="mb-6 bg-purple-50 border-purple-200">
          ...
          <AlertDescription className="text-purple-700">
            <div>
              ...
              <div className="mt-1">The system analyzes permit descriptions, values, and neighborhood codes to make smarter classification decisions.</div>
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <div className="text-xs mt-2 text-purple-600 flex items-center justify-center">
                  <Sparkles className="h-3 w-3 mr-1" />
                  <span>
                    <ContextualTooltip
                      content={
                        <div className="space-y-1.5">
                          ...
                          <ol className="list-decimal ml-4 space-y-0.5">
                            ...
                            <li>Validate property information</li>
              ...
              content={
                <div className="space-y-1.5">
                  ...
                  <ul className="list-disc ml-4 space-y-0.5">
                    ...
                    <li>Include Parcel Number for each permit entry</li>
                    <li>Provide complete address information when available</li>
                    <li>Use consistent formatting for dates and currency values</li>
                  </ul>
                </div>
              }
              width="wide"
              ...
              <ContextualTooltip
                content={
                  <div className="space-y-1.5">
                    ...
                    <ul className="list-disc ml-4 space-y-0.5">
                      <li>Permit type and value</li>
                      <li>Property location and zoning</li>
