        ...
        <ScrollArea className="h-[400px] px-1">
          <TabsContent value="overview" className="p-6 pt-4 space-y-4 m-0">
            <div>
              ...
              <p className="text-sm">{overview?.summary || 'No summary available'}</p>
            </div>
            ...
            {riskFactors && riskFactors.length > 0 && (
              <div>
                <h3 className="text-sm font-medium mb-2 flex items-center">
                  <AlertTriangle className="h-4 w-4 mr-2 text-warning" /> Risk Factors
                </h3>
                <ul className="space-y-2">
                  {riskFactors.map((risk: any, index: number) => (
                    <li key={index} className="text-sm flex bg-warning/10 p-2 rounded-md">
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground mt-1">{risk.details}</div>
                      </div>
                    </li>
                  ))}
                </ul>
                ...
                <ul className="space-y-2">
                  {recommendations.map((rec: any, index: number) => (
                    <li key={index} className="text-sm bg-primary/10 p-2 rounded-md">
                      ...
                      <div className="text-xs mt-1">{rec.rationale}</div>
                      {rec.priority && (
                        <Badge 
                          variant={
                    ...
                    <div key={index} className="border rounded-md p-3">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">{permit.description}</div>
                        </div>
                        <Badge 
