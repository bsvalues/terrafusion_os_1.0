...
function App() {
  ...
  const generateChartData = () => {
    // Generate last 24 hours of sync metrics
            ...
            <div key={source.id} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center">
                  {source.type === 'postgresql' && <Server className="h-5 w-5 text-blue-600 mr-2" />}
                ...
                <div className={`connection-indicator ${source.status}`}>
                  {source.status === 'connected' && <Wifi className="h-4 w-4 text-green-600" />}
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Refresh className="h-8 w-8 text-blue-600 mr-3 sync-pulse" />
              <div><>
