...
function App() {
  ...
  const handleProcessPayment = async (recordId: string, amount: number) => {
    try {
  ...
  const handleSendNotice = async (recordId: string, noticeType: string) => {
    try {
...
className="tf-button-primary" onClick={() => setActiveTab('collections')}>
                  ...
                  <button className="tf-button-primary" onClick={() => setActiveTab('notices')}>
                    📧 Send Notices
                  </button>
                  <button
</>
...
className="penalty">{formatCurrency(record.penalty_amount)}</span>
        ...
        {activeTab === 'collections' && (
          <div className="collections-panel">
            ...
            {selectedRecord ? (
              <div className="tf-card payment-form"><>
...
className="tf-button-primary full-width">
                  ...
                  <button className="tf-button-primary full-width">
                    📅 Setup Payment Plan
                  </button>
                  <button
</>
className="tf-button-primary full-width">
              ...
              <div className="empty-state">
                <p>Select a tax record from the Records tab to process payment</p>
              </div>
            )}
...
className={`status-badge ${plan.status}`}>
                  ...
                  <div className="plan-progress">
                    ...
                    <span className="progress-text">3 of 12 payments made</span>
                  </div>
                </div>
              ))}
            </div>
