  ...
  return (
    <div className="dashboard-container">
            ...
            <svg width="40" height="40" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="tfGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" style={{ stopColor: 'var(--tf-primary)', stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: 'var(--tf-accent)', stopOpacity: 1 }} />
                </linearGradient>
              </defs>
              <path d="M50 10 L85 30 L85 70 L50 90 L15 70 L15 30 Z" fill="url(#tfGradient)" />
              <text x="50" y="58" fontSize="28" fontWeight="bold" fill="white" textAnchor="middle">TF</text>
            </svg>
          </div>
          <h1 className="tf-gradient-text">Terrafusion Control Center</h1>
        </div>
      ...
      <div className="dashboard-grid">
        <section className="metrics-panel tf-card"><>
...
className="metric-value network-status" style={{ color: systemMetrics.network_status === 'connected' ? '#00ff00' : '#ff0000' }}>
        ...
        <section className="apps-panel tf-card">
          <h2>Application Status <span className="apps-counter">({runningApps}/{totalApps} Running)</span></h2>
...
className="app-status" style={{ color: getStatusColor(app.status) }}>
        ...
        <section className="controls-panel tf-card"><>
...
className="control-btn stop-all" onClick={async () => {
            ...
            <button className="control-btn restart-all" onClick={async () => {
              try {
...
className="log-entry">[INFO] System: Memory optimization completed</div>
        ...
        {selectedApp && (
          <section className="app-details-panel tf-card"><>
