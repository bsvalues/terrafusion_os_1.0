...
export class AssessorWorkflowEngine {
  ...
  public async createWorkflowDefinition(
    ...
    try {
      ...
      logger.error(`Error creating workflow definition: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
   ...
   */
  public async getAllWorkflowDefinitions(activeOnly: boolean = false): Promise<WorkflowDefinition[]> {
    try {
      const workflows = await this.storage.getAllWorkflowDefinitions();
      return activeOnly ? workflows.filter(wf => wf.isActive) : workflows;
    } catch (error) {
      logger.error(`Error getting workflow definitions: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getWorkflowDefinitionById(definitionId: string): Promise<WorkflowDefinition | null> {
    try {
      ...
      logger.error(`Error getting workflow definition ${definitionId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async updateWorkflowDefinition(
    ...
    try {
      ...
      logger.error(`Error updating workflow definition ${definitionId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
   ...
   */
  public async deleteWorkflowDefinition(definitionId: string, deactivateOnly: boolean = true): Promise<boolean> {
    try {
      if (deactivateOnly) {
      ...
      logger.error(`Error deleting workflow definition ${definitionId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getWorkflowInstances(options?: WorkflowFilterOptions): Promise<WorkflowInstance[]> {
    try {
      ...
      logger.error(`Error getting workflow instances: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getWorkflowInstanceById(instanceId: string): Promise<WorkflowInstance | null> {
    try {
      ...
      logger.error(`Error getting workflow instance ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async updateWorkflowInstance(
    ...
    try {
      ...
      logger.error(`Error updating workflow instance ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async startWorkflowExecution(
    ...
    try {
      ...
      logger.error(`Error starting workflow execution ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
    ...
    try {
      ...
      if (transitionId) {
        ...
        for (const transition of currentStep.nextSteps) {
          if (!transition.condition || this.evaluateCondition(transition.condition, instance, stepData)) {
            nextStepId = transition.targetStepId;
            break;
          }
        }
      ...
      logger.error(`Error completing workflow step for ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
   ...
   */
  public async validateWorkflowStep(
    instanceId: string
    ...
    try {
      ...
      for (const validation of currentStep.validations) {
        ...
        if (!entity) {
          logger.warn(`Entity not found for validation: ${instance.entityType}/${instance.entityId}`);
          continue;
        }
      ...
      logger.error(`Error validating workflow step for ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async reassignWorkflow(
    ...
    try {
      ...
      logger.error(`Error reassigning workflow ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async cancelWorkflow(
    ...
    try {
      ...
      logger.error(`Error canceling workflow ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getWorkflowHistory(instanceId: string): Promise<WorkflowStepHistory[]> {
    try {
      ...
      logger.error(`Error getting workflow history for ${instanceId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getOverdueWorkflows(): Promise<WorkflowInstance[]> {
    try {
      ...
      return activeWorkflows.filter(wf => 
        wf.dueDate && new Date(wf.dueDate) < now
      );
    } catch (error) {
      logger.error(`Error getting overdue workflows: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async getUserTasks(userId: number): Promise<WorkflowInstance[]> {
    try {
      ...
      logger.error(`Error getting tasks for user ${userId}: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async createPropertyReassessmentWorkflow(createdBy?: number): Promise<WorkflowDefinition> {
    try {
      ...
      logger.error(`Error creating property reassessment workflow: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async createNewConstructionWorkflow(createdBy?: number): Promise<WorkflowDefinition> {
    try {
      ...
      logger.error(`Error creating new construction workflow: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async createAppealProcessingWorkflow(createdBy?: number): Promise<WorkflowDefinition> {
    try {
      ...
      logger.error(`Error creating appeal processing workflow: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  public async createDataQualityWorkflow(createdBy?: number): Promise<WorkflowDefinition> {
    try {
      ...
      logger.error(`Error creating data quality workflow: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
  ...
  private parseWorkflowSteps(stepsJson: any): WorkflowStep[] {
    try {
      ...
      logger.error(`Error parsing workflow steps: ${error instanceof Error ? error.message : String(error)}`);
      return [];
    }
  }
  ...
  private async updateStepStatus(
    ...
    try {
      ...
      logger.error(`Error updating step status: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
   ...
   */
  public async createWashingtonCompliantWorkflows(createdBy?: number): Promise<WorkflowDefinition[]> {
    ...
    try {
      ...
      logger.error(`Error creating Washington compliant workflows: ${error instanceof Error ? error.message : String(error)}`);
      throw error;
    }
  }
}