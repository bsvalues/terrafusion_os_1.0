...
import { z } from 'zod';
import { voiceCommandProcessor, CommandContext } from '../services/voice-command/voice-command-processor';
...
router.post('/process', async (req, res) => {
  try {
    ...
    const { command, userId, sessionId = randomUUID(), contextId, deviceInfo } = validationResult.data;
...
router.post('/process-audio', async (req, res) => {
  try {
    ...
    const { audio, userId, sessionId = randomUUID(), contextId, deviceInfo } = validationResult.data;
