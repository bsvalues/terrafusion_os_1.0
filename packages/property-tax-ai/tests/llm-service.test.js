...
const runLLMServiceTests = async () => {
  ...
  allPassed = await test('LLM Service initializes with default configuration', async () => {
  ...
  allPassed = await test('LLM Service can update configuration', async () => {
    const llmService = new LLMService();
  ...
  allPassed = await test('Property trend analysis request format is valid', async () => {
    const llmService = new LLMService();
