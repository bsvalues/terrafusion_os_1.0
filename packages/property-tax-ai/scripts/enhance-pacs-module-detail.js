...
async function enhancePacsModuleDetail(moduleId) {
  ...
  try {
    ...
    try {
      ...
      const moduleResult = await client.query('SELECT * FROM pacs_modules WHERE id = $1', [moduleId]);
      ...
      console.log(`Enhancing module: ${module.module_name} (Category: ${module.category || 'N/A'})`);
