...
console.log('================================');
console.log('');
console.log('🌐 Starting diagnostic server on port \${{TF_ADMIN_PORT:-8080}}');
console.log('📍 URL: http://localhost:\${{TF_ADMIN_PORT:-8080}}');
console.log('');
...
server.listen(8081, () => {
  console.log('🚀 Diagnostic server ready on port \${{TF_ADMIN_PORT:-8080}} - check browser console for real errors!');
  console.log('🌐 URL: http://localhost:\${{TF_ADMIN_PORT:-8080}}');
});
