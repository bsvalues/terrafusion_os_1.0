...
var TemporalOptimizer = (function() {
    ...
    function generateBaselinePolicies() {
        return [
            ...
            { id: 4, name: "Environmental Transcendence Protocol", impact: 96.2, temporalStability: 87.3 },
            { id: 5, name: "Democratic Consciousness Enhancement", impact: 82.6, temporalStability: 91.8 }
        ];
    }
    ...
    function calculateCausalityImpact(policy, year) {
        ...
        return {
            ...
            totalCausalityImpact: (baseImpact * timeDecay) + (baseImpact * cascadeMultiplier * 0.3) + (baseImpact * year * 0.1)
        };
    }
