...
const DATA_SOURCES = {
  'king-wa': {
    ...
    apiEndpoint:
      'https://gis-kingcounty.opendata.arcgis.com/datasets/parcels-for-king-county-with-address-with-property-information-parcel-address-area.geojson',
    format: 'geojson',
    ...
    return {
      ...
      details: {
        ...
        marketTrends: {
          ...
          seasonalityFactors: Array(12)
            .fill(0)
            .map(() => Math.random() * 0.4 + 0.8),
        },
        riskAssessment: {
      ...
      'king-wa': {
        ...
        details: {
          ...
          marketTrends: {
            ...
            seasonalityFactors: [
              0.85, 0.89, 0.95, 1.05, 1.15, 1.12, 1.08, 1.02, 0.98, 0.92, 0.88, 0.82,
            ],
          },
          riskAssessment: {
      ...
      'miami-dade-fl': {
        ...
        details: {
          ...
          marketTrends: {
            ...
            seasonalityFactors: [
              0.92, 0.88, 0.95, 1.05, 1.12, 1.08, 0.98, 0.94, 1.02, 1.15, 1.18, 1.05,
            ],
          },
          riskAssessment: {
      ...
      'harris-tx': {
        ...
        details: {
          ...
          marketTrends: {
            ...
            seasonalityFactors: [
              0.88, 0.91, 0.97, 1.08, 1.12, 1.15, 1.09, 1.05, 1.02, 0.96, 0.89, 0.86,
            ],
          },
          riskAssessment: {
