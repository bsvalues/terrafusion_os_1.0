...
class TerraLevy {
  ...
  bindEvents() {
    ...
    // Optimization
    document
      .getElementById('run-optimization')
    ...
    // Scenario creation
    document
      .getElementById('create-scenario')
      .addEventListener('click', () => this.createScenario());
    ...
    document
      .getElementById('export-analysis')
      .addEventListener('click', () => this.exportAnalysis());
    document
      .getElementById('schedule-consultation')
      .addEventListener('click', () => this.scheduleConsultation());
  }
  ...
  async analyzeTaxes() {
    ...
    // Update UI
    document.getElementById('current-tax').textContent =
