...
const BrandKit: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <ul className='flex'>
          {['brand', 'colors', 'typography', 'modules'].map((section) => (
            <li key={section}>
              <button
      ...
      >
        ...
        {activeSection === 'brand' && (
          <section>
            <h2 className='text-center'>Brand Identity</h2>
            ...
            >
              <div className='p-8'>
                ...
                >
                  Terrafusion transcends traditional government technology. We transform complexity
              ...
              <div className='p-8'>
                ...
                >
                  To revolutionize government operations through transcendent technology. We empower
              ...
              <div className='p-8'>
                ...
                >
                  <strong>Precision:</strong> We do it right the first time.
                  <br />
                  <strong>Speed:</strong> 379 million times faster.
                  <br />
                  <strong>Clarity:</strong> Complex made simple.
                  <br />
        ...
        {activeSection === 'colors' && (
          <section>
            <h2 className='text-center'>Color System</h2>
        ...
        {activeSection === 'modules' && (
          <section>
            <h2 className='text-center'>Module Ecosystem</h2>
            ...
            >
              {modules.map((module, index) => (
                ...
                >
                  ...
                  <div className='text-sm'>{module.tagline}</div>
                </div>
              ))}
            </div>
          </section>
