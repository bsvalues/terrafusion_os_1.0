      ...
      >
        ...
        <div className='flex items-center gap-2'>
          ...
          <button
            ...
            className='rounded-full border border-fuchsia-500/50 bg-fuchsia-500/10 px-1.5 py-0.5 text-[0.55rem] text-fuchsia-300 transition-all hover:bg-fuchsia-500/20 hover:shadow-[0_0_8px_hsl(var(--tf-info)_/_0.3)]'
