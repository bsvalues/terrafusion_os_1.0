...
import { File, FileText, Image, MessageCircle, Video } from 'lucide-react';
          ...
          {Array.from({ length: 30 }).map((_, i) => (
            <div key={i}>
              <div className='text-sm py-1'>
                This is row {i + 1} with content that extends beyond the visible width of the
                container to demonstrate horizontal scrolling capabilities in addition to vertical
                scrolling.
              </div>
  ...
  render: () => {
    const messages = [
      ...
      },
      {
        ...
        user: 'Charlie',
        avatar: 'C',
        message: 'Nice work! Can you share them?',
        time: '10:33 AM',
      },
      {
        id: 4,
        user: 'Alice',
        avatar: 'A',
        message: "I'll review them this afternoon.",
        time: '10:35 AM',
      },
      {
        id: 5,
      ...
      },
      {
        ...
        user: 'Bob',
        avatar: 'B',
        message: 'Already added to my calendar!',
        time: '10:42 AM',
      },
      {
        id: 7,
        user: 'Charlie',
        avatar: 'C',
        message: 'Same here. See you all then!',
        time: '10:43 AM',
      },
      {
        id: 8,
      ...
      },
      {
        ...
        user: 'Charlie',
        avatar: 'C',
        message: 'This is going to be a great presentation!',
        time: '10:55 AM',
      },
      {
        id: 12,
        user: 'Alice',
        avatar: 'A',
        message: 'Definitely! Team effort always wins.',
        time: '11:00 AM',
      },
    ];
      ...
      <div>
        ...
        <ul className='space-y-2'>
          <li className='flex gap-2'>
            ...
            <span>
              Use ScrollArea for content that may overflow and needs custom scrollbar styling
            </span>
          </li>
          <li className='flex gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
          ...
          <li className='flex gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Use horizontal ScrollArea for wide content like image galleries or timelines
            </span>
          </li>
          <li className='flex gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
    ...
    {items.map((item) => (
      ...
      <div className='border-l-4 border-blue-500 bg-blue-50 p-4 rounded'>
        ...
        <ul className='space-y-2 text-sm'>
          <li>
            <strong>Keyboard Support:</strong> ScrollArea is fully keyboard accessible with arrow
            keys, Page Up/Down, Home, and End
          </li>
          <li>
            <strong>Focus Management:</strong> Focusable elements within ScrollArea maintain proper
            focus order
          </li>
          <li>
            <strong>Screen Readers:</strong> Content remains accessible to screen readers regardless
            of scroll position
          </li>
          <li>
            <strong>Touch Devices:</strong> Native smooth scrolling behavior on mobile and tablet
            devices
          </li>
          <li>
            <strong>Visual Indicators:</strong> Scrollbar visibility provides clear indication of
            scrollable content
          </li>
        </ul>
      </div>
    ...
    <div className='space-y-6 max-w-4xl'>
      <div>
        ...
        <p className='text-muted-foreground mb-4'>
          WCAG 2.1 AAA compliant scrolling with keyboard navigation.
        </p>
      </div>
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <p className='text-sm text-muted-foreground'>
          Tab to focus, Arrow keys to scroll, Page Up/Down for faster navigation
        </p>
        <ScrollArea className='h-48 rounded border' tabIndex={0}>
          <div className='p-4 space-y-4'>
            {Array.from({ length: 20 }).map((_, i) => (
              <div key={i} className='text-sm'>
                Line {i + 1}: Focus and use arrow keys to scroll through content
              </div>
            ))}
          </div>
        </ScrollArea>
          ...
          <ScrollArea className='w-48 rounded border'>
            <div className='p-4 space-y-2'>
              {[
                ...
                <div key={i} className='text-sm p-2 rounded hover:bg-muted cursor-pointer'>
                  {item}
                </div>
              ))}
            </div>
        ...
        <div className='flex rounded border overflow-hidden'>
          ...
          <ScrollArea className='flex-1'>
            <pre className='p-4 text-xs font-mono space-y-1'>
              {Array.from({ length: 50 }).map((_, i) => (
                <div key={i}>const line{i + 1} = "code here";</div>
              ))}
            </pre>
          </ScrollArea>
        </div>
