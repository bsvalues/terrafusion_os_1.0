...
export const RequiredField: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Labels with required field indicators. Both visual (*) and programmatic (aria-required) indicators.',
      },
    },
  },
};
...
export const DisabledState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Labels automatically styled when associated form controls are disabled via peer-disabled classes.',
      },
    },
  },
};
...
export const ErrorState: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Error state with red labels, border styling, and error messages using aria-invalid and role="alert".',
      },
    },
  },
};
...
export const FormControlTypes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Labels associated with various form control types: input, checkbox, radio, and switch.',
      },
    },
  },
};
...
export const RealWorldForm: Story = {
    ...
    <form className='space-y-6 w-full max-w-md p-6 border rounded-lg'>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid gap-1.5'>
          ...
          <Input id='signup-name' required aria-required='true' placeholder='John Doe' />
        </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Complete signup form demonstrating label best practices: required indicators, descriptions, optional fields, and proper associations.',
      },
    },
  },
};
...
export const AllVariants: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Complete overview of all label variants including sizes, states, indicators, weights, and colors.',
      },
    },
  },
};
...
export const Interactive: Story = {
    ...
    return (
      <div className='space-y-8 w-full max-w-2xl'>
        <div>
          ...
          {clickedLabel && (
            <p className='mt-4 text-sm text-muted-foreground'>Last clicked label: {clickedLabel}</p>
          )}
        </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Interactive label behaviors including click-to-focus, hover states, and disabled interactions.',
      },
    },
  },
};
...
export const Performance: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Performance testing with 100+ labels and complex forms. Demonstrates efficient rendering and scalability.',
      },
    },
  },
};
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Visual and programmatic indicators</p>
          </div>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Guide users with clear instructions</p>
          </div>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <div className='text-sm space-y-1'>
              ...
              <Input id='good-input-4' aria-invalid='true' className='border-destructive' />
              <p className='text-xs text-destructive' role='alert'>
                Invalid email format
              </p>
            </div>
            <p className='text-sm text-muted-foreground'>Clear error messages with proper ARIA</p>
          </div>
        </div>
      </div>
...
<div className="grid gap-1.5">
      ...
      <div className='space-y-4'>
        ...
        <ul className='space-y-2'>
          <li className='flex items-start gap-2'>
            ...
            <span>
              Always use <code className='bg-muted px-1 rounded'>htmlFor</code> attribute matching
              the input's <code className='bg-muted px-1 rounded'>id</code>
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
          ...
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Use <code className='bg-muted px-1 rounded'>aria-required="true"</code> for required
              fields (not just visual indicator)
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Use <code className='bg-muted px-1 rounded'>aria-describedby</code> to associate
              helper text with inputs
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Use <code className='bg-muted px-1 rounded'>aria-invalid="true"</code> for error
              states
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Error messages should have <code className='bg-muted px-1 rounded'>role="alert"</code>
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <span>
              Labels automatically styled when associated control is disabled (peer-disabled)
            </span>
          </li>
          <li className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Comprehensive guidelines with best practices, code examples, and accessibility patterns.',
      },
    },
  },
};
