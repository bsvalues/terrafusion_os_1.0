...
export const AllVariants: Story = {
      ...
      <div className='flex flex-wrap items-center gap-6'>
        <div className='space-y-3 text-center'>
          ...
          <div className='space-y-1'>
            ...
            <p className='text-xs text-slate-500'>{pressedDefault ? 'Pressed' : 'Unpressed'}</p>
          </div>
        </div>
        ...
        <div className='space-y-3 text-center'>
          ...
          <div className='space-y-1'>
            ...
            <p className='text-xs text-slate-500'>{pressedOutline ? 'Pressed' : 'Unpressed'}</p>
          </div>
        </div>
      </div>
    );
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Visual comparison of all available variants. Default variant has filled background when pressed, outline variant has bordered style.',
      },
    },
  },
};
...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Size variants for different UI contexts. All sizes maintain 44x44px minimum touch target for accessibility.',
      },
    },
  },
};
...
export const WithIcons: Story = {
      ...
      <div className='space-y-8'>
        <div className='space-y-3'>
          ...
          <p className='text-xs text-slate-600'>
            Always include <code className='rounded bg-slate-100 px-1'>aria-label</code> for
            accessibility
          </p>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Icon integration patterns with proper sizing (lucide-react 16px default) and spacing.',
      },
    },
  },
};
  ...
  render: () => {
    ...
    return (
      <div className='space-y-8 rounded-lg border-2 border-blue-200 bg-blue-50 p-6'>
        <div className='space-y-2'>
          <h3 className='text-lg font-semibold text-blue-900'>♿ Accessibility Test Suite</h3>
          <p className='text-sm text-blue-800'>
            These toggles demonstrate WCAG 2.1 AAA compliance with proper ARIA attributes, keyboard
        ...
        <div className='space-y-6 rounded-lg border border-blue-300 bg-white p-4'>
          <div className='space-y-3'>
            ...
            <div className='flex items-center gap-2'>
              ...
              >
                {notification ? <Bell className='h-4 w-4' /> : <BellOff className='h-4 w-4' />}
              </Toggle>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <span className='text-sm text-slate-700'>aria-pressed="{String(visibility)}"</span>
            </div>
            <p className='text-xs text-slate-600'>
              Screen readers announce: "Toggle visibility, button,{' '}
              {visibility ? 'pressed' : 'not pressed'}"
            </p>
          </div>
          ...
          <div className='space-y-3'>
            ...
            <div className='rounded bg-slate-50 p-3 text-xs font-mono text-slate-700'>
              <div>
                • <strong>Tab:</strong> Focus toggle
              </div>
              <div>
                • <strong>Enter/Space:</strong> Toggle state
              </div>
              <div>
                • <strong>Shift+Tab:</strong> Focus previous
              </div>
            </div>
          </div>
        ...
        <div className='space-y-2 rounded-lg bg-blue-100 p-4'>
          <h4 className='text-sm font-semibold text-blue-900'>✅ Accessibility Checklist</h4>
...
export const EdgeCases: Story = {
    ...
    return (
      <div className='space-y-6'>
        <div className='space-y-2'>
          ...
          <p className='text-xs text-slate-600'>Still functional, requires aria-label</p>
        </div>
        ...
        <div className='space-y-2'>
          ...
          <div className='max-w-xs'>
            <Toggle pressed={false} onPressedChange={() => {}}>
              This is an extremely long toggle label that tests text overflow and wrapping behavior
              when content exceeds expected width
            </Toggle>
          </div>
          <p className='text-xs text-slate-600'>Text wraps naturally, maintains readability</p>
        </div>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-xs text-slate-600'>React escapes dangerous characters automatically</p>
        </div>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-xs text-slate-600'>Right-to-left text rendering supported</p>
        </div>
        ...
        <div className='space-y-2'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <span className='text-sm text-slate-700'>Toggles: {toggleCount}</span>
          </div>
          <p className='text-xs text-slate-600'>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Edge cases ensure component robustness. All edge cases gracefully degrade or provide clear feedback.',
      },
    },
  },
};
          ...
          <div className='w-[768px] rounded-lg border border-slate-200 bg-slate-50 p-4'>
            <div className='flex items-center justify-between'>
              ...
              <Toggle
                ...
                aria-label='Enable notifications'
              >
                {tabletPressed ? <Bell className='h-4 w-4' /> : <BellOff className='h-4 w-4' />}
              </Toggle>
            </div>
          </div>
          <p className='text-xs text-slate-600'>
        ...
        <div className='space-y-3'>
          ...
          <div className='w-[1200px] rounded-lg border border-slate-200 bg-slate-50 p-4'>
            <div className='flex items-center gap-2'>
              ...
              <Toggle size='sm' pressed={false} onPressedChange={() => {}} aria-label='Toggle bold'>
                <Bold className='h-3 w-3' />
              </Toggle>
              <Toggle
                size='sm'
...
export const CompositionPatterns: Story = {
    ...
    return (
      <div className='space-y-8'>
        <div className='space-y-3'>
          ...
          <p className='text-xs text-slate-600'>Grouped toggles in contained toolbar</p>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <p className='text-xs text-slate-600'>Mutually exclusive toggles (only one active)</p>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <div className='w-full max-w-md space-y-3 rounded-lg border border-slate-200 bg-white p-4'>
            <div className='flex items-center justify-between'>
              ...
              <Toggle
                ...
                onPressedChange={(pressed) => setSettings({ ...settings, notifications: pressed })}
                aria-label='Enable notifications'
              >
            ...
            <div className='flex items-center justify-between'>
              ...
              <Toggle
                ...
                onPressedChange={(pressed) => setSettings({ ...settings, autoSave: pressed })}
            ...
            <div className='flex items-center justify-between'>
              ...
              <Toggle
                ...
                onPressedChange={(pressed) => setSettings({ ...settings, darkMode: pressed })}
          ...
          <p className='text-xs text-slate-600'>Toggles with descriptive labels and icons</p>
        </div>
      </div>
    );
  },
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Common composition patterns showing Toggle used with other design system components.',
      },
    },
  },
};
...
export const Performance: Story = {
  render: () => {
    ...
    const [states, setStates] = React.useState<boolean[]>(Array.from({ length: 100 }, () => false));
      ...
      <div className='space-y-6'>
        <div className='rounded-lg border border-blue-200 bg-blue-50 p-4'>
          <div className='space-y-2 text-sm'>
            ...
            <p>
              <span className='font-semibold'>Active:</span> {states.filter(Boolean).length} / 100
            </p>
          </div>
        </div>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Performance test with 100 component instances. Render time should be <100ms on modern hardware.',
      },
    },
  },
};
