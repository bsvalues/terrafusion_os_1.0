...
export const RealWorldExamples: Story = {
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <div className='flex items-center justify-between py-3 border-b'>
          <div className='space-y-1'>
            ...
            <p className='text-sm text-muted-foreground'>Load images in HD (uses more data)</p>
          </div>
        ...
        <div className='flex items-center justify-between py-3'>
          <div className='space-y-1'>
            ...
            <p className='text-sm text-muted-foreground'>Display captions on videos by default</p>
          </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Real-world switch patterns: account settings, device features, preferences, and accessibility.',
      },
    },
  },
};
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Switch takes effect immediately</p>
          </div>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Use checkbox for form submissions</p>
          </div>
          ...
          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Label should describe the feature</p>
          </div>
          ...
          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Use checkboxes for selecting items</p>
          </div>
        ...
        <div className='space-y-3 text-sm'>
          <div className='flex items-start gap-2'>
            ...
            <div>
              ...
              <p className='text-muted-foreground'>
                When a switch is toggled, show the result immediately (e.g., theme changes
                instantly)
              </p>
            </div>
          </div>
...
export const AccessibilityTest: Story = {
      ...
      <div className='space-y-8 max-w-4xl'>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-xs text-muted-foreground mt-4'>
            Screen readers announce: "Enable notifications, switch, off" (changes to "on" when
            toggled).
          </p>
        </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'WCAG 2.1 AAA accessibility compliance: keyboard navigation (Space/Enter), screen readers (role="switch"), focus indicators, high contrast, label association, disabled state, and ARIA attributes.',
      },
    },
  },
};
...
export const EdgeCases: Story = {
      ...
      <div className='space-y-8 max-w-4xl'>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex items-start justify-between max-w-2xl'>
            <div className='space-y-1 flex-1 mr-4'>
              <Label htmlFor='long1'>
                This is an extremely long label that demonstrates how the switch component handles
                multi-line text content. The switch should remain aligned properly while the label
                text wraps naturally to multiple lines without breaking the layout. This is
                important for settings panels with detailed explanations.
              </Label>
            </div>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center justify-between max-w-md'>
              <div className='space-y-1'>
                <Label htmlFor='async2' className='text-red-600'>
                  Failed to toggle
                </Label>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Edge cases: long labels, special characters, no labels, rapid toggling, loading/async states, tight layouts, large lists (50 switches), form integration, dynamic enable/disable, and default state variations.',
      },
    },
  },
};
...
export const Responsive: Story = {
  render: () => (
    <div className='space-y-8 max-w-4xl'>
      ...
      <div className='space-y-4'>
        ...
        <p className='text-sm text-muted-foreground mb-4'>1 column mobile, 2 columns desktop.</p>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Responsive behavior: touch-optimized spacing (44px targets), responsive labels, mobile settings panels, responsive grids, scrollable lists, stacked layouts, and mobile best practices.',
      },
    },
  },
};
...
export const CompositionPatterns: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Composition patterns: settings panels (appearance, notifications), privacy controls, feature toggles, accessibility settings, quick settings cards, and notification preferences.',
      },
    },
  },
};
        ...
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            <div className='border rounded-lg p-4'>
              ...
              <div className='mt-2 text-xs text-muted-foreground'>Minimal footprint per switch</div>
            </div>
            ...
            <div className='border rounded-lg p-4'>
              ...
              <div className='mt-2 text-xs text-muted-foreground'>Smooth 60fps transition</div>
            </div>
          </div>
        </div>
          ...
          <div className='space-y-3'>
            <div className='border rounded-lg p-4'>
              <h4 className='font-medium text-green-600 mb-2'>
                ✓ Do: Use controlled state for immediate actions
              </h4>
...
/>`}</code>
            ...
            <div className='border rounded-lg p-4'>
              <h4 className='font-medium text-green-600 mb-2'>
                ✓ Do: Debounce API calls if needed
              </h4>
              <pre className='bg-muted p-3 rounded text-xs overflow-x-auto'>
...
/>`}</code>
            ...
            <div className='border rounded-lg p-4'>
              <h4 className='font-medium text-green-600 mb-2'>
                ✓ Do: Use defaultChecked for simple cases
              </h4>
              <pre className='bg-muted p-3 rounded text-xs overflow-x-auto'>
                <code>{`<Switch
  id="notifications"
...
/>`}</code>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Performance characteristics: bundle size (~1 KB), toggle time (&lt;5ms), animation (16ms 60fps), large list testing (100 switches), state management, memory efficiency, accessibility performance, and best practices.',
      },
    },
  },
};
