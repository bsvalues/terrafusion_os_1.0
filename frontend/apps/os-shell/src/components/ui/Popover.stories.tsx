...
import { Calendar, HelpCircle, Info, Settings, Share2, Trash2, User } from 'lucide-react';
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A versatile overlay component for displaying rich contextual content anchored to a trigger element with smart positioning and animations.',
      },
    },
  },
  tags: ['autodocs'],
          ...
          <PopoverContent>
            <div className='space-y-3'>
              <div className='space-y-2'>
                ...
                <p className='text-sm text-muted-foreground'>Adjust common preferences.</p>
              </div>
              <div className='space-y-2'>
        ...
        <Popover>
          ...
          <PopoverContent className='w-60'>
            <div className='space-y-2'>
              ...
              <p className='text-sm text-muted-foreground'>Brief information or single action.</p>
              <Button size='sm' className='w-full'>
                Action
              </Button>
            </div>
    ...
    <div className='space-y-8 max-w-4xl p-6'>
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <Popover>
          ...
          <PopoverContent>
            <p className='text-sm'>
              Press Escape to close. Tab to navigate interactive elements inside.
            </p>
          </PopoverContent>
        </Popover>
        <p className='text-xs text-muted-foreground'>
          ✓ Enter/Space opens • Esc closes • Tab navigates content • Focus trap enabled
        </p>
      </div>
        ...
        <Popover>
          ...
          <PopoverContent>
            <div className='space-y-2 text-sm'>
              <p>
                • <code>role="dialog"</code> on popover content
              </p>
              <p>
                • <code>aria-expanded</code> reflects state
              </p>
              <p>
                • <code>aria-haspopup</code> on trigger
              </p>
