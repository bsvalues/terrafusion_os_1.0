...
describe('AspectRatio', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('handles empty children gracefully', () => {
      const { container } = render(<AspectRatio ratio={16 / 9}>{null}</AspectRatio>);
      expect(container.firstChild).toBeInTheDocument();
    });
    it('handles undefined children', () => {
      const { container } = render(<AspectRatio ratio={16 / 9}>{undefined}</AspectRatio>);
      expect(container.firstChild).toBeInTheDocument();
    });
