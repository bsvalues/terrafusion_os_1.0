          ...
          <div className='max-w-fit'>
            ...
            {range?.from && (
              <div className='text-sm text-muted-foreground mt-4 space-y-1'>
                <p>
                  From: <strong>{format(range.from, 'PPP')}</strong>
                </p>
                {range.to && (
                  <p>
                    To: <strong>{format(range.to, 'PPP')}</strong>
                  </p>
                )}
                {range.to && (
        ...
        <div className='space-y-8'>
          ...
          <div>
            ...
            <div className='flex gap-6 flex-wrap'>
              ...
              />
              <div>
                <p className='text-sm text-muted-foreground mb-2'>Holidays are disabled:</p>
          ...
          <div className='max-w-2xl bg-muted rounded-lg p-4'>
            ...
            <ul className='text-sm text-muted-foreground space-y-1 list-disc list-inside'>
              <li>
                <strong>Past dates:</strong> Booking systems, future planning
              </li>
              <li>
                <strong>Weekends:</strong> Business day selection
              </li>
              <li>
                <strong>Holidays:</strong> Service availability, office scheduling
              </li>
              <li>
                <strong>Specific dates:</strong> Blackout dates, maintenance windows
              </li>
            </ul>
          </div>
        </div>
      ...
      return (
        <div className='space-y-8'>
          <div>
            ...
            <div className='flex gap-6 flex-wrap'>
              ...
              <div>
                ...
                <p className='text-xs text-muted-foreground'>From: {format(today, 'MMM d')}</p>
          ...
          <div className='max-w-2xl bg-muted rounded-lg p-4'>
            ...
            <ul className='text-sm text-muted-foreground space-y-1 list-disc list-inside'>
              <li>
                <strong>Short-term booking:</strong> Same-day or next-week only
              </li>
              <li>
                <strong>Promotion periods:</strong> Limited-time offers
              </li>
              <li>
                <strong>Expiration dates:</strong> Cards, subscriptions
              </li>
              <li>
                <strong>Historical data:</strong> Report date ranges
              </li>
            </ul>
          </div>
        </div>
      ...
      return (
        <div className='space-y-8'>
          ...
          <div className='max-w-2xl bg-muted rounded-lg p-4'>
            ...
            <ul className='text-sm text-muted-foreground space-y-1 list-disc list-inside'>
              <li>
                <strong>Full (PPP):</strong> User-facing displays
              </li>
              <li>
                <strong>ISO (yyyy-MM-dd):</strong> API, database storage
              </li>
              <li>
                <strong>Short (P):</strong> Tables, compact displays
              </li>
              <li>
                <strong>Long:</strong> Confirmation screens, important dates
              </li>
            </ul>
          </div>
        </div>
...
export const BookingExample: Story = {
          ...
          <form onSubmit={handleSubmit} className='space-y-6 border rounded-lg p-6'>
            ...
            {submitted && (
              <div className='bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-md p-3 text-sm text-green-800 dark:text-green-200'>
                ✓ Booking confirmed! Check-in: {checkIn && format(checkIn, 'MMM d')}, Check-out:{' '}
                {checkOut && format(checkOut, 'MMM d')}, Guests: {guests}, Total: ${total}
              </div>
            )}
          </form>
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Complete hotel booking example with check-in/check-out dates, guest selection, and price calculation.',
      },
    },
  },
};
...
export const AccessibilityTest: Story = {
      ...
      return (
        <div className='space-y-8 w-full max-w-4xl'>
            ...
            <div className='flex gap-6 flex-wrap'>
              ...
              <div className='space-y-2'>
                ...
                <ul className='text-sm text-muted-foreground space-y-1'>
                  <li>
                    • <kbd className='bg-muted px-2 py-1 rounded'>Arrow keys</kbd> - Navigate dates
                  </li>
                  <li>
                    • <kbd className='bg-muted px-2 py-1 rounded'>Enter/Space</kbd> - Select date
                  </li>
                  <li>
                    • <kbd className='bg-muted px-2 py-1 rounded'>Page Up/Down</kbd> - Change month
                  </li>
                  <li>
                    • <kbd className='bg-muted px-2 py-1 rounded'>Home/End</kbd> - Week start/end
                  </li>
                  <li>
                    • <kbd className='bg-muted px-2 py-1 rounded'>Tab</kbd> - Navigate controls
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className='p-4 bg-blue-50 dark:bg-blue-950 rounded-lg'>
            ...
            <ul className='space-y-1 text-sm'>
              <li className='flex items-start gap-2'>
                ...
                <span>
                  <strong>1.1.1 Non-text Content:</strong> ARIA labels and roles provide text
                  alternatives
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>1.3.1 Info and Relationships:</strong> Semantic calendar structure with
                  proper ARIA
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>1.4.3 Contrast (Minimum):</strong> 4.5:1 contrast ratio for text
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>1.4.11 Non-text Contrast:</strong> 3:1 contrast for interactive elements
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
              ...
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>2.1.2 No Keyboard Trap:</strong> Users can tab in and out freely
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>2.4.3 Focus Order:</strong> Logical tab order through calendar
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>2.4.7 Focus Visible:</strong> Clear focus indicators on all dates
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
              ...
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>3.2.1 On Focus:</strong> No unexpected changes on focus
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>4.1.2 Name, Role, Value:</strong> Proper ARIA attributes via
                  react-day-picker
                </span>
              </li>
              <li className='flex items-start gap-2'>
                <span className='text-green-600'>✓</span>
                <span>
                  <strong>4.1.3 Status Messages:</strong> Date selection announced to screen readers
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className='border-l-4 border-primary pl-4'>
            ...
            <p className='text-sm text-muted-foreground mb-2'>Test with these screen readers:</p>
            <ul className='text-sm space-y-1'>
              <li>
                • <strong>NVDA</strong> (Windows, Free) - Navigate with arrow keys, hear date
                announcements
              </li>
              <li>
                • <strong>JAWS</strong> (Windows, Commercial) - Test forms mode and browse mode
              </li>
              <li>
                • <strong>VoiceOver</strong> (macOS/iOS, Built-in) - Use VO+Arrow keys
              </li>
              <li>
                • <strong>TalkBack</strong> (Android, Built-in) - Swipe gestures to navigate
              </li>
            </ul>
          </div>
        </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Comprehensive accessibility testing including keyboard navigation, screen reader announcements, focus management, and WCAG 2.1 AAA compliance validation.',
      },
    },
  },
};
...
export const EdgeCases: Story = {
        ...
        <div className='space-y-8 w-full max-w-4xl'>
          <div>
            ...
            <div className='flex gap-6 flex-wrap'>
              ...
              <div>
                ...
                {date1 && <p className='text-sm text-green-600 mt-2'>✓ Selected today's date</p>}
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex gap-6 flex-wrap'>
              ...
              />
              <div>
                <p className='text-sm text-amber-600'>⚠️ All dates are disabled</p>
                <p className='text-xs text-muted-foreground mt-1'>
          ...
          <div>
            ...
            <div className='border rounded-lg p-4 bg-muted'>
              <p className='text-sm'>
                For day-use bookings, use time picker instead of date range. Calendar range mode
                requires different dates for start and end.
              </p>
            </div>
          </div>
          ...
          <div className='p-4 bg-amber-50 dark:bg-amber-950 rounded-lg'>
            ...
            <ul className='text-sm space-y-1'>
              <li>
                • <strong>Single day:</strong> Clearly communicate limited availability
              </li>
              <li>
                • <strong>Leap year:</strong> date-fns and react-day-picker handle automatically
              </li>
              <li>
                • <strong>Year boundary:</strong> Ensure consistent behavior across years
              </li>
              <li>
                • <strong>No dates:</strong> Show helpful message, don't leave blank
              </li>
              <li>
                • <strong>Far future:</strong> Consider if calendar is best UI (vs text input)
              </li>
              <li>
                • <strong>Time zones:</strong> Be explicit about timezone in date storage
              </li>
            </ul>
          </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Edge cases and boundary conditions including single day selection, leap years, year boundaries, no available dates, and far future dates.',
      },
    },
  },
};
...
export const Performance: Story = {
      ...
      return (
        <div className='space-y-8 w-full max-w-4xl'>
          ...
          <div>
            ...
            <Calendar mode='range' numberOfMonths={3} className='rounded-md border' />
          </div>
          ...
          <div className='p-4 bg-blue-50 dark:bg-blue-950 rounded-lg'>
            ...
            <ul className='text-sm space-y-1'>
              <li>
                • <strong>Initial render:</strong> Typically 50-150ms for single month
              </li>
              <li>
                • <strong>Date selection:</strong> {'<'}5ms (instant user feedback)
              </li>
              <li>
                • <strong>Month navigation:</strong> 20-50ms (smooth transitions)
              </li>
              <li>
                • <strong>Multiple months:</strong> Linear scaling (3 months ≈ 3× render time)
              </li>
              <li>
                • <strong>Disabled logic:</strong> Runs 42 times per month (7 weeks × 6 days)
              </li>
              <li>
                • <strong>Re-renders:</strong> Only on state changes (selected date, visible month)
              </li>
            </ul>
          </div>
          ...
          <div className='p-4 bg-green-50 dark:bg-green-950 rounded-lg'>
            ...
            <ul className='text-sm space-y-1'>
              <li>
                • <strong>Memoize disabled functions:</strong> Use useCallback for complex logic
              </li>
              <li>
                • <strong>Lazy load months:</strong> Only render visible months
              </li>
              <li>
                • <strong>Debounce rapid selections:</strong> Prevent excessive re-renders
              </li>
              <li>
                • <strong>Virtual scrolling:</strong> For very large date ranges (years)
              </li>
              <li>
                • <strong>SSR-friendly:</strong> Works with server-side rendering
              </li>
              <li>
                • <strong>Code splitting:</strong> react-day-picker is separate chunk
              </li>
            </ul>
          </div>
          ...
          <div className='border-l-4 border-amber-500 pl-4'>
            ...
            <ul className='text-sm text-muted-foreground space-y-1'>
              <li>
                1. <strong>Memoize disabled/matcher functions</strong> to avoid recalculation
              </li>
              <li>
                2. <strong>Limit numberOfMonths</strong> to 2-3 max on desktop, 1 on mobile
              </li>
              <li>
                3. <strong>Use fromDate/toDate</strong> to limit navigable range
              </li>
              <li>
                4. <strong>Avoid inline functions</strong> in disabled prop
              </li>
              <li>
                5. <strong>Profile with React DevTools</strong> if experiencing slowness
              </li>
              <li>
                6. <strong>Consider native date input</strong> for mobile (better UX)
              </li>
            </ul>
          </div>
          ...
          <div className='border rounded-lg p-4 bg-muted'>
            ...
            <p className='text-sm text-muted-foreground mb-2'>Calendar component dependencies:</p>
            <ul className='text-sm space-y-1'>
              <li>
                • <strong>react-day-picker:</strong> ~50KB (minified)
              </li>
              <li>
                • <strong>date-fns:</strong> ~12KB (tree-shaken imports)
              </li>
              <li>
                • <strong>Total:</strong> ~62KB added to bundle
              </li>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Performance testing including render times, multiple months, complex disabled logic, optimization tips, and bundle size analysis.',
      },
    },
  },
};
      ...
      <div className='space-y-4'>
        ...
        <div className='space-y-2 text-sm'>
          <div className='flex items-start gap-2'>
            ...
            <p>
              <strong>Keyboard navigation</strong> - Arrow keys, Enter, Space, Page Up/Down work
              correctly
            </p>
          </div>
          <div className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <p>
              <strong>ARIA calendar role</strong> - Automatic via react-day-picker
            </p>
          </div>
          <div className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <p>
              <strong>Date announcements</strong> - Screen readers announce selected dates
            </p>
          </div>
          <div className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <p>
              <strong>Focus visible</strong> - Clear focus indicator on current date
            </p>
          </div>
          <div className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <p>
              <strong>Touch-friendly</strong> - Adequate spacing between dates
            </p>
          </div>
          <div className='flex items-start gap-2'>
            <span className='text-green-600 font-bold'>✓</span>
            <p>
              <strong>Labels</strong> - Associate label with calendar for context
            </p>
          </div>
        </div>
      </div>
