      ...
      <Card>
        ...
        <CardContent>
          <p className='text-sm text-muted-foreground'>
            Passionate about creating beautiful and functional user interfaces. 10+ years of
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex gap-3'>
            ...
            <div className='flex-1'>
              ...
              <p className='text-sm text-muted-foreground'>Can't wait to see this in production!</p>
            </div>
          </div>
        </CardContent>
      </Card>
    ...
    <div className='space-y-8 max-w-4xl p-6'>
        ...
        <div className='flex items-center gap-4'>
          <Avatar>
            <AvatarImage
              ...
              alt='User profile picture for shadcn'
            />
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Use initials or icons as meaningful fallbacks
          </p>
        </div>
      </div>
    ...
    <div className='space-y-8 p-6'>
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <p className='text-xs text-muted-foreground'>
          Scales from small to large based on breakpoint
        </p>
      </div>
      ...
      <div className='rounded-lg border p-6 space-y-4'>
        ...
        <p className='text-xs text-muted-foreground'>
          Smaller on mobile, larger overlap on desktop
        </p>
      </div>
