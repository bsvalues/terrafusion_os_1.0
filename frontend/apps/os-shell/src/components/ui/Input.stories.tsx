...
export const InteractiveExamples: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Real-time validation with state management showing error states and success feedback.',
      },
    },
  },
};
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Let HTML5 validation help users</p>
          </div>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Users need to know what to enter</p>
          </div>

          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            <p className='font-medium'>✗ Don't use vague placeholders</p>
            <Input placeholder='Enter here' />
            <p className='text-sm text-muted-foreground'>Placeholders should be descriptive</p>
          </div>

          <div className='rounded-lg border border-red-200 bg-red-50 dark:bg-red-950 p-4 space-y-2'>
            <p className='font-medium'>✗ Don't use wrong input types</p>
            <Input type='text' placeholder='user@email.com' />
            <p className='text-sm text-muted-foreground'>Use type="email" for email inputs</p>
          </div>
...
/>`}</code>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Comprehensive guidelines showing best practices, common mistakes, code examples, and accessibility requirements.',
      },
    },
  },
};
...
export const EdgeCases: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Edge cases including long text, XSS safety, special characters, RTL, and boundary values.',
      },
    },
  },
};
        ...
        <div className='max-w-[320px] border-2 border-dashed border-border p-4 rounded-lg'>
          <div className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-xs text-muted-foreground'>Mobile shows @ and . on keyboard</p>
            </div>

            <div className='space-y-2'>
              <Label htmlFor='mobile-3'>Phone Number</Label>
              <Input id='mobile-3' type='tel' placeholder='+1 (555) 000-0000' className='w-full' />
              <p className='text-xs text-muted-foreground'>Mobile shows numeric keypad</p>
            </div>
          </div>
        </div>
        <p className='mt-2 text-sm text-muted-foreground'>
...
export const CompositionPatterns: Story = {
    ...
    <div className='space-y-8 max-w-4xl'>
      ...
      <div>
        ...
        <div className='flex flex-wrap gap-2'>
          ...
          <button className='px-4 py-2 border rounded-md hover:bg-accent'>Apply Filters</button>
        </div>
      </div>
    </div>
  ),
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Common composition patterns: search bars, inline edit, form grids, input groups, and filter bars.',
      },
    },
  },
};
