...
export const ResearchPortal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: 'hsl(var(--tf-neutral-hs) 17% / 0.3)',
          backdropFilter: 'blur(20px)',
          borderBottom: '1px solid hsl(var(--tf-cyan-hs) 50% / 0.2)',
          padding: '1rem 2rem',
          boxShadow: '0 0 40px hsl(var(--tf-cyan-hs) 50% / 0.15)',
        }}
      >
        <div
          style={{
              ...
              style={{
                background:
                  activePanel === panel.id
                    ? 'linear-gradient(135deg, hsl(var(--tf-cyan-hs) 50% / 0.2) 0%, hsl(var(--tf-blue-hs) 50% / 0.2) 100%)'
                    : 'hsl(var(--tf-neutral-hs) 17% / 0.3)',
                border:
                  activePanel === panel.id
                    ? '2px solid hsl(var(--tf-cyan-hs) 50% / 0.5)'
                    : '1px solid hsl(var(--tf-neutral-hs) 65% / 0.3)',
                borderRadius: '8px',
                ...
                boxShadow: activePanel === panel.id ? '0 0 20px hsl(var(--tf-cyan-hs) 50% / 0.3)' : 'none',
              }}
            >
      ...
      {crossPanelInsights.length > 0 && (
        <div
          style={{
            background: 'hsl(var(--tf-blue-hs) 50% / 0.1)',
            borderBottom: '1px solid hsl(var(--tf-blue-hs) 50% / 0.3)',
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          ...
          <button
            ...
            style={{
              background:
                'linear-gradient(135deg, hsl(var(--tf-cyan-hs) 50% / 0.2) 0%, hsl(var(--tf-blue-hs) 50% / 0.2) 100%)',
              border: '1px solid hsl(var(--tf-cyan-hs) 50% / 0.5)',
              borderRadius: '6px',
              padding: '0.5rem 1rem',
              color: 'var(--tf-transcend-cyan)',
              cursor: 'pointer',
          ...
          <button
            ...
            style={{
              background: 'hsl(var(--tf-neutral-hs) 65% / 0.1)',
              border: '1px solid hsl(var(--tf-neutral-hs) 65% / 0.3)',
              borderRadius: '6px',
              padding: '0.5rem 1rem',
              color: 'var(--tf-text-secondary)',
              cursor: 'pointer',
