    ...
    >
      ...
      <div
        style={{
          ...
          textShadow: '0 0 30px hsl(var(--tf-accent) / 0.5)',
        }}
      >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 4px 20px hsl(var(--tf-accent) / 0.3)',
        }}
        onMouseOver={(e) => {
          e.currentTarget.style.transform = 'scale(1.05)';
          e.currentTarget.style.boxShadow = '0 6px 30px hsl(var(--tf-accent) / 0.5)';
        }}
        onMouseOut={(e) => {
          e.currentTarget.style.transform = 'scale(1)';
          e.currentTarget.style.boxShadow = '0 4px 20px hsl(var(--tf-accent) / 0.3)';
        }}
      >
