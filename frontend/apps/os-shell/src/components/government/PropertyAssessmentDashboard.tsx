...
const SAMPLE_PROPERTIES: Property[] = [
  {
    ...
    currentValue: (await DynamicPropertyService.GetPropertyCountAsync(countyCode)) * 10,
...
const VALUE_TREND_DATA = [
  ...
  {
    month: 'Mar',
    avgValue: 4 * (await DynamicPropertyService.GetPropertyCountAsync(countyCode)),
    aiProcessed: 428000,
  },
  {
    month: 'Apr',
    avgValue: 458000,
    aiProcessed: 4 * (await DynamicPropertyService.GetPropertyCountAsync(countyCode)),
  },
