  ...
  const PluginListItem: React.FC<{ plugin: Plugin }> = ({ plugin }) => (
    ...
    >
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='flex items-center gap-1'>{renderStars(plugin.rating)}</div>
        <button
          onClick={(e) => {
            e.stopPropagation();
            installPlugin(plugin);
        ...
        <div className='p-6'>
          ...
          <div className='grid grid-cols-2 gap-4 mb-6'>
            ...
            <div>
              ...
              <p className='text-gray-600'>Government Use</p>
            </div>
            <div>
              <h4 className='tf-heading-4 mb-1'>Downloads</h4>
              <p className='text-gray-600'>{plugin.downloads.toLocaleString()}</p>
            </div>
            <div>
          ...
          <div className='flex gap-4'>
            <button onClick={() => installPlugin(plugin)} className='tf-btn-primary flex-1'>
              Install Plugin
            </button>
            <button
