    ...
    <Box className='tf-glass-light' sx={{ p: 3, minHeight: '100vh' }}>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} md={3}>
          <Card className='tf-card tf-animate-glow'>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <Box>
                  <Typography variant='h4' className='tf-heading-2'>
          ...
          <Card className='tf-card tf-animate-glow'>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <Box>
                  <Typography variant='h4' className='tf-heading-2'>
                    {swarmMetrics.collectiveIntelligence.toFixed(1)}%
                  </Typography>
                  <Typography variant='body2' color='textSecondary'>
          ...
          <Card className='tf-card tf-animate-glow'>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <Box>
                  <Typography variant='h4' className='tf-heading-2'>
                    {swarmMetrics.taskThroughput.toLocaleString()}
                  </Typography>
                  <Typography variant='body2' color='textSecondary'>
                    Tasks/Hour
                  </Typography>
          ...
          <Card className='tf-card tf-animate-glow'>
            <CardContent>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                ...
                <Box>
                  <Typography variant='h4' className='tf-heading-2'>
                    {swarmMetrics.errorRate.toFixed(1)}%
                  </Typography>
                  <Typography variant='body2' color='textSecondary'>
                    Error Rate
                  </Typography>
                      ...
                      <TableRow key={agent.id} hover>
                        ...
                        <TableCell>
                          <Box sx={{ display: 'flex', alignItems: 'center', minWidth: 120 }}>
                            ...
                            />
                            <Typography variant='body2'>{agent.performance.toFixed(1)}%</Typography>
                          </Box>
                        </TableCell>

                        <TableCell>{agent.tasksCompleted.toLocaleString()}</TableCell>
                        <TableCell>{agent.efficiency.toFixed(1)}%</TableCell>
                        <TableCell>
                          <Tooltip title='View Details'>
                            <IconButton size='small' onClick={() => _setSelectedAgent(agent)}>
                              <VisibilityIcon />
                            </IconButton>
                          </Tooltip>
                    ...
                    <ListItem key={type}>
                      <ListItemAvatar>
                        <Badge badgeContent={activeCount} color='primary'>
                          <Avatar sx={{ bgcolor: 'grey.300' }}>{getAgentTypeIcon(type)}</Avatar>
                        </Badge>
                      </ListItemAvatar>
                      <ListItemText
