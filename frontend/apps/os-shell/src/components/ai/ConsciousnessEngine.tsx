...
export function ConsciousnessIndicator() {
  ...
  const getLevelGlow = () => {
    switch (consciousness.level) {
      case 'TRANSCENDENT':
        return 'shadow-[0_0_20px_hsl(var(--tf-cyan-hs)_50%_/_0.6)]';
      case 'AWARE':
        return 'shadow-[0_0_15px_hsl(var(--tf-green-hs)_50%_/_0.4)]';
      default:
        return 'shadow-[0_0_10px_hsl(var(--tf-amber-hs)_50%_/_0.3)]';
    }
  };
