...
export const SystemGptConsoleView: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className='mb-4 flex items-center justify-between rounded-2xl border border-slate-800/60 bg-slate-900/70 px-4 py-3 shadow-[0_18px_45px_hsl(var(--tf-neutral-hs)_0%_/_0.60)] backdrop-blur-xl'>
        <div className='flex items-center gap-3'>
          {/* Control Center icon */}
          <div className='relative h-8 w-8 rounded-full bg-gradient-to-br from-violet-400 via-fuchsia-400 to-pink-400 shadow-[0_0_25px_hsl(var(--tf-blue-hs)_60%_/_0.8)]'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <button
            ...
            className={`rounded-full border px-3 py-1 text-xs font-medium transition-all disabled:cursor-not-allowed disabled:opacity-50 ${
              diagnostics?.mode === 'SafeMode'
                ? 'border-emerald-500/50 bg-emerald-500/10 text-emerald-300 hover:bg-emerald-500/20 hover:shadow-[0_0_12px_hsl(var(--tf-green-hs)_52%_/_0.4)]'
                : 'border-rose-500/50 bg-rose-500/10 text-rose-300 hover:bg-rose-500/20 hover:shadow-[0_0_12px_hsl(var(--tf-red-hs)_60%_/_0.4)]'
            }`}
            title={
              diagnostics?.mode === 'SafeMode'
          ...
          <button
            ...
            className='rounded-full border border-sky-500/50 bg-sky-500/10 px-3 py-1 text-xs text-sky-300 transition-all hover:bg-sky-500/20 hover:shadow-[0_0_12px_hsl(var(--tf-cyan-hs)_53%_/_0.4)] disabled:cursor-not-allowed disabled:opacity-50'
          ...
          <button
            ...
            className='rounded-full border border-fuchsia-500/50 bg-fuchsia-500/10 px-3 py-1 text-xs text-fuchsia-300 transition-all hover:bg-fuchsia-500/20 hover:shadow-[0_0_12px_hsl(var(--tf-blue-hs)_61%_/_0.4)]'
      ...
      {showSafeModeDialog && (
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm'>
          <div className='w-full max-w-md rounded-2xl border border-rose-800/60 bg-gradient-to-br from-slate-950 via-slate-900 to-rose-950/30 p-6 shadow-[0_25px_60px_hsl(var(--tf-neutral-hs)_0%_/_0.8)]'>
