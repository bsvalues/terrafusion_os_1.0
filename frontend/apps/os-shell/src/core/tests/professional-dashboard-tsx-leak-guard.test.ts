/**
 * Leak-guard: ProfessionalDashboard.tsx
 *
...
const TARGET = resolve(__dirname, '../../components/layout/ProfessionalDashboard.tsx');

describe('ProfessionalDashboard.tsx – token leak guard', () => {
  it('contains no raw color values', () => {
    const content = readFileSync(TARGET, 'utf-8');
    assertNoRawColorLeaks(content, { label: 'ProfessionalDashboard.tsx' });
  });
});
