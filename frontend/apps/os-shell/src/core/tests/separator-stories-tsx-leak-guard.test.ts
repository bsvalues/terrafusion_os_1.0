/**
 * Leak-guard: Separator.stories.tsx
 *
...
const TARGET = resolve(__dirname, '../../components/ui/Separator.stories.tsx');

describe('Separator.stories.tsx – token leak guard', () => {
  it('contains no raw color values', () => {
    const content = readFileSync(TARGET, 'utf-8');
    assertNoRawColorLeaks(content, { label: 'Separator.stories.tsx' });
  });
});
