/**
 * Leak-guard: StatisticalValidationWorkbench.tsx
 *
 ...
 * code positions (style objects, className interpolations, THREE.js
 * material props, etc.) ARE caught.
 *
 * Three invariants:
...
const TARGET = resolve(
  __dirname,
  '../../components/research/StatisticalValidationWorkbench.tsx',
);
...
describe('StatisticalValidationWorkbench.tsx – token leak guard', () => {
