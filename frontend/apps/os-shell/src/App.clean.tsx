            ...
            {appStatuses.map((app) => (
              ...
              >
                <div className='tf-app-header'>
                  ...
                  <span className={`tf-status-badge tf-status-${app.status}`}>{app.status}</span>
                </div>
                {app.status === 'running' && (
...
const App: React.FC = () => {
  ...
  return (
    <TerraFusionCSSProvider>
      <ComplianceWrapper accessibilityLevel='AAA' securityLevel='enhanced' auditMode={false}>
        {viewMode === 'os' ? (
          <OSShellWindow>
          ...
          >
            ...
            <section className='tf-hero-section'>
              <div className='tf-hero-header'>
                <div className='tf-title'>Terrafusion OS</div>
                <div className='tf-tagline'>Government. Transcended.</div>
              </div>

              <div className='tf-hero-content'>
                <div className='tf-badge'>✨ OS Ready</div>

                <h1 className='tf-title tf-ai-command-brain'>Government. Transcended.</h1>

                <p className='tf-subtitle tf-neural-sync'>
                  Turn complexity into clarity across every department—so teams move faster, make
                  better calls, and never second-guess the next step.
                </p>
