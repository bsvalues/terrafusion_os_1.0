...
export const muiTheme = createTheme({
  palette: {
    ...
    background: {
      ...
      paper: 'hsl(var(--tf-text-primary-hs) 100% / 0.03)', // tf-glass
    },
    error: {
    ...
    MuiButton: {
      styleOverrides: {
        contained: {
          ...
          boxShadow: '0 4px 15px hsl(var(--tf-network-blue-hs) 50% / 0.3)',
          '&:hover': {
            transform: 'translateY(-2px)',
            boxShadow: '0 8px 25px hsl(var(--tf-transcend-cyan-hs) 50% / 0.4)',
          },
          '&:active': {
