...
export const CONSTITUTIONAL_SUITES: readonly SuiteDefinition[] = [
  {
    ...
    iconName: 'Hammer',
    route: '/forge',
    color: 'hsl(var(--tf-amber-hs) 60%)', // Forge orange
    status: 'wip',
    workbenchTab: true,
  ...
  },
  {
    ...
    iconName: 'Globe',
    route: '/atlas',
    color: 'hsl(var(--tf-cyan-hs) 50%)', // Cyan
    status: 'wip',
    workbenchTab: true,
  ...
  },
  {
    ...
    route: '/dais',
    color: 'hsl(var(--tf-blue-hs) 65%)', // Purple
    status: 'wip',
    workbenchTab: true,
  ...
  },
  {
    ...
    iconName: 'FileStack',
    route: '/dossier',
    color: 'hsl(var(--tf-green-hs) 45%)', // Green
    status: 'wip',
    workbenchTab: true,
  ...
  },
  {
    ...
    iconName: 'Bot',
    route: '/gpt',
    color: 'hsl(var(--tf-blue-hs) 60%)', // Blue
    status: 'wip',
    workbenchTab: true,
