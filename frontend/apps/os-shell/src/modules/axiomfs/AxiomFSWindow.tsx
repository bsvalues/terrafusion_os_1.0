        ...
        {!activeObject ? (
          ...
          <div className='animate-in slide-in-from-bottom-4 duration-700 max-w-3xl mx-auto'>
            ...
            <div className='flex flex-wrap gap-2 mb-10'>
              <span className='rounded bg-[var(--tf-surface-highlight)] px-3 py-1 text-[10px] font-bold text-[var(--tf-transcend-cyan)] border border-[var(--tf-transcend-cyan)]/20 shadow-[0_0_10px_hsl(var(--tf-transcend-cyan-hs)_50%_/_0.1)]'>
