...
const WORKSPACE_CARDS: WorkspaceCard[] = [
  ...
  },
  {
    ...
    icon: Store,
    description: 'GPT Marketplace is queued behind governed release work.',
    status: 'queued',
  },
  {
    id: 'builder',
    label: 'GPT Builder',
    icon: Wrench,
    description: 'GPT Builder is queued until the governed builder workflow is wired.',
    status: 'queued',
  },
  {
    id: 'analytics',
    label: 'GPT Analytics',
    icon: BarChart3,
    description: 'GPT usage analytics is queued until usage evidence is wired.',
    status: 'queued',
  },
];
