...
const JUNE_10_FORGE_NOTICE =
  'TerraForge is not part of the June 10 runtime proof path. Use Property Workbench for DB/API-backed Benton parcel proof.';
...
function getLaunchLabel(mod: ForgeModuleDef): string {
  if (JUNE_10_PROOF_FREEZE && mod.launchMode === 'standalone') {
    return 'Not part of June 10 proof path';
  }
      ...
      <main className="forge-workspace__viewport">
        <div className="forge-workspace__stage">
          <header className="forge-workspace__header">
            <div>
              <p className="forge-workspace__eyebrow">Suite-Forge · Preview surface</p>
              <h1 className="forge-workspace__title">TerraForge</h1>
              <p className="forge-workspace__subtitle">Excluded from the June 10 proof path until module metrics and workflows are separately verified.</p>
            </div>
            <div className="forge-workspace__status">
              ...
              <span className="forge-chip forge-chip--warn">
                Metrics not connected to J10 proof
              </span>
            </div>
          </header>
                ...
                <div className="forge-ops-card__head">
                  ...
                  <div className="forge-ops-actions">
                    ...
                    <button
                      ...
                      title={JUNE_10_FORGE_NOTICE}
                    >
                      County Studio unavailable for J10
                    </button>
                  </div>
                </div>
