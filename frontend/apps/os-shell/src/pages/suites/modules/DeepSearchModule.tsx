...
const SEARCH_INDEX: SearchResult[] = [
  ...
  { id: 'EV-2025-003', title: 'Cost Factor Analysis — New Construction', type: 'evidence', parcelId: '1-0315-200-0023-000', snippet: 'Benton County locally calibrated base cost: $125/sqft (standard quality). Ratio-study multiplier for Richland: 1.05...', relevance: 0.85, date: '2025-05-10', matchField: 'content' },
