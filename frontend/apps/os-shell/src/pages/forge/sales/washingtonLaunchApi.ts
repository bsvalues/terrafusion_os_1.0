...
function toDetail(sale: LaunchSaleRecord): SaleDetail {
  return applyDecision({
    ...
    slLandSqft: firstComparableNumber([sale.lotSizeSqft]),
    lotSizeSqft: firstComparableNumber([sale.lotSizeSqft]),
    yearBuilt: firstComparableNumber([sale.yearBuilt]),
    bedrooms: firstComparableNumber([sale.bedrooms]),
    bathrooms: firstComparableNumber([sale.bathrooms]),
    condition: firstComparableString([sale.condition, sale.propertyCondition]),
    qualityGrade: firstComparableString([sale.qualityGrade, sale.quality]),
    rawRatioCd: null,
