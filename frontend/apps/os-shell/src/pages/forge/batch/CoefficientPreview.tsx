...
const FIXTURE_PREVIEW: PreviewResult = {
  ...
  deltas: [
    { variable: 'Living Area (Sq Ft)', currentValue: 48.32, proposedValue: 51.07, delta: 2.75, deltaPct: 5.69 },
    ...
    { variable: 'Garage Area (Sq Ft)', currentValue: 22.1, proposedValue: 24.8, delta: 2.7, deltaPct: 12.22 },
