...
const DEMO_CARDS: DemoCard[] = [
  ...
  },
  {
    ...
    description: 'Explore 10 expert-level guides on real assessment challenges — from senior exemptions to Board of Equalization preparation. Ask any question.',
    route: '/academy',
    icon: GraduationCap,
    color: 'hsl(270 80% 60%)',
  ...
  },
  {
    ...
    description: 'The operating system that connects intelligence to action — suites, tools, and integrated workflows for county government.',
    route: '/home',
    icon: Monitor,
