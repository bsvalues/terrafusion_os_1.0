/**
 * ═══════════════════════════════════════════════════════════════
 * TERRAFUSION PILOT CONSOLE CONTENT
 * Phase 6: Slice 6 - Extracted content for StandaloneHomeShell
 *
 * This is the internal content of PilotConsole, extracted to work with
 * StandaloneHomeShell. The shell provides the header, badge, and actions.
 *
...
/**
 * PilotConsoleContent - The internal content of the Pilot Console.
 *
 * Designed to be rendered inside StandaloneHomeShell or used standalone.
 * Contains the tools list, invoke modal, and trace viewer.
 */
export function PilotConsoleContent(): React.ReactElement {
  // Tools state
...
export default PilotConsoleContent;
