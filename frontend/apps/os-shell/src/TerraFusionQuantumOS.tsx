      ...
      >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <div
              style={{
                ...
                boxShadow: '0 0 20px hsl(var(--tf-accent) / 0.5)',
              }}
            >
              T
            </div>
        ...
        >
          ...
          <nav
            ...
            style={{
              width: '280px',
              background: 'hsl(var(--tf-accent) / 0.05)',
              borderRight: '2px solid hsl(var(--tf-accent) / 0.2)',
              padding: '2rem 1rem',
              display: 'flex',
              flexDirection: 'column',
              gap: '1rem',
        ...
        <footer
          ...
          style={{
            ...
            background: 'hsl(var(--tf-accent) / 0.08)',
            backdropFilter: 'blur(20px)',
            borderTop: '2px solid hsl(var(--tf-accent) / 0.3)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'space-between',
            padding: '0 2rem',
