  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Background gradient
        isActive ? 'bg-gradient-to-r from-[var(--tf-void-black)] via-[var(--tf-surface-darker)] to-[var(--tf-void-black)]' : 'bg-[var(--tf-surface-darker)]/80',
        // Border
        'border-b border-[var(--tf-transcend-highlight)]/20',
        // Rounded top
        'rounded-t-lg'
      )}
    >
...
export const Window: React.FC<WindowProps> = ({ window: windowData, children }) => {
  ...
  const handleDrag = useCallback((_e: any, data: any) => {
    // Update cursor position for snap detection
    // data.x/y are window position, we need cursor position
      ...
      >
        <motion.div
          ...
          className={cn(
            ...
            'rounded-lg',
            isActive
              ? 'border border-[var(--tf-transcend-highlight)]/40 shadow-[0_0_30px_rgba(0,255,238,0.2),0_8px_32px_rgba(0,0,0,0.5)]'
          ...
          {!isMaximized && (
            <>
              ...
              <div className='absolute bottom-0 right-0 w-4 h-4 cursor-se-resize opacity-0 hover:opacity-100 transition-opacity'>
                <div className='absolute bottom-1 right-1 w-2 h-2 border-b-2 border-r-2 border-[var(--tf-transcend-highlight)]/50' />
              </div>
              <div className='absolute bottom-0 left-0 w-4 h-4 cursor-sw-resize opacity-0 hover:opacity-100 transition-opacity'>
                <div className='absolute bottom-1 left-1 w-2 h-2 border-b-2 border-l-2 border-[var(--tf-transcend-highlight)]/50' />
              </div>
              <div className='absolute top-0 right-0 w-4 h-4 cursor-ne-resize opacity-0 hover:opacity-100 transition-opacity'>
                <div className='absolute top-1 right-1 w-2 h-2 border-t-2 border-r-2 border-[var(--tf-transcend-highlight)]/50' />
              </div>
              <div className='absolute top-0 left-0 w-4 h-4 cursor-nw-resize opacity-0 hover:opacity-100 transition-opacity'>
                <div className='absolute top-1 left-1 w-2 h-2 border-t-2 border-l-2 border-[var(--tf-transcend-highlight)]/50' />
              </div>
            </>
          )}
        </motion.div>
