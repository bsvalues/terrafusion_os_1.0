  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      void main() {
        ...
        vec3 voidBlack = vec3(0.039, 0.055, 0.102);     // tf-bg
        vec3 terraCyan = vec3(0.0, 0.898, 1.0);         // tf-accent
        vec3 terraBlue = vec3(0.0, 0.502, 1.0);         // tf-accent-2
        vec3 terraGreen = vec3(0.0, 1.0, 0.533);        // tf-success
