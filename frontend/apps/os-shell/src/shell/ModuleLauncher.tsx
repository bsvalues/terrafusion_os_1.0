      ...
      <Card
        sx={{
          ...
          '&:hover': {
            ...
            boxShadow: '0 8px 32px hsl(var(--tf-neutral-hs) 0% / 0.3)',
          },
        }}
      ...
      >
        <CardContent sx={{ textAlign: 'center', p: 2 }}>
          <Box sx={{ mb: 2 }}>
            <IconButton
              sx={{
                bgcolor: 'hsl(var(--tf-neutral-hs) 100% / 0.2)',
                color: 'white',
                mb: 1,
                '&:hover': { bgcolor: 'hsl(var(--tf-neutral-hs) 100% / 0.3)' },
              }}
              size='large'
            >
          ...
          {module.description && (
            <Typography variant='body2' sx={{ color: 'hsl(var(--tf-neutral-hs) 100% / 0.7)', mb: 1 }}>
              {module.description}
            </Typography>
          )}
          ...
          <Typography variant='caption' sx={{ color: 'hsl(var(--tf-neutral-hs) 100% / 0.5)' }}>
            v{module.version}
          </Typography>
        </CardContent>
      </Card>
