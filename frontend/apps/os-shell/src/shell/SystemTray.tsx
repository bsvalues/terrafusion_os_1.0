  ...
  return (
    <Box
      sx={{
        ...
        right: 0,
        height: 40,
        background: 'hsl(var(--tf-bg-surface-hs) 5% / 0.9)',
        backdropFilter: 'blur(10px)',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'space-between',
        px: 2,
        borderTop: '1px solid hsl(var(--tf-text-primary-hs) 100% / 0.1)',
        zIndex: 1000,
      }}
    >
      {/* Left side - System info */}
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        <Typography variant='caption' sx={{ color: 'hsl(var(--tf-text-primary-hs) 100% / 0.7)' }}>
          Terrafusion OS 1.0
        </Typography>
        <Chip
          icon={<Memory />}
