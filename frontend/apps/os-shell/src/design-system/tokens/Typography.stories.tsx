...
export const DisplayText: Story = {
  render: () => (
    <div>
      ...
      >
        Large, impactful text for hero sections and major headings. Used sparingly for maximum
        effect.
      </p>
      <TextStyleExample
        title='display.2xl'
        style={tokens.typography.textStyles.display['2xl']}
        example='Welcome to TerraFusion'
      />
      <TextStyleExample
        title='display.xl'
        style={tokens.typography.textStyles.display.xl}
        example='Welcome to TerraFusion'
      />
      <TextStyleExample
        title='display.lg'
        style={tokens.typography.textStyles.display.lg}
        example='Welcome to TerraFusion'
      />
      <TextStyleExample
        title='display.md'
        style={tokens.typography.textStyles.display.md}
        example='Welcome to TerraFusion'
      />
      <TextStyleExample
        title='display.sm'
        style={tokens.typography.textStyles.display.sm}
        example='Welcome to TerraFusion'
      />
    </div>
  ),
...
export const Headings: Story = {
  render: () => (
    <div>
      ...
      <TextStyleExample
        title='heading.h2'
        style={tokens.typography.textStyles.heading.h2}
        example='Heading Level 2'
      />
      <TextStyleExample
        title='heading.h3'
        style={tokens.typography.textStyles.heading.h3}
        example='Heading Level 3'
      />
      <TextStyleExample
        title='heading.h4'
        style={tokens.typography.textStyles.heading.h4}
        example='Heading Level 4'
      />
      <TextStyleExample
        title='heading.h5'
        style={tokens.typography.textStyles.heading.h5}
        example='Heading Level 5'
      />
      <TextStyleExample
        title='heading.h6'
        style={tokens.typography.textStyles.heading.h6}
...
export const BodyText: Story = {
  render: () => (
    <div>
      ...
      <TextStyleExample
        title='body.lg'
        style={tokens.typography.textStyles.body.lg}
        example='Large body text for emphasis or lead paragraphs. The quick brown fox jumps over the lazy dog.'
      />
      <TextStyleExample
        title='body.md (default)'
        style={tokens.typography.textStyles.body.md}
        example='Standard body text for most content. The quick brown fox jumps over the lazy dog. This is the most common text size used throughout the application.'
      />
      <TextStyleExample
        title='body.sm'
        style={tokens.typography.textStyles.body.sm}
        example='Small body text for secondary information. The quick brown fox jumps over the lazy dog.'
      />
      <TextStyleExample
        title='body.xs'
        style={tokens.typography.textStyles.body.xs}
        example='Extra small text for captions and fine print. The quick brown fox jumps over the lazy dog.'
      />
    </div>
  ),
};
export const Labels: Story = {
  render: () => (
    <div>
      ...
      <TextStyleExample
        title='label.lg'
        style={tokens.typography.textStyles.label.lg}
        example='LARGE LABEL'
      />
      <TextStyleExample
        title='label.md'
        style={tokens.typography.textStyles.label.md}
        example='MEDIUM LABEL'
      />
      <TextStyleExample
        title='label.sm'
        style={tokens.typography.textStyles.label.sm}
        example='SMALL LABEL'
      />
    </div>
  ),
...
export const CodeText: Story = {
  render: () => (
    <div>
      ...
      <TextStyleExample
        title='code.lg'
        style={tokens.typography.textStyles.code.lg}
        example="const message = 'Hello, TerraFusion!';"
      />
      <TextStyleExample
        title='code.md'
        style={tokens.typography.textStyles.code.md}
        example='npm install @terrafusion/core'
      />
      <TextStyleExample
        title='code.sm'
        style={tokens.typography.textStyles.code.sm}
        example="git commit -m 'feat: add typography'"
      />
    </div>
  ),
};
  ...
  render: () => (
    <div>
      ...
      >
        ...
        >
          Lead paragraph with larger text for emphasis. This introduces the main topic and draws the
          reader in.
        </p>
        ...
        >
          Standard body text provides detailed information. The quick brown fox jumps over the lazy
          dog. This text uses the default body.md style which is optimized for readability.
        </p>
        ...
        <p className='text-gray-400'>Small text for footnotes and additional information.</p>
      </div>
    </div>
  ),
};
