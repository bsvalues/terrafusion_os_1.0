...
/**
 * Leak Guard: QuantumFormComponents.css
...
const CSS_PATH = resolve(__dirname, '../../../components/forms/QuantumFormComponents.css');
...
describe('Leak guard — QuantumFormComponents.css', () => {
