...
const TSX_PATH = resolve(__dirname, '../../../components/brand/TerraFusionBrandEnhancementSystem.tsx');
...
describe('TerraFusionBrandEnhancementSystem.tsx – TSX token leak guard', () => {
