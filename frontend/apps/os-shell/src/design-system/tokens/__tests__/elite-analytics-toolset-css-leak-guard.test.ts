...
/**
 * Leak Guard: elite-analytics-toolset.css
...
const CSS_PATH = resolve(__dirname, '../../../components/analytics/elite-analytics-toolset.css');
...
describe('Leak guard — elite-analytics-toolset.css', () => {
