          ...
          {show && (
            <>
              <div className='text-center'>
                <AnimatedBox animation={tokens.motion.animation.fadeIn}>Fade In</AnimatedBox>
                <div className='text-gray-400'>fadeIn</div>
              </div>
              <div className='text-center'>
                <AnimatedBox animation={tokens.motion.animation.scaleIn}>Scale In</AnimatedBox>
                <div className='text-gray-400'>scaleIn</div>
              </div>
              <div className='text-center'>
                <AnimatedBox animation={tokens.motion.animation.slideInUp}>Slide Up</AnimatedBox>
...
export const ContinuousAnimations: Story = {
  render: () => (
    <div>
      ...
      <div className='flex'>
        <div className='text-center'>
          <AnimatedBox animation={tokens.motion.animation.pulse}>Pulse</AnimatedBox>
        ...
        <div className='text-center'>
          <AnimatedBox animation={tokens.motion.animation.bounce}>Bounce</AnimatedBox>
...
export const InteractiveTransitions: Story = {
  render: () => {
    ...
    const Button = ({ label, speed }: { label: string; speed: 'fast' | 'normal' | 'slow' }) => (
      <button
        ...
        style={{
          backgroundColor:
            hoveredButton === label
              ? tokens.colors.component.button.primary.hover
              : tokens.colors.component.button.primary.background,
...
export const LoadingStates: Story = {
  render: () => (
    <div>
      ...
      >
        <h3 className='font-semibold'>Pulsing Dots</h3>
        <div className='flex'>
          {[0, 1, 2].map((i) => (
            <div
              key={i}
