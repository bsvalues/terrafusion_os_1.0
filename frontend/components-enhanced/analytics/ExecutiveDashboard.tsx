...
const ExecutiveDashboard: React.FC<ExecutiveDashboardProps> = ({
  ...
  const {
    ...
    exportDashboard,
    updateSettings
  } = useExecutiveDashboard(jurisdiction, refreshInterval);
...
<>
              ...
              <ListItemText
                ...
                secondary={`${dashboardData?.aiStats?.activeAgents || 0} active`}
              />
            </ListItem>
            <ListItem
</>
...
<>
              ...
              <ListItemText
                ...
                secondary={`${dashboardData?.aiStats?.avgResponseTime || 0}ms`}
              />
            </ListItem>
            <ListItem
</>
              ...
              <ListItemText
                ...
                secondary={`${dashboardData?.aiStats?.successRate || 0}%`}
              />
            </ListItem>
          </List>
        </Grid>
