...
function CommandDialog({title = "Command Palette",
  ...
  return (<Dialog {...props}><DialogHeader className="sr-only"><><DialogTitle>{title}</DialogTitle><DialogDescription
</></>>{description}</DialogDescription></DialogHeader><DialogContent
