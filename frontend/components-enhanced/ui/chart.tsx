...
function ChartContainer({id,
  ...
  children,
  config,
  ...props}: React.ComponentProps<"div"> & {config: ChartConfig
...
function ChartTooltipContent({active,
  payload,
  className,
  indicator = "dot",
  hideLabel = false,
  ...
  React.ComponentProps<"div">& {hideLabel?: boolean
    ...
    nameKey?: string
    labelKey?: string}) {const { config} = useChart()
