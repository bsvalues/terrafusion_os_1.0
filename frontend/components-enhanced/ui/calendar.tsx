...
import {ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon} from '@mui/icons-material';
...
function CalendarDayButton({className,
  day,
  modifiers,
  ...props}: React.ComponentProps<typeof DayButton>) {const defaultClassNames = getDefaultClassNames();
