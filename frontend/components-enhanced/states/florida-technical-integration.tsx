      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4"><>
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 bg-clip-text text-transparent">
            🌴 FLORIDA TECHNICAL INTEGRATION
          </h1>
          <p
</>
className="text-xl text-slate-300">Hurricane-Ready • Tourism-Aware • Multilingual • Future-Proof</p>
          <div className="flex justify-center gap-4"><>

            <Badge className="bg-orange-500/20 text-orange-400 border-orange-500">15 Counties Targeted</Badge>
            <Badge
</>
className="bg-green-500/20 text-green-400 border-green-500">5.8M Parcels</Badge>
...
className="text-slate-400 text-sm">4-hour post-storm assessment with NOAA/FEMA integration</p>
            </CardContent>
          </Card>
...
className="text-slate-400 text-sm">Theme parks, hotels, short-term rentals specialized handling</p>
            </CardContent>
          </Card>
...
className="text-slate-400 text-sm">English, Spanish, Haitian Creole interface and data</p>
            </CardContent>
          </Card>
...
className="text-slate-400 text-sm">Sea level rise projections and beach erosion modeling</p>
            </CardContent>
          </Card>
        </div>
...
className="text-slate-400">Tier {county.tier} Priority</p>
                    </div>
                    <Badge
                      className={`${
                        county.tier === 1
...
className="text-white font-semibold">{county.population}</div>
                    </div>
                    <div><>
...
className="text-white font-semibold">{county.parcels}</div>
                    </div>
                    <div><>
...
className="text-white font-semibold">{county.value}</div>
                    </div>
                    <div><>
...
className="text-white font-semibold">{county.timeline}</div>
                    </div>
                  </div>
...
className="text-cyan-400">{county.api}</span>
                    </div>
                    <Button
                      size="sm"
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• Snapshot all properties</li>
                            <li
</>
</>>• Identify vulnerable parcels</li><>

                        <li>• Notify property owners</li>
                            <li
</>
</>>• Coordinate with EOC</li>
                      </ul>
                    </div>
                    <div className="space-y-2"><>
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• 4-hour rapid assessment</li>
                            <li
</>
</>>• AI damage detection</li><>

                        <li>• FEMA report generation</li>
                            <li
</>
</>>• Insurance claim expediting</li>
                      </ul>
                    </div>
                  </div>
                </div>
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• Disney World integration</li>
                            <li
</>
</>>• Universal Studios</li><>

                        <li>• Special district handling</li>
                            <li
</>
</>>• Custom valuations</li>
                      </ul>
                    </div>
                    <div className="space-y-2"><>
...
</>>• RevPAR calculations</li><>

                        <li>• Brand value assessment</li>
                            <li
</>
</>>• Competition analysis</li>
                      </ul>
                    </div>
                    <div className="space-y-2"><>
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• Tourist tax compliance</li>
                            <li
</>
</>>• Neighborhood impact</li>
                      </ul>
                    </div>
                  </div>
                </div>
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• Beach erosion risk assessment</li>
                            <li
</>
</>>• Sea level rise projections (30-year)</li><>

                        <li>• Turtle nesting season compliance</li>
                            <li
</>
</>>• Dune preservation impact</li>
                      </ul>
                    </div>
                    <div className="space-y-2"><>
...
className="text-sm text-slate-300 space-y-1"><>
                        ...
                        <li>• Beach access premium calculation</li>
                            <li
</>
</>>• Ocean view value assessment</li><>

                        <li>• Storm surge risk discount</li>
                            <li
</>
</>>• Insurance cost integration</li>
                      </ul>
                    </div>
                  </div>
                </div>
...
className="text-sm text-slate-400">Parcel Query Speed</div>
                    </div>
                    <div className="text-center"><>
...
className="text-sm text-slate-400">Bulk Valuation</div>
                    </div>
                    <div className="text-center"><>
...
className="text-sm text-slate-400">Hurricane Assessment</div>
                    </div>
                    <div className="text-center"><>
...
className="text-sm text-slate-400">FEMA Reporting</div>
                    </div>
                  </div>
                </div>
              </TabsContent>
