...
className="text-sm text-blue-800">Total Properties</div>
        </div>
...
className="text-sm text-green-800">Avg Valuation</div>
        </div>
...
className="text-sm text-purple-800">Performance Score</div>
        </div>
      </div>
      {data && (
        <div className="mt-4 text-sm text-gray-600">
          Analytics data loaded: {typeof data}
        </div>
      )}
    </div>
  );
