    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            This is a basic dialog with a title and description. You can press Escape or click
            outside to close it.
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
      ...
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This feature is currently in beta. Some functionality may be limited or change in
              future updates.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
        ...
        <DialogContent className='sm:max-w-md'>
          ...
          <div className='flex items-center space-x-2'>
            <div className='grid flex-1 gap-2'>
              ...
              <Input id='share-link' defaultValue='https://terrafusion.io/project/123' readOnly />
            </div>
        ...
        <DialogContent className='sm:max-w-[500px]'>
          ...
          <div className='grid gap-4 py-4'>
            ...
            <div className='grid gap-2'>
              ...
              <Input id='invite-message' placeholder='Looking forward to working with you!' />
            </div>
          </div>
          <DialogFooter>
            <Button variant='outline'>Cancel</Button>
        ...
        <DialogContent className='sm:max-w-[600px]'>
          ...
          <div className='grid gap-4 py-4'>
            ...
            <div className='grid gap-2'>
              ...
              <Input id='project-desc' defaultValue='A revolutionary new application' />
            </div>
            <div className='grid gap-2'>
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Single purpose per dialog</p>
          </div>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Clear primary and secondary actions</p>
          </div>
          ...
          <div className='rounded-lg border border-green-200 bg-green-50 dark:bg-green-950 p-4 space-y-2'>
            ...
            <p className='text-sm text-muted-foreground'>Title should explain the action</p>
          </div>
        </div>
      </div>
        ...
        <div className='space-y-3 text-sm'>
          ...
          <div className='flex items-start gap-2'>
            ...
            <div>
              ...
              <p className='text-muted-foreground'>Dialogs should be scannable at a glance</p>
            </div>
          </div>
        </div>
      </div>
...
export const AccessibilityTest: Story = {
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This description is announced by screen readers via aria-describedby. The title is
                  announced via aria-labelledby.
                </DialogDescription>
              </DialogHeader>
              <div className='space-y-4'>
                <p className='text-sm text-muted-foreground'>
                  Screen readers announce: "Dialog, Accessible Dialog Title, This description is
                  announced..."
                </p>
              </div>
              <DialogFooter>
          ...
          <Dialog open={open3} onOpenChange={setOpen3}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Close this dialog (Escape or button). Focus returns to the "Focus Return Test"
                  button.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'WCAG 2.1 AAA accessibility compliance testing: keyboard navigation, focus trap, screen readers, high contrast, focus return, and ARIA attributes.',
      },
    },
  },
};
...
export const EdgeCases: Story = {
          ...
          <Dialog>
            ...
            <DialogContent className='max-h-[80vh] overflow-y-auto'>
              <DialogHeader>
                ...
                <DialogDescription>Scrollable content with extensive text.</DialogDescription>
              </DialogHeader>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Test loading states and async operations.</DialogDescription>
              </DialogHeader>
              <div className='py-4'>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Test form validation and error display.</DialogDescription>
              </DialogHeader>
              <div className='space-y-4'>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Dialog with multiple action buttons.</DialogDescription>
              </DialogHeader>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Edge cases: empty content, extremely long text, special characters, async actions, form validation errors, multiple actions, no footer, and destructive actions.',
      },
    },
  },
};
...
export const Responsive: Story = {
        ...
        <Dialog>
          ...
          <DialogContent className='max-h-[90vh] overflow-y-auto'>
            <DialogHeader>
              ...
              <DialogDescription>Content scrolls if it exceeds viewport height.</DialogDescription>
            </DialogHeader>
            <div className='space-y-4'>
        ...
        <Dialog>
          ...
          <DialogContent className='max-h-[80vh] overflow-hidden flex flex-col'>
            <DialogHeader>
              ...
              <DialogDescription>Never exceeds 80% of viewport height.</DialogDescription>
            </DialogHeader>
            <div className='flex-1 overflow-y-auto space-y-4'>
              {Array.from({ length: 20 }, (_, i) => (
                <p key={i} className='text-sm text-muted-foreground'>
                  Line {i + 1}: Content that scrolls within the dialog if it exceeds the viewport
                  height constraint.
                </p>
              ))}
            </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Responsive behavior: mobile optimization, full-width adaptation, scrollable content, stacked buttons, size variants, viewport height handling, and touch optimization.',
      },
    },
  },
};
...
export const CompositionPatterns: Story = {
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Choose one or more items from the list.</DialogDescription>
              </DialogHeader>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Find products, people, or content.</DialogDescription>
              </DialogHeader>
              <div className='space-y-4'>
                <input
                  type='search'
          ...
          <Dialog>
            ...
            <DialogContent className='sm:max-w-[700px]'>
              <DialogHeader>
                ...
                <DialogDescription>image.jpg (1920x1080, 2.4 MB)</DialogDescription>
              </DialogHeader>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Composition patterns: multi-step wizards, dialogs with tabs, selection lists, file upload, search functionality, and image previews.',
      },
    },
  },
};
              ...
              <Dialog key={i}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>Performance test dialog instance {i + 1}</DialogDescription>
                  </DialogHeader>
                </DialogContent>
              </Dialog>
            ))}
  ...
  {/* Simple, focused content */}
            ...
            <div className='border rounded-lg p-4'>
              <h4 className='font-medium text-green-600 mb-2'>
                ✓ Do: Use controlled state for complex flows
              </h4>
              <pre className='bg-muted p-3 rounded text-xs overflow-x-auto'>
                <code>{`const [open, setOpen] = useState(false);
      ...
      <DialogContent>...</DialogContent>
            ...
            <div className='border rounded-lg p-4'>
              <h4 className='font-medium text-red-600 mb-2'>
                ✗ Avoid: Heavy rendering in dialog content
              </h4>
              <pre className='bg-muted p-3 rounded text-xs overflow-x-auto'>
                <code>{`// ❌ Don't do this
<DialogContent>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Performance characteristics: bundle size, animation times, multiple dialog instances, portal rendering, focus management, memory efficiency, and optimization best practices.',
      },
    },
  },
};
