        ...
        <div className="space-y-8 max-w-2xl">
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Min: <strong>${priceRange[0]}</strong></span>
                <span className="text-muted-foreground">Max: <strong>${priceRange[1]}</strong></span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              />
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">From: <strong>{ageRange[0]} years</strong></span>
                <span className="text-muted-foreground">To: <strong>{ageRange[1]} years</strong></span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              independently. Ensure thumbs cannot pass each other (handled automatically by Radix UI).
            </p>
          </div>
        </div>
      );
        ...
        <div className="space-y-8 max-w-2xl">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-sm text-muted-foreground">
                Value: {step10[0]} (increments of 10)
              </p>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-lg p-4">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li><strong>step=&#123;1&#125;</strong>: Precise control, smooth movement</li>
              <li><strong>step=&#123;5 or 10&#125;</strong>: Good for most use cases</li>
              <li><strong>step=&#123;25&#125;</strong>: Coarse control, fewer options</li>
              <li><strong>Decimal steps</strong>: Ratings, measurements</li>
            </ul>
          </div>
        </div>
      );
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex items-start gap-2">
            ...
            <p><strong>Keyboard support</strong> - Arrow keys, Home, End, Page Up/Down work correctly</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>ARIA slider role</strong> - Automatic via Radix UI primitives</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Value announcements</strong> - Screen readers announce value changes</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Focus visible</strong> - Clear focus indicator on thumb</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Touch-friendly</strong> - Minimum 44x44px touch target</p>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-green-600 font-bold">✓</span>
            <p><strong>Labels</strong> - Associate label with slider using htmlFor and id</p>
          </div>
        </div>
      </div>
