...
const AIAgentMonitoringDashboard: React.FC = () => {
  ...
  const getAgentTypeIcon = (type: string) => {
    switch (type) {
      case 'scout': return <VisibilityIcon />;
      case 'worker': return <SmartToyIcon />;
      case 'queen': return <PsychologyIcon />;
      case 'sentinel': return <WarningIcon />;
      case 'communicator': return <TrendingUpIcon />;
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'idle': return <PauseIcon color="warning" />;
      case 'error': return <ErrorIcon color="error" />;
      case 'maintenance': return <StopIcon color="info" />;
...
width="100%" height={300}>
                <LineChart data={performanceData}>
                  ...
                  <YAxis domain={[85, 100]} />
                  <RechartsTooltip />
                  <Line type="monotone" dataKey="swarmCoherence" stroke="var(--tf-trust-blue)" strokeWidth={2} name="Swarm Coherence" />
                  <Line type="monotone" dataKey="emergentIntelligence" stroke="var(--tf-success-green)" strokeWidth={2} name="Emergent Intelligence" />
                  <Line type="monotone" dataKey="quantumEntanglement" stroke="var(--tf-transcend-cyan)" strokeWidth={2} name="Quantum Entanglement" />
...
width="100%" height={300}>
                <RadarChart data={radarData}>
                  ...
                  <Radar name="Performance" dataKey="A" stroke="var(--tf-trust-blue)" fill="var(--tf-trust-blue)" fillOpacity={0.3} />
                </RadarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
