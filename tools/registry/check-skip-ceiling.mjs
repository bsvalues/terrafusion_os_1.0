...
const FILE_BASELINES = {
  ...
  'src/components/ui/scroll-area.test.tsx':  { count: 15, category: 'jsdom' },
  'src/components/ui/select.test.tsx':       { count: 19, category: 'jsdom,radix' },
  ...
  'src/tests/integration/EliteIntegrationTestSuite.test.ts':         { count: 11, category: 'backend' },
  'src/tests/security/DependencyVulnerabilities.test.ts':            { count: 1, category: 'security-audit-opt-in' },
  ...
  'src/__tests__/desktop/CommandHistory.test.tsx':                   { count: 2, category: 'missing' },
  'src/__tests__/EmergencyEliteQuantumInterface.test.tsx':           { count: 1, category: 'missing' },
  'src/__tests__/integration/CostForgeIntegrationPanel.test.tsx':     { count: 1, category: 'dead-import' },
  'src/__tests__/integration/suiteHandoff.contract.test.tsx':        { count: 1, category: 'dead-import' },
  'src/__tests__/journey/AssessorValuationJourney.contract.test.tsx': { count: 1, category: 'dead-import' },
  'src/__tests__/shell/launchSurfaceContractParcelWorkbench.contract.test.tsx': { count: 1, category: 'dead-import' },
  'src/__tests__/shell/shellAccessibility.contract.test.tsx':        { count: 1, category: 'dead-import' },
  'src/__tests__/shell/suiteStates.contract.test.tsx':               { count: 1, category: 'dead-import' },
  'src/__tests__/visual/materialRegression.test.tsx':                { count: 2, category: 'visual-baseline' },
  'src/__tests__/workbench/IncomeValuationPanel.test.tsx':           { count: 2, category: 'backend' },
  'src/__tests__/workbench/PropertyDais.test.tsx':                   { count: 31, category: 'contract-rewrite' },
  'src/__tests__/workflows/contextPreservation.contract.test.tsx':   { count: 1, category: 'dead-import' },
  'src/__tests__/workflows/operatorJourneys.contract.test.tsx':      { count: 1, category: 'dead-import' },
  'src/components/workbench/ContextRibbon.test.tsx':                 { count: 1, category: 'missing' },
  'src/pages/workbench/__tests__/WorkbenchTabBar.test.tsx':          { count: 1, category: 'dead-import' },
  'src/tests/accessibility/AccessibilityCompliance.test.tsx':        { count: 7, category: 'jsdom,a11y' },
  'src/tests/accessibility/ScreenReaderCompatibility.test.tsx':      { count: 1, category: 'jsdom,a11y' },
  'src/tests/performance/PerformanceBenchmarks.test.tsx':            { count: 4, category: 'perf-flaky-jsdom' },
  // ── AI / live feature placeholders ───────────────────────────────────────
  'src/features/gpt/components/__tests__/SystemGptAtlasPanel.test.tsx': { count: 15, category: 'ph' },
};
