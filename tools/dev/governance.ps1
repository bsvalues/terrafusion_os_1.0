...
Write-Host "`n[1/7] Repo shape guard..." -ForegroundColor Yellow
...
Write-Host "`n[2/7] Quarantine plan --check..." -ForegroundColor Yellow
...
Write-Host "`n[3/7] Quarantine toolchain tests (23t/4s)..." -ForegroundColor Yellow
...
Write-Host "`n[4/7] Phase83 platform tests (32t/11s)..." -ForegroundColor Yellow
