...
interface Segment {id: string;
  ...
  messaging: {
    ...
    keyPoints: string[];
    tone: string;};
  metrics: {reach: string;
    engagement: string;
    conversion: string;};
}

const StrategyDashboard: React.FC = () => {const [selectedSegment, setSelectedSegment] = useState<string>('small');
  ...
  return (<div
      style={{
        ...
        color: '#fff',
        padding: '2rem',}}
    >{/* Header */}<div style={{ textAlign: 'center', marginBottom: '3rem'}}><h1
          style={{
            fontSize: '2.5rem',
            fontWeight: 900,
            ...
            backgroundClip: 'text',
            marginBottom: '0.5rem',}}
        >Terrafusion Strategic Messaging Dashboard</h1><p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem'}}>Targeted messaging strategies for government market segments</p></div>{/* Segment Cards Grid */}<div
        style={{
          display: 'grid',
      ...
      >{segments.map((segment) => (<div
          ...
          ><div
            ...
            ><div
              ...
              >{selectedSegment === segment.id ? 'ACTIVE' : 'SELECT'}</div></div><h3
              style={{
                fontSize: '1.3rem',
                fontWeight: 700,
                color: '#fff',
            ...
            >{segment.name}</h3><p
              style={{
                ...
                lineHeight: 1.5,
                marginBottom: '1rem',}}
            >{segment.description}</p><div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
                fontSize: '0.8rem',}}
            ><div style={{ textAlign: 'center'}}><div style={{ color: segment.color, fontWeight: 700}}>{segment.metrics.reach}</div><div style={{ color: 'rgba(255,255,255,0.5)'}}>Reach</div></div><div style={{ textAlign: 'center'}}><div style={{ color: segment.color, fontWeight: 700}}>{segment.metrics.engagement}</div><div style={{ color: 'rgba(255,255,255,0.5)'}}>Engagement</div></div><div style={{ textAlign: 'center'}}><div style={{ color: segment.color, fontWeight: 700}}>{segment.metrics.conversion}</div><div style={{ color: 'rgba(255,255,255,0.5)'}}>Conversion</div></div></div></div>))}</div>{/* Detailed Messaging Panel */}<div
        style={{
      ...
      ><div
        ...
        ><div
          ...
          >{selectedSegmentData.icon}</div><div><h2
              style={{
                fontSize: '2rem',
                fontWeight: 700,
                color: '#fff',
                margin: '0 0 0.5rem 0',}}
            >{selectedSegmentData.name}</h2><p
              style={{
                color: 'rgba(255,255,255,0.7)',
                fontSize: '1rem',
                margin: 0,}}
            >{selectedSegmentData.description}</p></div></div><div
          style={{
            display: 'grid',
            gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))',
            gap: '2rem',}}
        >{/* Messaging Strategy */}<div
            style={{
          ...
          ><h3
              style={{
                ...
                alignItems: 'center',
                gap: '0.5rem',}}
            >📝 Messaging Strategy</h3><div style={{ marginBottom: '1rem'}}><h4
                style={{
                  fontSize: '1rem',
                  fontWeight: 600,
                  color: '#fff',
                  marginBottom: '0.5rem',}}
              >Primary Headline</h4><p
                style={{
                  color: selectedSegmentData.color,
                  fontSize: '1.1rem',
                  fontWeight: 600,
                  fontStyle: 'italic',}}
              >"{selectedSegmentData.messaging.headline}"</p></div><div style={{ marginBottom: '1rem'}}><h4
                style={{
                  fontSize: '1rem',
                  fontWeight: 600,
                  color: '#fff',
              ...
              >Tagline</h4><p
                style={{
                  ...
                  fontSize: '0.95rem',}}
              >{selectedSegmentData.messaging.tagline}</p></div><div><h4
                style={{
                  fontSize: '1rem',
                  fontWeight: 600,
                  color: '#fff',
              ...
              >Tone & Voice</h4><p
                style={{
                  color: 'rgba(255,255,255,0.7)',
                  fontSize: '0.9rem',}}
              >{selectedSegmentData.messaging.tone}</p></div></div>{/* Key Points */}<div
            style={{
              background: 'rgba(0,0,0,0.3)',
              borderRadius: '15px',
              padding: '1.5rem',}}
          ><h3
              style={{
                ...
                alignItems: 'center',
                gap: '0.5rem',}}
            >🎯 Key Messaging Points</h3><div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem'}}>{selectedSegmentData.messaging.keyPoints.map((point, index) => (<div
                  key={index}
                  style={{
                    display: 'flex',
                ...
                ><div
                  ...
                  >{index + 1}</div><p
                    style={{
                      ...
                      lineHeight: 1.4,
                      margin: 0,}}
                  >{point}</p></div>))}</div></div>{/* Performance Metrics */}<div
            style={{
              background: 'rgba(0,0,0,0.3)',
              borderRadius: '15px',
              padding: '1.5rem',
          ...
          ><h3
            ...
            >{[
                ...
                ><div
                  ...
                  >{metric.desc}</div></div>))}</div></div></div></div></div>
  );
};
