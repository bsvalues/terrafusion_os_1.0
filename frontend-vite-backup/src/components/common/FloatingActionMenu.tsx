...
const StyledSpeedDial = styled(SpeedDial)(() => ({position: 'fixed',
  bottom: 32,
  right: 32,
  zIndex: 1300,
  '& .MuiFab-primary': {
  ...
  '& .MuiSpeedDialAction-fab': {background: 'rgba(255, 255, 255, 0.1)',
...
interface FloatingActionMenuProps {onNewAssessment?: () => void;
  onSearch?: () => void;
  onAnalytics?: () => void;
  onSecurity?: () => void;
  onExport?: () => void;}

const FloatingActionMenu: React.FC<FloatingActionMenuProps>= ({onNewAssessment,
  onSearch,
  onAnalytics,
  onSecurity,
  onExport,}) => {const [open, setOpen] = useState(false);
