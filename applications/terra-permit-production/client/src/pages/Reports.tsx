...
import { BarChart3, Sparkles, FileText, Database  } from '@mui/icons-material';
    ...
    return (
      <div className="flex items-center justify-center py-10">
        <div className="text-center"><>
          ...
          <p
</> className="text-gray-500">Loading reports...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <Card>
        <CardHeader><>
          ...
          <CardDescription
</>>Generate and view permit processing reports</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-6">
            ...
            <h3
</> className="text-lg font-medium text-gray-900 mb-1">No Data Available</h3>
    ...
    <div><>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger
</> value="insights" className="flex items-center"><>

            <Sparkles className="h-3 w-3 mr-1 text-purple-500" /> 
            AI Insights
          </TabsTrigger>
          <TabsTrigger
</> value="advanced" className="flex items-center"><>

            <Database className="h-3 w-3 mr-1" />
            Advanced
          </TabsTrigger>
          <TabsTrigger
</> value="legacy" className="flex items-center">
        ...
        <TabsContent
</> value="insights" className="space-y-4">
          <Card>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2"><>
                    ...
                    <Badge
</> variant="outline" className="bg-gradient-to-r from-violet-500 to-purple-500 text-white border-0">
        ...
        <TabsContent value="advanced" className="space-y-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Interactive D3.js visualization of permit data</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="legacy" className="space-y-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Previous reporting format (for reference)</CardDescription>
            </CardHeader>
      ...
      .on("mouseover", function(event, d) {
        tooltip
          ...
          .html(`<>
            ...
            <div
</>>Enter Rate: ${(d.enterRate * 100).toFixed(1)}%</div><>

            <div>Total Permits: ${d.total}</div>
            <div
</>>Enter: ${d.enter} | Skip: ${d.skip}</div>
          `);
    ...
    <div className="space-y-4">
        ...
        >
          ...
          <SelectContent
            ...
            <SelectGroup><>
              ...
              <SelectItem
</> value="all">All time</SelectItem><>

              <SelectItem value="lastMonth">Last month</SelectItem>
              <SelectItem
</> value="lastWeek">Last week</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-4">
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200"><>
          ...
          <div
</> className="text-sm text-blue-600">Higher enter rates (70-90%)</div>
        </div>
        <div className="p-4 bg-green-50 rounded-lg border border-green-200"><>

          <div className="text-green-800 font-semibold">Residential</div>
          <div
</> className="text-sm text-green-600">Lower enter rates (20-40%)</div>
        </div>
        <div className="p-4 bg-amber-50 rounded-lg border border-amber-200"><>

          <div className="text-amber-800 font-semibold">Mixed</div>
          <div
</> className="text-sm text-amber-600">Variable enter rates (40-60%)</div>
        </div>
      </div>
    </div>
  );
