...
import { Activity, Server, Clock, Bell, BarChart2, Settings, HelpCircle  } from '@mui/icons-material';
        ...
        >
          <Card className="card" data-tour="dashboard-recent">
            <CardHeader className="card-header"><>
              ...
              <CardDescription
</> className="secondary-text">Latest system events and notifications</CardDescription>
            </CardHeader>
        ...
        >
          <Card className="card" data-tour="system-actions">
            <CardHeader className="card-header"><>
              ...
              <CardDescription
</> className="secondary-text">Quick actions and system controls</CardDescription>
            </CardHeader>
            <CardContent className="p-5 bg-white">
