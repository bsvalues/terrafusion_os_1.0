        ...
        <div className="grid gap-6">
          <div className="grid gap-6 md:grid-cols-4">
            <div className="bg-white p-4 rounded-lg border shadow-sm flex flex-col items-center justify-center"><>
              ...
              <div
</> className="text-sm text-gray-500 mt-1">Completed Modules</div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border shadow-sm flex flex-col items-center justify-center"><>
              ...
              <div
</> className="text-sm text-gray-500 mt-1">In-Progress Modules</div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border shadow-sm flex flex-col items-center justify-center"><>
              ...
              <div
</> className="text-sm text-gray-500 mt-1">Planned/Blocked Modules</div>
            </div>
