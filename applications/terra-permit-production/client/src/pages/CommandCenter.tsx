          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2"><>
                ...
                <Progress
</> value={metrics.permits.rate} className="h-2" />
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between text-sm"><>
                  ...
                  <span>CPU:</span>
                  <span
</> className={getStatusColor(100 - metrics.performance.cpu, 70)}>
                ...
                <div className="flex justify-between text-sm"><>
                  ...
                  <span>Memory:</span>
                  <span
</> className={getStatusColor(100 - metrics.performance.memory, 70)}>
            ...
            <div className="space-y-2"><>
              ...
              <div
                ...
                <div className="flex items-center justify-between text-sm"><>
                  ...
                  <Badge
</> variant="default" className="text-xs">Healthy</Badge>
                </div>
                <div className="flex items-center justify-between text-sm"><>
                ...
                <div className="flex items-center justify-between text-sm"><>
                  ...
                  <Badge
</> variant="default" className="text-xs">Optimal</Badge>
                </div>
                <div className="flex items-center justify-between text-sm"><>

                  <span>Security Monitor</span>
                  <Badge
</> variant="default" className="text-xs">Active</Badge>
                </div>
              </div>
            </div>
