    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs value={selectedCounty} onValueChange={setSelectedCounty} className="w-full">
        <TabsList className="grid w-full grid-cols-4"><>
          ...
          <TabsTrigger
</> value="washington">Washington County</TabsTrigger><>

          <TabsTrigger value="multnomah">Multnomah County</TabsTrigger>
          <TabsTrigger
</> value="clackamas">Clackamas County</TabsTrigger>
        </TabsList>
              ...
              {quantumDecisionMutation.data && (
                <div className="mt-4 p-4 border rounded-lg bg-muted/50">
                  <div className="flex items-center justify-between mb-3"><>
                    ...
                    <Badge
</> className={getAutomationBadge(quantumDecisionMutation.data.automationLevel)}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                    <div><>
                      ...
                      <div
</> className="font-medium capitalize">{quantumDecisionMutation.data.decision.recommendation}</div>
                    </div>
                    <div><>

                      <span className="text-sm text-muted-foreground">Confidence</span>
                      <div
</> className={`font-medium ${getConfidenceColor(quantumDecisionMutation.data.decision.confidence)}`}>
                    ...
                    <div><>
                      ...
                      <div
</> className="font-medium">{quantumDecisionMutation.data.decision.processingTime}ms</div>
                    </div>
                  </div>
