              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-end gap-2"><>
                    ...
                    <Badge
</> className="bg-terrafusion-green/20 text-terrafusion-primary hover:bg-terrafusion-green/30">+12%</Badge>
                  </div>
                ...
                <div className="flex gap-3 p-3 border rounded-lg bg-terrafusion-blue/10">
                  ...
                  <div
                    ...
                    <div className="flex gap-2 mt-2"><>
                      ...
                      <Badge
</> variant="outline" className="text-xs">Strategic</Badge>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <CardContent>
          <Tabs defaultValue="upload" onValueChange={setActiveTab} value={activeTab}>
            <TabsList className="grid w-full grid-cols-2 mb-6">
              ...
              <TabsTrigger
</> value="export" className="flex items-center">
