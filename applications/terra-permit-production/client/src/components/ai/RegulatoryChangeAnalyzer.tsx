          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="px-6 pt-2">
              <TabsList className="grid grid-cols-5 w-full"><>
                ...
                <TabsTrigger
</> value="changes" className="text-xs">Key Changes</TabsTrigger><>

                <TabsTrigger value="timeline" className="text-xs">Timeline</TabsTrigger>
                <TabsTrigger
</> value="compliance" className="text-xs">Compliance</TabsTrigger>
            ...
            <ScrollArea className="h-[400px] px-1">
              <TabsContent value="summary" className="p-6 pt-4 space-y-4 m-0">
                <div>
                  ...
                  <p
</> className="text-sm">{analysis.summary}</p>
                  ...
                  <div className="flex gap-4 mt-4">
                    <div className="flex-1 border rounded-lg p-4"><>
                      ...
                      <div
</> className={`text-4xl font-bold ${getImpactColor(analysis.impactScore)}`}>
                    ...
                    <div className="flex-1 border rounded-lg p-4"><>
                      ...
                      <div
                        ...
                        <div className="flex justify-between text-xs"><>
                          ...
                          <span>Affected</span>
                          <span
</> className="font-medium">{analysis.permitImpacts.affected}</span>
                        </div>
                        <div className="flex justify-between text-xs"><>

                          <span>Unaffected</span>
                          <span
</> className="font-medium">{analysis.permitImpacts.unaffected}</span>
                        </div>
                        <div className="flex justify-between text-xs"><>

                          <span className="text-green-600">Improved</span>
                          <span
</> className="font-medium">{analysis.permitImpacts.improved}</span>
                        </div>
                        <div className="flex justify-between text-xs"><>

                          <span className="text-red-600">Complicated</span>
                          <span
</> className="font-medium">{analysis.permitImpacts.complicated}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    {analysis.timeline.map((phase /* , index */) => (
                      <div key={index} className="relative mb-8">
                        ...
                        <div
                          ...
                          <div
</> className="text-xs text-muted-foreground mt-1 mb-2">{phase.timeframe}</div>
                  ...
                  <div
                    ...
                    {analysis.recommendations.map((recommendation /* , index */) => (
                      <div key={index} className="flex items-start gap-2 p-2 bg-primary/5 rounded-md">
                        ...
                        <p
</> className="text-sm">{recommendation}</p>
                      </div>
                    ))}
                  </div>
                </div>
