    ...
    <Card className={`${className} border-primary/20`}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="px-6 pt-2">
          <TabsList className="grid grid-cols-2 w-full"><>
            ...
            <TabsTrigger
</> value="results" className="text-xs" disabled={extractedDocuments.length === 0}>
                          ...
                          <TableBody>
                            {Object.entries(selectedDocument.extracted.permitDetails || {}).map(([key, value]) => (
                              <TableRow key={key}><>
                                ...
                                <TableCell
</> className="py-1.5 text-xs">{value}</TableCell>
                              </TableRow>
                            ))}
                          </TableBody>
                        </Table>
                          ...
                          <TableBody>
                            {selectedDocument.extracted.keyFields.map((field, idx) => (
                              <TableRow key={idx}><>
                                ...
                                <TableCell
</> className="text-xs">{field.value}</TableCell>
      ...
      <CardFooter className="p-4 pt-0">
        <div className="w-full flex justify-between"><>
          ...
          <Button
</> variant="outline" size="sm" className="text-xs" disabled={extractedDocuments.length === 0}>
