      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="px-6 pt-2">
          <TabsList className="grid grid-cols-5 w-full"><>
            ...
            <TabsTrigger
</> value="pipeline" className="text-xs">Pipeline</TabsTrigger><>

            <TabsTrigger value="anomalies" className="text-xs">Anomalies</TabsTrigger>
            <TabsTrigger
</> value="optimizations" className="text-xs">Optimizations</TabsTrigger>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="border rounded-lg p-4"><>
                  ...
                  <div
                    ...
                    <Progress
</> value={insights.summary.optimizationScore} className="h-2" />
                  </div>
                </div>
                ...
                <div className="border rounded-lg p-4"><>
                  ...
                  <div
                    ...
                    <Progress
                      ...
                      value={insights.summary.processingEfficiency} 
                      className={`h-2 ${
                  ...
                  <div key={stage.id} className="border rounded-lg p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center"><>
                        ...
                        <h4
</> className="font-medium text-sm">{stage.name}</h4>
                      </div>
                      {stage.bottleneck && (
                    ...
                    <div className="grid grid-cols-3 gap-3 mb-3">
                      <div className="bg-secondary/20 rounded p-2 text-center"><>
                        ...
                        <div
</> className="text-sm font-medium">{formatTime(stage.processingTime)}</div>
                      </div>
                      <div className="bg-secondary/20 rounded p-2 text-center"><>

                        <div className="text-xs text-muted-foreground">Error Rate</div>
                        <div
</> className="text-sm font-medium">{stage.errorRate}%</div>
                      </div>
                      <div className="bg-secondary/20 rounded p-2 text-center"><>

                        <div className="text-xs text-muted-foreground">Throughput</div>
                        <div
</> className="text-sm font-medium">{stage.throughput}/min</div>
                      </div>
                    </div>
                    ...
                    <div key={anomaly.id} className="border rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-3 mb-3">
                        <div className="bg-secondary/20 rounded p-2"><>
                          ...
                          <div
</> className="text-sm font-medium">{anomaly.affectedPermits}</div>
                        </div>
                        <div className="bg-secondary/20 rounded p-2"><>
                      ...
                      <div className="bg-primary/10 p-3 rounded-md"><>
                        ...
                        <div
</> className="text-sm">{anomaly.suggestedAction}</div>
                      </div>
                ...
                <div
                  ...
                  <div className="space-y-2 mb-3">
                    <div className="flex justify-between items-center"><>
                      ...
                      <Badge
</> variant="outline" className="text-xs">Enabled</Badge>
                    </div>
                    <div className="flex justify-between items-center"><>
                    ...
                    <div className="flex justify-between items-center"><>
                      ...
                      <Badge
</> variant="outline" className="text-xs">Manual approval</Badge>
                    </div>
                  </div>
                  ...
                  <div key={suggestion.id} className="border rounded-lg p-4">
                    ...
                    <div
                      ...
                      <div className="bg-secondary/20 rounded p-2"><>
                        ...
                        <div
</> className="text-sm font-medium">{suggestion.estimatedImprovement}</div>
                      </div>
                      <div className="bg-secondary/20 rounded p-2"><>

                        <div className="text-xs text-muted-foreground">Category</div>
                        <div
</> className="text-sm font-medium capitalize">{suggestion.category}</div>
                      </div>
                    </div>
              ...
              <div className="border rounded-lg p-4"><>
                ...
                <div
                  ...
                  <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200"><>
                    ...
                    <div
</> style={{ width: `${100 - (insights.predictiveModels.processingTimeOptimization.potentialAverage / insights.predictiveModels.processingTimeOptimization.currentAverage) * 100}%` }} className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-primary"></div>
                  </div>
