      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <div className="px-6 pt-2">
          <TabsList className="grid grid-cols-4 w-full"><>
            ...
            <TabsTrigger
</> value="strategies" className="text-xs">Strategies</TabsTrigger><>

            <TabsTrigger value="priorities" className="text-xs">Priorities</TabsTrigger>
            <TabsTrigger
</> value="bottlenecks" className="text-xs">Bottlenecks</TabsTrigger>
          </TabsList>
        </div>
              ...
              <div
                ...
                {insights.prioritizationRecommendations.map((permit /* , index */) => (
                  <div key={index} className="border rounded-lg p-3">
                    ...
                    <div
</> className="flex items-center mt-3 text-xs text-muted-foreground">
              ...
              <div
                ...
                {insights.bottlenecks.map((bottleneck /* , index */) => (
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div
</> className="mt-4 bg-muted/30 p-2 rounded-md">
