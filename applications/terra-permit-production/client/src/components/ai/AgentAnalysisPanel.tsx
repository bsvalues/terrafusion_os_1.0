      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-4 mb-4"><>
            ...
            <TabsTrigger
</> value="bulk-analysis" id="tour-bulk-analysis"><>

              <BarChart4 className="h-4 w-4 mr-1" />
              Bulk Analysis
            </TabsTrigger>
            <TabsTrigger
</> value="neighborhood-analysis" id="tour-neighborhood-analysis">Neighborhood Analysis</TabsTrigger>
      ...
      {analysis && !showImpactAnalysis ? (
        <div className="space-y-4">
          <div><>
            ...
            <div
</> className="p-4 bg-slate-50 rounded-md whitespace-pre-wrap">
              {analysis.analysis}
            </div>
          </div>
      ...
      {showImpactAnalysis && (
        <div className="space-y-4 mt-4 p-4 border rounded-md">
          <div className="flex items-center justify-between"><>
            ...
            <Button
</> variant="ghost" size="sm" onClick={() => setShowImpactAnalysis(false)}>
              <X className="h-4 w-4" />
            </Button>
          </div>
        ...
        <>
          <div className="space-y-4 p-4 border rounded-md">
            ...
            <div><>
              ...
              <Select
</> value={optimization} onValueChange={handleOptimizationChange}>
                  ...
                  <SelectItem value="speed">
                    <div className="flex items-center gap-2">
                      ...
                      <div><>
                        ...
                        <span>Speed</span>
                        <div
</> className="text-xs text-gray-500">Faster analysis with less depth</div>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="balanced">
                    <div className="flex items-center gap-2">
                      ...
                      <div><>
                        ...
                        <span>Balanced</span>
                        <div
</> className="text-xs text-gray-500">Good balance of speed and depth</div>
                      </div>
                    </div>
                  </SelectItem>
                  <SelectItem value="depth">
                    <div className="flex items-center gap-2">
                      ...
                      <div><>
                        ...
                        <span>Depth</span>
                        <div
</> className="text-xs text-gray-500">Deeper analysis but slower processing</div>
                      </div>
                    </div>
                  </SelectItem>
                </SelectContent>
          ...
          <div className="p-4 border rounded-md bg-slate-50"><>
            ...
            <ul
              ...
              <li className="flex items-start gap-2"><>
                ...
                <span
</>>Identify patterns and trends across multiple permits</span>
              </li>
              <li className="flex items-start gap-2"><>

                <Badge variant="outline" className="mt-1">2</Badge>
                <span
</>>Compare decisions and detect inconsistencies</span>
              </li>
              <li className="flex items-start gap-2"><>

                <Badge variant="outline" className="mt-1">3</Badge>
                <span
</>>Generate comprehensive insights with cross-permit context</span>
              </li>
              <li className="flex items-start gap-2"><>

                <Badge variant="outline" className="mt-1">4</Badge>
                <span
</>>Save time by processing multiple permits simultaneously</span>
              </li>
            </ul>
          </div>
        </>
              ...
              <div><>
                ...
                <div
                  ...
                  <div className="border rounded-md p-3 bg-white text-center"><>
                    ...
                    <div
</> className="text-xs text-gray-500">Avg. processing time per permit</div>
                  </div>
                  <div className="border rounded-md p-3 bg-white text-center"><>
                    ...
                    <div
</> className="text-xs text-gray-500">Permits with insights</div>
                  </div>
                </div>
              </div>
              ...
              <div className="h-40">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    ...
                    <Tooltip
</> formatter={(value) => [`${value} permits`, 'Count']} />
                    <Legend />
                  </PieChart>
                </ResponsiveContainer>
              </div>
                    ...
                    <ul className="text-xs space-y-1">
                      {Object.entries(analysisResults.trends.categories).map(([category, count], i) => (
                        <li key={i} className="flex justify-between"><>
                          ...
                          <span>{category}:</span>
                          <span
</> className="font-semibold">{count}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                    ...
                    <ul className="text-xs space-y-1">
                      {Object.entries(analysisResults.trends.approvalRates).map(([type, rate], i) => (
                        <li key={i} className="flex justify-between"><>
                          ...
                          <span>{type}:</span>
                          <span
</> className="font-semibold">{(Number(rate) * 100).toFixed(0)}%</span>
                        </li>
                      ))}
                    </ul>
                  </div>
              ...
              {analysisResults.results.map((result, i) => (
                <div key={i} className="p-3 border rounded-md">
                  <div className="flex items-center justify-between mb-2"><>
                    ...
                    <Badge
</> variant={result.insights && result.insights.length > 0 ? "default" : "secondary"}>
                  ...
                  {result.insights && result.insights.length > 0 && (
                    <div className="mt-2 pt-2 border-t"><>
                      ...
                      <div
</> className="text-xs">{result.insights[0]}</div>
                    </div>
                  )}
                </div>
              ))}
