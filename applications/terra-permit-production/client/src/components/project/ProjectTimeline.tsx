      ...
      <div
        ...
        <div
          ...
          {Object.entries(groupedByMonth).map(([monthYear, monthModules], monthIndex) => (
            <div key={monthYear} className="relative">
              ...
              >
                ...
                <span
</> className="ml-4 text-sm font-semibold bg-primary/10 px-3 py-1 rounded-full">
                  {monthYear}
                </span>
              </motion.div>
          ...
          >
            ...
            <span
</> className="ml-4 text-sm font-medium text-green-700">
      ...
      <div className="mt-8 pt-4 border-t border-gray-200"><>
        ...
        <div
          ...
          <div className="bg-gray-50 p-3 rounded-lg"><>
            ...
            <div
</> className="text-xs text-gray-500">Total Modules</div>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg"><>
            ...
            <div
</> className="text-xs text-gray-500">Total Tasks</div>
          </div>
          ...
          <div className="bg-gray-50 p-3 rounded-lg"><>
            ...
            <div
</> className="text-xs text-gray-500">Task Completion</div>
          </div>
        </div>
      </div>
    </div>
