      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between"><>
            ...
            <div
</> className="font-bold">{overallProgress}%</div>
          </div><>
        ...
        <Tabs defaultValue="overview" className="mt-6">
          <TabsList className="grid w-full grid-cols-4"><>
            ...
            <TabsTrigger
</> value="modules" onClick={() => setActiveTab('modules')}>Modules</TabsTrigger><>

            <TabsTrigger value="tasks" onClick={() => setActiveTab('tasks')}>Tasks</TabsTrigger>
            <TabsTrigger
</> value="dependencies" onClick={() => setActiveTab('dependencies')}>Dependencies</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="overview" className="space-y-4 mt-4">
            <div className="text-sm text-gray-700"><>
              ...
              <p
</> className="mt-2">The overview shows high-level progress across all aspects of the project.</p>
            </div>
            ...
            <div className="divide-y rounded-md border border-gray-100 overflow-hidden bg-white">
              {getFilteredModules().length > 0 ? getFilteredModules().map(module => (
                ...
                <div className="p-6 text-center text-gray-500">
                  ...
                  <h3
</> className="text-sm font-medium mb-1">No modules found</h3>
              ...
              <div className="bg-white rounded-md border border-gray-100 p-3 col-span-1"><>
                ...
                <div
                  ...
                  >
                    ...
                    <span>Completed</span>
                    <Badge
</> variant="outline" className="ml-auto border-green-200 text-green-700">
                  ...
                  >
                    ...
                    <span>In Progress</span>
                    <Badge
</> variant="outline" className="ml-auto border-blue-200 text-blue-700">
                  ...
                  >
                    ...
                    <span>Blocked</span>
                    <Badge
</> variant="outline" className="ml-auto border-red-200 text-red-700">
                ...
                <div className="divide-y max-h-[400px] overflow-y-auto p-1">
                  ...
                  {modules.flatMap(module => 
                    ...
                    <div className="p-6 text-center text-gray-500">
                      ...
                      <h3
</> className="text-sm font-medium mb-1">No tasks found</h3>
                      <p className="text-xs text-gray-400">
                        {filterStatus 
