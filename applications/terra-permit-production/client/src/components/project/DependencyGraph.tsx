...
import { AlertCircle, CheckCircle2, Clock, CircleSlash  } from '@mui/icons-material';
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm text-gray-700"><>
        ...
        <p
</> className="mt-2">Arrows indicate dependencies, flowing from prerequisite modules to dependent modules.</p>
      </div>
