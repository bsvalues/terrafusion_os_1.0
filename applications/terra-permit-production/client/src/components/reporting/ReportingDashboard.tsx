      ...
      <Card className="w-full mt-4">
        ...
        <CardContent>
          <div className="animate-pulse space-y-4"><>
            ...
            <div
</> className="h-40 bg-gray-200 rounded w-full"></div><>
        ...
        <div
          ...
          <div className="flex items-center space-x-2">
            ...
            ><>
              ...
              <option
</> value="week">Past Week</option><>

              <option value="month">Past Month</option>
              <option
</> value="quarter">Past Quarter</option>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="pt-6"><>
              ...
              <p
</> className="text-xs text-muted-foreground">Total Permits</p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6"><>
              ...
              <div
                ...
                <div
</> className="text-xs text-green-600 ml-auto flex items-center">
          ...
          <Card>
            <CardContent className="pt-6"><>
              ...
              <div
                ...
                <div
</> className="text-xs text-orange-600 ml-auto flex items-center">
          ...
          <Card>
            <CardContent className="pt-6"><>
              ...
              <p
</> className="text-xs text-muted-foreground">Total Value</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-4">
            ...
            <TabsTrigger
</> value="details" className="flex items-center"><>

              <List className="h-4 w-4 mr-2" />
              Details
            </TabsTrigger>
            <TabsTrigger
</> value="trends" className="flex items-center">
