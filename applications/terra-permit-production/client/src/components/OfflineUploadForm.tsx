          ...
          <TabsContent value="export" className="space-y-4">
            ...
            {offlineUploads.length > 0 ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p
</> className="text-sm">Process permits first to enable export</p>
              </div>
            )}
          </TabsContent>
                ...
                <AccordionContent
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between"><>
                      ...
                      <span
</> className="font-medium">Active</span>
                    </div>
                    <div className="flex justify-between"><>

                      <span className="text-muted-foreground">Stored Uploads:</span>
                      <span
</> className="font-medium">{offlineUploads.length}</span>
                    </div>
                    <div className="flex justify-between"><>

                      <span className="text-muted-foreground">Stored Permits:</span>
                      <span
</> className="font-medium">{offlinePermits.length}</span>
                    </div>
                    <div className="flex justify-between"><>

                      <span className="text-muted-foreground">Pending Syncs:</span>
                      <span
</> className="font-medium">{pendingUploadCount}</span>
                    </div>
                  </div>
                </AccordionContent>
              </AccordionItem>
