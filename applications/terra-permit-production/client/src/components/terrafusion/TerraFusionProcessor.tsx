              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-end gap-2"><>
                    ...
                    <Badge
</> className="bg-green-500/20 text-primary hover:bg-green-500/30">+12%</Badge>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-end gap-2"><>
                    ...
                    <span
</> className="text-xs text-gray-500">of 42</span>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex items-end gap-2"><>
                    ...
                    <span
</> className="text-xs">min/permit</span>
                  </div>
              ...
              <div
                ...
                <div className="flex gap-3 p-3 border rounded-lg bg-amber-50">
                  ...
                  <div
                    ...
                    <div
</> className="text-xs text-gray-600 mt-0.5">Processing permits by neighborhood or type can increase efficiency by 18%</div>
                    <div className="flex gap-2 mt-2"><>

                      <Badge variant="outline" className="text-xs">High Impact</Badge>
                      <Badge
</> variant="outline" className="text-xs">Easy to Implement</Badge>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3 p-3 border rounded-lg bg-blue-50">
                  ...
                  <div
                    ...
                    <div
</> className="text-xs text-gray-600 mt-0.5">Based on current backlog analysis, residential permits should be prioritized</div>
                    <div className="flex gap-2 mt-2"><>

                      <Badge variant="outline" className="text-xs">Medium Impact</Badge>
                      <Badge
</> variant="outline" className="text-xs">Quick Win</Badge>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3 p-3 border rounded-lg bg-green-50">
                  ...
                  <div
                    ...
                    <div
</> className="text-xs text-gray-600 mt-0.5">Using templates for renewal permits can save approximately 45 minutes per day</div>
                    <div className="flex gap-2 mt-2"><>

                      <Badge variant="outline" className="text-xs">High Impact</Badge>
                      <Badge
</> variant="outline" className="text-xs">Requires Setup</Badge>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {error && (
            ...
            {processingStep === 0 ? (
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <div
</> className="text-sm text-gray-500 mb-4 max-w-md mx-auto">
                ...
                <CardContent>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between p-2 border-b"><>
                      ...
                      <span
</> className="font-medium">TFP-{simulatedUploadId}</span>
                    </div>
                    <div className="flex justify-between p-2 border-b"><>

                      <span className="text-gray-500">Processing Date</span>
                      <span
</> className="font-medium">{new Date().toLocaleDateString()}</span>
                    </div>
                    <div className="flex justify-between p-2 border-b"><>

                      <span className="text-gray-500">Time to Process</span>
                      <span
</> className="font-medium">1 minute 42 seconds</span>
                    </div>
                    <div className="flex justify-between p-2 border-b"><>

                      <span className="text-gray-500">Processor Version</span>
                      <span
</> className="font-medium">TerraFusionPermit v2.5.1</span>
                    </div>
                    <div className="flex justify-between p-2"><>

                      <span className="text-gray-500">Process Mode</span>
                      <Badge
</> variant="outline">Standard</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          {showSuccessAlert ? (
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <Card>
                        ...
                        <CardContent><>
                          ...
                          <div
</> className="text-xs text-muted-foreground mt-1">Upload #{simulatedUploadId || 0}</div>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent><>
                          ...
                          <div
</> className="text-xs text-muted-foreground mt-1">Average per permit</div>
                        </CardContent>
                      </Card>
                      ...
                      <Card>
                        ...
                        <CardContent><>
                          ...
                          <div
</> className="text-xs text-muted-foreground mt-1">All permits processed</div>
                        </CardContent>
                      </Card>
                    </div>
                  </div>
            ...
            <div className="py-10 text-center">
              <div className="flex flex-col items-center">
                ...
                <h3
</> className="text-lg font-medium mb-2">TerraFusionPermit Results</h3><>
