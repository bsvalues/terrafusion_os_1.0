...
import { CheckCircle, FileCheck, Server, Shield, Settings, Zap, Bot  } from '@mui/icons-material';
  ...
  return (
    <div>
      <div className="flex flex-col items-center mb-8">
        ...
        <h2
</> className="text-xl font-semibold text-center">System Configuration Complete!</h2>
        ...
        <div className="border rounded-md p-4 shadow-sm">
          ...
          <div className="pl-7 space-y-2 text-sm">
            <div className="flex items-center justify-between"><>
              ...
              <span
</> className="font-medium">{config.general.applicationName}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Default Theme:</span>
              <span
</> className="font-medium capitalize">{config.general.defaultTheme}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Default View:</span>
              <span
</> className="font-medium capitalize">{config.general.defaultView}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Notifications:</span>
              <span
</> className="font-medium">{config.general.enableNotifications ? 'Enabled' : 'Disabled'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="border rounded-md p-4 shadow-sm">
          ...
          <div className="pl-7 space-y-2 text-sm">
            <div className="flex items-center justify-between"><>
              ...
              <span
</> className={`font-medium ${config.ai.apiKeyConfigured ? 'text-green-600' : 'text-amber-600'}`}>
            ...
            <div className="flex items-center justify-between"><>
              ...
              <span
</> className="font-medium">{config.ai.aiModel}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Content Filtering:</span>
              <span
</> className="font-medium">{config.ai.enableContentFiltering ? 'Enabled' : 'Disabled'}</span>
            </div>
            <div className="flex items-center justify-between"><>
        ...
        <div className="border rounded-md p-4 shadow-sm">
          ...
          <div className="pl-7 space-y-2 text-sm">
            <div className="flex items-center justify-between"><>
              ...
              <span
</> className="font-medium capitalize">{config.database.connectionType}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Automated Backups:</span>
              <span
</> className="font-medium">{config.database.enableBackups ? 'Enabled' : 'Disabled'}</span>
            </div>
            {config.database.enableBackups && (
              <>
                <div className="flex items-center justify-between"><>
                  ...
                  <span
</> className="font-medium capitalize">{config.database.backupFrequency}</span>
                </div>
                <div className="flex items-center justify-between"><>

                  <span className="text-muted-foreground">Retention Period:</span>
                  <span
</> className="font-medium">{config.database.retentionPeriod} days</span>
                </div>
              </>
            )}
          </div>
        ...
        <div className="border rounded-md p-4 shadow-sm">
          ...
          <div className="pl-7 space-y-2 text-sm">
            <div className="flex items-center justify-between"><>
              ...
              <span
</> className="font-medium">{config.security.requireMFA ? 'Required' : 'Optional'}</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Session Timeout:</span>
              <span
</> className="font-medium">{config.security.sessionTimeout} minutes</span>
            </div>
            <div className="flex items-center justify-between"><>

              <span className="text-muted-foreground">Password Policy:</span>
              <span
</> className="font-medium capitalize">{config.security.passwordPolicy}</span>
            </div>
            <div className="flex items-center justify-between"><>
