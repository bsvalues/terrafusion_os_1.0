            ...
            <div className="grid gap-2"><>
              ...
              >
                ...
                <SelectContent
                  ...
                  <SelectItem
</> value="POST">POST</SelectItem><>

                  <SelectItem value="PUT">PUT</SelectItem>
                  <SelectItem
</> value="DELETE">DELETE</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </>
            ...
            <div className="grid gap-2"><>
              ...
              >
                ...
                <SelectContent
                  ...
                  <SelectItem
</> value="json">JSON</SelectItem><>

                  <SelectItem value="xml">XML</SelectItem>
                  <SelectItem
</> value="excel">Excel</SelectItem>
            ...
            <div className="grid gap-2"><>
              ...
              >
                ...
                <SelectContent
                  ...
                  <SelectItem
</> value="azure-blob">Azure Blob Storage</SelectItem><>

                  <SelectItem value="gcp-storage">Google Cloud Storage</SelectItem>
                  <SelectItem
</> value="sftp">SFTP Server</SelectItem>
    ...
    return (
      <Card className={className}>
        <CardHeader><>
          ...
          <CardDescription
</>>Connect to external data sources and services</CardDescription>
        </CardHeader>
          ...
          <div className="space-y-4"><>
              ...
              <div className="grid gap-2"><>
                ...
                >
                  ...
                  <SelectContent
                    ...
                    <SelectItem
</> value="database">Database</SelectItem><>

                    <SelectItem value="file">File System</SelectItem>
                    <SelectItem
</> value="service">Cloud Service</SelectItem>
                ...
                <div className="grid gap-2"><>
                  ...
                  >
                    ...
                    <SelectContent
                      ...
                      <SelectItem
</> value="basic">Basic Auth</SelectItem><>

                      <SelectItem value="api_key">API Key</SelectItem>
                      <SelectItem
</> value="oauth2">OAuth 2.0</SelectItem>
                  ...
                  <div className="grid gap-2"><>
                    ...
                    >
                      ...
                      <SelectContent
                        ...
                        <SelectItem
</> value="30">Every 30 minutes</SelectItem><>

                        <SelectItem value="60">Hourly</SelectItem>
                        <SelectItem
</> value="360">Every 6 hours</SelectItem><>

                        <SelectItem value="720">Every 12 hours</SelectItem>
                        <SelectItem
</> value="1440">Daily</SelectItem>
            ...
            {testResult && (
              <Alert variant={testResult.success ? "default" : "destructive"} className="mt-4">
                ...
                <AlertDescription
</>>{testResult.message}</AlertDescription>
              </Alert>
            )}
        ...
        {isConfiguring && selectedConnector && (
          <div className="space-y-4">
            <div className="flex items-center justify-between"><>
              ...
              <Badge
</> className="ml-2">{getStatusBadge(selectedConnector.status)}</Badge>
            </div>
                          ...
                          <TableCell>
                            {connector.schedule?.enabled ? (
                              <div className="text-sm">
                                <div className="flex items-center">
                                  <Refresh className="h-3.5 w-3.5 mr-1.5 text-muted-foreground" />
                      ...
                      connectors
                        ...
                        .map((connector) => (
                          <TableRow key={connector.id}>
                            ...
                            <TableCell
</>>{formatDate(connector.lastConnected)}</TableCell>
                            <TableCell>
                              {connector.schedule?.enabled ? (
                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4 text-center">
                          ...
                          <div className="space-y-1"><>
                            ...
                            <div
</> className="text-xs text-muted-foreground">Errors</div>
                          </div>
                        </div>
                        ...
                        {connector.health.latency !== undefined && (
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm"><>
                              ...
                              <span
</> className="font-medium">{connector.health.latency} ms</span>
                            </div>
                            <Progress 
                        ...
                        {connector.health.uptimePercentage !== undefined && (
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm"><>
                              ...
                              <span
</> className="font-medium">{connector.health.uptimePercentage.toFixed(1)}%</span>
                            </div>
                            <Progress 
                        ...
                        {connector.health.lastError && (
                          <div className="text-xs text-red-500 mt-2"><>
                            ...
                            <div
</>>{connector.health.lastError}</div>
                          </div>
                        )}
