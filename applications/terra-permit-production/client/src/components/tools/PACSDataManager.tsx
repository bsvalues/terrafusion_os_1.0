  ...
  return (
    <Card className="w-full">
      <CardHeader><>
        ...
        <CardDescription
</>>Manage property value imports and exports for PACS integration</CardDescription>
      </CardHeader>
      <CardContent>
        <Tabs defaultValue="import">
          <TabsList className="mb-4"><>
            ...
            <TabsTrigger
</> value="import-logs">Import Logs</TabsTrigger><>

            <TabsTrigger value="export-logs">Export Logs</TabsTrigger>
            <TabsTrigger
</> value="health">Health Status</TabsTrigger>
          </TabsList>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <div className="flex items-center"><>
                        ...
                        <span
</> className="ml-2">Records: {validationResult.record_count}</span>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div><>
                          ...
                          <p
</> className="text-sm">{importResult.import_id}</p>
                        </div>
                        <div><>

                          <p className="text-sm font-medium">Total Records</p>
                          <p
</> className="text-sm">{importResult.total_records}</p>
                        </div>
                        <div><>

                          <p className="text-sm font-medium">Processed</p>
                          <p
</> className="text-sm">{importResult.processed_records}</p>
                        </div>
                        <div><>

                          <p className="text-sm font-medium">Success</p>
                          <p
</> className="text-sm text-green-600">{importResult.success_count}</p>
                        </div>
                        <div><>

                          <p className="text-sm font-medium">Errors</p>
                          <p
</> className="text-sm text-red-600">{importResult.error_count}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="flex justify-between items-center"><>
                ...
                <div
                  ...
                  <Button 
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Refresh className="h-4 w-4 mr-2" />}
                    Refresh
                  </Button>
                </div>
              </div>
                    ...
                    <TableBody>
                      {importLogs.map((log) => (
                        <TableRow key={log.import_id}><>
                          ...
                          <TableCell
</>>{log.success_count}/{log.total_records}</TableCell><>

                          <TableCell>{formatDate(log.started_at)}</TableCell>
                          <TableCell
</>>{log.completed_at ? formatDate(log.completed_at) : 'In progress'}</TableCell>
                          <TableCell>
                            <AlertDialog>
                                    ...
                                    <div className="space-y-4 py-2">
                                      <div className="grid grid-cols-2 gap-2">
                                        <div><>
                                          ...
                                          <p className="text-sm font-medium">Import ID</p>
                                          <p
</> className="text-sm">{log.import_id}</p>
                                        </div>
                                        <div><>
                                        ...
                                        <div><>
                                          ...
                                          <p
</> className="text-sm">{log.import_type}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Started At</p>
                                          <p
</> className="text-sm">{formatDate(log.started_at)}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Completed At</p>
                                          <p
</> className="text-sm">{log.completed_at ? formatDate(log.completed_at) : 'N/A'}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Total Records</p>
                                          <p
</> className="text-sm">{log.total_records}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Success Count</p>
                                          <p
</> className="text-sm text-green-600">{log.success_count}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Error Count</p>
                                          <p
</> className="text-sm text-red-600">{log.error_count}</p>
                                        </div>
                                      </div>
                                      {log.notes && (
                                        <div><>
                    ...
                    <TableBody>
                      {exportLogs.map((log) => (
                        <TableRow key={log.export_id}><>
                          ...
                          <TableCell
</>>{formatDate(log.started_at)}</TableCell><>
                                    ...
                                    <div className="space-y-4 py-2">
                                      <div className="grid grid-cols-2 gap-2">
                                        <div><>
                                          ...
                                          <p
</> className="text-sm">{log.export_id}</p>
                                        </div>
                                        <div><>
                                        ...
                                        <div><>
                                          ...
                                          <p
</> className="text-sm">{log.export_type}</p>
                                        </div>
                                        <div><>

                                          <p className="text-sm font-medium">Format</p>
                                          <p
</> className="text-sm">{log.format.toUpperCase()}</p>
                                        </div>
                                        <div><>
                                        ...
                                        <div><>
                                          ...
                                          <p
</> className="text-sm">{log.record_count}</p>
                                        </div>
                                      </div>
                                      {log.notes && (
                                        <div><>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {Object.entries(healthStatus.details).map(([key, value]: [string, any]) => (
                            <div key={key}><>
                              ...
                              <p
</> className="text-sm">{value?.toString() || 'N/A'}</p>
                            </div>
                          ))}
                        </div>
                      )}
