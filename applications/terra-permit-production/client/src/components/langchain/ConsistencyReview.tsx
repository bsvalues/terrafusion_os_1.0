      ...
      <CardContent className="pt-6">
        <Tabs defaultValue="potential-errors" className="w-full">
          <TabsList className="mb-4">
            ...
            <TabsTrigger
</> value="inconsistencies" className="flex items-center gap-1"><>

              <GitBranch className="h-4 w-4" /> 
              Inconsistencies ({data.inconsistencies.length})
            </TabsTrigger>
            <TabsTrigger
</> value="recommendations" className="flex items-center gap-1">
                    ...
                    <CardContent className="py-3">
                      <div className="space-y-3">
                        <div><>
                          ...
                          <p
</> className="text-sm text-muted-foreground">{error.issue}</p>
                        </div>
                        <div><>

                          <h4 className="text-sm font-medium mb-1">Recommendation:</h4>
                          <p
</> className="text-sm text-muted-foreground">{error.recommendation}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="py-3">
                      <div className="space-y-3">
                        ...
                        <div><>
                          ...
                          <p
</> className="text-sm text-muted-foreground">{inconsistency.description}</p>
                        </div>
                        <div><>

                          <h4 className="text-sm font-medium mb-1">Suggested Resolution:</h4>
                          <p
</> className="text-sm text-muted-foreground">{inconsistency.resolution}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
