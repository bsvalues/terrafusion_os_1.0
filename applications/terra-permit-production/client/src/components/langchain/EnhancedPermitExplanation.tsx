...
import { AlertCircle, BookOpen, Lightbulb, Scale, Sparkles  } from '@mui/icons-material';
      ...
      <CardContent className="pt-6">
        <Tabs defaultValue="explanation" className="w-full">
          <TabsList className="mb-4">
            ...
            <TabsTrigger
</> value="regulations" className="flex items-center gap-1">
