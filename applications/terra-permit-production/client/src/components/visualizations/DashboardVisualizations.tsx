    ...
    >
      <div className="flex items-center justify-between">
        <motion.div variants={itemVariants}><>
          ...
          <p
</> className="text-gray-600">Interactive visualizations that reveal system patterns</p>
        </motion.div>
      ...
      <AnimatePresence>
        {showHelp && (
          ...
          ><>
            ...
            <ul
</> className="list-disc list-inside text-blue-700 text-sm space-y-1"><>

              <li>Click on any data point to see detailed information</li>
                            <li
</>>Toggle between daily, weekly, and monthly views for different perspectives</li><>

              <li>Click on insights to emphasize the related data patterns</li>
                            <li
</>>Filter metrics by category to focus on specific areas</li><>

              <li>Anomaly detection automatically highlights unusual patterns</li>
                            <li
</>>Use the refresh button to update all visualizations with latest data</li>
            </ul>
            <Button 
              variant="link" 
              size="sm" 
          ...
          <motion.div variants={itemVariants}>
            <Card>
              <CardHeader className="card-header">
                ...
                <CardDescription
</> className="secondary-text">Weekly traffic analysis by day</CardDescription>
              </CardHeader>
              <CardContent className="px-5 py-6 bg-white">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div
                    ...
                    <div className="p-3 border border-dashed border-purple-300 rounded-md mt-4"><>
                      ...
                      <ul
</> className="mt-2 text-xs text-purple-700 space-y-1"><>

                        <li>• Scale resources for midweek traffic peaks</li>
                            <li
</>>• Schedule maintenance during weekend lows</li>
          ...
          <motion.div variants={itemVariants}>
            <Card>
              <CardHeader className="card-header"><>
                ...
                <CardDescription
</> className="secondary-text">Current allocation of system resources</CardDescription>
              </CardHeader>
              <CardContent className="px-5 py-6 bg-white">
        ...
        <TabsContent value="metrics" className="space-y-4" ref={metricsRef}>
          <motion.div variants={itemVariants}>
            <Card>
              ...
              <CardFooter
</> className="card-footer bg-blue-50 rounded-b-lg">
                <div className="w-full">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center p-2 bg-white rounded-md border border-blue-200"><>
                      ...
                      <div
</> className="text-2xl font-bold text-green-600">4</div>
                    ...
                    <div className="text-center p-2 bg-white rounded-md border border-blue-200"><>
                      ...
                      <div
</> className="text-2xl font-bold text-blue-600">1</div>
                      <div className="text-xs text-gray-500">metrics</div>
                    </div>
                    <div className="text-center p-2 bg-white rounded-md border border-blue-200"><>
                      ...
                      <div
</> className="text-2xl font-bold text-amber-600">1</div>
                      <div className="text-xs text-gray-500">metrics</div>
                    </div>
                  </div>
                </div>
                      ...
                      {[
                        ...
                        >
                          ...
                          <div><>
                            ...
                            <p
</> className="text-sm text-gray-600">{anomaly.description}</p>
                          </div>
                          <Badge 
                            variant="outline" 
                            className={`ml-auto ${
