          ...
          >
            {(user || isDevelopment) && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-60 p-2 shadow-lg border border-blue-100">
                  <DropdownMenuLabel className="bg-blue-50 rounded-md mb-1">
                    <div className="flex flex-col space-y-1"><>

                      <p className="text-base font-bold text-blue-800">{user?.displayName || user?.username || 'Development User'}</p>
                      <p
</> className="text-sm text-blue-600">{user?.email || 'dev@example.com'}</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator className="my-2"/>
                  <DropdownMenuItem className="cursor-pointer py-2 hover:bg-blue-50 hover:text-blue-700" asChild>
                    <Link href="/settings">
                  ...
                  <DropdownMenuSeparator className="my-2"/>
                  <DropdownMenuItem onClick={handleLogout} className="cursor-pointer py-2 hover:bg-red-50 text-red-600 font-medium">
