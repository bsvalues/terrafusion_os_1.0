          ...
          <div className="flex flex-col gap-2"><>
            ...
            <dl
              ...
              <div className="flex justify-between"><>
                ...
                <dd
</> className="font-medium">{records.length}</dd>
              </div>
              <div className="flex justify-between"><>

                <dt className="text-muted-foreground">Unique Fields Modified:</dt>
                <dd
</> className="font-medium">{Object.keys(fieldDistribution).length}</dd>
              </div>
              <div className="flex justify-between"><>
              ...
              <div className="flex justify-between"><>
                ...
                <dd
</> className="font-medium">{sourceDistribution.length}</dd>
              </div>
            </dl>
          </div>
