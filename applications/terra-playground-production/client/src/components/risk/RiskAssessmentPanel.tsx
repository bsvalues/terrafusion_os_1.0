...
export function RiskAssessmentPanel({ propertyId, className = '' }: RiskAssessmentPanelProps) {
  ...
  const getRiskLevelIcon = (level: string) => {
    ...
    if (level === 'Moderate') return <Warning className="h-5 w-5 text-amber-500" />;
    ...
    return (
      <Card className={className}>
        <CardHeader><>
          ...
          <CardDescription
</>>Loading property risk analysis...</CardDescription>
        </CardHeader>
  ...
  if (!data) {
    return (
      <Alert className={className}>
        ...
        <AlertDescription
</>>No risk assessment data is available for this property.</AlertDescription>
      </Alert>
    );
  }
      ...
      <CardContent>
        <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-4 mb-6"><>
            ...
            <TabsTrigger
</> value="economic">Economic</TabsTrigger><>

            <TabsTrigger value="regulatory">Regulatory</TabsTrigger>
            <TabsTrigger
</> value="environmental">Environmental</TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent><>
                  ...
                  <div
</> className={`text-sm mt-1 ${getRiskLevelColor(data.riskLevel)}`}>
              ...
              <Card>
                ...
                <CardContent><>
                  ...
                  <div
</> className="text-sm mt-1 text-muted-foreground">Identified factors</div>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent><>
                  ...
                  <div
</> className="text-sm mt-1 text-muted-foreground">Highest risk score</div>
                </CardContent>
              </Card>
            </div>
