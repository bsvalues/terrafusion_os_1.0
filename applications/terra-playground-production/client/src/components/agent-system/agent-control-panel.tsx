    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start">
        <div><>
          ...
          <p
</> className="text-muted-foreground">Monitor and control the multi-agent system</p>
        </div><>
      ...
      <Tabs
</> defaultValue="agents" className="space-y-4">
        <TabsList>
        ...
        <TabsContent value="agents" className="space-y-4">
          <div className="flex justify-between items-center"><>
            ...
            <Button
</> variant="outline" size="sm" onClick={fetchAgents} disabled={loadingAgents}>
              <Refresh className={`h-4 w-4 mr-2 ${loadingAgents ? 'animate-spin' : ''}`} />
              Refresh
            </Button>
          </div>
              ...
              >
                ...
                <CardContent className="text-sm"><>
                  ...
                  <div
                    ...
                    ></div>
                    <span
</> className="capitalize">{agent.status}</span>
                  </div>
            ...
            {agents.length === 0 && !loadingAgents && (
              <Card className="col-span-full">
                <CardContent className="pt-6 flex flex-col items-center justify-center h-40">
                  ...
                  <Button
</> variant="outline" size="sm" className="mt-4" onClick={fetchAgents}>
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between">
                <div><>
                  ...
                  <CardDescription
</>>Direct an agent to perform a specific action</CardDescription>
                </div>
          ...
          <div className="flex justify-between items-center"><>
            ...
            <div
              ...
              <Button variant="outline" size="sm" onClick={fetchTasks} disabled={loadingTasks}><>
                ...
                <Refresh className={`h-4 w-4 mr-2 ${loadingTasks ? 'animate-spin' : ''}`} />
                Refresh
              </Button>
              <Button
          ...
          <ScrollArea className="h-[400px] rounded-md border">
            {tasks.length > 0 ? (
                  ...
                  <Card key={task.id} className="mb-4">
                    ...
                    <CardContent className="text-sm"><>
                      ...
                      <div
                        ...
                        ></div>
                        <span
</> className="capitalize">{task.status}</span>
              ...
              <div className="h-full flex flex-col items-center justify-center py-10">
                ...
                <Button
</> variant="outline" size="sm" className="mt-4" onClick={fetchTasks}>
                  <Refresh className="h-4 w-4 mr-2" />
                  Refresh
                </Button>
              </div>
        ...
        <TabsContent value="settings" className="space-y-6">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Configure how agents communicate and operate</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2"><>
                ...
                <Input
</> id="connection-timeout" type="number" placeholder="30000" />
              </div>
              ...
              <div className="space-y-2"><>
                ...
                <Input
</> id="agent-timeout" type="number" placeholder="5000" />
              </div>
