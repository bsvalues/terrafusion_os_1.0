...
import { Send, Bot, X, ChevronLeft, ChevronRight, Settings  } from '@mui/icons-material';
      ...
      >
        ...
        >
          ...
          <TabsContent value="chat" className="flex-1 flex flex-col overflow-hidden p-0">
            ...
            <form
</> onSubmit={handleSubmit} className="border-t border-gray-200 p-4 pt-2">
              <div className="flex items-center gap-2">
                <Input
          ...
          <TabsContent value="settings" className="p-4 flex-1 overflow-y-auto">
            <div className="space-y-4">
              <div><>
                ...
                <Select
</> value={selectedProvider} onValueChange={setSelectedProvider}>
                  <SelectTrigger><>
            ...
            <div className="space-y-4"><>
              ...
              <ul className="list-disc pl-5 text-sm text-gray-600 space-y-2"><>
                ...
                <li>Answer questions about property assessment processes</li>
                            <li
</>>Explain property valuation methods</li><>

                <li>Provide context about property data</li>
                            <li
</>>Help with navigating the property assessment system</li>
