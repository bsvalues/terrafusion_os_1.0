...
import { CheckCircle2, XCircle, Lightbulb, Navigation, Copy, Refresh  } from '@mui/icons-material';
      ...
      <div className="flex flex-wrap gap-2 mt-3">
        {result.actions.map((action /* , index */) => {
          ...
          if (action.type === VoiceCommandActionType.NAVIGATE) {
            ...
            icon = <Refresh className="h-4 w-4 mr-1" />;
          }
      ...
      <CardContent>
        ...
        {result.error && (
          <Alert variant="destructive" className="mb-3">
            ...
            <AlertDescription
</> className="ml-2">{result.error}</AlertDescription>
          </Alert>
        )}
