...
export function VoiceCommandShortcuts({ userId, className = '' }: VoiceCommandShortcutsProps) {
  ...
  const renderEmpty = () => (
    <div className="text-center py-12 text-muted-foreground">
      ...
      <p
</> className="mt-1 mb-4">You don't have any voice command shortcuts yet.</p>
  ...
  const renderCreateDialog = () => (
    <DialogContent className="sm:max-w-[600px]">
      <DialogHeader><>
        ...
        <DialogDescription
</>>Create a new shortcut for a voice command.</DialogDescription>
      </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem><>
                  ...
                  <FormDescription
</>>What you'll say to trigger this command</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem><>
                  ...
                  <FormDescription
</>>Category for organizing commands</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem><>
                ...
                <FormDescription
</>>The full command that will be executed</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem><>
                  ...
                  <FormDescription
</>>Higher priority takes precedence</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5"><>
                    ...
                    <FormDescription
</>>Activate this shortcut</FormDescription>
                  </div>
                  <FormControl><>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                  <div className="space-y-0.5"><>
                    ...
                    <FormDescription
</>>Available in all contexts</FormDescription>
                  </div>
                  <FormControl><>
  ...
  const renderEditDialog = () => (
    <DialogContent className="sm:max-w-[600px]">
      <DialogHeader><>
        ...
        <DialogDescription
</>>Update an existing voice command shortcut.</DialogDescription>
      </DialogHeader>
      ...
      <CardHeader>
        <div className="flex justify-between items-center"><>
          ...
          <div
            ...
            <Dialog
</> open={isCreating} onOpenChange={setIsCreating}>
              <DialogTrigger asChild>
                <Button size="sm">
                  <Plus className="h-4 w-4 mr-2" />
                  New Shortcut
            ...
            <Table>
              <TableHeader>
                <TableRow><>
                  ...
                  <TableHead
</> className="w-[150px]">Shortcut</TableHead><>

                  <TableHead>Command</TableHead>
                  <TableHead
</> className="w-[100px]">Type</TableHead><>

                  <TableHead className="w-[70px]">Priority</TableHead>
                  <TableHead
</> className="text-right w-[120px]">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
