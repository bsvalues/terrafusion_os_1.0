...
export function EnhancedVoiceCommandResults({
        ...
        <CollapsibleContent className="px-4 pb-4 border-t">
          <div className="mt-4 space-y-3">
            ...
            <div className="text-sm"><>
              ...
              <div
</> className="bg-muted p-2 rounded-md">{result.command}</div>
            </div>
            ...
            {result.processedCommand && result.processedCommand !== result.command && (
              <div className="text-sm"><>
                ...
                <div
</> className="bg-muted p-2 rounded-md">{result.processedCommand}</div>
              </div>
            )}
            ...
            {result.response && (
              <div className="text-sm"><>
                ...
                <div
</> className="bg-muted p-2 rounded-md whitespace-pre-wrap">{result.response}</div>
              </div>
            )}
            ...
            {result.error && (
              <div className="text-sm"><>
                ...
                <div
</> className="bg-red-50 p-2 rounded-md text-red-500">{result.error}</div>
              </div>
            )}
  ...
  const renderEmpty = () => (
    <div className="text-center py-12 text-muted-foreground">
      ...
      <p
</> className="mt-1 mb-4">Use the voice button or type a command to get started.</p>
    </div>
  );
