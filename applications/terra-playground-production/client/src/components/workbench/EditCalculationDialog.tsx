...
import { Save, X, PlayCircle  } from '@mui/icons-material';
      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-4">
          <TabsList className="grid w-full grid-cols-3"><>
            ...
            <TabsTrigger
</> value="formula">Formula</TabsTrigger>
          ...
          <TabsContent value="details" className="space-y-4 py-4">
            <div className="grid grid-cols-4 gap-4">
              ...
              <div><>
                ...
                <Select
</> value={formData.type} onValueChange={value => handleChange('type', value)}>
                  <SelectTrigger><>
                  ...
                  <SelectContent
                    ...
                    {calculationTypes.length > 0 ? (
                      ...
                      <><>
                        ...
                        <SelectItem
</> value="adjustment">Adjustment</SelectItem><>

                        <SelectItem value="market">Market</SelectItem>
                        <SelectItem
</> value="depreciation">Depreciation</SelectItem>
          ...
          <TabsContent value="implementation" className="py-4">
            ...
            {testResult && (
              <div className="mt-4 p-3 border rounded-md bg-slate-50"><>
                ...
                <pre
</> className="mt-1 p-2 bg-slate-100 rounded-sm text-sm overflow-auto">
