        ...
        <CardDescription
          ...
          <ul className="mt-2 list-disc list-inside space-y-1"><>
            ...
            <li>Show me property data for [property ID]</li>
                            <li
</>>Generate a valuation report for [address]</li><>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div><>
            ...
            <AgentVoiceInterface
</> onResult={handleVoiceResult} agentId={agentId} subject={subject} />
          </div>
          ...
          <div>
            ...
            {!lastResult ? (
              <div className="rounded-md border p-4 text-muted-foreground text-center"><>
                ...
                <p
</> className="text-sm mt-2">Try saying something to the agent.</p>
              </div>
            ) : (
