...
import { Loader2, Share2, Eye, Trash2, Download, QrCode, Copy, Link, Mail  } from '@mui/icons-material';
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <div className="container mx-auto py-6"><>
      ...
      <Card
        ...
        <CardHeader><>
          ...
          <CardDescription
</>>Configure what to include in the property stories</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-4"><>
          ...
          <TabsTrigger
</> value="multiple">Multiple Properties</TabsTrigger><>

          <TabsTrigger value="compare">Compare Properties</TabsTrigger>
          <TabsTrigger
</> value="share">Property Insight Sharing</TabsTrigger>
        </TabsList>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>Configure and create a shareable property insight</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid w-full gap-4">
                  <div className="flex flex-col space-y-1.5"><>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col space-y-1.5"><>
                      ...
                      <Select
</> value={shareInsightType} onValueChange={setShareInsightType}>
                        ...
                        <SelectContent
                          ...
                          <SelectItem
</> value="comparison">Comparison</SelectItem>
                    ...
                    <div className="flex flex-col space-y-1.5"><>
                      ...
                      <Select
</> value={shareFormat} onValueChange={setShareFormat}>
                        ...
                        <SelectContent
                          ...
                          <SelectItem
</> value="detailed">Detailed</SelectItem>
            ...
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>View a shared property insight using the share ID</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid w-full gap-4">
                  <div className="flex flex-col space-y-1.5"><>
          ...
          <div className="grid grid-cols-1 gap-4 mt-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex justify-between items-center"><>
                    ...
                    <Badge
</>>{getShareMutation.data.insightType}</Badge>
                  </CardTitle>
                  <CardDescription>
            ...
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>List of all available property insight shares</CardDescription>
              </CardHeader>
              <CardContent>
      ...
      <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="flex gap-2 justify-end"><>
            ...
            <Button
</> onClick={handleSendEmail} disabled={emailSending || !emailRecipient}>
              {emailSending ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Sending...
