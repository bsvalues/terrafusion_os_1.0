  ...
  return (
    <Tabs defaultValue="settings" className="w-full">
      <TabsList className="w-full max-w-md mx-auto grid grid-cols-3">
        ...
        <TabsTrigger
</> value="test" className="flex items-center gap-1"><>

          <Terminal className="h-4 w-4" />
          Testing
        </TabsTrigger>
        <TabsTrigger
</> value="examples" className="flex items-center gap-1">
      ...
      <TabsContent value="settings" className="space-y-6 mt-6">
            ...
            <div className="space-y-2"><>
              ...
              >
                ...
                <SelectContent
                  ...
                  <SelectItem
</> value="plandex-code-pro-v1">Plandex Code Pro v1</SelectItem>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription
</>>Check the status of your Plandex AI integration</CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2"><>
                ...
                <div
                  ...
                  <div><>
                    ...
                    <h3 className="text-sm font-medium mb-2">BugReport Fixing</h3>
                    <Input
</> placeholder="Enter buggy code snippet" className="mb-2" />
