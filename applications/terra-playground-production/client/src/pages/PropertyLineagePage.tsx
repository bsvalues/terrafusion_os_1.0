      ...
      <div className="container mx-auto py-8">
        <Card>
          <CardHeader><>
            ...
            <CardDescription
</>>Property ID is missing</CardDescription>
          </CardHeader>
          <CardContent><>
      ...
      <div className="container mx-auto py-8">
        <Card>
          <CardHeader><>
            ...
            <CardTitle>Error</CardTitle>
            <CardDescription
</>>Failed to load property data</CardDescription>
          </CardHeader>
          <CardContent><>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div><>
                  ...
                  <p
</> className="font-medium">{activeEntry.fieldName}</p>
                </div>
                ...
                <div><>
                  ...
                  <div
</> className="p-2 bg-muted/50 rounded-md whitespace-pre-wrap">
                ...
                <div><>
                  ...
                  <p
</>>{activeEntry.source.charAt(0).toUpperCase() + activeEntry.source.slice(1)}</p>
                </div>
                ...
                {activeEntry.details && (
                  <div><>
                    ...
                    <div
</> className="p-2 bg-muted/50 rounded-md text-xs whitespace-pre-wrap">
          ...
          {lineageQuery.isError ? (
            <Card>
              <CardHeader><>
                ...
                <CardTitle>Error</CardTitle>
                <CardDescription
</>>Failed to load lineage data</CardDescription>
              </CardHeader>
              <CardContent><>

                <p>There was an error loading the property lineage data. Please try again later.</p>
                <Button
</> className="mt-4" onClick={() => lineageQuery.refetch()}>
