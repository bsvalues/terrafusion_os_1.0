...
import { Loader2, CheckCircle, Warning, X, Upload, FileText  } from '@mui/icons-material';
            ...
            <Alert>
              ...
              <AlertDescription
                ...
                <div className="mt-2 space-y-2"><>
                  ...
                  <p
</>>Valid Records: {uploadMutation.data.validation.validRecords}</p><>
  ...
  const renderStagedProperties = () => (
    <Card>
      <CardHeader><>
        ...
        <CardDescription
</>>Review and manage properties staged for import.</CardDescription>
      </CardHeader>
      <CardContent>
        {stagedPropertiesQuery.isLoading ? (
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription
</>>Failed to load staged properties. Please try again.</AlertDescription>
          </Alert>
        ) : stagedPropertiesQuery.data?.properties?.length === 0 ? (
    ...
    <div className="container py-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-2"><>
          ...
          <TabsTrigger
</> value="staged">Staged Properties</TabsTrigger>
        </TabsList>
        <div className="mt-6"><>
