    ...
    <DevelopmentWorkspaceLayout>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger
</> value="components" className="flex items-center justify-center"><>

            <Code className="h-4 w-4 mr-1" />
            Components
          </TabsTrigger>
          <TabsTrigger
</> value="calculations" className="flex items-center justify-center"><>

            <Calculator className="h-4 w-4 mr-1" />
            Calculations
          </TabsTrigger>
          <TabsTrigger
</> value="validations" className="flex items-center justify-center">
                  ...
                  <TableBody>
                    {filteredModels.map(model => (
                      ...
                      ><>
                        ...
                        <TableCell
</>>{new Date(model.lastModifiedAt).toLocaleDateString()}</TableCell>
        ...
        <TabsContent value="components" className="mt-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Manage reusable components for assessment models</CardDescription>
            </CardHeader>
            <CardContent>
              {!selectedModel ? (
                <div className="text-center py-8">
