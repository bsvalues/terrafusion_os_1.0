    ...
    <Card className="overflow-hidden transition-all hover:shadow-md">
      ...
      <CardContent className="p-4 pt-0">
        <div className="flex flex-wrap gap-2 mt-2">
          ...
          <Badge
</> variant="outline" className="bg-gray-100 text-gray-800">
            {project.status}
          </Badge>
        </div>
      </CardContent>
    ...
    <Card className="overflow-hidden transition-all hover:shadow-md">
      ...
      <CardContent className="p-4 pt-0">
        <div className="flex flex-wrap gap-2 mt-2"><>
          ...
          <Badge
</> variant="outline" className="bg-purple-100 text-purple-800">
            {template.framework}
          </Badge>
    ...
    <DevelopmentWorkspaceLayout>
      <div className="flex justify-between items-center mb-6">
        <div><>
          ...
          <p
</> className="text-gray-500">Build and deploy assessment applications with ease</p>
        </div>
        ...
        <TabsContent value="projects" className="m-0">
          {isLoadingProjects ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed border-gray-300">
              ...
              <h3
</> className="text-lg font-medium text-gray-900 mb-2">No projects yet</h3><>

              <p className="text-gray-500 max-w-md mx-auto mb-4">
                Create your first project to get started with the TaxI_AI Development Platform.
              </p>
              <Button
</> onClick={() => setShowNewProjectDialog(true)}>Create Project</Button>
            </div>
          ) : (
        ...
        <TabsContent value="templates" className="m-0">
          {isLoadingTemplates ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed border-gray-300">
              ...
              <h3
</> className="text-lg font-medium text-gray-900 mb-2">No templates available</h3>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2"><>
              ...
              ><>
                ...
                <option
</> value="STREAMLIT">Streamlit App</option><>

                <option value="STATIC">Static Web App</option>
                <option
</> value="API">API Server</option>
              </select>
            </div>
            <div className="grid gap-2"><>
