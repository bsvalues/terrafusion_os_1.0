    ...
    <div className="container mx-auto py-6"><>
      ...
      <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-7 mb-6"><>
          ...
          <TabsTrigger
</> value="schema">Schema Registry</TabsTrigger><>

          <TabsTrigger value="security">Security Policies</TabsTrigger>
          <TabsTrigger
</> value="services">Active Services</TabsTrigger><>
        ...
        <TabsContent value="overview">
          {isLoadingStatus ? (
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription
</>>Failed to load Master Development Agent status.</AlertDescription>
            </Alert>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader><>
                  ...
                  <CardDescription
</>>Current operational status</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center"><>
                      ...
                      <span
</> className="text-sm">{agentStatus?.componentName || 'Unknown'}</span>
                    </div>
                    <div className="flex justify-between items-center"><>

                      <span className="text-sm font-medium">Role:</span>
                      <span
</> className="text-sm">{agentStatus?.role || 'Unknown'}</span>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardHeader><>
                  ...
                  <CardDescription
</>>Available agent functions</CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>Validate an entity against its schema</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...validationForm}>
                  <form
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem><>
                          ...
                          <FormDescription
</>>The type of entity to validate</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem><>
                          ...
                          <FormDescription
</>>JSON representation of the entity</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
            ...
            <Card>
              <CardHeader><>
                ...
                <CardDescription
</>>Update or create a schema definition</CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem><>
                          ...
                          <FormDescription
</>>The type of schema to update</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem><>
                          ...
                          <FormDescription
</>>JSON schema definition</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                ...
                <CardContent>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div><>
                      ...
                      <Badge
</> variant="outline">{schemaUpdateResult.version}</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        <TabsContent value="security">
          {isLoadingPolicies ? (
            ...
            <Alert variant="destructive">
              ...
              <AlertTitle>Error</AlertTitle>
              <AlertDescription
</>>Failed to load security policies.</AlertDescription>
            </Alert>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="md:col-span-2">
              ...
              <Card className="md:col-span-2">
                <CardHeader><>
                  ...
                  <CardDescription
</>>Complete security policy configuration</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <TabsContent value="services">
          {isLoadingStatus ? (
            ...
            <Alert variant="destructive">
              ...
              <AlertTitle>Error</AlertTitle>
              <AlertDescription
</>>Failed to load active services.</AlertDescription>
            </Alert>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <div><>
                    ...
                    <CardDescription
</>>Currently active system services</CardDescription>
                  </div><>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <div><>
                    ...
                    <CardDescription
</>>Current integration system status</CardDescription>
                  </div><>
              ...
              <Card className="md:col-span-2">
                <CardHeader><>
                  ...
                  <CardDescription
</>>Health metrics for core services</CardDescription>
                </CardHeader>
                <CardContent>
