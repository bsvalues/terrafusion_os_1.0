    ...
    <div className="container mx-auto p-4">
      ...
      <Tabs defaultValue="single" value={activeTab} onValueChange={setActiveTab} className="mb-8">
        <TabsList className="grid grid-cols-3 mb-4"><>
          ...
          <TabsTrigger
</> value="compare">Compare Properties</TabsTrigger>
        ...
        <Card className="mb-6">
          <CardHeader><>
            ...
            <CardDescription
</>>Configure how property stories are generated</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2"><>
                ...
                >
                  ...
                  <SelectContent
                    ...
                    <SelectItem
</> value="anthropic">Anthropic</SelectItem><>

                    <SelectItem value="perplexity">Perplexity</SelectItem>
                    <SelectItem
</> value="template">Template (Fastest)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <TabsContent value="single" className="space-y-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Choose a property to generate a story for</CardDescription>
            </CardHeader>
            <CardContent>
              {propertiesLoading ? (
                    ...
                    properties.map(property => (
                      ...
                      >
                        <div><>
                          ...
                          <div
</> className="text-sm text-muted-foreground">{property.address}</div>
                        </div>
        ...
        <TabsContent value="compare" className="space-y-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Choose 2-5 properties to generate a comparison</CardDescription>
            </CardHeader>
            <CardContent>
              {propertiesLoading ? (
                <div className="flex items-center justify-center p-4">
        ...
        <TabsContent value="batch" className="space-y-4">
          <Card>
            <CardHeader><>
              ...
              <CardDescription
</>>Generate stories for multiple properties at once</CardDescription>
            </CardHeader>
            <CardContent>
              {propertiesLoading ? (
                <div className="flex items-center justify-center p-4">
