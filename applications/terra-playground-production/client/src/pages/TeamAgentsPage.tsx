      ...
      <div className="flex flex-col space-y-6">
        <div className="flex items-center justify-between">
          <div><>
            ...
            <p
</> className="text-muted-foreground">Manage and collaborate with AI team agents</p>
          </div>
          <Badge
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-1">
            <CardHeader>
              ...
              <CardDescription
</>>Available team members and their status</CardDescription>
            </CardHeader>
            <CardContent>
              {agentsLoading ? (
              ...
              <CardHeader>
                <div className="flex items-center justify-between"><>
                  ...
                  <TabsList
                    ...
                    <TabsTrigger
</> value="tasks" className="flex items-center gap-2">
                      <ClipboardList className="h-4 w-4" />
                      Tasks
                    </TabsTrigger>
                  </TabsList>
