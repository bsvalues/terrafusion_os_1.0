...
import { Loader2, QrCode, FileDown, Copy, Link as LinkIcon  } from '@mui/icons-material';
...
<>
        ...
        <CardDescription
</>>Choose how you want to share this property insight</CardDescription>
      </CardHeader>
      <CardContent>
...
<>
            ...
            <TabsTrigger
</> value="qrcode">QR Code</TabsTrigger>
...
<>
                  ...
                  <Button
</> variant="outline" onClick={handleOpenQRCodeInNewTab}>
...
<>
                ...
                <Input
</> id="pdfTitle" value={pdfTitle} onChange={e => setPdfTitle(e.target.value)} />
              </div>
