...
import { Loader2, Settings as SettingsIcon, Command, Package  } from '@mui/icons-material';
...
<>
                  ...
                  <TabsTrigger
</> value="commands">Commands</TabsTrigger>
...
<>
                      ...
                      <p
</> className="mt-1 text-base">{currentExtension.version}</p>
                    </div>
