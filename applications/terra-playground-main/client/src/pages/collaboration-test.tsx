...
import { AlertCircle, CheckCircle2, Users, Edit, MousePointerClick, Send  } from '@mui/icons-material';
...
<>
            ...
            <span
</> className="text-xs text-muted-foreground">{time}</span>
          </div>
          <div
...
<>
              ...
              <CardDescription
</>>WebSocket connection information</CardDescription>
            </CardHeader>
            <CardContent>
...
<>
                  ...
                  <Badge
</> variant={sessionJoined ? 'outline' : 'secondary'} className="py-1">
...
<>
                ...
                <CardDescription
</>>Send test messages to the server</CardDescription>
              </CardHeader>
...
<>
              ...
              <CardDescription
</>>WebSocket communication history</CardDescription>
            </CardHeader>
            <CardContent>
