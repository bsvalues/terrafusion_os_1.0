...
import { Info, FileBarChart2, Database, Users, Calendar  } from '@mui/icons-material';
...
<>
                ...
                <p
</> className="text-xs text-muted-foreground mt-1">No source data available</p>
              </>
            )}
          </CardContent>
        </Card>
...
<>
        ...
        <TabsContent
</> value="source" className="m-0 pt-2">
<>
          <LineageFilters
            onChange={handleFilterChange}
            availableSources={availableSources}
