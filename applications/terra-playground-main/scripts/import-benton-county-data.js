...
function convertToSchemaFormat(propertyData) {
  return {
    ...
    value: parseInt(
      propertyData.assessed_value || propertyData.assessedValue || propertyData.total_value || 0,
      10
    ),
...
async function importPropertyData() {
  ...
  console.log(
    `Import completed. ${importedCount} properties imported/updated. ${errorCount} errors.`
  );
}
