...
>
                    ...
                    <SelectItem value="realtime-etl">Realtime ETL</SelectItem>
                    <SelectItem value="event-driven">Event-Driven</SelectItem>
                    <SelectItem value="continuous-query">Continuous Query</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-2">
...
>
                    ...
                    <SelectItem value="src-002">County Assessor Database</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <Separator />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Select value={configValues.priority || 'medium'}
...
>
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button onClick={handleSaveNewProcess}>Create Process</Button>
            </div>
          </div>
        )}
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{process.metrics.throughput.toFixed(1)} rec/s</span>
                              </div>
                            ...
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className={`font-medium ${getMetricStatus(process.metrics.latency, process.alertThresholds.latency)}`}>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{process.metrics.successRate.toFixed(1)}%</span>
                              </div>
                            ...
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className={`font-medium ${getMetricStatus(process.metrics.errorRate, process.alertThresholds.errorRate)}`}>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium">{process.metrics.backpressure.toFixed(0)}%</span>
                              </div>
                            ...
                            <div className="space-y-1">
                              <div className="flex justify-between text-sm">
                                ...
                                <span className={`font-medium ${getMetricStatus(process.metrics.resourceUtilization, process.alertThresholds.resourceUtilization)}`}>
