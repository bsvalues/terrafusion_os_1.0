      ...
      case 'api':
        return (
            ...
            <div className="grid gap-2">
              ...
              <Select value={newConnectorConfig.method || 'GET'}
      ...
      case 'file':
        return (
            ...
            <div className="grid gap-2">
              ...
              <Select value={newConnectorConfig.format || ''}
      ...
      case 'service':
        return (
            <div className="grid gap-2">
              ...
              <Select value={newConnectorConfig.serviceType || ''}
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Textarea id="connector-description"
...
>
              ...
              <div className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <Select value={newConnectorAuth.type}
              ...
              <div className="space-y-4">
                ...
                {newConnectorSchedule.enabled && (
                  <div className="grid gap-2">
                    ...
                    <Select value={String(newConnectorSchedule.interval)}
                      onValueChange={(value) => 
