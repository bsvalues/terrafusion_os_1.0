                  ...
                  <CardContent className="space-y-2 text-sm">
                    <div className="flex items-start">
                      ...
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">Set up your organization and preferences</div>
                      </span>
                    </div>
                    <div className="flex items-start">
                      <FileText className="h-4 w-4 mr-2 mt-0.5 text-gray-500" />
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">Learn how to import and process permit data</div>
                      </span>
                    </div>
                    <div className="flex items-start">
                      <FileText className="h-4 w-4 mr-2 mt-0.5 text-gray-500" />
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">Leverage AI to analyze and process permits</div>
                      </span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-2 text-sm">
                    <div className="flex items-start">
                      ...
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">How to efficiently handle multiple permits</div>
                      </span>
                    </div>
                    <div className="flex items-start">
                      <Lightbulb className="h-4 w-4 mr-2 mt-0.5 text-gray-500" />
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">Work together with your team in real-time</div>
                      </span>
                    </div>
                    <div className="flex items-start">
                      <Lightbulb className="h-4 w-4 mr-2 mt-0.5 text-gray-500" />
                      <span className="flex-1">
                        ...
                        <div className="text-gray-500 text-xs mt-0.5">Generate reports and export processed data</div>
                      </span>
                    </div>
                  </CardContent>
                </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.DASHBOARD} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.PERMIT_PROCESSING} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.AI_FEATURES} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.COLLABORATION} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.BATCH_PROCESSING} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <PlayTourButton tourName={TourType.DATA_EXPORT} 
                      size="sm" 
                      onClick={() => closeHelpCenter()} 
                    />
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Available 9am - 5pm PT</div>
                  </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Personal walkthrough with an expert</div>
                  </div>
                  <Button size="sm" variant="outline" className="ml-auto">
                    Book Now
                  </Button>
