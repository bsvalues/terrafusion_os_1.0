    ...
    >
      <div className="flex items-center p-4 cursor-pointer"
        ...
        <div className="flex-1 ml-2">
          ...
          <div className="text-sm text-muted-foreground">{result.service} - {relativeTime}</div>
        </div>
