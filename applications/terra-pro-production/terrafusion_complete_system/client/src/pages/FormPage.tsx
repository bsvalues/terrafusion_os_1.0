            ...
            <form onSubmit={propertyForm.handleSubmit(onPropertySubmit)} className="space-y-6">
              ...
              <Card>
                ...
                <CardFooter className="flex justify-between border-t p-4"><>
                  ...
                  <Button
</> type="submit" disabled={propertyMutation.isPending}>
              ...
              <form onSubmit={reportForm.handleSubmit(onReportSubmit)} className="space-y-6">
                <Card>
                  <CardHeader><>
                    ...
                    <CardDescription
</>>Enter the appraisal assignment details</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <FormField
                ...
                <Card>
                  <CardHeader><>
                    ...
                    <CardDescription
</>>Enter the client and lender details</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <FormField
                      control={reportForm.control}
                ...
                <Card>
                  <CardHeader><>
                    ...
                    <CardDescription
</>>Enter sales price and market value</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4 md:grid-cols-2">
                    <FormField
                      control={reportForm.control}
