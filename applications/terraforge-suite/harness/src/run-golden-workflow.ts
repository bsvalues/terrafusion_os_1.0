...
import { CostKernel } from './stubs/cost-kernel';
// import { DefenseStudio } from './stubs/defense-studio'; // Replaced by inline stub
import { v4 as uuidv4 } from "uuid";
import { ValuationKernel } from './stubs/valuation-kernel';
...
async function runGoldenWorkflow() {
    ...
    console.log(`   ✅ Total Value: ${result.totalValue} (Land: ${result.components.land}, Bldg: ${result.components.building})`);
