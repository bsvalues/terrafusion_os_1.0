"use client"
import { Activity, Bell, Calendar, Home, Settings, User  } from '@mui/icons-material'
...
placeholder="Enter some text" className="bg-[#002a4a] border-[#00e5ff]/20 text-white" />
        </div>
      ),
      footer: (<>
...
className="p-2 bg-[#00e5ff]/10 border border-[#00e5ff]/20 rounded-lg text-white">Item 2</div>
