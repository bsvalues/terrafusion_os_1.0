  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        {/* Hero Header */}
                  {/* Terrafusion Platform Header */}
          <div className="terrafusion-platform-header mb-8">
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white py-3 px-6 rounded-t-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="flex items-center mr-6">
                    <div className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center mr-2">
                      <span className="text-xs font-bold text-white">TF</span>
                    </div>
<>

                    <div className="text-cyan-400 text-lg animate-pulse mx-2">⚡</div>
                    <div
</>

className="w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full flex items-center justify-center mr-3">
...
<>
                    ...
                    <span className="font-bold text-sm">Terrafusion Platform</span>
                    <span
</>

className="ml-2 opacity-75 text-sm">Civil Infrastructure Brain • AI-Powered Assessment</span>
                  </div>
                </div>
                <div className="hidden md:flex items-center space-x-4 text-xs opacity-90">
<>

                  <span>🏛️ Multi-County Platform</span>
                  <span
</>

</>>🤖 AI-Enhanced Intelligence</span>
                </div>
              </div>
            </div>
...
<>
                    ...
                    <h6 className="font-bold text-blue-600 mb-0">Terrafusion Platform</h6>
                    <p
</>

className="text-gray-500 text-sm mb-0">Advanced Civil Infrastructure Technology</p>
                  </div>
                </div>
...
className="text-xl text-gray-600">Civil Infrastructure Brain • ICSF Secure Kernel</p>
                <p className="text-lg text-blue-600 font-semibold">Enterprise Platform Edition</p>
              </div>
            </div>
