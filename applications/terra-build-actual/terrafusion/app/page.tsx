...
<>
            ...
            <Button
</> onClick={() => setShowSplash(true)} className="bg-[#00e5ff] hover:bg-[#00b8d4] text-[#001529]">
              Show Splash Screen
            </Button>
          </div>
        )
...
<>
            ...
            <Button
</> onClick={() => setShowAuth(true)} className="bg-[#00e5ff] hover:bg-[#00b8d4] text-[#001529]">
              Show Auth Modal
            </Button>
...
<>
            ...
            <Button
</> onClick={() => setShowToast(true)} className="bg-[#00e5ff] hover:bg-[#00b8d4] text-[#001529]">
...
<>
            ...
            <DashboardCard
</> title="System Uptime" metric="98%" description="Last 30 days performance" />
          </div>
        )
      default:
        return null
...
<>
        ...
        <h1
</> className="text-2xl font-bold text-white">Terrafusion Design System</h1>
      </header>
