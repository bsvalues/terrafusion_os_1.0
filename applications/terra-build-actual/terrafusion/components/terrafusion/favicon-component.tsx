...
<>
          ...
          <p
</> className="mt-2 text-sm text-gray-500">16×16 .ico</p>
        </div>
...
<>
          ...
          <p
</> className="mt-2 text-sm text-gray-500">192×192 PNG</p>
        </div>
...
<>
          ...
          <p
</> className="mt-2 text-sm text-gray-500">512×512 PNG</p>
        </div>
      </div>
...
<>
        ...
        <pre
</> className="text-xs bg-gray-800 text-white p-3 rounded overflow-x-auto">
          {`{
  "name": "Terrafusion",
  "short_name": "TF",
  "icons": [
