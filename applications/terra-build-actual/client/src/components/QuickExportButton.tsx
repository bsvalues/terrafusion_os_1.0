...
import { FilePlus2, Printer, FileSpreadsheet, FileText, ShieldAlert, Eye  } from '@mui/icons-material';
...
</>>${formatCurrency(mat.totalCost)}</td>
                    </tr>
                  `).join('')}
                </tbody>
              </table>
...
className="text-sm font-medium text-primary">Exporting to {exportFormat}...</span>
          </div>
        </div>
      )}
...
className="absolute inset-0 bg-gradient-to-r from-[#243E4D]/0 via-[#243E4D]/10 to-[#243E4D]/0 opacity-0 group-hover:opacity-100 duration-700 transform -translate-x-full animate-shimmer"></span>
          </Button>
        </DropdownMenuTrigger>
