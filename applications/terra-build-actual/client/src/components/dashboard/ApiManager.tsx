...
import { Plus, Search, Refresh, Check, X, Edit, Trash2, Terminal, FileText  } from '@mui/icons-material';
...
scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Method</th>
<>

                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Status</th>
                <th
</>
scope="col" className="px-6 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Auth</th>
...
className="absolute left-0 mt-2 bg-white border border-neutral-200 rounded shadow-lg p-2 hidden group-hover:block z-10 w-28">
                            <button 
...
className="px-6 py-3 whitespace-nowrap text-xs text-neutral-400">
