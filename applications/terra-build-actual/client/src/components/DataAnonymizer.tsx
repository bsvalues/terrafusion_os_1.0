...
import { Check, Eye, EyeOff, ShieldAlert, X  } from '@mui/icons-material';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
className="text-xs text-muted-foreground">IDs, names, and unique numbers</p>
                </div>
<>
...
className="text-xs text-muted-foreground">Addresses and specific locations</p>
                </div>
<>
...
className="text-xs text-muted-foreground">Costs and monetary values</p>
                </div>
                <Switch 
...
className="text-xs text-muted-foreground">Significant</span>
                  </div>
...
className="text-xs text-muted-foreground">Maintain data relationships</p>
                    </div>
                  </div>
                </div>
              )}
...
size="sm" onClick={handleAnonymize}>
