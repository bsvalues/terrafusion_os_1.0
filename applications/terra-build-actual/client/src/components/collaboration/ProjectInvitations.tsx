...
className="text-lg font-medium">No pending invitations</h3>
...
className="text-sm">{getDisplayName(invitation.inviter)}</span>
                    </div>
                  </TableCell>
<>
...
</>>{getStatusBadge(invitation.status)}</TableCell>
<>
