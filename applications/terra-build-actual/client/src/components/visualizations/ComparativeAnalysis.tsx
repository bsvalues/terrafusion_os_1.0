...
value={selectedBuildingType} onValueChange={setSelectedBuildingType}>
              <SelectTrigger>
<>
...
className="text-muted-foreground">({item.buildingType})</span>
                    <Button
                      variant="ghost"
                      size="sm"
...
value="line" data-testid="viz-type-line">
<>
...
value="radial" data-testid="viz-type-radial">
