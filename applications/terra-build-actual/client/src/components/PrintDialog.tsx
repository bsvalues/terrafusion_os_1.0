...
</>><strong>Square Footage:</strong></td>
...
</>><strong>Age Depreciation:</strong></td>
...
</>>{calculation.complexityFactor.toFixed(2)}</td>
                  <td>
...
</>>{calculation.conditionFactor.toFixed(2)}</td>
                  <td>
...
</>>{calculation.regionalMultiplier.toFixed(2)}</td>
                  <td>
...
</>>${material.totalCost.toLocaleString()}</td>
                    </tr>
                  ))}
                </tbody>
                <tfoot>
...
</>>Report generated on {new Date().toLocaleDateString()} at {new Date().toLocaleTimeString()}</p>
            </div>
          )}
        </div>
      </div>
