...
import { CircleOff, Eye, EyeOff, Info, Refresh  } from '@mui/icons-material';
...
className="flex-1 text-blue-800 text-sm">
<>
...
</>>Click on data points with popover indicators to see more detailed information</li>
<>

                    <li>Explore the Cost-Value Relationship chart by hovering over points and clicking them</li>
                            <li
</>
</>>Notice how similar types of data use consistent interaction patterns</li>
...
value="cost">Cost Breakdown</TabsTrigger>
...
</>>Contextual data examples</CardDescription>
                    </CardHeader>
                    <CardContent>
...
className="text-xs mt-1">Hover or click on data points to see interactions here</p>
                  </div>
                ) : (
                  <div className="space-y-3">
