...
import ... from "@/animation/glassmorphic-effects"
...
className="space-y-4 bg-[#002a4a]/50 p-4 rounded-lg">
              <div><>

                <h1 className="text-4xl font-bold text-white">Heading 1</h1>
                <p
</>
className="text-xs text-[#00e5ff]/50 mt-1">text-4xl font-bold</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-3xl font-bold</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-2xl font-bold</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-xl font-medium</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-lg font-medium</p>
              </div>
            </div>
          </div>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-base</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-sm</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-xs</p>
              </div>
            </div>
          </div>
...
className="text-xs text-[#00e5ff]/50 mt-1">font-bold</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">font-medium</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">italic</p>
              </div>
              <div><>
...
className="text-xs text-[#00e5ff]/50 mt-1">text-[#00e5ff]</p>
              </div>
            </div>
          </div>
        </div>
