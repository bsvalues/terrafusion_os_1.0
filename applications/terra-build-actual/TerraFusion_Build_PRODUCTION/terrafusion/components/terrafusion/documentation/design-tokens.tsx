...
className="bg-[#002a4a]/50 rounded-lg overflow-hidden">
...
className="text-left p-3 text-[#00e5ff]/70">Value</th>
...
className="p-3 text-white font-mono text-xs">{token.value}</td>
