...
import { Activity, Bell, Calendar, Home, Info, Settings, User  } from '@mui/icons-material'
...
className="bg-[#00e5ff] hover:bg-[#00b8d4] text-[#001529]">Confirm</Button>
...
value="components" className="data-[state=active]:bg-[#00e5ff]/20 data-[state=active]:text-[#00e5ff]">
              Component Library
            </TabsTrigger>
<>
...
value="documentation" className="data-[state=active]:bg-[#00e5ff]/20 data-[state=active]:text-[#00e5ff]">
              Documentation
            </TabsTrigger>
<>
...
value="existing" className="data-[state=active]:bg-[#00e5ff]/20 data-[state=active]:text-[#00e5ff]">
              Existing Components
            </TabsTrigger>
          </TabsList>
...
className="p-2 bg-[#00e5ff]/10 border border-[#00e5ff]/20 rounded-lg text-white">
                      Item 2
                    </div>
                    <div className="p-2 bg-[#00e5ff]/10 border border-[#00e5ff]/20 rounded-lg text-white">
                      Item 3
