...
value="logs" className="data-[state=active]:bg-blue-800/50">
<>
...
value="tasks" className="data-[state=active]:bg-blue-800/50">
<>
...
value="settings" className="data-[state=active]:bg-blue-800/50">
...
className="grid grid-cols-2 gap-2 text-xs text-blue-400">
                        <div>
<>
...
className="text-blue-200">{agent.version}</span>
                        </div>
                        <div>
<>
...
className="text-blue-200">{agent.type}</span>
                        </div>
                        <div>
<>
...
className="text-blue-200">{agent.lastActive || 'N/A'}</span>
                        </div>
                        <div>
<>
...
className="text-blue-200">{agent.capabilities.length}</span>
                        </div>
                      </div>
                      {agent.status === 'active' && (
