...
import ... from "@/components/ai/CostPredictionWizard";
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbSeparator } from "@/components/ui/breadcrumb";
import { Bot, Home, ChevronRight, Info, HelpCircle  } from '@mui/icons-material';
...
</>>AI-powered cost predictions based on current market data</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-primary/10 text-primary p-1 rounded mr-2 mt-0.5"><>
...
</>>Intelligent guidance through each step of the estimation process</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-primary/10 text-primary p-1 rounded mr-2 mt-0.5"><>
...
</>>Detailed breakdown of cost factors and their impacts</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-primary/10 text-primary p-1 rounded mr-2 mt-0.5"><>
...
</>>Smart material substitution recommendations</span>
                </li>
                <li className="flex items-start">
                  <div className="bg-primary/10 text-primary p-1 rounded mr-2 mt-0.5"><>
...
</>>Export capabilities for reports and presentations</span>
                </li>
              </ul>
            </CardContent>
          </Card>
