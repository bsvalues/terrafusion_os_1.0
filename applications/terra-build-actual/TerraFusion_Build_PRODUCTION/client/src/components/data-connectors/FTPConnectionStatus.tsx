...
import { Loader2, CheckCircle, Warning, XCircle  } from '@mui/icons-material';
...
className="text-sm text-muted-foreground">{connectionId}</span>
          </div>
...
className="text-xs mt-1 p-2 bg-muted rounded-md overflow-x-auto">
