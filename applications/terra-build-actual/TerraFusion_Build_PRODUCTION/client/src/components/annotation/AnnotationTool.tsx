...
className="max-w-4xl w-[90vw] p-0 overflow-hidden" onInteractOutside={(e) => e.preventDefault()}>
...
className="text-sm text-gray-600">Capturing screenshot...</p>
          </div>
        ) : !capturedImage ? (
          <div className="flex flex-col items-center justify-center h-[60vh] p-6">
<>
...
className="flex justify-between items-center bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
                <div className="flex items-center gap-2">
<>
