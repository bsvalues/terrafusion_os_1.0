...
import { PlayCircle, PauseCircle, Refresh  } from '@mui/icons-material';
...
className="w-2 h-2 transform rotate-45 bg-black absolute -bottom-1 left-1/2 -ml-1"></div>
                </div>
...
className="absolute top-1/2 left-1/4 w-1/4 h-1/6 bg-white opacity-30 rounded-sm"></div>
<>
...
className="absolute top-1/2 right-1/4 w-1/4 h-1/6 bg-white opacity-30 rounded-sm"></div>
