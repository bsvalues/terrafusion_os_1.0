...
import { Copy, Trash2, BarChart3, ArrowRight, Info, Plus, GitCompare, FileDown, Refresh  } from '@mui/icons-material';
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { Tooltip as UITooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip";
import ... from "@/BCBSCostCalculatorAPI";
...
className="text-sm text-gray-500 mb-6 max-w-md">
...
value="chart">Cost Chart</TabsTrigger>
...
className="text-right">Total Cost</TableHead>
...
</>>{scenario.buildingType || 'Unknown'}</TableCell><>
...
</>>{scenario.conditionFactor?.toFixed(2) || '1.00'}</TableCell><>
