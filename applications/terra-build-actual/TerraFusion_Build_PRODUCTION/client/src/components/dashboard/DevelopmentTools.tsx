...
className="text-xs bg-primary text-white rounded-md px-3 py-1.5 hover:bg-primary-dark">
              Save Configuration
            </button>
          </div>
...
value={selectedUser} onValueChange={setSelectedUser}>
...
value={expiration} onValueChange={setExpiration}>
                <SelectTrigger className="w-full bg-neutral-100 border border-neutral-200 rounded px-3 py-2 text-sm text-neutral-600"><>
