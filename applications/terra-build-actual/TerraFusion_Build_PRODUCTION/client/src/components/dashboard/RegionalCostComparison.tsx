...
import { AlertCircle, MapPin, Building  } from '@mui/icons-material';
...
</>><span className="font-semibold">{lowest.region}</span> at <span className="font-semibold text-green-600">${lowest.cost}/sq.ft</span></p>
              </div>
            </div>
...
</>><span className="font-semibold">{highest.region}</span> at <span className="font-semibold text-red-600">${highest.cost}/sq.ft</span></p>
              </div>
            </div>
          </div>
        )}
