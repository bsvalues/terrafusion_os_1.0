...
className="bg-neutral-100 rounded-md p-3 space-y-2">
...
className="ml-2 px-1.5 py-0.5 bg-success bg-opacity-10 rounded text-success text-xs">Set</span>
                </div>
...
className="bg-neutral-100 rounded-md p-4 space-y-4">
            <div>
