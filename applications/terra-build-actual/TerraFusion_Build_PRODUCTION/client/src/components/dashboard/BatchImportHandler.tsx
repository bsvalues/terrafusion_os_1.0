...
import { FileText, PlayCircle, AlertCircle, CheckCircle, PauseCircle, Refresh, FileSpreadsheet  } from '@mui/icons-material';
import { Badge } from '@/components/ui/badge';
import { FileUpload } from '@shared/schema';
import { useFileUploads } from '@/hooks/use-file-uploads';
import ... from "@/common/FileUploader";
...
className={statusColors[selectedFile.status] || 'bg-gray-500'}>
                {selectedFile.status}
              </Badge>
            </div>
          </CardHeader>
