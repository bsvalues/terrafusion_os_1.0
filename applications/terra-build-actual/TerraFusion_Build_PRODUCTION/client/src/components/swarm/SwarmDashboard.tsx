...
import ... from "@/SwarmAgentStatus";
import ... from "@/SwarmTaskRunner";
...
value="tasks">Run Tasks</TabsTrigger>
...
agents={statusData?.status?.agents || []} />
            </TabsContent>
...
value="demos" className="space-y-4"><>
