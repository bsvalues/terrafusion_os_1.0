...
import { InfoIcon, Warning, ArrowRight, Play, Pause, SkipBack, SkipForward  } from '@mui/icons-material';
// We'll implement just one visualization type for now
// import ... from "@/Infrastructure2DLifecycle";
// import ... from "@/Infrastructure3DLifecycle";
...
variant="outline" className="bg-[#e6eef2] text-[#243E4D] border-none">
                  Interactive View
                </Badge>
              </div>
              <CardDescription>
...
className="text-2xl font-bold text-gray-800 mb-2">{currentStage.title}</h3><>
...
</>>Cumulative Cost: {cumulativeCost}%</span>
                </div>
...
className="bg-[#e6eef2] rounded-md p-3 text-[#243E4D]">
...
className="font-medium">{currentStage.costPercentage}% of total</span>
                  </div>
...
className="font-medium">{cumulativeCost}% of total</span>
                  </div>
                </div>
              </div>
