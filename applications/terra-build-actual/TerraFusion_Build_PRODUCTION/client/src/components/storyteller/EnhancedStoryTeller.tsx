...
import ... from "@/InfrastructureLifecycleStoryTeller";
import ... from "@/AIStorytellerForm";
import ... from "@/StoryDisplay";
import { StoryInsight } from '@/hooks/useStorytellingAPI';
import { Building, Brain, Warning  } from '@mui/icons-material';
...
value="ai-storyteller" className="mt-0">
