...
import ... from "@/ProjectProgressTracker";
import ... from "@/ProjectActivitiesLog";
...
value="export">Export Options</TabsTrigger>
            </TabsList>
...
className="list-disc list-inside text-xs space-y-1 text-muted-foreground"><>

                              <li>Building cost matrices</li>
                            <li
</>

</>>Regional cost factors</li><>

                              <li>Depreciation tables</li>
                            <li
</>

</>>Building class definitions</li>
                            </ul>
                          </div>
                          <div className="flex flex-col gap-1.5"><>
...
</>>County standard formatting</li><>

                              <li>Historical data tracking</li>
                            <li
</>

</>>Statistical validation ready</li>
                            </ul>
                          </div>
                        </div>
                      </div>
...
className="text-xs mt-1">For CAMA system integration and county assessor use</p>
                    </div>
                  </div>
                </div>
              </ScrollArea>
