...
import { Shield, UserRoundPlus, Link as LinkIcon, Copy, Trash2, Users, Clock  } from '@mui/icons-material';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
value="editor">Editor (can edit)</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
...
value="edit">Can edit</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
