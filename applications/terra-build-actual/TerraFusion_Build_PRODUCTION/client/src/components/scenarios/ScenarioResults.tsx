...
className="text-2xl font-bold">{formatCurrency(scenario.results.baseCost)}</div>
            </div>
            <div className="bg-muted p-4 rounded-md">
<>
...
className="text-2xl font-bold">{formatCurrency(scenario.results.adjustedCost)}</div>
            </div>
            <div className="bg-muted p-4 rounded-md">
<>
