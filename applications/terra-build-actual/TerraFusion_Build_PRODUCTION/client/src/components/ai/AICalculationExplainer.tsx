...
import { Loader2, Database, Info  } from '@mui/icons-material';
...
className="text-sm whitespace-pre-line">{explanationResult.explanation}</p>
                  </div>
                )}
...
className="text-sm bg-background p-3 rounded-md font-mono">
                      {explanationResult.formulaBreakdown}
                    </div>
                  </div>
                )}
...
className="text-sm">{explanationResult.additionalInsights}</p>
                  </div>
                )}
              </div>
            </CardContent>
