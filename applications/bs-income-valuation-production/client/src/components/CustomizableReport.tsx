...
import { FileDown, Printer, Calendar, DollarSign, BarChart3, TrendingUp, Settings  } from '@mui/icons-material';
import {
  ResponsiveContainer,
  BarChart,
  Bar,
...
value="sections">Sections</TabsTrigger><>
...
</>>{settings.description}</CardDescription>
            </div>
