...
<head>
    ...
    <title>CostForge AI - TerraFusion Professional Valuation Platform</title>
...
<body>
    <header class="header">
        <div class="header-content">
            <div class="logo">
                <i class="fas fa-brain" style="font-size: 2.5rem; color: #ffffff;"></i>
                <div>
                    <h1>CostForge AI</h1>
                    <div style="font-size: 0.9rem; color: rgba(255,255,255,0.8);">TerraFusion Professional Valuation Platform v3.0.0</div>
                </div>
            </div>
