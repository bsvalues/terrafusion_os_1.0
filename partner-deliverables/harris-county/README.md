# 🏛️ TerraFusion OS Integration Guide
## Harris County, Texas
...
This package contains comprehensive technical documentation for integrating Harris County, Texas with the TerraFusion OS platform. It includes:

- **12 registered components** relevant to your integration
...
Based on your focus areas (gis, valuation, appraisal, government-approvals), you'll primarily interact with:
...
response = requests.post(
    ...
    data={
        'name': 'Harris County, Texas Parcels',
        'type': 'geojson',
        'crs': 'EPSG:4326'
    }
)
...
*This integration guide is confidential and intended solely for Harris County, Texas.*
