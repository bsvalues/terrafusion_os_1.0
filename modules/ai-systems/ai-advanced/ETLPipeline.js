...
exports.etlPipeline = exports.ETLPipeline = void 0;
...
class ETLPipeline extends events_1.EventEmitter {
     ...
     */
    async testDatabaseConnection(source) {
     ...
     */
    async testFileConnection(source) {
     ...
     */
    generateSampleDatabaseData(sourceId) {
        const data = [];
     ...
     */
    generateSampleAPIData(sourceId) {
        const data = [];
     ...
     */
    generateSampleFileData(sourceId) {
        const data = [];
     ...
     */
    async transformData(records, transformations) {
     ...
     */
    applyNormalization(data, params) {
     ...
     */
    async applyEnrichment(data, params) {
        const enriched = { ...data };
        // GIS data enrichment
        ...
        if (params.neighborhoodData && enriched.city) {
            ...
            enriched.neighborhood =
                cityNeighborhoods[Math.floor(Math.random() * cityNeighborhoods.length)];
        }
     ...
     */
    async validateData(records, validations) {
     ...
     */
    async loadData(records, destination) {
...
exports.etlPipeline = new ETLPipeline();
//# sourceMappingURL=ETLPipeline.js.map