...
const LeafScopeViewer: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-xl">Loading LeafScope Viewer...</div>
      </div>
    );
  }

  return (
    <div className="leafscope-viewer h-screen w-full">
      <div className="h-16 bg-gray-800 text-white flex items-center px-6"><>
