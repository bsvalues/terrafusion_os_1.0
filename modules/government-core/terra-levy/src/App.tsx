  ...
  const renderCalculatorTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Advanced calculations for property tax planning and investment modeling</p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="text-left py-2">Assessed Value</th>
                <th className="text-left py-2">Tax Rate</th>
                <th className="text-left py-2">Annual Tax</th>
                <th className="text-left py-2">Exemptions</th>
                <th className="text-left py-2">Effective Rate</th>
              </tr>
            </thead>
            <tbody>
              {calculations.map((calc) => (
                <tr key={calc.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-2">${calc.assessed_value.toLocaleString()}</td>
                  <td className="py-2">{(calc.tax_rate * 100).toFixed(2)}%</td>
                  <td className="py-2 font-semibold">${calc.annual_tax.toLocaleString()}</td>
                  <td className="py-2">
  ...
  const renderAnalysisTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Advanced ROI analysis and investment optimization</p>
      </div>
  ...
  const renderReportsTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Comprehensive reporting and business intelligence</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="text-sm text-gray-600 mt-1">+12% from last month</div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="text-sm text-gray-600 mt-1">+8% from last year</div>
        </div>
  ...
  const renderComplianceTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Regulatory compliance tracking and audit trails</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-3 max-h-64 overflow-y-auto">
            <div className="border-l-4 border-green-500 pl-4 py-2">
              ...
              <div className="text-xs text-gray-600">Property ID: prop-12345 - 2 minutes ago</div>
            </div>
            
            <div className="border-l-4 border-blue-500 pl-4 py-2">
              <div className="font-medium text-sm">Investment model generated</div>
              <div className="text-xs text-gray-600">Analysis ID: inv-001 - 15 minutes ago</div>
            </div>
            
            <div className="border-l-4 border-purple-500 pl-4 py-2">
              <div className="font-medium text-sm">Compliance check passed</div>
              <div className="text-xs text-gray-600">System audit - 1 hour ago</div>
            </div>
            
            <div className="border-l-4 border-orange-500 pl-4 py-2">
              <div className="font-medium text-sm">Data synchronization</div>
              <div className="text-xs text-gray-600">External MLS sync - 2 hours ago</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Government. Transcended. • Tax & Levy Module</p>
              </div>
            </div>
