    ...
    <QueryClientProvider client={queryClient}>
      <Router>
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
          {/* Header */}
          <header className="bg-gray-900 shadow-lg border-b border-cyan-500/20">
...
className="bg-purple-900/50 text-purple-400 border border-purple-500/30 px-3 py-1 rounded-full text-sm font-medium">
          ...
          {/* Navigation */}
          <nav className="bg-gray-900/95 backdrop-blur border-b border-cyan-500/20 sticky top-0 z-40">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
