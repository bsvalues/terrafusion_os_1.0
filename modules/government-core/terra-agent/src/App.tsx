...
function App() {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        id: "welcome",
        content: "Welcome to TerraAgent! I'm your AI-powered property analysis assistant. How can I help you today?",
        role: "assistant",
        timestamp: new Date()
      }
    ]);
  ...
  return (
    <div className="terra-agent-container">
      <header className="app-header">
        <h1>TerraAgent Desktop</h1>
        <p>Your AI-powered property analysis assistant</p>
      </header>
