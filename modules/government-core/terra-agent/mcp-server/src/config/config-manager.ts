...
export class ConfigManager {
  ...
  private loadConfiguration(): ServerConfig {
    ...
    return {
      ...
      services: {
        terraAgentBackend: {
          baseUrl: process.env.TERRA_AGENT_BACKEND_URL || 'http://localhost:5000',
        ...
        propertyData: {
          baseUrl: process.env.PROPERTY_DATA_URL || 'http://localhost:5001',
        ...
        assessmentAPI: {
          baseUrl: process.env.ASSESSMENT_API_URL || 'http://localhost:5002',
