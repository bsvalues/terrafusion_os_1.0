...
export const AIOptimizationPanel: React.FC<AIOptimizationPanelProps> = ({ 
  ...
  return (
    <div className={`ai-optimization-panel p-6 h-full overflow-auto ${className || ''}`}>
      {/* Header */}
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900">AI Optimization Center</h2>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{insights.activeAgents}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{insights.optimizationScore}%</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{insights.predictions.resourceUsage}%</p>
              </div>
        ...
        <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex items-center gap-2">
                <TrendingUp className={`w-5 h-5 ${trendColors[insights.predictions.performanceTrend]}`} />
                <span className={`font-medium capitalize ${trendColors[insights.predictions.performanceTrend]}`}>
                  {insights.predictions.performanceTrend}
                </span>
              </div>
              <p className="text-sm text-gray-600 mt-1">
                Workflow performance is showing positive trends
              </p>
            </div>

            <div>
              <h4 className="font-medium text-gray-900 mb-2">Next Failure Prediction</h4>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-500" />
                <span className="font-medium text-green-600">
                  {insights.predictions.nextFailure || 'No failures predicted'}
                </span>
              </div>
              <p className="text-sm text-gray-600 mt-1">
                System reliability is optimal
              </p>
            </div>
          </div>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium text-green-600">{agent.efficiency}%</span>
              </div>
