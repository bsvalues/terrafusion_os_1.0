...
export default function FileExplorer() {
  ...
  const renderFileGrid = () => {
    ...
    if (filesQuery.error) {
      return (
        <div className="col-span-full flex flex-col items-center justify-center py-12 text-center tf-government-badge">
          <FileX className="h-12 w-12 text-muted-foreground mb-4" />
          <h3 className="text-lg font-semibold tf-transcendence-glow">Error loading files</h3>
          <p className="text-muted-foreground tf-clarity-gradient">
    ...
    if (!filteredFiles?.length) {
      return (
        <div className="col-span-full flex flex-col items-center justify-center py-12 text-center tf-government-badge">
          <FileX className="h-12 w-12 text-muted-foreground mb-4" />
          <h3 className="text-lg font-semibold tf-transcendence-glow">No files found</h3>
          <p className="text-muted-foreground tf-clarity-gradient">
    ...
    return filteredFiles.map((file) => (
      <FilePreview key={file.id} file={{...file, status: 'processed', path: file.path || ''}} />
    ));
  };
  ...
  const renderFileList = () => {
    ...
    return (
      <div className="rounded-md border overflow-hidden tf-transcendence-glow">
        <div className="bg-muted/50 p-3 grid grid-cols-12 text-sm font-medium tf-government-badge">
          <div className="col-span-5 tf-clarity-gradient">Name</div>
          <div className="col-span-2 tf-clarity-gradient">Type</div>
          <div className="col-span-2 tf-clarity-gradient">Size</div>
          <div className="col-span-2 tf-clarity-gradient">Date</div>
          <div className="col-span-1 text-right tf-clarity-gradient">Actions</div>
        </div>
          ...
          {filteredFiles.map((file) => (
            <div key={file.id} className="p-3 grid grid-cols-12 items-center hover:bg-muted/20">
              ...
              <div className="col-span-2">
                <span className="px-2 py-1 rounded-full bg-muted/20 text-xs tf-government-badge">
                  {file.type}
                </span>
              </div>
              <div className="col-span-2 text-muted-foreground text-sm tf-clarity-gradient">
  ...
  return (
    <div className="container mx-auto p-6 tf-transcendence-glow">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8 tf-government-badge">
        <h1 className="text-3xl font-bold tf-clarity-gradient">File Explorer</h1>
      ...
      <div className="mb-8 tf-transcendence-glow">
        <FileUpload />
      </div>
      
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 tf-government-badge">
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm text-muted-foreground tf-clarity-gradient">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <SelectTrigger className="w-[180px] tf-transcendence-glow">
          ...
          <Tabs defaultValue="grid" className="w-[100px] tf-transcendence-glow">
            <TabsList>
              <TabsTrigger 
                value="grid" 
