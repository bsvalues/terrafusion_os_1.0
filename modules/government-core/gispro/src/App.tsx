...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <ThemeProvider defaultTheme="light" storageKey="terrafusion-theme">
        <Router>
          <AppLayout>
            <Routes>
              {/* Public Routes */}
              <Route path="/auth" element={<AuthPage />} />
              <Route path="/public" element={<PublicPropertyPortal />} />
              ...
              <Route path="/documents" element={
                <ProtectedRoute>
                  <DocumentClassificationPage />
                </ProtectedRoute>
              } />
              
              <Route path="/legal-descriptions" element={
                <ProtectedRoute>
                  <LegalDescriptionAgentPage />
                </ProtectedRoute>
              } />
              ...
              <Route path="/mapbox-demo" element={
                <ProtectedRoute>
                  <MapboxDemoPage />
                </ProtectedRoute>
              } />
              
              <Route path="/collaborative-mapbox" element={
                <ProtectedRoute>
                  <CollaborativeMapboxPage />
                </ProtectedRoute>
              } />
              
              <Route path="/geospatial" element={
                <ProtectedRoute>
                  <GeospatialAnalysisPage />
                </ProtectedRoute>
              } />
              
              <Route path="/cartographer" element={
                <ProtectedRoute>
                  <CartographerToolsPage />
                </ProtectedRoute>
              } />
              
              <Route path="/enhanced-collaboration" element={
                <ProtectedRoute>
                  <EnhancedMapCollaborationPage />
                </ProtectedRoute>
              } />
              
              <Route path="/document-parcel-map" element={
                <ProtectedRoute>
                  <CollaborativeDocumentParcelMap />
                </ProtectedRoute>
              } />
              
              <Route path="/document-management" element={
                <ProtectedRoute>
                  <DocumentParcelManagement />
                </ProtectedRoute>
              } />
