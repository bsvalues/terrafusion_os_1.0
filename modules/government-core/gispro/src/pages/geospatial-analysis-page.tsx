...
export default function GeospatialAnalysisPage() {
  ...
  // Submit analysis
  const onSubmit = useCallback(async (values: GeospatialFormValues) => {
    if (selectedFeatures.length === 0 && (!drawnItems || drawnItems.getLayers().length === 0)) {
      toast({
  ...
  const selectedFeaturesStyle = {
    color: '#3B82F6',
    weight: 3,
    fillOpacity: 0.2
  };

  const resultFeaturesStyle = {
    color: '#10B981',
    weight: 3,
    fillOpacity: 0.3
  };
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Analysis Operation</FormLabel>
                        ...
                        <FormDescription>
                          Choose the spatial operation to perform
                        </FormDescription>
                      </FormItem>
                    )}
                  />
                  ...
                  {(form.watch('operation') === GeospatialOperationType.BUFFER) && (
                    <div>
                      <FormField
                        control={form.control}
                        name="bufferDistance"
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value={MeasurementUnit.YARDS}>Yards</SelectItem>
                  ...
                  {(form.watch('operation') === GeospatialOperationType.SIMPLIFY) && (
                    <FormField
                      control={form.control}
                      name="toleranceDistance"
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Tolerance Distance</FormLabel>
                          <FormControl>
                            <Input
                              type="number"
                              placeholder="1"
                  ...
                  <TabsContent value="summary">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium">
                        {operationLabels[analysisResult.type as GeospatialOperationType]}
                      </span>
        ...
        <div className="w-full lg:w-2/3">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Draw, select, and visualize geographic features
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between">
              ...
              <div className="text-sm text-muted-foreground">
                Selected: {selectedFeatures.length + (drawnItems?.getLayers().length || 0)} features
              </div>
            </CardFooter>
          </Card>
        </div>
