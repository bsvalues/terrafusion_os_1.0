/**
 * DataSlicer Component - RESTORED from BCBSCOSTApp
 * 
 * Advanced data filtering and slicing component for complex data exploration
 * featuring multi-type filters, range sliders, and interactive filtering.
 * 
 * Features:
 * - Select, multiselect, and range filter types
 * - Compact and full display modes
 * - Real-time filter counting and reset
 * - Accordion-based organization
 * - Custom value formatting for ranges
 * - 3D transform effects for visual depth
 */
...
import { X, Filter, RotateCcw  } from '@mui/icons-material';
        ...
        <CardHeader className="pb-3">
          <div className="flex justify-between items-center">
            <CardTitle className="text-base text-[#243E4D] flex items-center gap-2">
              ...
              {title}
              <Badge variant="secondary" className="ml-1 text-xs">RESTORED</Badge>
