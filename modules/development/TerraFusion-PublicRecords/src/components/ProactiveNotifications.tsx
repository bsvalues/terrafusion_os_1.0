...
import { Bell, Warning, Info, CheckCircle, Calendar,
  ...
  AlertCircle, TrendingUp, Sparkles, X 
...
export const ProactiveNotifications: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const simulateNotifications = () => {
      const proactiveAlerts: Notification[] = [
        {
          id: '1',
          type: 'urgent',
      ...
      if (permission === 'granted') {
        const urgent = proactiveAlerts.find(n => n.type === 'urgent');
        if (urgent) {
            ...
            >
              ...
              {showDetail.metadata && (
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  {Object.entries(showDetail.metadata).map(([key, value]) => (
