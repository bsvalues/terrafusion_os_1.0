...
import { User, Bell, FileText, Clock, DollarSign, Calendar, 
  ...
  TrendingUp, Archive, Eye, Star, MessageSquare
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-4 mt-3 text-sm">
                                <span className="text-gray-500">
                                  Submitted: {app.submittedDate.toLocaleDateString()}
                                </span>
                                {app.fee && (
                                  <span className="text-gray-500">
                                    Fee: ${app.fee}
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              {app.messages.length > 0 && (
                                <span className="flex items-center gap-1 text-xs text-orange-600">
                                  ...
                                  {app.messages.length} new message
                                </span>
                              )}
                            </div>
                          </div>
                          {app.documents.length > 0 && (
                            <div className="mt-3 pt-3 border-t">
                              <div className="flex items-center gap-2 text-sm text-gray-600">
                                ...
                                <span>{app.documents.length} documents attached</span>
                              </div>
                            </div>
                          )}
                        </motion.div>
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-sm text-gray-600">
                                <span>Last run: {search.lastRun.toLocaleDateString()}</span>
                                {search.alerts && (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              {payment.status === 'due' ? (
                                <button className="mt-2 px-3 py-1 bg-red-600 text-white rounded text-sm font-medium">
                                  Pay Now
                                </button>
                              ) : (
