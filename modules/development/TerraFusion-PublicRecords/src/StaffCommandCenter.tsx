...
const StaffCommandCenter: React.FC<StaffCommandCenterProps> = ({ onReturnToPublic }) => {
  const [selectedView, setSelectedView] = useState<'dashboard' | 'requests' | 'analytics' | 'team' | 'ai' | 'settings'>('dashboard');
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex">
      {/* Sidebar Navigation */}
      <div className="w-64 bg-gradient-to-b from-slate-800 to-slate-900 border-r border-slate-700">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4"><>
              ...
              <h2 className="text-2xl font-bold">
                {selectedView === 'dashboard' && 'Operations Dashboard'}
        ...
        <main className="flex-1 overflow-auto p-6">
          ...
          {selectedView === 'dashboard' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="bg-gradient-to-br from-blue-900/30 to-blue-800/30 p-6 rounded-xl border border-blue-700/30">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-blue-400">-47%</span>
                  </div><>
                ...
                <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/30 p-6 rounded-xl border border-purple-700/30">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-purple-400">{stats.citizenSatisfaction}%</span>
                  </div><>
                ...
                <div className="bg-gradient-to-br from-orange-900/30 to-orange-800/30 p-6 rounded-xl border border-orange-700/30">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-orange-400">Revenue</span>
                  </div><>
              ...
              {/* AI Discoveries Alert */}
              <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 rounded-xl border border-purple-700/30 p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-800/50 rounded-xl border border-slate-700 p-4">
                ...
                {showBulkActions && selectedRequests.length > 0 && (
                  <div className="mt-4 p-3 bg-blue-900/20 rounded-lg border border-blue-700/30 flex items-center justify-between"><>
                    ...
                    {filteredRequests.map(request => (
                      <tr key={request.id} className="hover:bg-slate-800/50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <span className="font-mono text-sm text-blue-400">{request.id}</span>
                        </td>
                        <td className="px-4 py-3">
                          <div><>
                        ...
                        <td className="px-4 py-3">
                          <p className="text-sm text-slate-300 max-w-xs truncate">{request.naturalLanguage}</p>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2"><>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-6">
                {staffMembers.map(staff => (
                  <div key={staff.id} className="bg-slate-800/50 rounded-xl border border-slate-700 p-6">
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-700 flex gap-2"><>
                      ...
                      <button className="flex-1 py-1 bg-slate-700 hover:bg-slate-600 rounded text-xs transition-colors">
                        View Work
                      </button>
                      <button
                ...
                <div><>
                  ...
                  <div
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-blue-400">{selectedRequest.citizenEmail}</span>
                    </div>
                    {selectedRequest.citizenPhone && (
                      <div className="flex items-center gap-2">
                        <Globe size={16} className="text-slate-400" />
                        <span>{selectedRequest.citizenPhone}</span>
                      </div>
                    )}
                  </div>
                </div>
