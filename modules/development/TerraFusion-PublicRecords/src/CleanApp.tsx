...
const CleanApp: React.FC = () => {
  ...
  useEffect(() => {
    // Initialize with impressive county stats
    setCountyStats({
  ...
  const generateDocuments = (property: Property): Document[] => {
    return [
      {
        id: '1',
        title: 'Property Deed',
            ...
            {BentonCountyData.aiDiscoveries.map((discovery /* , index */) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <Warning className="text-yellow-400 mt-1" />
                  <div><>
        ...
        {selectedTab === 'documents' && (
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6"><>
              ...
              <div className="space-y-3">
                <h3 className="font-medium text-gray-900 mb-3">Document Types</h3>
                {[
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <docType.icon size={20} className="text-gray-600" />
                      <div><>
              ...
              <div className="mt-6 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-800">
                  ...
                  All documents are searchable and available for download
                </p>
              </div>
            </div>
          </div>
