...
This guide will get you from a clean server to a fully operational Benton County
AI Championship System in **4 hours**. Follow these steps exactly for
...
- [ ] **GENIUS Agent**: http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/health (should return "OK")
- [ ] **HELPER Agent**: http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/health (should return "OK")
- [ ] **GUARDIAN Agent**: http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/health (should return "OK")
- [ ] **ChromaDB**: http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/api/v1/heartbeat (should return
      heartbeat)
...
```bash
# Via command line
curl -X POST http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/api/properties \
...
curl "http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/api/valuations/11S03W21DD00100"
```

### 3. Access the Dashboard

Navigate to `http://localhost` in your browser to access the championship
dashboard.
...
curl http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/metrics
```
...
- **API Reference**: http://localhost:\${{TF_SERVICE_8001_PORT:-8001}}/docs
...
_"The way I look at it, everything is a team sport." - Tom Brady_
