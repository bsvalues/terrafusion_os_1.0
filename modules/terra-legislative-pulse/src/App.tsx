...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <header className="bg-[#27374D] text-white p-4 shadow-lg">
...
className="text-sm text-blue-200">Government Legislative Intelligence System</p>
      ...
      <main className="container mx-auto p-6">
        <Switch>
          <Route path="/" component={LegislativeDashboard} />
          <Route path="/bills" component={BillTracker} />
          <Route path="/analysis" component={PolicyAnalysis} />
          <Route path="/compliance" component={ComplianceMonitor} />
