...
import { Shield, Globe, Database, Users, Lock, Network  } from '@mui/icons-material';
...
const DeploymentModeSelector: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
              ...
              <div><>
                ...
                <div
                  ...
                  {selectedCounties.map(countyId => {
                    ...
                    return (
                      <Badge key={countyId} variant="outline">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Deployment Model Comparison</CardTitle>
        </CardHeader>
        <CardContent>
