...
const DYNAMIC_ASSETS = ['/assets/icons/', '/assets/images/', '/assets/screenshots/'];
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('Terrafusion Market', options));
});
...
function isDynamicAsset(pathname) {
  return (
    DYNAMIC_ASSETS.some(pattern => pathname.startsWith(pattern)) ||
