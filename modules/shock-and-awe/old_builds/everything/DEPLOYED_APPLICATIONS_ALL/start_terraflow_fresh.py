...
def index():
    ...
    """, port=8010, timestamp=datetime.now().strftime('%Y-%m-%d %H:%M:%S'))
...
def main():
    ...
    if success:
        ...
        print("🌐 Access your application at: http://localhost:8010")
        print("📊 API Status: http://localhost:8010/api/status")
        print("🔄 Workflows: http://localhost:8010/workflows")
    else:
