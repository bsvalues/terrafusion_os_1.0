...
def check_application_status():
    ...
    applications = [
        {'name': 'TerraFusion Build', 'port': 5000, 'description': 'Property Assessment Platform with AI Valuation'},
        {'name': 'TerraFlow', 'port': 5001, 'description': 'Workflow Management Engine'},
        {'name': 'TerraFusionSync', 'port': 5002, 'description': 'Data Synchronization Hub'},
        {'name': 'TerraAgent', 'port': 5003, 'description': 'AI Management System'},
        {'name': 'TerraFusionAssessor', 'port': 5004, 'description': 'Enterprise Assessment Platform'},
        {'name': 'TerraFusionDashboard', 'port': 5005, 'description': 'Executive Command Center'},
        {'name': 'TerraMiner', 'port': 5006, 'description': 'Advanced Data Mining & Analytics'},
        {'name': 'BSIncomeValuation', 'port': 5007, 'description': 'Income-Based Valuation System'},
        {'name': 'TerraFusionPro', 'port': 5008, 'description': 'Professional Services Portal'},
        {'name': 'BCBSGISPRO', 'port': 5010, 'description': 'GIS Professional Tools'},
        {'name': 'BCBSLevy', 'port': 5009, 'description': 'Tax Levy Management System'},
        {'name': 'TerraFusionAssistant', 'port': 5011, 'description': 'AI Assistant Platform'},
        {'name': 'TerraFusionProPlus', 'port': 5012, 'description': 'Professional Plus Services'},
        {'name': 'TerraFusionPermit', 'port': 5013, 'description': 'Permit Management System'},
        {'name': 'TerraFusionPilt', 'port': 5014, 'description': 'Property Information Lookup Tool'}
    ]
