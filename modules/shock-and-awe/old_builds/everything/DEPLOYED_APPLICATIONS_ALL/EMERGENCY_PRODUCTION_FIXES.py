...
class TerraFusionProductionFixer:
    ...
    def check_app_connects_to_sync(self, app_dir):
        ...
        api_patterns = [
            "localhost:\${{TF_API_5002_PORT:-5002}}",
            "terrafusionsync",
            "/api/v1/",
    ...
    def fix_database_architecture(self):
        ...
        try:
            ...
            master_config = {
                "master_database": {
                    "type": "postgresql",
                    "connection_string": "postgresql://terrafusion:secure_password@localhost:\${{TF_API_5002_PORT:-5002}}/terrafusion_master"
                },
                "sync_endpoints": {
                    "base_url": "http://localhost:\${{TF_API_5002_PORT:-5002}}/api/v1",
                    "health_check": "/health",
                ...
                "applications": {
                    "TerraFusion_Build": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": True},
                    "TerraFlow": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": True},
                    "TerraFusionSync": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": False, "is_master": True},
                    "TerraAgent": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": True},
                    "TerraMiner": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": True},
                    "TerraLevy": {"port": \${{TF_API_PORT:-5000}}, "sync_enabled": True}
                }
            }
...
class TerraFusionAPI:
    def __init__(self, base_url: str = "http://localhost:\${{TF_API_5002_PORT:-5002}}/api/v1"):
