    ...
    <Box sx={{ p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ background: 'linear-gradient(145deg, rgba(26, 26, 26, 0.7), rgba(31, 31, 31, 0.7))' }}>
            <CardContent>
              <Typography variant="h6" gutterBottom>
                Overall System Status
              </Typography>
              <Box display="flex" alignItems="center" gap={2} mb={2}>
                <Typography variant="h3" sx={{ color: overallHealth > 80 ? 'success.main' : 'error.main' }}>
                ...
                <Box flex={1}>
                  ...
                  <Typography variant="body2" color="text.secondary" mt={1}>
                    {successCount} of {totalCount} tests passed
                  </Typography>
                </Box>
              </Box>
              {overallHealth > 90 ? (
                <Alert severity="success">System operating at optimal performance</Alert>
              ) : overallHealth > 70 ? (
                <Alert severity="warning">System operational with minor issues</Alert>
              ) : (
          ...
          <Card sx={{ background: 'linear-gradient(145deg, rgba(26, 26, 26, 0.7), rgba(31, 31, 31, 0.7))' }}>
            <CardContent>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                  <Box textAlign="center">
                    <CloudDoneIcon sx={{ color: 'secondary.main', mb: 1 }} />
                ...
                <Grid item xs={6}>
                  <Box textAlign="center">
                    <MemoryIcon sx={{ color: 'success.main', mb: 1 }} />
                ...
                <Grid item xs={6}>
                  <Box textAlign="center">
                    <SecurityIcon sx={{ color: 'warning.main', mb: 1 }} />
            ...
            <CardContent>
              ...
              <List>
                {validationResults.map((result, index) => (
                  <ListItem key={index} sx={{ bgcolor: 'rgba(255, 255, 255, 0.02)', mb: 1, borderRadius: 1 }}>
                    <ListItemIcon>
