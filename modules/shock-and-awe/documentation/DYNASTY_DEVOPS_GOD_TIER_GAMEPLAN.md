...
class NarrativeLogger {
  format(event) {
    ...
    return {
      time: '3:23 PM',
      story:
        'Defense Swarm 12 noticed unusual behavior from an internal device. ' +
...
The DevOps team doesn't manage security anymore. They coach an autonomous
champion that never loses.
