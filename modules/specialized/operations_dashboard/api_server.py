...
SERVICES = {
    'terrafusion-sync': {'port': 5002, 'name': 'TerraFusionSync'},
    'propertyworkbench': {'port': 5003, 'name': 'PropertyWorkbench'},
    'costforgeai': {'port': 8000, 'name': 'CostForgeAI'},
    'terralevy': {'port': 5006, 'name': 'TerraLevy'},
    'terraagent': {'port': 5009, 'name': 'TerraAgent'},
    'terraflow': {'port': 8001, 'name': 'TerraFlow'},
    'terraminer': {'port': 8002, 'name': 'TerraMiner'},
    'webaudittracker': {'port': 8003, 'name': 'WebAuditTracker'}
}
...
if __name__ == '__main__':
    ...
    print("Access dashboard at: http://localhost:9999")
