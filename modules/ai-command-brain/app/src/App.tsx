...
function App() {
  const [activeView, setActiveView] = useState<'overview' | 'models' | 'neural' | 'automation' | 'predictions' | 'monitoring'>('overview');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/10 to-slate-900 text-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-2xl shadow-purple-500/25"><>
      ...
      {/* Navigation Tabs */}
      <div className="bg-slate-800/30 backdrop-blur border-b border-slate-700/50">
        ...
        {activeView === 'overview' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-purple-900/30 to-purple-800/30 rounded-2xl border border-purple-500/20 p-6">
              ...
              <div className="bg-gradient-to-br from-blue-900/30 to-blue-800/30 rounded-2xl border border-blue-500/20 p-6">
                <div className="flex items-center justify-between mb-4">
              ...
              <div className="bg-gradient-to-br from-green-900/30 to-green-800/30 rounded-2xl border border-green-500/20 p-6">
                <div className="flex items-center justify-between mb-4">
                  <Database className="text-green-400" size={24} />
                  <span className="text-xs text-green-400">SCALE</span>
                </div><>
              ...
              <div className="bg-gradient-to-br from-orange-900/30 to-orange-800/30 rounded-2xl border border-orange-500/20 p-6">
                <div className="flex items-center justify-between mb-4">
                  <DollarSign className="text-orange-400" size={24} />
                  <span className="text-xs text-orange-400">VALUE</span>
                </div><>
                ...
                <tbody className="divide-y divide-slate-700">
                  {automationRules.map(rule => (
                    <tr key={rule.id} className="hover:bg-slate-800/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className="font-mono text-sm">{rule.avgExecutionTime}s</span>
                      </td>
                      <td className="px-6 py-4">
                        <button className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${
                          rule.status === 'active' 
                          ...
                          {rule.status === 'active' ? <Unlock size={12} /> : <Lock size={12} />}
                          {rule.status}
                        </button>
                      </td>
                    </tr>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-start gap-4">
                      <div className={`p-2 rounded-lg ${
                        ...
                        {prediction.category === 'revenue' && <DollarSign size={20} />}
