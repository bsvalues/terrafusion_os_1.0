...
function bu(e, n, t) {
  ...
  return { $$typeof: Xt, type: e, key: i, ref: o, props: l, _owner: Vi.current };
}
function vc(e, n) {
        ...
        : l != null &&
          (Bi(l) &&
            (l = vc(
              l,
              t +
                (!l.key || (o && o.key === l.key) ? '' : ('' + l.key).replace(Io, '$&/') + '/') +
                e
            )),
          n.push(l)),
      1
...
var ue = { current: null },
  wr = { transition: null },
  wc = { ReactCurrentDispatcher: ue, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Vi };
function es() {
...
function ns(e, n, t) {
  ...
  return { $$typeof: xc, type: e, key: i, ref: o, props: l, _owner: Cc.current };
}
el.Fragment = Ec;
el.jsx = ns;
el.jsxs = ns;
 ...
 */ (function (e) {
      ...
      e: for (var W = 0, G = _.length, bt = G >>> 1; W < bt; ) {
        ...
        if (0 > l(gl, T))
          yn < G && 0 > l(er, gl)
            ? ((_[W] = er), (_[yn] = T), (W = yn))
            : ((_[W] = gl), (_[vn] = T), (W = vn));
        else if (yn < G && 0 > l(er, T)) ((_[W] = er), (_[yn] = T), (W = yn));
        else break e;
      }
    }
    return z;
  ...
  function d(_) {
    for (var z = t(c); z !== null; ) {
      ...
      else if (z.startTime <= _) (r(c), (z.sortIndex = z.expirationTime), n(s, z));
      else break;
      z = t(c);
    }
  }
  ...
  function E(_, z) {
    ...
    var T = p;
    try {
      for (d(z), m = t(s); m !== null && (!(m.expirationTime > z) || (_ && !Ne())); ) {
        var W = m.callback;
    ...
    (e.unstable_scheduleCallback = function (_, z, T) {
      ...
      return (
        ...
        T > W
          ? ((_.sortIndex = T),
            n(c, _),
            t(s) === null && _ === t(c) && (k ? (f(P), (P = -1)) : (k = !0), yl(y, T - W)))
          : ((_.sortIndex = G), n(s, _), w || v || ((w = !0), vl(E))),
        _
      );
    }),
...
function $c(e, n, t, r, l, i, o, u, s) {
  ((Et = !1), (Lr = null), Uc.apply(Ac, arguments));
}
...
function qc(e, n) {
  for (
    ...
    var o = 31 - Le(i),
      u = 1 << o,
      s = l[o];
    (s === -1 ? (!(u & t) || u & r) && (l[o] = Jc(u, n)) : s <= n && (e.expiredLanes |= u),
      (i &= ~u));
  }
}
function ai(e) {
...
function nf(e, n, t, r, l) {
  switch (n) {
    ...
    case 'gotpointercapture':
      return ((i = l.pointerId), Ft.set(i, dt(Ft.get(i) || null, e, n, t, r, l)), !0);
  }
  return !1;
}
function Os(e) {
...
function pt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ci || ((ci = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, tf)));
}
function Dt(e) {
  function n(l) {
    return pt(l, e);
...
function bi(e, n, t, r) {
  if (Fr) {
    var l = fi(e, n, t, r);
    if (l === null) (Ol(e, n, r, Dr, t), Xo(e, r));
    else if (nf(l, e, n, t, r)) r.stopPropagation();
    else if ((Xo(e, r), n & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var i = Jt(l);
        if ((i !== null && js(i), (i = fi(e, n, t, r)), i === null && Ol(e, n, r, Dr, t), i === l))
          break;
        l = i;
      }
...
var wf = V({}, Zt, {
  ...
  Ef = we(xf),
  _f = V({}, ot, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = we(_f),
  Nf = V({}, tl, {
    deltaX: function (e) {
...
var Tf = We && 'TextEvent' in window && !_t,
  Is = We && (!ro || (_t && 8 < _t && 11 >= _t)),
...
function $s(e, n, t, r) {
  (ys(r),
    (n = Ir(n, 'onChange')),
    0 < n.length &&
      ((t = new no('onChange', 'change', null, t, r)), e.push({ event: t, listeners: n })));
}
var Ct = null,
  It = null;
function Mf(e) {
...
function Bs(e) {
  if (e.propertyName === 'value' && rl(It)) {
    var n = [];
    ($s(n, It, e, Gi(e)), ks(Mf, n));
  }
}
function Ff(e, n, t) {
  e === 'focusin'
    ? (lu(), (Ct = n), (It = t), Ct.attachEvent('onpropertychange', Bs))
    : e === 'focusout' && lu();
}
function Df(e) {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              y !== null &&
              ((d = y), f !== null && ((y = Mt(a, f)), y != null && k.push($t(a, y, d)))),
            I)
          )
            break;
          a = a.return;
        }
        0 < k.length && ((p = new v(p, w, null, t, h)), m.push({ event: p, listeners: k }));
      }
    }
    if (!(n & 7)) {
      e: {
        if (
          ...
          p && t !== ii && (w = t.relatedTarget || t.fromElement) && (kn(w) || w[Qe]))
        )
          break e;
        if (
          (v || p) &&
          ...
          if (
            ...
            (e === 'pointerout' || e === 'pointerover') &&
              ((k = bo), (y = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
            (I = v == null ? p : An(v)),
            (d = w == null ? p : An(w)),
            (p = new k(y, a + 'leave', v, t, h)),
            (p.target = I),
            (p.relatedTarget = d),
            (y = null),
            kn(h) === c &&
            ...
            n: {
              for (k = v, f = w, a = 0, d = k; d; d = Mn(d)) a++;
          ...
          (v !== null && cu(m, p, v, k, !1), w !== null && I !== null && cu(m, I, w, k, !0));
        }
      }
      e: {
        if (
      ...
      switch (((C = c ? An(c) : window), e)) {
        case 'focusin':
          (tu(C) || C.contentEditable === 'true') && ((In = C), (di = c), (Nt = null));
          break;
        case 'focusout':
          Nt = di = In = null;
          break;
      ...
      (P &&
        (Is &&
          ...
          (Dn || P !== 'onCompositionStart'
            ...
            : ((en = h), (eo = 'value' in en ? en.value : en.textContent), (Dn = !0))),
        (C = Ir(c, P)),
        0 < C.length &&
...
function cu(e, n, t, r, l) {
  for (var i = n._reactName, o = []; t !== null && t !== r; ) {
    ...
    (u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = Mt(t, i)), s != null && o.unshift($t(t, s, u)))
        : l || ((s = Mt(t, i)), s != null && o.push($t(t, s, u)))),
      (t = t.return));
  }
...
function hn() {
  if (!Dl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Cs(Zi, hn), l);
    } finally {
      ((M = n), (Dl = !1));
    }
  }
  ...
  if (U) {
    ...
    if (n) {
      ...
      if (!vu(e, n)) {
        ...
        n = on(t.nextSibling);
        var r = ve;
        n && vu(e, n) ? ta(r, t) : ((e.flags = (e.flags & -4097) | 2), (U = !1), (ve = e));
      }
    } else {
      if (Si(e)) throw Error(g(418));
...
function dr(e) {
  ...
  if (
    ((n = e.tag !== 3) &&
      !(n = e.tag !== 5) &&
      ((n = e.type), (n = n !== 'head' && n !== 'body' && !vi(e.type, e.memoizedProps))),
    n && (n = he))
  ) {
...
function la(e) {
  ...
  function s(f, a, d, y) {
    ...
    return E === Fn
      ...
      : a !== null &&
          (a.elementType === E ||
            (typeof E == 'object' && E !== null && E.$$typeof === Ze && gu(E) === a.type))
  ...
  function w(f, a, d, y) {
    ...
    if (N === null) {
      for (; P < d.length; P++)
        ((N = m(f, d[P], y)),
          N !== null && ((a = i(N, a, P)), C === null ? (E = N) : (C.sibling = N), (C = N)));
      return (U && gn(f, P), E);
    }
  ...
  function k(f, a, d, y) {
    ...
    for (
      var C = (E = null), N = a, P = (a = 0), H = null, L = d.next();
      N !== null && !L.done;
      P++, L = d.next()
    ) {
      N.index > P ? ((H = N), (N = null)) : (H = N.sibling);
    ...
    if (L.done) return (t(f, N), U && gn(f, P), E);
    if (N === null) {
      for (; !L.done; P++, L = d.next())
        ((L = m(f, L.value, y)),
          L !== null && ((a = i(L, a, P)), C === null ? (E = L) : (C.sibling = L), (C = L)));
      return (U && gn(f, P), E);
    }
      ...
      switch (d.$$typeof) {
        case tr:
          e: {
            for (var E = d.key, C = a; C !== null; ) {
              if (C.key === E) {
                if (((E = d.type), E === Fn)) {
                  ...
                  C.elementType === E ||
                  (typeof E == 'object' && E !== null && E.$$typeof === Ze && gu(E) === C.type)
                ) {
                  (t(f, C.sibling),
                    (a = l(C, d.props)),
                    (a.ref = ht(f, C, d)),
            ...
            d.type === Fn
              ? ((a = Cn(d.props.children, f.mode, y, d.key)), (a.return = f), (f = a))
              : ((y = Tr(d.type, d.key, d.props, null, f.mode, y)),
                (y.ref = ht(f, a, d)),
                (y.return = f),
                (f = y));
      ...
      if ((r & p) === p) {
        ...
        e: {
          ...
          switch (((p = n), (v = t), k.tag)) {
            ...
            case 0:
              if (((w = k.payload), (p = typeof w == 'function' ? w.call(v, m, p) : w), p == null))
                break e;
              m = V({}, m, p);
              break e;
            case 2:
...
function go(e, n, t, r, l, i) {
  if (
    ...
    i = 0;
    do {
      if (((Pt = !1), (Wt = 0), 25 <= i)) throw Error(g(301));
      ((i += 1), (Z = Y = null), (n.updateQueue = null), (_r.current = od), (e = t(r, l)));
    } while (Pt);
  }
  if (
    ((_r.current = Xr),
...
function ca(e, n) {
  ...
  if (
    ...
    if (((t.flags |= 2048), Kt(9, da.bind(null, t, r, l, n), void 0, null), J === null))
      throw Error(g(349));
    zn & 30 || fa(t, n, l);
  }
  return l;
...
function ul(e, n, t, r) {
  ...
  (($.flags |= e), (l.memoizedState = Kt(1 | n, t, i, r)));
}
function xu(e, n) {
...
function Ea(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = zs()), ($.lanes |= t), (Tn |= t), (e.baseState = !0)), n)
    ...
    if (e.lanes === 0 && (i === null || i.lanes === 0) && ((i = n.lastRenderedReducer), i !== null))
      try {
        ...
        if (((l.hasEagerState = !0), (l.eagerState = u), Me(u, o))) {
          var s = n.interleaved;
          (s === null ? ((l.next = l), fo(n)) : ((l.next = s.next), (s.next = l)),
            (n.interleaved = l));
          return;
        }
      } catch {
...
function ja(e, n, t) {
  ...
  return (
    i !== null &&
      ...
      (t.callback = function () {
        (Ci(e, n), typeof r != 'function' && (sn === null ? (sn = new Set([this])) : sn.add(this)));
        var o = n.stack;
...
function ju(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null)) (Nr(e, n), za(n, t, r), _i(n, t, r, l), (r = !0));
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
    ...
    u !== m || p !== w || fe.current || Je
      ? (typeof v == 'function' && (Ei(n, t, v, r), (w = n.memoizedState)),
...
function ad(e, n, t, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), ce || u)) {
    ...
    return (zo(), (r = Vl(Error(g(421)))), mr(e, n, o, r));
  }
  return l.data === '$?'
    ? ((n.flags |= 128), (n.child = e.child), (n = xd.bind(null, e)), (l._reactRetry = n), null)
    : ((e = i.treeContext),
      (he = on(l.nextSibling)),
      (ve = n),
      (U = !0),
...
function Da(e, n, t) {
  var r = n.pendingProps,
    l = r.revealOrder,
    i = r.tail;
  if ((ie(e, n, r.children, t), (r = A.current), r & 2)) ((r = (r & 1) | 2), (n.flags |= 128));
  else {
      ...
      if (((r = n.memoizedState), r !== null))
        return r.dehydrated !== null
          ...
          : t & n.child.childLanes
            ? Fa(e, n, t)
            : (O(A, A.current & 1), (e = Ye(e, n, t)), e !== null ? e.sibling : null);
      O(A, A.current & 1);
      break;
    case 19:
      ...
      if (!r.hasOwnProperty(c) && l.hasOwnProperty(c) && l[c] != null)
        if (c === 'style') {
          ...
          c !== 'dangerouslySetInnerHTML' &&
            ...
            c !== 'autoFocus' &&
            (Lt.hasOwnProperty(c) ? i || (i = []) : (i = i || []).push(c, null));
    for (c in r) {
      var s = r[c];
      if (
        ((u = l != null ? l[c] : void 0),
          ...
          c === 'dangerouslySetInnerHTML'
            ...
            : c === 'children'
              ...
              : c !== 'suppressContentEditableWarning' &&
                c !== 'suppressHydrationWarning' &&
                (Lt.hasOwnProperty(c)
                  ? (s != null && c === 'onScroll' && F('scroll', e), i || u === s || (i = []))
                  : (i = i || []).push(c, s));
    }
    t && (i = i || []).push('style', t);
    var c = i;
        ...
        (e === null || e.child === null) &&
          (dr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), je !== null && (Ui(je), (je = null)))),
        ji(e, n),
        te(n),
        null
      );
              ...
              o === 'children'
                ? typeof u == 'string'
                  ...
                  : typeof u == 'number' &&
                    ...
                    (i.suppressHydrationWarning !== !0 && fr(r.textContent, u, e),
                    (l = ['children', '' + u]))
                : Lt.hasOwnProperty(o) && u != null && o === 'onScroll' && F('scroll', r);
            }
          switch (t) {
            case 'input':
              (rr(r), Bo(r, i, !0));
    ...
    case 13:
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          ...
          null);
    case 4:
      return (tt(), ji(e, n), e === null && At(n.stateNode.containerInfo), te(n), null);
    case 10:
...
function md(e, n) {
  ...
  for (hi = { focusedElem: e, selectionRange: t }, Fr = !1, x = n; x !== null; )
              ...
              case 1:
                if (w !== null) {
                  var k = w.memoizedProps,
                    I = w.memoizedState,
                    f = n.stateNode,
                    a = f.getSnapshotBeforeUpdate(n.elementType === n.type ? k : ze(n.type, k), I);
...
function $a(e) {
  ...
  (n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null && (delete n[De], delete n[Vt], delete n[gi], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
    ...
    case 5:
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), s !== null))
          try {
            (u === 'input' && i.type === 'radio' && i.name != null && fs(l, i), li(u, o));
            var c = li(u, i);
...
function Wa(e, n, t) {
  for (var r = (e.mode & 1) !== 0; x !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      Du(e);
    } else l.subtreeFlags & 8772 && i !== null ? ((i.return = l), (x = i)) : Du(e);
  }
}
function Du(e) {
  for (; x !== null; ) {
...
function Re(e, n, t, r) {
  if (50 < jt) throw ((jt = 0), (Di = null), Error(g(185)));
  (Gt(e, t, r),
    (!(R & 2) || e !== J) &&
...
function Qa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    while (1);
    (ao(), (Gr.current = i), (R = l), K !== null ? (n = 0) : ((J = null), (b = 0), (n = X)));
  }
  if (n !== 0) {
    if ((n === 2 && ((l = ai(e)), l !== 0 && ((r = l), (n = Ii(e, l)))), n === 1))
    ...
    if (n === 6) be(e, r);
      ...
      if (
        ...
        !(r & 30) &&
          !yd(l) &&
          ((n = qr(e, r)), n === 2 && ((i = ai(e)), i !== 0 && ((r = i), (n = Ii(e, i)))), n === 1))
      )
        throw ((t = Yt), _n(e, 0), be(e, r), pe(e, Q()), t);
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if ((be(e, r), (r & 130023424) === r && ((n = Co + 500 - Q()), 10 < n))) {
            ...
            e.timeoutHandle = yi(wn.bind(null, e, ae, Ae), n);
            break;
          }
          wn(e, ae, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yi(wn.bind(null, e, ae, Ae), r);
            break;
          }
          wn(e, ae, Ae);
          break;
...
function be(e, n) {
  for (
    n &= ~_o, n &= ~cl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
    0 < n;
    ...
    try {
      ...
      e: {
        ...
        if (
          ...
          var v = Nu(o);
          if (v !== null) {
            ((v.flags &= -257), Pu(v, o, u, i, n), v.mode & 1 && Cu(i, c, n), (n = v), (s = c));
            var w = n.updateQueue;
            if (w === null) {
              var k = new Set();
          ...
          var I = Nu(o);
          if (I !== null) {
            (!(I.flags & 65536) && (I.flags |= 256), Pu(I, o, u, i, n), uo(rt(s, u)));
            break e;
          }
        }
...
function Xa(e) {
  ...
  ((e.memoizedProps = e.pendingProps), n === null ? Ga(e) : (K = n), (Eo.current = null));
}
function Ga(e) {
  var n = e;
  do {
...
function kd(e, n, t) {
  ...
  (r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - Co) ? _n(e, 0) : (_o |= t)),
    pe(e, n));
}
function Za(e, n) {
...
ws = No;
Ss = jn;
var jd = { usingClientEntryPoint: !1, Events: [Jt, An, il, ys, gs, No] },
  yt = {
...
function Wu(e, n = !1) {
  ...
  return (
    Object.defineProperty(window, r, {
      value: l => (n && Reflect.deleteProperty(window, r), e == null ? void 0 : e(l)),
      writable: !1,
      configurable: !0,
    }),
    t
...
async function Ql(e, n = {}) {
  return new Promise((t, r) => {
    const l = Wu(o => {
        (t(o), Reflect.deleteProperty(window, `_${i}`));
      }, !0),
      i = Wu(o => {
        (r(o), Reflect.deleteProperty(window, `_${l}`));
      }, !0);
    window.__TAURI_IPC__({ cmd: e, callback: l, error: i, ...n });
  });
}
function Od() {
  var p;
  const [e, n] = Sn.useState({
      cpu_usage: 0,
      memory_usage: 0,
      disk_usage: 0,
    ...
    [l, i] = Sn.useState(null);
  Sn.useEffect(() => {
    const v = setInterval(async () => {
      try {
        const w = await Ql('get_system_metrics');
        n(w);
      } catch (w) {
        console.error('Failed to fetch system metrics:', w);
      }
    }, 5e3);
  ...
  const o = async v => {
      try {
        (await Ql('start_app', { appId: v }),
          r(w => w.map(k => (k.id === v ? { ...k, status: 'running', health_score: 85 } : k))));
      } catch (w) {
        console.error(`Failed to start app ${v}:`, w);
      }
    },
    u = async v => {
      try {
        (await Ql('stop_app', { appId: v }),
          r(w => w.map(k => (k.id === v ? { ...k, status: 'stopped', health_score: 0 } : k))));
      } catch (w) {
        console.error(`Failed to stop app ${v}:`, w);
      }
    },
    s = v => {
      switch (v) {
    ...
    c = t.filter(v => v.status === 'running').length,
    h = t.length,
    m = Math.round((c / h) * 100);
  return S.jsxs('div', {
    ...
    children: [
      S.jsxs('header', {
        ...
        children: [
          S.jsx('h1', { children: '🚀 Terrafusion Master Control Center' }),
          S.jsx('div', {
            className: 'system-health',
            children: S.jsxs('span', {
              className: 'health-indicator',
              style: { color: m > 80 ? '#00ff00' : m > 60 ? '#ff9500' : '#ff0000' },
              children: ['System Health: ', m, '%'],
            }),
          }),
        ],
      }),
      S.jsxs('div', {
        ...
        children: [
          S.jsxs('section', {
            ...
            children: [
              S.jsx('h2', { children: '🖥️ System Metrics' }),
              S.jsxs('div', {
                ...
                children: [
                  S.jsxs('div', {
                    ...
                    children: [
                      S.jsx('div', { className: 'metric-label', children: 'CPU Usage' }),
                      S.jsxs('div', {
                        className: 'metric-value',
                        children: [e.cpu_usage.toFixed(1), '%'],
                      }),
                      S.jsx('div', {
                        className: 'metric-bar',
                        children: S.jsx('div', {
                          className: 'metric-fill',
                          style: { width: `${e.cpu_usage}%` },
                        }),
                      }),
                    ],
                  }),
                  S.jsxs('div', {
                    className: 'metric-card',
                    children: [
                      S.jsx('div', { className: 'metric-label', children: 'Memory Usage' }),
                      S.jsxs('div', {
                        className: 'metric-value',
                        children: [e.memory_usage.toFixed(1), '%'],
                      }),
                      S.jsx('div', {
                        className: 'metric-bar',
                        children: S.jsx('div', {
                          className: 'metric-fill',
                          style: { width: `${e.memory_usage}%` },
                        }),
                      }),
                    ],
                  }),
                  S.jsxs('div', {
                    className: 'metric-card',
                    children: [
                      S.jsx('div', { className: 'metric-label', children: 'Disk Usage' }),
                      S.jsxs('div', {
                        className: 'metric-value',
                        children: [e.disk_usage.toFixed(1), '%'],
                      }),
                      S.jsx('div', {
                        className: 'metric-bar',
                        children: S.jsx('div', {
                          className: 'metric-fill',
                          style: { width: `${e.disk_usage}%` },
                        }),
                      }),
                    ],
                  }),
                  S.jsxs('div', {
                    className: 'metric-card',
                    children: [
                      S.jsx('div', { className: 'metric-label', children: 'Network' }),
                      S.jsx('div', {
                        className: 'metric-value network-status',
                        style: { color: e.network_status === 'connected' ? '#00ff00' : '#ff0000' },
                        children: e.network_status,
                      }),
                    ],
                  }),
                ],
          ...
          S.jsxs('section', {
            ...
            children: [
              S.jsxs('h2', { children: ['🎯 Application Status (', c, '/', h, ' Running)'] }),
              S.jsx('div', {
                className: 'apps-grid',
                children: t.map(v =>
                  S.jsxs(
                    'div',
                    {
                      className: `app-card ${l === v.id ? 'selected' : ''}`,
                      onClick: () => i(v.id),
                      children: [
                        S.jsxs('div', {
                          className: 'app-header',
                          children: [
                            S.jsx('span', { className: 'app-name', children: v.name }),
                            S.jsx('span', {
                              className: 'app-status',
                              style: { color: s(v.status) },
                              children: '●',
                            }),
                          ],
                        }),
                        S.jsxs('div', {
                          ...
                          children: [
                            S.jsxs('div', { children: ['Status: ', v.status] }),
                            v.port && S.jsxs('div', { children: ['Port: ', v.port] }),
                            v.uptime && S.jsxs('div', { children: ['Uptime: ', v.uptime] }),
                            S.jsxs('div', { children: ['Health: ', v.health_score, '%'] }),
                          ],
                        }),
                        S.jsx('div', {
          ...
          S.jsxs('section', {
            ...
            children: [
              S.jsx('h2', { children: '🎛️ Master Controls' }),
              S.jsxs('div', {
                className: 'control-buttons',
                children: [
                  S.jsx('button', {
                    className: 'control-btn start-all',
                    onClick: () => console.log('Start All'),
                    children: '🚀 Start All Apps',
                  }),
                  S.jsx('button', {
                    className: 'control-btn stop-all',
                    onClick: () => console.log('Stop All'),
                    children: '🛑 Stop All Apps',
                  }),
                  S.jsx('button', {
                    className: 'control-btn restart-all',
                    onClick: () => console.log('Restart All'),
                    children: '🔄 Restart All Apps',
                  }),
                  S.jsx('button', {
              ...
              S.jsxs('div', {
                ...
                children: [
                  S.jsx('h3', { children: '📋 Recent Activity' }),
                  S.jsxs('div', {
                    className: 'logs-container',
                    children: [
                      S.jsx('div', {
                        className: 'log-entry',
                        children: '🟢 TerraAgent: Health check passed',
                      }),
                      S.jsx('div', {
                        className: 'log-entry',
                        children: '🟡 PropertyWorkbench: Connection timeout',
                      }),
                      S.jsx('div', {
                        className: 'log-entry',
                        children: '🟢 CostForgeAI: Processing complete',
                      }),
                      S.jsx('div', {
                        className: 'log-entry',
                        children: '🔵 System: Memory optimization completed',
                      }),
                      S.jsx('div', {
                        className: 'log-entry',
                        children: '🟢 TerraMiner: Data sync successful',
                      }),
                    ],
                  }),
                ],
            ...
            S.jsxs('section', {
              ...
              children: [
                S.jsxs('h2', {
                  children: [
                    '📊 ',
                    (p = t.find(v => v.id === l)) == null ? void 0 : p.name,
                    ' Details',
                  ],
                }),
                S.jsxs('div', {
                  ...
                  children: [
                    S.jsxs('div', {
                      ...
                      children: [
                        S.jsx('h4', { children: 'Performance Metrics' }),
                        S.jsx('div', { children: 'Response Time: 45ms' }),
                        S.jsx('div', { children: 'Throughput: 1,250 req/min' }),
                        S.jsx('div', { children: 'Error Rate: 0.02%' }),
                      ],
                    }),
                    S.jsxs('div', {
                      className: 'detail-card',
                      children: [
                        S.jsx('h4', { children: 'Resource Usage' }),
                        S.jsx('div', { children: 'CPU: 12.5%' }),
                        S.jsx('div', { children: 'Memory: 256MB' }),
                        S.jsx('div', { children: 'Connections: 23' }),
                      ],
                    }),
                    S.jsxs('div', {
                      className: 'detail-card',
                      children: [
                        S.jsx('h4', { children: 'Quick Actions' }),
                        S.jsx('button', { className: 'action-btn', children: '🔧 Configure' }),
                        S.jsx('button', { className: 'action-btn', children: '📊 View Logs' }),
                        S.jsx('button', { className: 'action-btn', children: '🔄 Restart' }),
                      ],
                    }),
                  ],
                }),
...
Kl.createRoot(document.getElementById('root')).render(
  S.jsx(Sc.StrictMode, { children: S.jsx(Od, {}) })
);
