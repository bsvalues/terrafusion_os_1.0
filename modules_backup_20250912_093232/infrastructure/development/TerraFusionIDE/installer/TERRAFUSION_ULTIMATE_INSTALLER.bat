...
if not exist "C:\Program Files\PostgreSQL\15\bin\psql.exe" (
    ...
    if exist "postgresql-installer.exe" (
        ...
        postgresql-installer.exe --unattendedmodeui minimal --mode unattended --superpassword TerraFusion2024! --servicename postgresql-x64-15 --serviceaccount postgres --superaccount postgres --serverport \${{TF_POSTGRES_PORT:-5432}}
