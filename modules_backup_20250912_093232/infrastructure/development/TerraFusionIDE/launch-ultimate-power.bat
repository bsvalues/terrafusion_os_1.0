...
echo 🌟 TerraFusionSync: Port \${{TF_API_5002_PORT:-5002}} ✓
echo 🌟 TerraAgent: Port \${{TF_API_5002_PORT:-5002}} ✓
echo 🌟 TerraFlow: Port \${{TF_API_5002_PORT:-5002}} ✓
echo 🌟 TerraMiner: Port \${{TF_API_5002_PORT:-5002}} ✓
echo 🌟 TerraLevy: Port \${{TF_API_5002_PORT:-5002}} ✓
echo 🌟 CostForge: Port \${{TF_API_5002_PORT:-5002}} ✓
