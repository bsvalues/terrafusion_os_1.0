...
if command -v curl >/dev/null 2>&1; then
    curl -f http://localhost:${TF_STATIC_PORT:-8080}/health || echo "⚠️ Backend health check failed"
    curl -f http://localhost:${TF_STATIC_PORT:-8080}/ || echo "⚠️ Frontend health check failed"
else
...
- **Frontend IDE**: Port \${{TF_API_PORT:-5000}}
...
3. Access the IDE at http://localhost:${TF_STATIC_PORT:-8080}
4. Monitor performance at http://localhost:${TF_STATIC_PORT:-8080}/health
...
echo "📊 To monitor: http://localhost:${TF_STATIC_PORT:-8080}/health"
echo "🌐 To access IDE: http://localhost:${TF_STATIC_PORT:-8080}"
