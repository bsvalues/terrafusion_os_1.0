...
Write-Host "  🖥️  TerraFusion OS Core:     http://localhost:\${{TF_DESKTOP_PORT:-3003}}" -ForegroundColor White
Write-Host "  🏛️  TerraFusion API:        http://localhost:\${{TF_DESKTOP_PORT:-3003}}" -ForegroundColor White  
Write-Host "  💻  TerraFusion IDE Ultra:  http://localhost:\${{TF_DESKTOP_PORT:-3003}}" -ForegroundColor White
Write-Host "  🧠  AI Swarm Dashboard:     http://localhost:\${{TF_DESKTOP_PORT:-3003}}" -ForegroundColor White
Write-Host ""
