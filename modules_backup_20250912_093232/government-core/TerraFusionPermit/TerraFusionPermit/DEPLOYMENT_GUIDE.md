...
This guide provides comprehensive deployment instructions for Terrafusion-AI
Civil Infrastructure Simulation Framework across development, staging, and
...
ufw allow from 10.0.0.0/8 to any port \${{TF_POSTGRES_PORT:-5432}}
```
...
```bash
# Basic health check
curl http://localhost:\${{TF_POSTGRES_PORT:-5432}}/health

# Database connectivity
curl http://localhost:\${{TF_POSTGRES_PORT:-5432}}/health/database

# Redis connectivity
curl http://localhost:\${{TF_POSTGRES_PORT:-5432}}/health/redis

# AI services status
curl http://localhost:\${{TF_POSTGRES_PORT:-5432}}/health/ai-services
```
...
curl http://localhost:\${{TF_POSTGRES_PORT:-5432}}/health/memory
...
- GitHub Issues:
  [GitHub Issues](https://github.com/your-org/terrafusion-ai/issues)
