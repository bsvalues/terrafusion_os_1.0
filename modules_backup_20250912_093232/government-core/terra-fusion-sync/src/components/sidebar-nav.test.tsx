...
describe('SidebarNav Component', () => {beforeEach(() => {
    vi.clearAllMocks();});

  it('renders the sidebar navigation with all links', () => {render(<SidebarNav />);
  ...
  it('highlights the current active route', () => {// Mock current location as /dashboard
  ...
  it('navigates to the clicked route', () => {// Mock current location
  ...
  it('renders correct icons for each navigation item', () => {render(<SidebarNav />);
  ...
  it('includes a sign out button', () => {render(<SidebarNav />);
  ...
  it('handles sign out action', () => {const navigateMock = vi.fn();
    const useLocationMock = vi.spyOn(wouter, 'useLocation');
    useLocationMock.mockReturnValue(['/dashboard', navigateMock]);
