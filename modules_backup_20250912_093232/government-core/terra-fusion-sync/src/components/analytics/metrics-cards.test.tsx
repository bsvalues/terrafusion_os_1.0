...
describe('MetricsCards', () => {beforeEach(() => {
    queryClient.clear();
    vi.clearAllMocks();});

  it('renders metrics cards with initial values', () => {renderWithProviders(<MetricsCards />);
  ...
  it('displays loading state initially', async () => {// Mock successful response
  ...
  it('handles API error gracefully', async () => {
    ...
    global.fetch = vi.fn().mockImplementationOnce(() => Promise.reject(new Error('API Error')));
