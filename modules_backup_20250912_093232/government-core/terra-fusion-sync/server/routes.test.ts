...
describe('Authentication Routes', () => {
  ...
  describe('Authentication Middleware', () => {
    it('should allow access to protected routes with valid session', async () => {
      ...
      const protectedRoute = app._router.stack.find(
        (layer: any) => layer.route && layer.route.path === '/api/auth/protected'
      );
  ...
  describe('Protected Routes with Permissions', () => {
    it('should allow access to own files', async () => {
      ...
      const fileHandler = app._router.stack.find(
        (layer: any) =>
          layer.route && layer.route.path === '/api/files/:id' && layer.route.methods.get
