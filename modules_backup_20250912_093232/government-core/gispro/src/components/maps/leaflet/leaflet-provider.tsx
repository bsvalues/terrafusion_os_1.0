...
export interface LeafletProviderProps extends MapContainerProps {children?: React.ReactNode;
 ...
 */
function MapEventsHandler({onMapReady}: {onMapReady?: (map: L.Map) => void}) {const map = useMap();
...
export function LeafletProvider({children,
  ...
  return (<MapContainer
      ...
      className={className}
      {...props}
    >{/* Default base layer */}<TileLayer
        attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>contributors'
        url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
      />

      {/* Events handler */}<MapEventsHandler onMapReady={onMapReady} />{/* Children components */}
