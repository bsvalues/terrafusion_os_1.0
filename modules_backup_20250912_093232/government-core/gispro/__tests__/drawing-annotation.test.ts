...
describe('Drawing Annotation Tool', () => {
  ...
  test('getAnnotations should return all added annotations', () => {
    ...
    const annotation1 = addAnnotation({ lat: 45.123, lng: -122.456 }, 'First annotation', 'note');
  ...
  test('clearAnnotations should remove all annotations', () => {
    ...
    addAnnotation({ lat: 45.123, lng: -122.456 }, 'Test annotation', 'note');

    addAnnotation({ lat: 45.789, lng: -122.987 }, 'Another test', 'measurement');
  ...
  test('annotations should maintain order of addition', () => {
    ...
    const annotation1 = addAnnotation({ lat: 45.123, lng: -122.456 }, 'First', 'note');

    const annotation2 = addAnnotation({ lat: 45.789, lng: -122.987 }, 'Second', 'measurement');

    const annotation3 = addAnnotation({ lat: 46.123, lng: -123.456 }, 'Third', 'warning');
  ...
  test('annotations with the same position but different text should be treated as separate', () => {
    ...
    const annotation1 = addAnnotation(position, 'First at this position', 'note');

    const annotation2 = addAnnotation(position, 'Second at this position', 'note');
