...
describe('MeasurementTool Component', () => {beforeEach(() => {
    jest.clearAllMocks();});

  it('should render measurement tool controls correctly', () => {
    render(<MeasurementTool map={mockMap as any} position="topright" />);
  ...
  it('should change measurement units', () =>{
    ...
    render(<MeasurementTool map={mockMap as any} position="topright" onUnitChange={onUnitChange} />
    );
  ...
  it('should reset measurement', () => {
    ...
    render(<MeasurementTool map={mockMap as any} position="topright" onReset={onReset} />);
