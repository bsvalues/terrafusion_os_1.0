...
describe('EnhancedLayerControl', () => {const mockLayers = [
    {
      id: 1,
  ...
  test('toggles layer visibility when checkbox is clicked', async () => {
    ...
    render(<EnhancedLayerControl layers={mockLayers} onLayersChanged={mockOnLayersChanged} />);
  ...
  test('handles errors from API gracefully', async () => {// Mock an error response
    ...
    await waitFor(() => {// Look for error message
