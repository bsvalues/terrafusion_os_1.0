...
// Mock turf functions
jest.mock('@turf/turf', () => ({area: jest.fn(() => 10000), // 10000 square meters (roughly 2.47 acres)}));

// Sample parcel data for testing
const mockParcel: Parcel = {id: 1,
...
const mockFeature: GeoJSONFeature = {type: 'Feature',
  properties: {
    id: 1,
    parcelNumber: '123456789012345',},
...
describe('ParcelPopup', () => {
  test('renders parcel information correctly', () => {
    render(<ParcelPopup parcel={mockParcel} feature={mockFeature} />);
  ...
  test('triggers onViewDetails callback when Details button is clicked', () =>{
    ...
    render(<ParcelPopup parcel={mockParcel} feature={mockFeature} onViewDetails={handleViewDetails} />);
  ...
  test('triggers onSelectParcel callback when Select button is clicked', () => {
    ...
    render(<ParcelPopup parcel={mockParcel} feature={mockFeature} onSelectParcel={handleSelectParcel} />
    );
  ...
  test('close button works when provided', () => {
    ...
    render(<ParcelPopup parcel={mockParcel} feature={mockFeature} onClose={handleClose} />);
  ...
  test('handles missing data gracefully', () => {const incompleteParcel: Parcel = {
      id: 2,
      parcelNumber: '987654321098765',
      // Missing other fields};

    render(<ParcelPopup parcel={incompleteParcel} feature={mockFeature} />);
