...
describe('Document Confidence Visualization', () => {
  ...
  describe('ClassificationConfidenceCard', () => {const mockClassification = {
    ...
    test('should indicate manual classification', () => {const manualClassification = {
        ...mockClassification,
    ...
    test('should show suggestions for low confidence classifications', () => {const lowConfidenceClassification = {
        ...mockClassification,
        confidence: 0.35,};
    ...
    test('should allow updating classification', () =>{
      ...
      render(<ClassificationConfidenceCard
