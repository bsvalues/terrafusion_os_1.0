...
describe('Document Version Comparison', () => {// Sample document versions for testing
  const mockVersion1 = {
    id: 1,
    documentId: 100,
    versionNumber: 1,
  ...
  beforeEach(() => {jest.clearAllMocks();
    ...
    (useQuery as jest.Mock).mockImplementation(({ queryKey}) => {
      if (queryKey[0] === `/api/documents/versions/${mockVersion1.id}/content`) {return {
          data: mockVersion1.content,
          isLoading: false,
          error: null,};
      } else if (queryKey[0] === `/api/documents/versions/${mockVersion2.id}/content`) {return {
  ...
  test('should render side-by-side version comparison', async () => {
    render(<DocumentVersionComparison
    ...
    await waitFor(() => {// Check both version contents are displayed
  ...
  test('should handle content loading state', () => {// Override the mock to simulate loading
  ...
  test('should handle content loading errors', () => {// Override the mock to simulate error
    (useQuery as jest.Mock).mockImplementation(() => ({
      data: null,
      isLoading: false,
  ...
  test('should provide navigation controls between versions', async () => {
    ...
    render(<DocumentVersionComparison
        ...
        availableVersions={[
          mockVersion1,
          mockVersion2,
          { ...mockVersion2, id: 3, versionNumber: 3},
        ]} />);
  ...
  test('should highlight specific differences between versions', async () => {// Mock versions with specific differences to test highlighting
    ...
    await waitFor(() => {// Check for removed content highlighted in red
