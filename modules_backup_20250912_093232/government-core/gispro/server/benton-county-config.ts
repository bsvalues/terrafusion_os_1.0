export const BENTON_COUNTY_CONFIG = {
  ...
  gisServices: {
    ...
    parcelService:
      'https://services7.arcgis.com/NURlY7V8UHl6XumF/arcgis/rest/services/Parcels/FeatureServer/0',
    taxLotService:
      'https://services7.arcgis.com/NURlY7V8UHl6XumF/arcgis/rest/services/TaxLots/FeatureServer/0',
    zoningService:
      'https://services7.arcgis.com/NURlY7V8UHl6XumF/arcgis/rest/services/Zoning/FeatureServer/0',
  },
  ...
  economicData: {
    ...
    agriculturalProducts: ['Wine Grapes', 'Wheat', 'Potatoes', 'Onions', 'Corn', 'Alfalfa'],
  },
  ...
  geography: {
    ...
    majorWaterways: ['Columbia River', 'Yakima River', 'Snake River'],
  },
  ...
  assessmentDistricts: [
    ...
    {
      id: 3,
      name: 'West Richland District',
      description: 'City of West Richland and surrounding areas',
    },
  ...
  propertyTypes: [
    ...
    { code: 'COM', name: 'Commercial', description: 'Retail, office, hospitality properties' },
    {
      code: 'IND',
      name: 'Industrial',
      description: 'Manufacturing, warehouses, processing facilities',
    },
    ...
    { code: 'UTI', name: 'Utility', description: 'Power plants, substations, transmission lines' },
    {
      code: 'GOV',
      name: 'Government',
      description: 'Federal, state, county, municipal properties',
    },
  ],
