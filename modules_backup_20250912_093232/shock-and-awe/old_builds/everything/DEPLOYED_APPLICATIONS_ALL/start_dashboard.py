...
def start_dashboard():
    ...
    try:
        ...
        print("🌐 Opening at: http://localhost:\${{TF_API_PORT:-5000}}")
        ...
        # Open browser
        try:
            subprocess.run(['start', 'http://localhost:\${{TF_API_PORT:-5000}}'], shell=True)
        except:
            print("🌐 Please open http://localhost:\${{TF_API_PORT:-5000}} in your browser")
