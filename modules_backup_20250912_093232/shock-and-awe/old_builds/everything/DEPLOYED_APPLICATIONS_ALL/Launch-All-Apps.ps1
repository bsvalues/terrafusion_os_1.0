...
Write-Host "1. 🏠 TerraFusion Build      - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "2. 🔄 TerraFlow              - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White  
Write-Host "3. 🔗 TerraFusionSync        - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "4. 🤖 TerraAgent             - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "5. 🏢 TerraFusionAssessor    - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "6. 📊 TerraFusionDashboard   - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "7. ⛏️  TerraMiner            - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
Write-Host "8. 💰 TerraFusionLevy        - http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
...
switch ($choice) {
    ...
    "3" {
        ...
        Write-Host "🏠 TerraFusion Build:     http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "🔄 TerraFlow:             http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "🔗 TerraFusionSync:       http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "🤖 TerraAgent:            http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "🏢 TerraFusionAssessor:   http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "📊 TerraFusionDashboard:  http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "⛏️  TerraMiner:           http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
        Write-Host "💰 TerraFusionLevy:       http://localhost:\${{TF_API_PORT:-5000}}" -ForegroundColor White
