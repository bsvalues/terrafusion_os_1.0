...
def main():
    ...
    try:
        ...
        print("🌐 Access at: http://localhost:\${{TF_SERVICE_8009_PORT:-8009}}")
        ...
        print("   • http://localhost:\${{TF_SERVICE_8009_PORT:-8009}} - TerraFusion Comprehensive")
        print("   • http://localhost:\${{TF_SERVICE_8009_PORT:-8009}} - TerraAgent AI")
        print("   • http://localhost:\${{TF_SERVICE_8009_PORT:-8009}} - TerraMiner Analytics")
        print("   • http://localhost:\${{TF_SERVICE_8009_PORT:-8009}} - BSIncomeValuation")
        return 1
