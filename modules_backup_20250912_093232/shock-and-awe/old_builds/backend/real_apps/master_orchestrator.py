...
class TerraFusionMasterOrchestrator:
    def __init__(self):
        self.applications = {
            "terrafusion-build": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terraflow": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-sync": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terraagent": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-assessor": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-dashboard": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terraminer": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "bs-income-valuation": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-pro": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "bcbs-gis-pro": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "bcbs-levy": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-assistant": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-pro-plus": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-permit": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "terrafusion-pilt": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None},
            "rag-system": {"port": \${{TF_API_PORT:-5000}}, "status": "unknown", "last_check": None}
        }
