...
export class ResearchLogger {
  ...
  experiment(
    ...
    this.log(LogLevel.INFO, `Experiment ${action}: ${experimentId}`, {
      ...metadata,
      experimentId,
      action,
      results,
  ...
  aiDecision(
    ...
    this.log(LogLevel.INFO, `AI Decision: ${decision}`, {
      ...metadata,
      decision,
      reasoning,
      confidence,
  ...
  performance(
    ...
    this.log(level, `Performance Metric: ${metric} = ${value} ${unit}`, {
      ...metadata,
      metric,
      value,
      unit,
  ...
  researchIteration(
    ...
    this.log(LogLevel.INFO, `Research Iteration ${iteration}: ${hypothesis.substring(0, 100)}...`, {
      ...metadata,
      iteration,
      hypothesis,
      results,
