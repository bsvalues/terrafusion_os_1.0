...
export function DocumentParcelLinker({
  ...
  useEffect(() => {
    const handleWebSocketMessage = (message: any) => {
      if (message.type === 'document_parcel_link_created' || 
  ...
  const handleCreateLink = () => {
    if (!selectedParcelId || !selectedDocumentId) {
      toast({
    ...
    const linkData: InsertDocumentParcelLink = {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Document-Parcel Links</h2>
            ...
            <Dialog open={linkDialogOpen} onOpenChange={setLinkDialogOpen}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Link a document to a parcel with additional context information
                  </DialogDescription>
                </DialogHeader>
                        ...
                        {parcels.map((parcel: any) => (
                          <SelectItem key={parcel.id} value={parcel.id.toString()}>
                            <div className="flex items-center gap-2">
                              ...
                              <span>{parcel.parcelNumber} - {parcel.address}</span>
                            </div>
                          </SelectItem>
                        ))}
                      </SelectContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Current document-parcel relationships
          </CardDescription>
        </CardHeader>
          ...
          {linksLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                No document-parcel relationships have been created yet.
              </p>
              {showLinkButton && (
            ...
            <ScrollArea className="h-96">
              <Table>
                ...
                <TableBody>
                  {links.map((link: DocumentParcelLink & { document: Document; parcel: any }) => {
                      ...
                      <TableRow key={link.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <MapPin className="h-4 w-4" />
                            <div>
                              <div className="font-medium">{link.parcel.parcelNumber}</div>
                              <div className="text-sm text-muted-foreground">
                                {link.parcel.address}
                              </div>
                            </div>
                        ...
                        <TableCell>
                          <Badge variant={linkBadge.variant as any}>
                            {linkBadge.label}
                          </Badge>
                        </TableCell>
                        ...
                        <TableCell>
                          {link.notes && (
                            <div className="text-sm max-w-xs truncate" title={link.notes}>
                              {link.notes}
                            </div>
                          )}
                        </TableCell>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-2xl font-bold">
                    {new Set(links.map(l => l.documentId)).size}
                  </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-2xl font-bold">
                    {new Set(links.map(l => l.parcelId)).size}
                  </div>
                  <div className="text-sm text-muted-foreground">Linked Parcels</div>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Collaboration Status</div>
                </div>
              </div>
            </CardContent>
          </Card>
