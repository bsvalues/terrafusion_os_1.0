...
import { Search, MapPin, Home, DollarSign, Calendar, FileText, Phone, Mail } from '@mui/icons-material';
...
export default function PublicPropertyPortal() {
  ...
  const handlePropertySelect = async (propertyId: string) => {
    setSelectedParcelId(propertyId);
  ...
  const applyFilters = () => {
    ...
    if (filters.minValue) {
      filtered = filtered.filter(p => p.assessedValue >= parseInt(filters.minValue));
    }
    
    if (filters.maxValue) {
      filtered = filtered.filter(p => p.assessedValue <= parseInt(filters.maxValue));
    }
    
    if (filters.yearBuilt) {
      filtered = filtered.filter(p => p.yearBuilt >= parseInt(filters.yearBuilt));
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-primary-700 text-white py-6">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Benton County Property Portal</h1>
              <p className="text-primary-100">Find property information across Benton County, Washington</p>
            </div>
            <div className="text-right">
              <p className="text-sm">Official Public Records</p>
      ...
      <main className="container mx-auto px-4 py-8">
            ...
            <details className="mt-4">
              ...
              <div className="mt-4 p-4 border rounded-lg bg-gray-50">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
                  ...
                  <div>
                    <Label htmlFor="yearBuilt">Built After</Label>
                    <Input
                      id="yearBuilt"
                      type="number"
                      placeholder="Year"
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="C-1">C-1 (Commercial)</option>
                      <option value="C-2">C-2 (Commercial)</option>
                      <option value="I-1">I-1 (Industrial)</option>
                      <option value="A-1">A-1 (Agricultural)</option>
                    </select>
                  </div>
                </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            ...
                            <Badge variant="secondary">{property.zoning}</Badge>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-medium">${property.assessedValue.toLocaleString()}</p>
                          <p className="text-sm text-neutral-500">{property.yearBuilt}</p>
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        {selectedParcelId && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed information for selected property
              </CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingDetails ? (
                ...
                <Tabs defaultValue="overview">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            <span>Owner:</span>
                            <span>{propertyDetails.owner}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Address:</span>
                          ...
                          <div className="flex justify-between">
                            <span>Tax Parcel ID:</span>
                            <span>{propertyDetails.taxParcelId}</span>
                          </div>
                          <div className="flex justify-between">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span>{propertyDetails.squareFootage.toLocaleString()} sq ft</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Lot Size:</span>
                            <span>{propertyDetails.lotSize.toLocaleString()} sq ft</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Acreage:</span>
                            <span>{propertyDetails.acreage.toFixed(2)} acres</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Year Built:</span>
                            <span>{propertyDetails.yearBuilt || "N/A"}</span>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-neutral-500">
                              Coordinates: {propertyDetails.coordinates[1].toFixed(4)}, {propertyDetails.coordinates[0].toFixed(4)}
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span className="text-lg font-medium">${propertyDetails.assessedValue.toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Tax Year:</span>
                            <span>{propertyDetails.taxYear}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            ...
                            <span>{new Date(propertyDetails.lastSaleDate).toLocaleDateString()}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Last Sale Price:</span>
                            <span className="text-sm text-neutral-600">
                              ${propertyDetails.lastSalePrice.toLocaleString()}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <TabsContent value="zoning" className="mt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <h4 className="font-semibold mb-3">Zoning Information</h4>
                        <div className="space-y-2">
                          <div className="flex justify-between">
                            <span>Zoning District:</span>
                            <span className="text-lg">{propertyDetails.zoning}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Property Type:</span>
                            <span>{propertyDetails.propertyType}</span>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          <p className="text-sm text-neutral-600">
                            For detailed zoning regulations and permitted uses, please contact the Planning Department.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <p className="text-neutral-500">Property details not found.</p>
              )}
            </CardContent>
          </Card>
        )}
        ...
        {/* Help Section */}
        {!selectedParcelId && filteredProperties.length === 0 && !searchTerm && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li>• Search by property address, owner name, or tax parcel ID</li>
                  <li>• Use advanced filters to narrow your search</li>
                  <li>• Click on any property to view detailed information</li>
                  <li>• All data is from official county records</li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  <p><strong>Assessor's Office:</strong> (509) 736-3085</p>
                  <p><strong>Planning Department:</strong> (509) 736-3090</p>
                  <p><strong>Email:</strong> assessor@co.benton.wa.us</p>
                  <p className="text-xs text-neutral-500 mt-2">This website provides public record information for reference purposes only.</p>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h3 className="text-lg font-semibold">Benton County, Washington</h3>
            <p className="text-sm text-gray-300 mt-1">This website provides public record information for reference purposes only.</p>
          </div>
        </div>
      </footer>
    </div>
