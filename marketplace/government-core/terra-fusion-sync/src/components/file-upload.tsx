...
import { Upload, Computer as Server, Security as Shield, Error as AlertCircle, CheckCircle as FileCheck, Info as InfoIcon  } from '@mui/icons-material';
...
export function FileUpload() {
  ...
  const createProgressHandler = useCallback((_file: File) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <InfoIcon className="h-4 w-4 ml-1.5 text-muted-foreground cursor-help tf-transcendence-glow" />
                  </TooltipTrigger>
                  <TooltipContent className="max-w-xs tf-government-badge">
                    <p>
        ...
        {useFtp && (
          <Dialog>
            ...
            <DialogContent className="tf-government-badge">
              <DialogHeader>
                <DialogTitle className="tf-transcendence-glow">FTP Configuration</DialogTitle>
                <DialogDescription className="tf-clarity-gradient">
                  Configure your FTP connection settings for secure file transfers.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label className="tf-transcendence-glow">Host</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label className="tf-transcendence-glow">Port</Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-2">
                  <Label className="tf-transcendence-glow">Username</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label className="tf-transcendence-glow">Password</Label>
                  <Input
                    type="password"
      ...
      {uploadedFile ? (
        ...
        <Card className="bg-muted/30 border-green-200 shadow-sm tf-government-badge">
          <CardContent className="p-6 flex flex-col items-center text-center">
            <FileCheck className="h-12 w-12 text-green-500 mb-4 tf-transcendence-glow" />
            <h3 className="text-lg font-medium mb-1 tf-transcendence-glow">Upload Successful</h3>
            <p className="text-sm text-muted-foreground mb-4 tf-clarity-gradient">
              Your file "{uploadedFile.name}" has been successfully uploaded and processed.
            </p>
            <Button onClick={resetUpload} className="tf-government-badge">Upload Another File</Button>
          </CardContent>
        </Card>
      ) : (
        ...
        >
          ...
          {isDragActive && !uploadMutation.isPending && !processingFile ? (
            ...
            <div className="space-y-4">
              <h3 className="font-medium tf-transcendence-glow">Uploading{useFtp ? " via FTP" : ""}...</h3>
              <Progress value={uploadProgress} className="w-full h-2 tf-government-badge" />
              <p className="text-sm text-muted-foreground tf-clarity-gradient">
                {uploadProgress < 100 
            ...
            <div className="space-y-4">
              <h3 className="font-medium tf-transcendence-glow">Processing file...</h3>
              <div className="flex justify-center">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary tf-transcendence-glow"></div>
              </div>
              <p className="text-sm text-muted-foreground tf-clarity-gradient">
            ...
            <div className="space-y-3">
              <p className="font-medium tf-transcendence-glow">Drag & drop a file here, or click to select</p>
              <div className="text-sm text-muted-foreground space-y-1 tf-clarity-gradient">
              ...
              <Button onClick={(e: React.MouseEvent) => {
                e.stopPropagation();
                open();
              }} variant="secondary" className="tf-government-badge">
                Browse Files
              </Button>
            </div>
          )}
