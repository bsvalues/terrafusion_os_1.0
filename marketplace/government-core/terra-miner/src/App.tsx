  ...
  const renderMiningTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Advanced pattern recognition and machine learning insights</p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <NetworkCheck className="h-4 w-4 text-orange-600" />
            </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-semibold flex items-center">
            <Storage className="h-5 w-5 mr-2 text-blue-600" />
            Mining Jobs
          </h3>
          <button
            ...
            <div key={job.id} className="border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <p className="text-sm text-gray-600 capitalize">{job.type.replace('-', ' ')}</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                <div>
                  ...
                  <div className="font-semibold">{job.data_points.toLocaleString()}</div>
                </div>
                <div>
                  <span className="text-gray-600">Insights:</span>
                  <div className="font-semibold">{job.insights}</div>
                </div>
                <div>
  ...
  const renderInsightsTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Machine learning insights and pattern discoveries</p>
      </div>
          ...
          <div key={insight.id} className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                <Psychology className="h-6 w-6 text-blue-600 mr-2" />
                <div>
                  <h3 className="font-semibold text-lg">{insight.title}</h3>
                  <p className="text-sm text-gray-600 capitalize">{insight.type.replace('-', ' ')}</p>
                </div>
              </div>
            ...
            {insight.metrics && (
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold">{(insight.metrics.correlation * 100).toFixed(1)}%</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Statistical Significance:</span>
                  <span className="font-semibold">{(insight.metrics.significance * 100).toFixed(1)}%</span>
                </div>
              </div>
            )}
  ...
  const renderPatternsTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Advanced pattern recognition and trend analysis</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-3">
                  <div>
                    ...
                    <div className="font-semibold">{pattern.frequency.toFixed(1)}%</div>
                  </div>
                  <div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4 flex items-center">
            <Visibility className="h-5 w-5 mr-2 text-purple-600" />
  ...
  const renderAnalyticsTab = () => (
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-lg">
        ...
        <p className="opacity-90">Comprehensive performance metrics and visualizations</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4 flex items-center">
            <GpsFixed className="h-5 w-5 mr-2 text-purple-600" />
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-semibold mb-4 flex items-center">
            <FlashOn className="h-5 w-5 mr-2 text-yellow-600" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              ...
              <span className="text-xl font-bold text-purple-600">94.2%</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
              <span className="font-medium">Processing Speed</span>
              <span className="text-xl font-bold text-orange-600">2.3k/min</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              <Storage className="h-8 w-8 text-purple-600 mr-3" />
              <div>
                <h1 className="text-2xl font-bold text-gray-900">TerraMiner</h1>
                <p className="text-sm text-gray-600">Advanced Data Mining & Analytics</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
