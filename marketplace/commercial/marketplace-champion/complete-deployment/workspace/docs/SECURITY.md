...
## Security Overview
Terrafusion implements government-grade security standards to protect sensitive municipal data and ensure compliance with federal, state, and local regulations.
...
const roles = {
  ...
  'county_admin': {
    permissions: [
      'county.read', 'county.write',
      'users.manage', 'reports.generate',
      'properties.manage', 'assessments.manage'
    ],
  ...
  'realtor': {
    permissions: [
      'properties.read', 'assessments.read',
      'reports.property'
    ],
  ...
  'user': {
    permissions: [
      'properties.read', 'own_property.read'
    ],
