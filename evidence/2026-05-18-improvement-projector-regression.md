...
(`evidence/2026-05-17-projector-delete-insert-atomicity-bug.md`, commit
...
Per `evidence/2026-05-17-projector-delete-insert-atomicity-bug.md`:
...
- Widen `canonical_tf.tf_improvement_feature.FeatureCode` from varchar(32) to
  ...
  successfully. Per `evidence/2026-05-17-varchar32-overflow-finding.md`.
