...
function main() {
  ...
  console.log(`║                                                              ║`);
  console.log(
    `║  📁 Test Files Found: ${String(testFiles.length).padStart(3)} files                        ║`
  );
  console.log(
    `║  ✅ Valid Tests: ${String(validTests).padStart(3)} files                            ║`
  );
  console.log(
    `║  ❌ Invalid Tests: ${String(invalidTests).padStart(3)} files                          ║`
  );
  console.log(`║                                                              ║`);
  ...
  console.log(
    `║  📊 Test Categories: ${String(categories.size).padStart(2)} categories                     ║`
  );
  ...
  console.log(`║                                                              ║`);
  console.log(
    `║  🏆 STATUS: ${validTests > 0 ? 'OPERATIONAL' : 'NEEDS SETUP'}                              ║`
  );
